...
.field public onLoad:Lcom/my/target/nativeads/NativeAdLoader$OnLoad;
...
.method public constructor <init>(IILandroid/content/Context;Lcom/my/target/common/menu/MenuFactory;)V
    ...
    const-string p2, "NativeAdLoader: Invalid bannersCount < 1, bannersCount set to 1"
    ...
    iput-object p4, p0, Lcom/my/target/nativeads/NativeAdLoader;->menuFactory:Lcom/my/target/common/menu/MenuFactory;

    const-string p1, "Native ad loader created. Version - 5.19.0"
...
.method private handleResult(Lcom/my/target/r6;Lcom/my/target/common/models/IAdLoadingError;)V
    ...
    iget-object v3, p0, Lcom/my/target/nativeads/NativeAdLoader;->menuFactory:Lcom/my/target/common/menu/MenuFactory;

    iget-object v4, p0, Lcom/my/target/nativeads/NativeAdLoader;->appContext:Landroid/content/Context;
    ...
    invoke-virtual {v1, v2}, Lcom/my/target/nativeads/NativeAd;->setCachePolicy(I)V

    invoke-virtual {v1, v0}, Lcom/my/target/nativeads/NativeAd;->setBanner(Lcom/my/target/e6;)V
...
.method public synthetic a(Lcom/my/target/l;Lcom/my/target/r6;Lcom/my/target/m;)V
    ...
    iget-object v0, p0, Lcom/my/target/nativeads/NativeAdLoader;->adFactory:Lcom/my/target/l;

    if-ne p1, v0, :cond_0

    const/4 p1, 0x0

    iput-object p1, p0, Lcom/my/target/nativeads/NativeAdLoader;->adFactory:Lcom/my/target/l;

    invoke-direct {p0, p2, p3}, Lcom/my/target/nativeads/NativeAdLoader;->handleResult(Lcom/my/target/r6;Lcom/my/target/common/models/IAdLoadingError;)V
...
.method public load()Lcom/my/target/nativeads/NativeAdLoader;
    ...
    iput-object v1, p0, Lcom/my/target/nativeads/NativeAdLoader;->adFactory:Lcom/my/target/l;

    new-instance v2, Lcom/lenovo/anyshare/scc;

    invoke-direct {v2, p0, v1}, Lcom/lenovo/anyshare/scc;-><init>(Lcom/my/target/nativeads/NativeAdLoader;Lcom/my/target/l;)V

    invoke-virtual {v1, v2}, Lcom/my/target/l;->a(Lcom/my/target/l$b;)Lcom/my/target/l;

    move-result-object v1

    iget-object v2, p0, Lcom/my/target/nativeads/NativeAdLoader;->appContext:Landroid/content/Context;
