.class public Lcom/my/target/v1;
...
.method public declared-synchronized a(Lcom/my/target/common/MyTargetConfig;Landroid/content/Context;)Ljava/util/Map;
    ...
    :cond_0
    :try_start_1
    iget-object p1, p0, Lcom/my/target/v1;->a:Ljava/util/Map;
    ...
    iput-object p1, p0, Lcom/my/target/v1;->a:Ljava/util/Map;

    invoke-virtual {p0, p1, p2}, Lcom/my/target/v1;->b(Ljava/util/Map;Landroid/content/Context;)V

    :cond_1
    new-instance p1, Ljava/util/HashMap;

    iget-object p2, p0, Lcom/my/target/v1;->a:Ljava/util/Map;
...
.method public final b(Ljava/util/Map;Landroid/content/Context;)V
    ...
    const-string v0, "GoogleAIdDataProvider: Send google AId"
    ...
    const-string v2, "GoogleAIdDataProvider: Google AId - "
    ...
    const-string v4, "GoogleAIdDataProvider: Ad tracking enabled - "
    ...
    :goto_2
    invoke-static {v0}, Lcom/my/target/v1;->a(Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-virtual {p0, p1, p2}, Lcom/my/target/v1;->a(Ljava/util/Map;Landroid/content/Context;)V
