.class public Lcom/my/target/q2;
...
.method public static a(Ljava/lang/String;Lcom/my/target/s;Lcom/my/target/s2;Lcom/my/target/j;Lcom/my/target/n;)Lcom/my/target/s2;
    .locals 1
    ...
    invoke-static {}, Lcom/my/target/s2;->e()Lcom/my/target/s2;

    move-result-object p2

    :cond_1
    invoke-virtual {p2, p0}, Lcom/my/target/s2;->a(Ljava/lang/String;)Lcom/my/target/h3;
    ...
    invoke-static {p3, p0, p1}, Lcom/my/target/q2;->a(Lcom/my/target/ga;Lcom/my/target/h3;Lcom/my/target/s;)V
    ...
    invoke-virtual {p0}, Lcom/my/target/h3;->h()Ljava/lang/String;
    ...
    :cond_4
    invoke-virtual {p0}, Lcom/my/target/h3;->a()I
    ...
    invoke-virtual {p0, p3}, Lcom/my/target/h3;->a(Lcom/my/target/s;)V
...
.method public static a(Ljava/lang/String;Lcom/my/target/s;Lcom/my/target/s2;Lcom/my/target/j;Lcom/my/target/p5$a;Lcom/my/target/p5;Ljava/util/List;Lcom/my/target/n;Landroid/content/Context;)Lcom/my/target/s2;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p4, p0, p2}, Lcom/my/target/t2;->a(Lorg/json/JSONObject;Lcom/my/target/s2;)V
    ...
    invoke-virtual {p2, p5}, Lcom/my/target/s2;->a(Ljava/lang/String;)Lcom/my/target/h3;

    move-result-object v2

    if-eqz v2, :cond_5

    invoke-static {p1, p3, p8}, Lcom/my/target/d1;->a(Lcom/my/target/s;Lcom/my/target/j;Landroid/content/Context;)Lcom/my/target/d1;

    move-result-object v3

    invoke-static {p1, p3, p8}, Lcom/my/target/c1;->a(Lcom/my/target/s;Lcom/my/target/j;Landroid/content/Context;)Lcom/my/target/c1;
    ...
    invoke-static/range {v0 .. v6}, Lcom/my/target/q2;->a(Lorg/json/JSONObject;Lcom/my/target/y;Lcom/my/target/h3;Lcom/my/target/d1;Lcom/my/target/c1;Lcom/my/target/s;Lcom/my/target/n;)V

    goto :goto_2

    :cond_4
    invoke-virtual {p2}, Lcom/my/target/s2;->c()Ljava/util/ArrayList;
...
.method public static a(Lcom/my/target/ga;Lcom/my/target/h3;Lcom/my/target/s;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1, v1, v0}, Lcom/my/target/h3;->a(Lcom/my/target/f0;I)V
    ...
    :cond_6
    invoke-virtual {p1, v1}, Lcom/my/target/h3;->a(Lcom/my/target/f0;)V
...
.method public static a(Lcom/my/target/s;Lcom/my/target/y;Lorg/json/JSONObject;Lcom/my/target/h3;Ljava/util/ArrayList;Ljava/util/ArrayList;Lcom/my/target/n;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-virtual {p3}, Lcom/my/target/h3;->h()Ljava/lang/String;

    move-result-object p2

    invoke-virtual {p1, p2}, Lcom/my/target/s;->e(Ljava/lang/String;)V

    invoke-virtual {p0}, Lcom/my/target/s;->a()Lcom/my/target/c;
    ...
    :cond_2
    invoke-virtual {p3}, Lcom/my/target/h3;->a()I
    ...
    :cond_3
    invoke-virtual {p3, p1}, Lcom/my/target/h3;->a(Lcom/my/target/s;)V
...
.method public static a(Lorg/json/JSONObject;Lcom/my/target/y;Lcom/my/target/h3;Lcom/my/target/d1;Lcom/my/target/c1;Lcom/my/target/s;Lcom/my/target/n;)V
    .locals 13

    move-object v7, p2

    invoke-virtual {p2}, Lcom/my/target/h3;->h()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual/range {p5 .. p5}, Lcom/my/target/s;->A()I
    ...
    invoke-static/range {v0 .. v6}, Lcom/my/target/q2;->a(Lcom/my/target/s;Lcom/my/target/y;Lorg/json/JSONObject;Lcom/my/target/h3;Ljava/util/ArrayList;Ljava/util/ArrayList;Lcom/my/target/n;)V
    ...
    invoke-static {}, Lcom/my/target/ka;->newBanner()Lcom/my/target/ka;

    move-result-object v0

    move-object/from16 v3, p4

    invoke-virtual {v3, v2, v0}, Lcom/my/target/c1;->a(Lorg/json/JSONObject;Lcom/my/target/ka;)Z

    move-result v2

    if-eqz v2, :cond_6

    invoke-virtual/range {p5 .. p5}, Lcom/my/target/s;->y()F
    ...
    :cond_3
    invoke-virtual/range {p5 .. p5}, Lcom/my/target/s;->z()F
    ...
    invoke-virtual {v4, v2, v0}, Lcom/my/target/d1;->a(Lorg/json/JSONObject;Lcom/my/target/b5;)Z
    ...
    invoke-virtual {p2, v0, v12}, Lcom/my/target/h3;->a(Lcom/my/target/f0;I)V
    ...
    :cond_a
    :goto_3
    invoke-virtual {p2, v0}, Lcom/my/target/h3;->a(Lcom/my/target/f0;)V
    ...
    :cond_c
    invoke-static {v10, v9}, Lcom/my/target/q2;->a(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method public bridge synthetic a(Ljava/lang/String;Lcom/my/target/s;Lcom/my/target/q;Lcom/my/target/j;Lcom/my/target/p5$a;Lcom/my/target/p5;Ljava/util/List;Lcom/my/target/n;Landroid/content/Context;)Lcom/my/target/q;
    ...
    check-cast p3, Lcom/my/target/s2;

    invoke-virtual/range {p0 .. p9}, Lcom/my/target/q2;->b(Ljava/lang/String;Lcom/my/target/s;Lcom/my/target/s2;Lcom/my/target/j;Lcom/my/target/p5$a;Lcom/my/target/p5;Ljava/util/List;Lcom/my/target/n;Landroid/content/Context;)Lcom/my/target/s2;
...
.method public b(Ljava/lang/String;Lcom/my/target/s;Lcom/my/target/s2;Lcom/my/target/j;Lcom/my/target/p5$a;Lcom/my/target/p5;Ljava/util/List;Lcom/my/target/n;Landroid/content/Context;)Lcom/my/target/s2;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, p2, p3, p4, p8}, Lcom/my/target/q2;->a(Ljava/lang/String;Lcom/my/target/s;Lcom/my/target/s2;Lcom/my/target/j;Lcom/my/target/n;)Lcom/my/target/s2;
    ...
    :cond_0
    invoke-static/range {p1 .. p9}, Lcom/my/target/q2;->a(Ljava/lang/String;Lcom/my/target/s;Lcom/my/target/s2;Lcom/my/target/j;Lcom/my/target/p5$a;Lcom/my/target/p5;Ljava/util/List;Lcom/my/target/n;Landroid/content/Context;)Lcom/my/target/s2;
