...
.method public a(Lcom/lenovo/anyshare/Rlc;)Lcom/lenovo/anyshare/cEc;
    ...
    .line 4
    invoke-virtual {v1, v0, v2}, Lcom/reader/office/java/awt/geom/Path2D$Float;->moveTo(FF)V

    int-to-float v3, p1

    .line 5
    invoke-virtual {v1, v0, v3}, Lcom/reader/office/java/awt/geom/Path2D$Float;->lineTo(FF)V

    const v4, 0x46a8c000    # 21600.0f

    .line 6
    invoke-virtual {v1, v4, v3}, Lcom/reader/office/java/awt/geom/Path2D$Float;->lineTo(FF)V
    ...
    .line 7
    invoke-virtual {v1, v4, p1}, Lcom/reader/office/java/awt/geom/Path2D$Float;->lineTo(FF)V

    .line 8
    invoke-virtual {v1, v0, p1}, Lcom/reader/office/java/awt/geom/Path2D$Float;->lineTo(FF)V

    .line 9
    invoke-virtual {v1, v0, v4}, Lcom/reader/office/java/awt/geom/Path2D$Float;->lineTo(FF)V

    const p1, 0x4628c000    # 10800.0f

    .line 10
    invoke-virtual {v1, v2, p1}, Lcom/reader/office/java/awt/geom/Path2D$Float;->lineTo(FF)V
