.class public Lcom/lenovo/anyshare/DUc;
...
.method static constructor <clinit>()V
    ...
    .line 1
    invoke-static {}, Lcom/lenovo/anyshare/qUc;->i()I

    move-result v0

    sput v0, Lcom/lenovo/anyshare/DUc;->c:I

    .line 2
    invoke-static {}, Lcom/lenovo/anyshare/qUc;->h()I

    move-result v0

    sput v0, Lcom/lenovo/anyshare/DUc;->d:I
...
.method public static a()Lokhttp3/OkHttpClient;
    ...
    .line 19
    sget-object v0, Lcom/lenovo/anyshare/DUc;->b:Lokhttp3/OkHttpClient;
    ...
    .line 20
    :cond_0
    const-class v0, Lcom/lenovo/anyshare/DUc;

    monitor-enter v0

    .line 21
    :try_start_0
    sget-object v1, Lcom/lenovo/anyshare/DUc;->b:Lokhttp3/OkHttpClient;
    ...
    sput-object v1, Lcom/lenovo/anyshare/DUc;->b:Lokhttp3/OkHttpClient;
...
.method public static a(ZII)Lokhttp3/OkHttpClient;
    ...
    .line 1
    sget-object v0, Lcom/lenovo/anyshare/DUc;->a:Lokhttp3/OkHttpClient;
    ...
    .line 3
    :try_start_0
    sget-object v1, Lcom/lenovo/anyshare/DUc;->a:Lokhttp3/OkHttpClient;
    ...
    new-instance p1, Lcom/sharead/base/network/http/OkEventListenerStats;

    invoke-direct {p1}, Lcom/sharead/base/network/http/OkEventListenerStats;-><init>()V
    ...
    new-instance p1, Lcom/lenovo/anyshare/uUc;

    invoke-direct {p1}, Lcom/lenovo/anyshare/uUc;-><init>()V
    ...
    invoke-static {p1, p2, v1}, Lcom/lenovo/anyshare/xbd;->a(Landroid/content/Context;Ljava/lang/String;Z)Z
    ...
    .line 12
    new-instance p1, Lcom/lenovo/anyshare/DUc$a;

    invoke-direct {p1}, Lcom/lenovo/anyshare/DUc$a;-><init>()V

    invoke-virtual {p0, p1}, Lokhttp3/OkHttpClient$Builder;->addInterceptor(Lokhttp3/Interceptor;)Lokhttp3/OkHttpClient$Builder;

    .line 13
    :cond_1
    sget p1, Lcom/lenovo/anyshare/DUc;->c:I

    const/4 p2, 0x5

    if-ne p1, p2, :cond_2

    sget p1, Lcom/lenovo/anyshare/DUc;->d:I
    ...
    sget p2, Lcom/lenovo/anyshare/DUc;->c:I

    sget v1, Lcom/lenovo/anyshare/DUc;->d:I
    ...
    sput-object p0, Lcom/lenovo/anyshare/DUc;->a:Lokhttp3/OkHttpClient;
    ...
    .line 17
    sget-object p0, Lcom/lenovo/anyshare/DUc;->a:Lokhttp3/OkHttpClient;
