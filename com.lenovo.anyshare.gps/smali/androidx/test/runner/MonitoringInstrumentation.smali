...
# static fields
.field public static final MILLIS_TO_POLL_FOR_ACTIVITY_STOP:J

.field public static final MILLIS_TO_WAIT_FOR_ACTIVITY_TO_STOP:J


# instance fields
.field public anActivityHasBeenLaunched:Ljava/util/concurrent/atomic/AtomicBoolean;

.field public applicationMonitor:Landroidx/test/internal/runner/lifecycle/ApplicationLifecycleMonitorImpl;

.field public executorService:Ljava/util/concurrent/ExecutorService;

.field public volatile finished:Z

.field public handlerForMainLooper:Landroid/os/Handler;

.field public idleHandler:Landroid/os/MessageQueue$IdleHandler;

.field public intentMonitor:Landroidx/test/internal/runner/intent/IntentMonitorImpl;

.field public volatile interceptingActivityFactory:Landroidx/test/runner/intercepting/InterceptingActivityFactory;

.field public isDexmakerClassLoaderInitialized:Ljava/lang/ThreadLocal;
...
.field public isJsBridgeLoaded:Ljava/util/concurrent/atomic/AtomicBoolean;

.field public volatile isOriginalInstr:Ljava/lang/Boolean;

.field public jsBridgeClassName:Ljava/lang/String;

.field public lastIdleTime:Ljava/util/concurrent/atomic/AtomicLong;

.field public lifecycleMonitor:Landroidx/test/internal/runner/lifecycle/ActivityLifecycleMonitorImpl;

.field public standardHandler:Ljava/lang/Thread$UncaughtExceptionHandler;

.field public startedActivityCounter:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public static getMultiDexClass()Ljava/lang/Class;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private isOriginalUncached()Z
    ...
    .line 9
    :cond_3
    invoke-direct {p0, v0, v1}, Landroidx/test/runner/MonitoringInstrumentation;->isHostingProcess(Ljava/lang/String;Landroidx/test/internal/util/ProcSummary;)Z
