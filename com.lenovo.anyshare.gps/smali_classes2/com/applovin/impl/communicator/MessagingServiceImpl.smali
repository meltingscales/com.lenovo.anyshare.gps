...
# instance fields
.field public ajX:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

.field public final ajY:Ljava/lang/Object;
...
.method private tt()Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    sget-object v3, Lcom/lenovo/anyshare/eq;->a:Lcom/lenovo/anyshare/eq;
...
.method public publish(Lcom/applovin/communicator/AppLovinCommunicatorMessage;)V
    ...
    .line 2
    iget-object v0, p0, Lcom/applovin/impl/communicator/MessagingServiceImpl;->ajX:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    new-instance v1, Lcom/lenovo/anyshare/dq;

    invoke-direct {v1, p1}, Lcom/lenovo/anyshare/dq;-><init>(Lcom/applovin/communicator/AppLovinCommunicatorMessage;)V
