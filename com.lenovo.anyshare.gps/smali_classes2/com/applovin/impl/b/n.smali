...
# instance fields
.field public aXT:Ljava/util/List;
...
.field public aXU:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field public aXW:Lcom/applovin/impl/b/g;
...
.field public final aXe:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/applovin/impl/b/n;->aXT:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/applovin/impl/b/n;->aXU:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/applovin/impl/b/n;->aXd:Ljava/util/Set;
    ...
    iput-object v0, p0, Lcom/applovin/impl/b/n;->aXe:Ljava/util/Map;

    return-void
.end method

.method public constructor <init>(Lcom/applovin/impl/b/e;)V
    .locals 1
    ...
    .line 11
    invoke-virtual {p1}, Lcom/applovin/impl/b/e;->Ms()Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lcom/applovin/impl/b/n;->aXU:Ljava/util/List;
...
.method public static a(Lcom/applovin/impl/sdk/utils/y;Lcom/applovin/impl/b/n;Lcom/applovin/impl/b/e;Lcom/applovin/impl/sdk/n;)Lcom/applovin/impl/b/n;
    ...
    .line 2
    :goto_0
    iget v0, p1, Lcom/applovin/impl/b/n;->aXV:I
    ...
    .line 5
    iput v0, p1, Lcom/applovin/impl/b/n;->aXV:I
    ...
    .line 9
    iget-object v1, p1, Lcom/applovin/impl/b/n;->aXT:Ljava/util/List;
    ...
    .line 11
    :cond_2
    iput-object v0, p1, Lcom/applovin/impl/b/n;->aXT:Ljava/util/List;
    ...
    .line 13
    iget-object v1, p1, Lcom/applovin/impl/b/n;->aXb:Landroid/net/Uri;
    ...
    .line 14
    invoke-virtual {v0, v1}, Lcom/applovin/impl/sdk/utils/y;->dO(Ljava/lang/String;)Lcom/applovin/impl/sdk/utils/y;
    ...
    iput-object v1, p1, Lcom/applovin/impl/b/n;->aXb:Landroid/net/Uri;

    :cond_4
    const-string v1, "ClickTracking"

    .line 18
    invoke-virtual {v0, v1}, Lcom/applovin/impl/sdk/utils/y;->dN(Ljava/lang/String;)Ljava/util/List;

    move-result-object v0

    .line 19
    iget-object v1, p1, Lcom/applovin/impl/b/n;->aXd:Ljava/util/Set;
    ...
    .line 23
    invoke-virtual {v0, v2}, Lcom/applovin/impl/sdk/utils/y;->dO(Ljava/lang/String;)Lcom/applovin/impl/sdk/utils/y;
    ...
    .line 24
    invoke-virtual {v2, v3}, Lcom/applovin/impl/sdk/utils/y;->dN(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 25
    iget-object v3, v1, Lcom/applovin/impl/b/g;->aXd:Ljava/util/Set;
    ...
    .line 26
    invoke-virtual {v0, v2}, Lcom/applovin/impl/sdk/utils/y;->dN(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 27
    iget-object v2, v1, Lcom/applovin/impl/b/g;->aXz:Ljava/util/Set;
    ...
    .line 28
    :cond_7
    iput-object v1, p1, Lcom/applovin/impl/b/n;->aXW:Lcom/applovin/impl/b/g;

    .line 29
    :cond_8
    iget-object v0, p1, Lcom/applovin/impl/b/n;->aXe:Ljava/util/Map;
...
.method public static c(Lcom/applovin/impl/sdk/utils/y;Lcom/applovin/impl/sdk/n;)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    sget-object v3, Lcom/applovin/impl/sdk/c/b;->aPo:Lcom/applovin/impl/sdk/c/b;
    ...
    :cond_1
    :try_start_0
    invoke-virtual {v4}, Lcom/applovin/impl/b/o;->MH()Ljava/lang/String;
    ...
    .line 10
    :cond_2
    sget-object v5, Lcom/applovin/impl/sdk/c/b;->aPq:Lcom/applovin/impl/sdk/c/b;
    ...
    .line 11
    invoke-virtual {v4}, Lcom/applovin/impl/b/o;->FG()Landroid/net/Uri;
...
.method public static f(Ljava/lang/String;Lcom/applovin/impl/sdk/n;)I
    .locals 8
...
.method public LW()Lcom/applovin/impl/b/g;
    ...
    .line 1
    iget-object v0, p0, Lcom/applovin/impl/b/n;->aXW:Lcom/applovin/impl/b/g;
...
.method public ME()Ljava/util/List;
    ...
    .line 1
    iget-object v0, p0, Lcom/applovin/impl/b/n;->aXT:Ljava/util/List;
...
.method public MF()I
    ...
    .line 1
    iget v0, p0, Lcom/applovin/impl/b/n;->aXV:I

    return v0
.end method

.method public Ml()Landroid/net/Uri;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/applovin/impl/b/n;->aXb:Landroid/net/Uri;
...
.method public Mn()Ljava/util/Set;
    ...
    .line 1
    iget-object v0, p0, Lcom/applovin/impl/b/n;->aXd:Ljava/util/Set;
...
.method public Mo()Ljava/util/Map;
    ...
    .line 1
    iget-object v0, p0, Lcom/applovin/impl/b/n;->aXe:Ljava/util/Map;
...
.method public a(Lcom/applovin/impl/b/n$a;J)Lcom/applovin/impl/b/o;
    ...
    .line 37
    iget-object v2, p0, Lcom/applovin/impl/b/n;->aXU:Ljava/util/List;
    ...
    .line 38
    iget-object v4, p0, Lcom/applovin/impl/b/n;->aXT:Ljava/util/List;
    ...
    .line 39
    invoke-virtual {v5}, Lcom/applovin/impl/b/o;->MH()Ljava/lang/String;
    ...
    .line 45
    sget-object v2, Lcom/applovin/impl/b/n$a;->aYc:Lcom/applovin/impl/b/n$a;
    ...
    .line 47
    invoke-virtual {v2}, Lcom/applovin/impl/b/o;->MI()J
    ...
    .line 49
    :cond_9
    sget-object p2, Lcom/applovin/impl/b/n$a;->aXZ:Lcom/applovin/impl/b/n$a;
    ...
    .line 51
    :cond_a
    sget-object p2, Lcom/applovin/impl/b/n$a;->aYa:Lcom/applovin/impl/b/n$a;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 3
    iget v1, p0, Lcom/applovin/impl/b/n;->aXV:I

    iget v3, p1, Lcom/applovin/impl/b/n;->aXV:I
    ...
    .line 4
    :cond_2
    iget-object v1, p0, Lcom/applovin/impl/b/n;->aXT:Ljava/util/List;

    if-eqz v1, :cond_3

    iget-object v3, p1, Lcom/applovin/impl/b/n;->aXT:Ljava/util/List;
    ...
    .line 5
    :cond_4
    iget-object v1, p0, Lcom/applovin/impl/b/n;->aXb:Landroid/net/Uri;

    if-eqz v1, :cond_5

    iget-object v3, p1, Lcom/applovin/impl/b/n;->aXb:Landroid/net/Uri;
    ...
    .line 6
    :cond_6
    iget-object v1, p0, Lcom/applovin/impl/b/n;->aXd:Ljava/util/Set;

    if-eqz v1, :cond_7

    iget-object v3, p1, Lcom/applovin/impl/b/n;->aXd:Ljava/util/Set;
    ...
    .line 7
    :cond_8
    iget-object v1, p0, Lcom/applovin/impl/b/n;->aXe:Ljava/util/Map;

    if-eqz v1, :cond_9

    iget-object p1, p1, Lcom/applovin/impl/b/n;->aXe:Ljava/util/Map;
...
.method public hashCode()I
    ...
    .line 2
    iget v2, p0, Lcom/applovin/impl/b/n;->aXV:I
    ...
    .line 3
    iget-object v2, p0, Lcom/applovin/impl/b/n;->aXb:Landroid/net/Uri;
    ...
    .line 4
    iget-object v2, p0, Lcom/applovin/impl/b/n;->aXd:Ljava/util/Set;
    ...
    .line 5
    iget-object v2, p0, Lcom/applovin/impl/b/n;->aXe:Ljava/util/Map;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/applovin/impl/b/n;->aXW:Lcom/applovin/impl/b/g;
