...
.method public static between(Lcom/lenovo/anyshare/eyk;Lcom/lenovo/anyshare/eyk;)Lorg/threeten/bp/Duration;
    .locals 11

    .line 1
    sget-object v0, Lorg/threeten/bp/temporal/ChronoUnit;->SECONDS:Lorg/threeten/bp/temporal/ChronoUnit;

    invoke-interface {p0, p1, v0}, Lcom/lenovo/anyshare/eyk;->until(Lcom/lenovo/anyshare/eyk;Lcom/lenovo/anyshare/uyk;)J
    ...
    invoke-interface {p0, v2}, Lcom/lenovo/anyshare/fyk;->isSupported(Lcom/lenovo/anyshare/kyk;)Z
    ...
    invoke-interface {p1, v2, v5, v6}, Lcom/lenovo/anyshare/eyk;->with(Lcom/lenovo/anyshare/kyk;J)Lcom/lenovo/anyshare/eyk;
    ...
    invoke-interface {p0, p1, v2}, Lcom/lenovo/anyshare/eyk;->until(Lcom/lenovo/anyshare/eyk;Lcom/lenovo/anyshare/uyk;)J
...
.method public static create(JI)Lorg/threeten/bp/Duration;
    .locals 5
...
.method public static create(Ljava/math/BigDecimal;)Lorg/threeten/bp/Duration;
    .locals 5
...
.method public static create(ZJJJJI)Lorg/threeten/bp/Duration;
    .locals 0

    .line 1
    invoke-static {p5, p6, p7, p8}, Lcom/lenovo/anyshare/Xxk;->d(JJ)J

    move-result-wide p5

    invoke-static {p3, p4, p5, p6}, Lcom/lenovo/anyshare/Xxk;->d(JJ)J

    move-result-wide p3

    invoke-static {p1, p2, p3, p4}, Lcom/lenovo/anyshare/Xxk;->d(JJ)J
...
.method public static from(Lcom/lenovo/anyshare/jyk;)Lorg/threeten/bp/Duration;
    .locals 5
    ...
    .line 3
    invoke-interface {p0}, Lcom/lenovo/anyshare/jyk;->getUnits()Ljava/util/List;
    ...
    check-cast v2, Lcom/lenovo/anyshare/uyk;

    .line 4
    invoke-interface {p0, v2}, Lcom/lenovo/anyshare/jyk;->get(Lcom/lenovo/anyshare/uyk;)J

    move-result-wide v3

    invoke-virtual {v0, v3, v4, v2}, Lorg/threeten/bp/Duration;->plus(JLcom/lenovo/anyshare/uyk;)Lorg/threeten/bp/Duration;
...
.method public static of(JLcom/lenovo/anyshare/uyk;)Lorg/threeten/bp/Duration;
    .locals 1

    .line 1
    sget-object v0, Lorg/threeten/bp/Duration;->ZERO:Lorg/threeten/bp/Duration;

    invoke-virtual {v0, p0, p1, p2}, Lorg/threeten/bp/Duration;->plus(JLcom/lenovo/anyshare/uyk;)Lorg/threeten/bp/Duration;
...
.method public static ofDays(J)Lorg/threeten/bp/Duration;
    ...
    .line 1
    invoke-static {p0, p1, v0}, Lcom/lenovo/anyshare/Xxk;->b(JI)J
...
.method public static parseNumber(Ljava/lang/CharSequence;Ljava/lang/String;ILjava/lang/String;)J
    ...
    .line 4
    invoke-static {v2, v3, p2}, Lcom/lenovo/anyshare/Xxk;->b(JI)J
...
.method public minus(JLcom/lenovo/anyshare/uyk;)Lorg/threeten/bp/Duration;
    .locals 3
    ...
    .line 5
    invoke-virtual {p0, p1, p2, p3}, Lorg/threeten/bp/Duration;->plus(JLcom/lenovo/anyshare/uyk;)Lorg/threeten/bp/Duration;

    move-result-object p1

    const-wide/16 v0, 0x1

    invoke-virtual {p1, v0, v1, p3}, Lorg/threeten/bp/Duration;->plus(JLcom/lenovo/anyshare/uyk;)Lorg/threeten/bp/Duration;
...
.method public plus(JLcom/lenovo/anyshare/uyk;)Lorg/threeten/bp/Duration;
    .locals 6
    ...
    .line 5
    :cond_0
    invoke-interface {p3}, Lcom/lenovo/anyshare/uyk;->isDurationEstimated()Z
    ...
    .line 7
    sget-object v0, Lcom/lenovo/anyshare/wwk;->a:[I
    ...
    .line 8
    invoke-interface {p3}, Lcom/lenovo/anyshare/uyk;->getDuration()Lorg/threeten/bp/Duration;

    move-result-object p3

    iget-wide v0, p3, Lorg/threeten/bp/Duration;->seconds:J

    invoke-static {v0, v1, p1, p2}, Lcom/lenovo/anyshare/Xxk;->e(JJ)J
