...
.method public openConnection(Lorg/apache/http/conn/OperatedClientConnection;Lorg/apache/http/HttpHost;Ljava/net/InetAddress;Lorg/apache/http/protocol/HttpContext;Lorg/apache/http/params/HttpParams;)V
    ...
    invoke-static {v0, v9}, Lorg/apache/http/util/Asserts;->check(ZLjava/lang/String;)V
    ...
    invoke-virtual {v0, v9}, Lorg/apache/http/conn/scheme/SchemeRegistry;->getScheme(Ljava/lang/String;)Lorg/apache/http/conn/scheme/Scheme;
    ...
    invoke-virtual {v1, v10}, Lorg/apache/http/impl/conn/DefaultClientConnectionOperator;->resolveHostname(Ljava/lang/String;)[Ljava/net/InetAddress;
    ...
    invoke-virtual {v0, v11}, Lorg/apache/http/conn/scheme/Scheme;->resolvePort(I)I
    ...
    .line 13
    :goto_2
    invoke-interface {v9, v6}, Lorg/apache/http/conn/scheme/SchemeSocketFactory;->createSocket(Lorg/apache/http/params/HttpParams;)Ljava/net/Socket;
    ...
    invoke-direct {v15, v3, v0, v11}, Lorg/apache/http/conn/HttpInetSocketAddress;-><init>(Lorg/apache/http/HttpHost;Ljava/net/InetAddress;I)V
    ...
    invoke-direct {v0, v4, v8}, Ljava/net/InetSocketAddress;-><init>(Ljava/net/InetAddress;I)V
    ...
    :cond_3
    :try_start_0
    invoke-interface {v9, v14, v15, v0, v6}, Lorg/apache/http/conn/scheme/SchemeSocketFactory;->connectSocket(Ljava/net/Socket;Ljava/net/InetSocketAddress;Ljava/net/InetSocketAddress;Lorg/apache/http/params/HttpParams;)Ljava/net/Socket;
    ...
    .line 22
    invoke-interface {v9, v14}, Lorg/apache/http/conn/scheme/SchemeSocketFactory;->isSecure(Ljava/net/Socket;)Z
