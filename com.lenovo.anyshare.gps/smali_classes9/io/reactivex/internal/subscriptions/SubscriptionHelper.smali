...
.method public static cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    check-cast p0, Lcom/lenovo/anyshare/swk;
    ...
    .line 5
    invoke-interface {p0}, Lcom/lenovo/anyshare/swk;->cancel()V
...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    .line 2
    invoke-interface {v0, p2, p3}, Lcom/lenovo/anyshare/swk;->request(J)V
    ...
    .line 4
    invoke-static {p1, p2, p3}, Lcom/lenovo/anyshare/rck;->a(Ljava/util/concurrent/atomic/AtomicLong;J)J
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Lcom/lenovo/anyshare/swk;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, p2}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lcom/lenovo/anyshare/swk;)Z
    ...
    .line 3
    invoke-interface {p2, p0, p1}, Lcom/lenovo/anyshare/swk;->request(J)V
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Lcom/lenovo/anyshare/swk;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Lcom/lenovo/anyshare/swk;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lcom/lenovo/anyshare/swk;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lcom/lenovo/anyshare/swk;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-interface {p1, p2, p3}, Lcom/lenovo/anyshare/swk;->request(J)V
...
.method public static validate(Lcom/lenovo/anyshare/swk;Lcom/lenovo/anyshare/swk;)Z
    .locals 1
    ...
    invoke-static {p0}, Lcom/lenovo/anyshare/fdk;->b(Ljava/lang/Throwable;)V
