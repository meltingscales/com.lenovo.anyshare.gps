...
.method public static a(Lcom/lenovo/anyshare/OPj;)Lio/opencensus/trace/MessageEvent;
    .locals 3
    ...
    .line 8
    :goto_0
    invoke-virtual {p0}, Lio/opencensus/trace/NetworkEvent;->c()J
    ...
    invoke-virtual {v0, v1, v2}, Lio/opencensus/trace/MessageEvent$a;->c(J)Lio/opencensus/trace/MessageEvent$a;

    move-result-object v0

    .line 10
    invoke-virtual {p0}, Lio/opencensus/trace/NetworkEvent;->a()J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, Lio/opencensus/trace/MessageEvent$a;->a(J)Lio/opencensus/trace/MessageEvent$a;
...
.method public static b(Lcom/lenovo/anyshare/OPj;)Lio/opencensus/trace/NetworkEvent;
    .locals 3
    ...
    .line 5
    invoke-virtual {p0}, Lio/opencensus/trace/MessageEvent;->c()Lio/opencensus/trace/MessageEvent$Type;
    ...
    .line 9
    invoke-virtual {p0}, Lio/opencensus/trace/MessageEvent;->d()J
    ...
    .line 10
    invoke-virtual {p0}, Lio/opencensus/trace/MessageEvent;->a()J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, Lio/opencensus/trace/NetworkEvent$a;->a(J)Lio/opencensus/trace/NetworkEvent$a;
