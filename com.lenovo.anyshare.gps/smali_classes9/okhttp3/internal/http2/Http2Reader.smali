...
.method public constructor <init>(Lcom/lenovo/anyshare/ysk;Z)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/lenovo/anyshare/ysk;
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/lenovo/anyshare/ysk;

    invoke-direct {p1, p2}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lcom/lenovo/anyshare/ysk;)V
    ...
    invoke-direct {p1, v0, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILcom/lenovo/anyshare/Zsk;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/lenovo/anyshare/ysk;
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/lenovo/anyshare/ysk;

    invoke-interface {p1, v2, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILcom/lenovo/anyshare/ysk;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/lenovo/anyshare/ysk;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, Lcom/lenovo/anyshare/ysk;->skip(J)V
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/lenovo/anyshare/ysk;

    invoke-interface {p4}, Lcom/lenovo/anyshare/ysk;->readInt()I

    move-result p4

    .line 2
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/lenovo/anyshare/ysk;

    invoke-interface {v3}, Lcom/lenovo/anyshare/ysk;->readInt()I
    ...
    invoke-interface {p3, v1, v2}, Lcom/lenovo/anyshare/ysk;->f(J)Lokio/ByteString;
...
.method public static readMedium(Lcom/lenovo/anyshare/ysk;)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {p2}, Lcom/lenovo/anyshare/ysk;->readInt()I
...
.method private readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    invoke-interface {v0}, Lcom/lenovo/anyshare/ysk;->readInt()I
    ...
    invoke-interface {v3}, Lcom/lenovo/anyshare/ysk;->readByte()B
...
.method private readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 2
    :cond_0
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/lenovo/anyshare/ysk;

    invoke-interface {v1}, Lcom/lenovo/anyshare/ysk;->readInt()I
...
.method private readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v3}, Lcom/lenovo/anyshare/ysk;->readShort()S
    ...
    .line 6
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/lenovo/anyshare/ysk;

    invoke-interface {v4}, Lcom/lenovo/anyshare/ysk;->readInt()I
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v1, v2, v3}, Lcom/lenovo/anyshare/ysk;->i(J)V
    :try_end_0
    ...
    invoke-static {v1}, Lokhttp3/internal/http2/Http2Reader;->readMedium(Lcom/lenovo/anyshare/ysk;)I
    ...
    invoke-interface {v4}, Lcom/lenovo/anyshare/ysk;->readByte()B
    ...
    invoke-interface {p1}, Lcom/lenovo/anyshare/ysk;->readByte()B
    ...
    invoke-interface {p1, v0, v1}, Lcom/lenovo/anyshare/ysk;->skip(J)V
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v4, v5}, Lcom/lenovo/anyshare/ysk;->f(J)Lokio/ByteString;
