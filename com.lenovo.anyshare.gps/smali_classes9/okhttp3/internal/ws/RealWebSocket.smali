...
.method public connect(Lokhttp3/OkHttpClient;)V
    ...
    invoke-interface {p1}, Lokhttp3/Call;->timeout()Lcom/lenovo/anyshare/atk;

    move-result-object p1

    invoke-virtual {p1}, Lcom/lenovo/anyshare/atk;->clearTimeout()Lcom/lenovo/anyshare/atk;
...
.method public initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Lcom/lenovo/anyshare/xsk;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLcom/lenovo/anyshare/xsk;Ljava/util/Random;)V
    ...
    iget-object p2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Lcom/lenovo/anyshare/ysk;

    invoke-direct {p1, v0, p2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLcom/lenovo/anyshare/ysk;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public writeOneFrame()Z
    ...
    .line 21
    invoke-virtual {v0, v2, v5, v6}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lcom/lenovo/anyshare/Ysk;
    ...
    .line 22
    invoke-interface {v0, v1}, Lcom/lenovo/anyshare/xsk;->a(Lokio/ByteString;)Lcom/lenovo/anyshare/xsk;
