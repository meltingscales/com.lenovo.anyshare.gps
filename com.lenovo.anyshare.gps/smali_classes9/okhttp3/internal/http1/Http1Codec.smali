...
# direct methods
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lcom/lenovo/anyshare/ysk;Lcom/lenovo/anyshare/xsk;)V
    .locals 2
    ...
    .line 6
    iput-object p3, p0, Lokhttp3/internal/http1/Http1Codec;->source:Lcom/lenovo/anyshare/ysk;

    .line 7
    iput-object p4, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lcom/lenovo/anyshare/xsk;
...
.method private readHeaderLine()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->source:Lcom/lenovo/anyshare/ysk;

    iget-wide v1, p0, Lokhttp3/internal/http1/Http1Codec;->headerLimit:J

    invoke-interface {v0, v1, v2}, Lcom/lenovo/anyshare/ysk;->g(J)Ljava/lang/String;
...
.method public createRequestBody(Lokhttp3/Request;J)Lcom/lenovo/anyshare/Ysk;
    .locals 2
    ...
    .line 2
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSink()Lcom/lenovo/anyshare/Ysk;
    ...
    .line 3
    invoke-virtual {p0, p2, p3}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSink(J)Lcom/lenovo/anyshare/Ysk;
...
.method public detachTimeout(Lcom/lenovo/anyshare/Csk;)V
    .locals 2

    .line 1
    iget-object v0, p1, Lcom/lenovo/anyshare/Csk;->a:Lcom/lenovo/anyshare/atk;

    .line 2
    sget-object v1, Lcom/lenovo/anyshare/atk;->NONE:Lcom/lenovo/anyshare/atk;

    invoke-virtual {p1, v1}, Lcom/lenovo/anyshare/Csk;->a(Lcom/lenovo/anyshare/atk;)Lcom/lenovo/anyshare/Csk;
...
.method public finishRequest()V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lcom/lenovo/anyshare/xsk;
...
.method public newChunkedSink()Lcom/lenovo/anyshare/Ysk;
    .locals 3
...
.method public newChunkedSource(Lokhttp3/HttpUrl;)Lcom/lenovo/anyshare/Zsk;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newFixedLengthSink(J)Lcom/lenovo/anyshare/Ysk;
    .locals 2
...
.method public newFixedLengthSource(J)Lcom/lenovo/anyshare/Zsk;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newUnknownLengthSource()Lcom/lenovo/anyshare/Zsk;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    .line 4
    invoke-virtual {p0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lcom/lenovo/anyshare/Zsk;
    ...
    invoke-direct {v3, v0, v1, v2, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLcom/lenovo/anyshare/ysk;)V
    ...
    invoke-virtual {p0, p1}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSource(Lokhttp3/HttpUrl;)Lcom/lenovo/anyshare/Zsk;
    ...
    invoke-direct {v1, v0, v2, v3, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLcom/lenovo/anyshare/ysk;)V
    ...
    .line 10
    invoke-virtual {p0, v4, v5}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lcom/lenovo/anyshare/Zsk;
    ...
    invoke-direct {v1, v0, v4, v5, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLcom/lenovo/anyshare/ysk;)V
    ...
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newUnknownLengthSource()Lcom/lenovo/anyshare/Zsk;
    ...
    invoke-direct {p1, v0, v2, v3, v1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLcom/lenovo/anyshare/ysk;)V
...
.method public writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lcom/lenovo/anyshare/xsk;->f(Ljava/lang/String;)Lcom/lenovo/anyshare/xsk;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lcom/lenovo/anyshare/xsk;->f(Ljava/lang/String;)Lcom/lenovo/anyshare/xsk;
    ...
    .line 4
    iget-object v2, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lcom/lenovo/anyshare/xsk;

    invoke-virtual {p1, p2}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v3}, Lcom/lenovo/anyshare/xsk;->f(Ljava/lang/String;)Lcom/lenovo/anyshare/xsk;
    ...
    .line 7
    invoke-interface {v2, v0}, Lcom/lenovo/anyshare/xsk;->f(Ljava/lang/String;)Lcom/lenovo/anyshare/xsk;
    ...
    .line 8
    :cond_0
    iget-object p1, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lcom/lenovo/anyshare/xsk;

    invoke-interface {p1, v0}, Lcom/lenovo/anyshare/xsk;->f(Ljava/lang/String;)Lcom/lenovo/anyshare/xsk;
