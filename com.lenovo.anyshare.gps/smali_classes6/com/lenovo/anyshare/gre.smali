...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/lenovo/anyshare/gre;->a:Ljava/util/List;
...
.method public static a()Ljava/io/File;
    ...
    const-string v1, "game_boost_white_list"
    ...
    .line 3
    :cond_0
    invoke-static {v0}, Lcom/lenovo/anyshare/gre;->b(Ljava/lang/String;)Ljava/io/File;

    move-result-object v0

    const-string v1, "GameWhiteListConfigManager"

    if-nez v0, :cond_1

    const-string v0, "check ug file, could not generate file according url!"
    ...
    const-string v0, "check ug file, config file not exist!"
...
.method public static a(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {}, Lcom/lenovo/anyshare/gre;->b()Ljava/io/File;
...
.method public static a(Ljava/io/File;)Ljava/util/List;
    ...
    const-string v0, "GameWhiteListConfigManager"
    ...
    const-string v4, "readFromFile line : "
...
.method public static c()Ljava/util/List;
    ...
    .line 1
    invoke-static {}, Lcom/lenovo/anyshare/gre;->e()Z
    ...
    .line 2
    sget-object v0, Lcom/lenovo/anyshare/gre;->a:Ljava/util/List;
    ...
    .line 4
    invoke-static {}, Lcom/lenovo/anyshare/gre;->d()Ljava/util/List;
    ...
    const-string v1, "getGBConfigWhiteList "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget-object v1, Lcom/lenovo/anyshare/gre;->a:Ljava/util/List;
...
.method public static d()Ljava/util/List;
    ...
    .line 1
    invoke-static {}, Lcom/lenovo/anyshare/gre;->a()Ljava/io/File;
    ...
    const-string v2, "getGBConfigWhiteListFromFile file : "
    ...
    const-string v2, "GameWhiteListConfigManager"
    ...
    .line 3
    invoke-static {v0}, Lcom/lenovo/anyshare/gre;->a(Ljava/io/File;)Ljava/util/List;
...
.method public static f()V
    ...
    const-string v0, "syncGBConfigFile failed no network"
    ...
    .line 10
    :cond_3
    invoke-static {v0}, Lcom/lenovo/anyshare/gre;->a(Ljava/lang/String;)Ljava/io/File;
    ...
    :try_start_4
    const-string v3, "syncGBConfigFile "
    ...
    const-string v3, "syncGBConfigFile download result : "
    ...
    .line 22
    new-instance v0, Lcom/lenovo/anyshare/fre;

    invoke-direct {v0, v1}, Lcom/lenovo/anyshare/fre;-><init>(Ljava/io/File;)V
    ...
    const-string v1, "syncGBConfigFile download mGBConfigWhiteList : "
    ...
    :try_start_5
    const-string v1, "syncGBConfigFile failed"
    ...
    const-string v3, "syncGBConfigFile, config file : "
