...
public enum CharDirectionality {
    ...
    public static final Mek directionalityMap$delegate = Pek.a(new InterfaceC10209clk<Map<Integer, ? extends CharDirectionality>>() { // from class: com.lenovo.anyshare.Upk
        @Override // com.lenovo.anyshare.InterfaceC10209clk
        public final Map<Integer, ? extends CharDirectionality> invoke() {
            CharDirectionality[] values = CharDirectionality.values();
            LinkedHashMap linkedHashMap = new LinkedHashMap(C21235unk.a(Mhk.b(values.length), 16));
    ...
    public static final class a {
        ...
        private final Map<Integer, CharDirectionality> a() {
            Mek mek = CharDirectionality.directionalityMap$delegate;
            a aVar = CharDirectionality.Companion;
            return (Map) mek.getValue();
        }
