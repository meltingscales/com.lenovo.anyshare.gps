...
public abstract class MutablePropertyReference0 extends MutablePropertyReference implements Nnk {
    ...
    public Object getDelegate() {
        return ((Nnk) getReflected()).getDelegate();
    }
    ...
    public Rnk.a getGetter() {
        return ((Nnk) getReflected()).getGetter();
    }

    @Override // com.lenovo.anyshare.Mnk
    public Nnk.a getSetter() {
        return ((Nnk) getReflected()).getSetter();
    }
