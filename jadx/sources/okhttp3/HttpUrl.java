...
public final class HttpUrl {
    public static final char[] HEX_DIGITS = {BCc.f6785a, '1', '2', '3', '4', '5', '6', '7', '8', '9', 'A', 'B', 'C', 'D', 'E', 'F'};
    @Qdk
    ...
    public static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        ...
        while (i3 < i2) {
            ...
            c22517wsk.a(str, i, i3);
            canonicalize(c22517wsk, str, i3, i2, str2, z, z2, z3, z4, charset);
            return c22517wsk.I();
        }
    ...
    public List<String> encodedPathSegments() {
        ...
        while (indexOf < delimiterOffset) {
            int i = indexOf + 1;
            int delimiterOffset2 = Util.delimiterOffset(this.url, i, delimiterOffset, (char) C15259kyc.f);
    ...
    public static final class Builder {
        ...
        */
        ...
        public Builder addEncodedQueryParameter(String str, @Qdk String str2) {
            if (str != null) {
        ...
        public Builder addQueryParameter(String str, @Qdk String str2) {
            if (str != null) {
                if (this.encodedQueryNamesAndValues == null) {
                    this.encodedQueryNamesAndValues = new ArrayList();
                }
        ...
        public Builder encodedFragment(@Qdk String str) {
        ...
        public Builder encodedQuery(@Qdk String str) {
        ...
        public Builder fragment(@Qdk String str) {
        ...
        public Builder parse(@Qdk HttpUrl httpUrl, String str) {
            ...
            if (slashCount < 2 && httpUrl != null && httpUrl.scheme.equals(this.scheme)) {
                ...
                while (true) {
                    ...
                    if (charAt == '@') {
                        if (!z) {
                            int delimiterOffset2 = Util.delimiterOffset(str, i2, delimiterOffset, (char) C13478iCc.b);
                            i = delimiterOffset;
                ...
                if (i3 < delimiterOffset) {
                    ...
                    if (this.port == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str.substring(i3, delimiterOffset) + C23731ysc.g);
                    }
                } else {
                    this.host = canonicalizeHost(str, i2, portColonOffset);
                ...
                if (this.host == null) {
                    throw new IllegalArgumentException("Invalid URL host: \"" + str.substring(i2, portColonOffset) + C23731ysc.g);
                }
        ...
        public Builder query(@Qdk String str) {
        ...
        public Builder setEncodedQueryParameter(String str, @Qdk String str2) {
        ...
        public Builder setQueryParameter(String str, @Qdk String str2) {
    ...
    public static String percentDecode(String str, int i, int i2, boolean z) {
        for (int i3 = i; i3 < i2; i3++) {
            ...
            if (charAt == '%' || (charAt == '+' && z)) {
                C22517wsk c22517wsk = new C22517wsk();
                c22517wsk.a(str, i, i3);
                percentDecode(c22517wsk, str, i3, i2, z);
                return c22517wsk.I();
            }
        }
        return str.substring(i, i2);
    ...
    public static void canonicalize(C22517wsk c22517wsk, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
            ...
            if (!z || (codePointAt != 9 && codePointAt != 10 && codePointAt != 12 && codePointAt != 13)) {
                if (codePointAt == 43 && z3) {
                    ...
                    if (charset != null && !charset.equals(Util.UTF_8)) {
                        c22517wsk2.a(str, i, Character.charCount(codePointAt) + i, charset);
                    } else {
                    ...
                    while (!c22517wsk2.L()) {
                        ...
                        c22517wsk.writeByte((int) HEX_DIGITS[(readByte >> 4) & 15]);
                        c22517wsk.writeByte((int) HEX_DIGITS[readByte & 15]);
                    }
                }
            }
    ...
    public static void percentDecode(C22517wsk c22517wsk, String str, int i, int i2, boolean z) {
        int i3;
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
            if (codePointAt == 37 && (i3 = i + 2) < i2) {
                ...
                if (decodeHexDigit != -1 && decodeHexDigit2 != -1) {
                    c22517wsk.writeByte((decodeHexDigit << 4) + decodeHexDigit2);
                    i = i3;
                }
                c22517wsk.f(codePointAt);
            } else {
                if (codePointAt == 43 && z) {
                    c22517wsk.writeByte(32);
                }
                c22517wsk.f(codePointAt);
            }
            i += Character.charCount(codePointAt);
