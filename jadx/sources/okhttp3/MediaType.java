...
public final class MediaType {
    ...
    public MediaType(String str, String str2, String str3, @Qdk String str4) {
        this.mediaType = str;
        this.type = str2;
        this.subtype = str3;
        this.charset = str4;
                ...
                if (matcher2.lookingAt()) {
                    ...
                    if (group != null && group.equalsIgnoreCase("charset")) {
                        ...
                        if (str2 != null && !group2.equalsIgnoreCase(str2)) {
                            throw new IllegalArgumentException("Multiple charsets defined: \"" + str2 + "\" and: \"" + group2 + "\" for: \"" + str + C23731ysc.g);
                        }
                        str2 = group2;
                    }
                } else {
                    throw new IllegalArgumentException("Parameter is not formatted correctly: \"" + str.substring(end) + "\" for: \"" + str + C23731ysc.g);
                }
            }
            return new MediaType(str, lowerCase, lowerCase2, str2);
        }
        throw new IllegalArgumentException("No subtype found for: \"" + str + C23731ysc.g);
    }
    ...
    @Qdk
    public Charset charset(@Qdk Charset charset) {
        try {
