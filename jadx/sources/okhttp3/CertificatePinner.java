...
public final class CertificatePinner {
    ...
    public CertificatePinner(Set<Pin> set, @Qdk CertificateChainCleaner certificateChainCleaner) {
        this.pins = set;
    ...
    public CertificatePinner withCertificateChainCleaner(@Qdk CertificateChainCleaner certificateChainCleaner) {
