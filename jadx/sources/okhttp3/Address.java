...
public final class Address {
    ...
    public Address(String str, int i, Dns dns, SocketFactory socketFactory, @Qdk SSLSocketFactory sSLSocketFactory, @Qdk HostnameVerifier hostnameVerifier, @Qdk CertificatePinner certificatePinner, Authenticator authenticator, @Qdk Proxy proxy, List<Protocol> list, List<ConnectionSpec> list2, ProxySelector proxySelector) {
