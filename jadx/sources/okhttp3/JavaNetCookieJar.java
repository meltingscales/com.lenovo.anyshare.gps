...
public final class JavaNetCookieJar implements CookieJar {
    ...
    private List<Cookie> decodeHeaderAsJavaNetCookies(HttpUrl httpUrl, String str) {
        ...
        while (i < length) {
            ...
            int delimiterOffset2 = Util.delimiterOffset(str, i, delimiterOffset, (char) t.f);
    ...
    public void saveFromResponse(HttpUrl httpUrl, List<Cookie> list) {
        if (this.cookieHandler != null) {
            ...
            try {
                this.cookieHandler.put(httpUrl.uri(), Collections.singletonMap(HttpHeaders.HEAD_KEY_SET_COOKIE, arrayList));
            } catch (IOException e) {
                Platform platform = Platform.get();
