...
public final class Util {
    ...
    public static final Charset UTF_16_BE = Charset.forName(C7770Yhc.d);
    public static final Charset UTF_16_LE = Charset.forName(C7770Yhc.e);
    ...
    public static Charset bomAwareCharset(InterfaceC23739ysk interfaceC23739ysk, Charset charset) throws IOException {
        if (interfaceC23739ysk.a(0L, UTF_8_BOM)) {
            interfaceC23739ysk.skip(UTF_8_BOM.size());
            return UTF_8;
        } else if (interfaceC23739ysk.a(0L, UTF_16_BE_BOM)) {
            interfaceC23739ysk.skip(UTF_16_BE_BOM.size());
            return UTF_16_BE;
        } else if (interfaceC23739ysk.a(0L, UTF_16_LE_BOM)) {
            interfaceC23739ysk.skip(UTF_16_LE_BOM.size());
            return UTF_16_LE;
        } else if (interfaceC23739ysk.a(0L, UTF_32_BE_BOM)) {
            interfaceC23739ysk.skip(UTF_32_BE_BOM.size());
            return UTF_32_BE;
        } else if (interfaceC23739ysk.a(0L, UTF_32_LE_BOM)) {
            interfaceC23739ysk.skip(UTF_32_LE_BOM.size());
            return UTF_32_LE;
        } else {
            return charset;
        }
    ...
    @com.lenovo.anyshare.Qdk
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static java.net.InetAddress decodeIpv6(java.lang.String r10, int r11, int r12) {
        /*
            r0 = 16
            byte[] r0 = new byte[r0]
            r1 = -1
    ...
    public static boolean discard(Zsk zsk, int i, TimeUnit timeUnit) {
        try {
            return skipAll(zsk, i, timeUnit);
    ...
    public static String inet6AddressToAscii(byte[] bArr) {
        ...
        while (i < bArr.length) {
            if (i == i3) {
                ...
                c22517wsk.d(((bArr[i] & 255) << 8) | (bArr[i + 1] & 255));
                i += 2;
            }
        }
        return c22517wsk.I();
    ...
    public static boolean skipAll(Zsk zsk, int i, TimeUnit timeUnit) throws IOException {
        long nanoTime = System.nanoTime();
        long deadlineNanoTime = zsk.timeout().hasDeadline() ? zsk.timeout().deadlineNanoTime() - nanoTime : Long.MAX_VALUE;
        zsk.timeout().deadlineNanoTime(Math.min(deadlineNanoTime, timeUnit.toNanos(i)) + nanoTime);
        try {
            C22517wsk c22517wsk = new C22517wsk();
            while (zsk.read(c22517wsk, 8192L) != -1) {
                c22517wsk.b();
            }
            if (deadlineNanoTime == Long.MAX_VALUE) {
                zsk.timeout().clearDeadline();
            } else {
                zsk.timeout().deadlineNanoTime(nanoTime + deadlineNanoTime);
            }
            return true;
