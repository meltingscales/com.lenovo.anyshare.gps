...
public class Platform {
    ...
    public static byte[] concatLengthPrefixed(List<Protocol> list) {
        ...
        for (int i = 0; i < size; i++) {
            Protocol protocol = list.get(i);
            if (protocol != Protocol.HTTP_1_0) {
                c22517wsk.writeByte(protocol.toString().length());
                c22517wsk.f(protocol.toString());
            }
        }
        return c22517wsk.F();
    }
    ...
    public void configureTlsExtensions(SSLSocket sSLSocket, @Qdk String str, List<Protocol> list) throws IOException {
    }
    ...
    public void log(int i, String str, @Qdk Throwable th) {
    ...
    public X509TrustManager trustManager(SSLSocketFactory sSLSocketFactory) {
        try {
            Object readFieldOrNull = readFieldOrNull(sSLSocketFactory, Class.forName("sun.security.ssl.SSLContextImpl"), LogEntry.LOG_ITEM_CONTEXT);
