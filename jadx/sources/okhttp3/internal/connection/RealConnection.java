...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectSocket(int i, int i2, Call call, EventListener eventListener) throws IOException {
        ...
        try {
            ...
            try {
                this.source = Msk.a(Msk.b(this.rawSocket));
                this.sink = Msk.a(Msk.a(this.rawSocket));
        ...
        try {
            try {
                ...
                try {
                    ...
                    this.source = Msk.a(Msk.b(this.socket));
                    this.sink = Msk.a(Msk.a(this.socket));
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            Zsk newFixedLengthSource = http1Codec.newFixedLengthSource(contentLength);
            Util.skipAll(newFixedLengthSource, Integer.MAX_VALUE, TimeUnit.MILLISECONDS);
            newFixedLengthSource.close();
            int code = build.code();
            if (code == 200) {
                if (this.source.y().L() && this.sink.y().L()) {
                    return null;
                }
                ...
                if (authenticate != null) {
                    if ("close".equalsIgnoreCase(build.header(com.ushareit.muslim.networklibrary.model.HttpHeaders.HEAD_KEY_CONNECTION))) {
                        return authenticate;
                    }
    ...
    private Request createTunnelRequest() throws IOException {
        Request build = new Request.Builder().url(this.route.address().url()).method("CONNECT", null).header("Host", Util.hostHeader(this.route.address().url(), true)).header("Proxy-Connection", b.c).header("User-Agent", Version.userAgent()).build();
    ...
    /* JADX WARN: Removed duplicated region for block: B:61:0x0143 A[EDGE_INSN: B:77:0x0143->B:61:0x0143 ?: BREAK  ] */
    /*
    ...
    */
    ...
    public boolean isEligible(Address address, @Qdk Route route) {
