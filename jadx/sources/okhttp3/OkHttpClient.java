...
import com.lenovo.anyshare.C1174Bjh;
import com.lenovo.anyshare.C2344Fjh;
...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public class _lancet {
            ...
            public static OkHttpClient com_ushareit_medusa_apm_plugin_network_aop_NetHookLancet_build(Builder builder) {
                C6040Sge.a("AOP_LANCET", "okhttp build: ==========");
                builder.eventListenerFactory(new C1174Bjh(C2344Fjh.a(builder)));
                return builder.build$___twin___();
            }
        }
        ...
        public OkHttpClient build$___twin___() {
        ...
        public OkHttpClient build() {
            return _lancet.com_ushareit_medusa_apm_plugin_network_aop_NetHookLancet_build(this);
        }

        public Builder cache(@Qdk Cache cache) {
            this.cache = cache;
        ...
        public Builder proxy(@Qdk Proxy proxy) {
            this.proxy = proxy;
            return this;
        }
        ...
        public void setInternalCache(@Qdk InternalCache internalCache) {
    ...
    static {
        Internal.instance = new Internal() { // from class: okhttp3.OkHttpClient.1
            ...
            @Override // okhttp3.internal.Internal
            @Qdk
            public IOException timeoutExit(Call call, @Qdk IOException iOException) {
