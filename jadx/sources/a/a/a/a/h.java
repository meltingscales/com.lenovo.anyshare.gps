...
public final class h extends Lambda implements InterfaceC19989slk<C14273jT, Integer, String, Kfk> {
    ...
    public Kfk invoke(C14273jT c14273jT, Integer num, String str) {
        ...
        Log.e("DownloadInstallService", "pauseDownloadInstall: task=" + c14273jT2 + ", errorCode=" + intValue + ", errorMsg=" + str2);
        return Kfk.f11108a;
    }
}
