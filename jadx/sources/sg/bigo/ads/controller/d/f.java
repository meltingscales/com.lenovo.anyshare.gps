...
import sg.bigo.ads.controller.i.m;

/* loaded from: classes9.dex */
public final class f extends a {
    public f(sg.bigo.ads.common.e eVar, sg.bigo.ads.controller.a.b bVar) {
        super(eVar, bVar);
    }

    @Override // sg.bigo.ads.common.f
    public final void a(Map<String, Object> map, final f.a aVar) {
        new m(map, this.f33117a, this.b, new sg.bigo.ads.controller.c() { // from class: sg.bigo.ads.controller.d.f.1
