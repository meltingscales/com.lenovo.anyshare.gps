...
public final class u {
    public static View a(Context context, View view) {
        ...
        if (view != null) {
            if (!(Build.VERSION.SDK_INT >= 19 ? view.isAttachedToWindow() : view.getWindowToken() != null)) {
                sg.bigo.ads.common.k.a.b("Views", "Attempting to call View#getRootView() on an unattached View.");
            }
    ...
    public static void a(View view) {
        ...
        sg.bigo.ads.common.k.a.a(0, "Views", "parent is not a view group, parent:" + view.getParent());
    }
    ...
    public static boolean b(View view) {
        ViewParent parent;
        if (!sg.bigo.ads.common.q.b.c() && view.getWindowVisibility() == 0) {
