...
public class f extends c {
    ...
    public static final String f1385a = "f";
    public j k;

    public f(Context context, n nVar, String str, boolean z) {
    ...
    public final void a(Activity activity, Map<String, Object> map) {
        try {
            ...
            com.anythink.basead.e.b.a().a(str, new b.AbstractC0249b() { // from class: com.anythink.basead.f.f.1
                @Override // com.anythink.basead.e.b.AbstractC0249b
                public final void a(i iVar) {
                    String str2 = f.f1385a;
                    if (f.this.k != null) {
