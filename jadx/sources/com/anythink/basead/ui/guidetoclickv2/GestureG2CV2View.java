...
public class GestureG2CV2View extends BaseG2CV2View {
    ...
    public void onAttachedToWindow() {
        ...
        d dVar2 = this.i;
        if (dVar2 != null) {
            dVar2.setCallback(new c() { // from class: com.anythink.basead.ui.guidetoclickv2.GestureG2CV2View.2
    ...
    public final void a(int i, int i2) {
        ...
        if (i == 1 || i == 3) {
            this.h.setBackgroundResource(i.a(getContext(), "myoffer_g2c_gesture_bg", k.c));
