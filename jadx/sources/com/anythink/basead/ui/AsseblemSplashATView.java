...
public class AsseblemSplashATView extends BaseSdkSplashATView {
    ...
    public final void b() {
        ...
        if (TextUtils.isEmpty(this.c.y())) {
            ...
            com.anythink.core.common.res.b.a(getContext()).a(new e(1, this.c.y()), getResources().getDisplayMetrics().widthPixels, (getResources().getDisplayMetrics().widthPixels * 627) / 1200, new b.a() { // from class: com.anythink.basead.ui.AsseblemSplashATView.3
                @Override // com.anythink.core.common.res.b.a
                public final void onFail(String str, String str2) {
                }
    ...
    public final void a() {
        View inflate;
        if (this.b.n.w() == 2) {
            inflate = LayoutInflater.from(getContext()).inflate(i.a(getContext(), "myoffer_splash_ad_layout_asseblem_vertical_land", "layout"), this);
        } else {
            inflate = LayoutInflater.from(getContext()).inflate(i.a(getContext(), "myoffer_splash_ad_layout_asseblem_vertical_port", "layout"), this);
        }
        o();
        com.anythink.basead.ui.d.a aVar = this.L;
        if (aVar != null) {
            aVar.a(com.anythink.basead.ui.d.a.c).a(new com.anythink.basead.ui.c.a() { // from class: com.anythink.basead.ui.AsseblemSplashATView.1
