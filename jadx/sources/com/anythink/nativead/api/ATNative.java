...
public class ATNative {
    ...
    public ATAdStatusInfo checkAdStatus() {
        if (n.a().f() != null && !TextUtils.isEmpty(n.a().o()) && !TextUtils.isEmpty(n.a().p())) {
            ...
            p.b(this.mPlacementId, h.n.r, h.n.A, a2.toString(), "");
            return a2;
        }
    ...
    public NativeAd getNativeAd() {
        com.anythink.core.common.f.b a2 = this.mAdLoadManager.a("", this.mTKExtraMap);
        if (a2 != null) {
    ...
    public NativeAd getNativeAd(String str) {
        ...
        com.anythink.core.common.f.b a2 = this.mAdLoadManager.a(str, this.mTKExtraMap);
        if (a2 != null) {
            return new NativeAd(getContext(), this.mPlacementId, a2);
        }
        return null;
