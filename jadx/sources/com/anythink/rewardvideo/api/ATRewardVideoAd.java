...
public class ATRewardVideoAd {
    ...
    public final String TAG = ATRewardVideoAd.class.getSimpleName();
    public ATRewardVideoExListener mInterListener = new ATRewardVideoExListener() { // from class: com.anythink.rewardvideo.api.ATRewardVideoAd.1
    ...
    private boolean isPlaceStrategyNeedAutoLoad() {
        com.anythink.core.d.h a2 = com.anythink.core.d.j.a(n.a().f()).a(this.mPlacementId);
    ...
    public boolean isAdReady() {
        ...
        p.b(this.mPlacementId, h.n.q, h.n.z, String.valueOf(isReady), "");
        return isReady;
    }
