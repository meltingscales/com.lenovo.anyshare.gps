...
public class ATInterstitial {
    ...
    public ATInterstitialExListener mInterListener = new ATInterstitialExListener() { // from class: com.anythink.interstitial.api.ATInterstitial.1
    ...
    public boolean isAdReady() {
        ...
        p.b(this.mPlacementId, h.n.p, h.n.z, String.valueOf(isReady), "");
        return isReady;
    }
