...
public class DeviceDataInfo {
    ...
    public static final String BUILD_BOARD = "bld_board";
    public static final String BUILD_BOOTLOADER = "bld_bootloader";
    public static final String BUILD_CODENAME = "bld_codename";
    public static final String BUILD_DISPLAY = "bld_display";
    public static final String BUILD_HARDWARE = "bld_hardware";
    public static final String BUILD_HOST = "bld_host";
    public static final String BUILD_INCREMENTAL = "bld_incremental";
    public static final String BUILD_RADIO = "bld_radio";
    public static final String BUILD_SERIAL = "bld_serial";
    public static final String BUILD_TAGS = "bld_tags";
    public static final String BUILD_TYPE = "bld_type";
    public static final String BUILD_USER = "bld_user";
    public static final String BUILD_VERSION_CODES = "bld_version_codes";
