...
public class ax implements Comparable<ax> {
    ...
    public int b = 0;
    public int ar = -1;
    public ATAdConst.CURRENCY as = ATAdConst.CURRENCY.USD;
    public int q = 2;
    ...
    public final int Y() {
        int i;
        r rVar = this.aj;
        return (rVar == null || (i = rVar.n) == 0) ? this.f : i;
    }
    ...
    public /* synthetic */ int compareTo(ax axVar) {
        ax axVar2 = axVar;
        if (com.anythink.core.common.o.h.a(this) > com.anythink.core.common.o.h.a(axVar2)) {
            return -1;
        }
        return com.anythink.core.common.o.h.a(this) == com.anythink.core.common.o.h.a(axVar2) ? 0 : 1;
    }
    ...
    private int a(ax axVar) {
        if (com.anythink.core.common.o.h.a(this) > com.anythink.core.common.o.h.a(axVar)) {
            return -1;
        }
        return com.anythink.core.common.o.h.a(this) == com.anythink.core.common.o.h.a(axVar) ? 0 : 1;
    }

    public final synchronized void a(ax axVar, int i, int i2, int i3) {
        if (axVar.Q.equals(this.Q)) {
            this.G = axVar.G;
            this.j = axVar.j;
            this.K = i2;
            this.I = axVar.I;
    ...
    public final void a(r rVar, int i, int i2, int i3) {
        this.K = i2;
        this.G = rVar.getPrice();
        this.j = rVar.getSortPrice();
        this.I = rVar.token;
        this.am = rVar.m;
        this.ah = 0;
        this.ak = i;
