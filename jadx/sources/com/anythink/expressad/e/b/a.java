package com.anythink.expressad.e.b;
...
public class a {
        ...
        public final void run() {
            synchronized (a.this.g) {
                try {
                    ...
                    File file = new File(a.this.f, "mraid_js.txt");
                    if (file.exists()) {
                        file.delete();
                    }
                    p.a(this.f2334a.getBytes(), file);
                }
            }
        }
    }
    ...
    public a() {
        try {
            this.f = new File(n.a().f().getFilesDir().getAbsoluteFile().getAbsolutePath() + "/anythink_template/other");
        } catch (Throwable unused) {
        }
        com.anythink.core.common.o.b.b.a().a(new Runnable() { // from class: com.anythink.expressad.e.b.a.1
            @Override // java.lang.Runnable
            public final void run() {
                a aVar = a.this;
                aVar.e = aVar.c();
    ...
    public String c() {
        ...
        synchronized (this.g) {
            str = "";
            File file = new File(this.f, "mraid_js.txt");
    ...
    public static /* synthetic */ void b(a aVar, String str) {
        com.anythink.core.common.o.b.b.a().a(new AnonymousClass3(str));
    }
    ...
    public final synchronized void a(final Context context, final String str) {
        ...
        String b2 = s.b(context, "anythink_sdk", com.anythink.expressad.e.a.b.dt, "");
        if (TextUtils.isEmpty(b2) || !b2.equals(str)) {
            this.f2331a = true;
            new com.anythink.expressad.e.a.a(context);
            g gVar = new g(0, str, null, new com.anythink.expressad.foundation.g.f.b.b() { // from class: com.anythink.expressad.e.b.a.2
                @Override // com.anythink.expressad.foundation.g.f.b.b
                public final void a(String str2) {
                    if (!TextUtils.isEmpty(str2)) {
                        a.this.e = str2;
                        a.b(a.this, str2);
                        s.a(context, "anythink_sdk", com.anythink.expressad.e.a.b.dt, str);
                    }
                    a.this.f2331a = false;
                }
            ...
            gVar.a((l) new com.anythink.expressad.foundation.g.f.b());
            m.a(gVar);
        }
    }
