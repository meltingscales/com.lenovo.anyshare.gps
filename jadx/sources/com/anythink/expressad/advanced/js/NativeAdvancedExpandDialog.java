...
public class NativeAdvancedExpandDialog extends Dialog {
    ...
    public class AnonymousClass3 implements DialogInterface.OnDismissListener {
        ...
        public void onDismiss(DialogInterface dialogInterface) {
            ...
            NativeAdvancedExpandDialog.this.e.loadDataWithBaseURL(null, "", "text/html", com.anythink.expressad.foundation.g.a.bR, null);
    ...
    public NativeAdvancedExpandDialog(Context context, Bundle bundle, a aVar) {
        super(context);
        this.f2257a = "NativeAdvancedExpandDialog";
        this.j = new IMraidJSBridge() { // from class: com.anythink.expressad.advanced.js.NativeAdvancedExpandDialog.4
            ...
            public void open(String str) {
                try {
                    if (NativeAdvancedExpandDialog.this.e != null && System.currentTimeMillis() - NativeAdvancedExpandDialog.this.e.lastTouchTime > com.anythink.expressad.a.b.a.c) {
                        NativeAdvancedExpandDialog.this.e.getUrl();
                        int i = com.anythink.expressad.a.b.a.f2200a;
                        if (com.anythink.expressad.a.b.a.a((d) NativeAdvancedExpandDialog.this.h.get(0))) {
                            return;
                        }
                    }
    ...
    public static /* synthetic */ void a(NativeAdvancedExpandDialog nativeAdvancedExpandDialog) {
        try {
            ...
            hashMap.put(CallMraidJS.d, jSONObject);
            int[] iArr = new int[2];
            nativeAdvancedExpandDialog.e.getLocationInWindow(iArr);
            ...
            CallMraidJS.getInstance().fireSetScreenSize(nativeAdvancedExpandDialog.e, com.anythink.expressad.foundation.h.n.e(n.a().f()), com.anythink.expressad.foundation.h.n.f(n.a().f()));
