...
public final class c implements e<String, b> {
    ...
    public final LinkedHashMap<String, b> f2199a;
    public final int b;
    public int c;
    ...
    public c(int i) {
        if (i > 0) {
            this.b = i;
            this.f2199a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    public final void a(String str) {
        if (str != null) {
            synchronized (this) {
                if (this.f2199a.remove(str) != null) {
                    this.c--;
                }
            }
            return;
    ...
    public final boolean a(String str, b bVar) {
        if (str != null && bVar != null) {
            synchronized (this) {
                this.c++;
                if (this.f2199a.put(str, bVar) != null) {
                    this.c--;
                }
            }
            a(this.b);
    ...
    */
    private void a(int r3) {
        ...
        L0:
            ...
            if (r0 < 0) goto L4a
            java.util.LinkedHashMap<java.lang.String, com.anythink.expressad.a.a.b> r0 = r2.f2199a     // Catch: java.lang.Throwable -> L69
        ...
        L32:
            ...
            java.util.LinkedHashMap<java.lang.String, com.anythink.expressad.a.a.b> r0 = r2.f2199a     // Catch: java.lang.Throwable -> L46
    ...
    public final Collection<String> a() {
        HashSet hashSet;
        synchronized (this) {
            hashSet = new HashSet(this.f2199a.keySet());
        }
        return hashSet;
    }
}
