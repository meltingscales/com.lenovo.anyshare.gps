...
public abstract class a {
    ...
    public static final int f2416a = 8;
    ...
    public static final int g = af.f(com.anythink.expressad.exoplayer.f.d.i);
    public static final int h = af.f("avc3");
    public static final int i = af.f(com.anythink.expressad.exoplayer.f.d.m);
    public static final int j = af.f(com.anythink.expressad.exoplayer.f.d.l);
    ...
    public static final int aG = af.f(CleverCache.CACHE_META);
    ...
    /* loaded from: classes2.dex */
    static final class C0296a extends a {
        public final long aV;
        public final List<b> aW;
        public final List<C0296a> aX;
        ...
        public final C0296a e(int i) {
            int size = this.aX.size();
            for (int i2 = 0; i2 < size; i2++) {
                C0296a c0296a = this.aX.get(i2);
                if (c0296a.aU == i) {
                    return c0296a;
                }
            }
