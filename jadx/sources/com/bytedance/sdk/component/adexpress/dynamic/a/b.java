...
public class b {
    public static DynamicBaseWidget a(Context context, DynamicRootView dynamicRootView, h hVar) {
        if (context == null || dynamicRootView == null || hVar == null || hVar.j() == null) {
            return null;
        }
        switch (hVar.j().a()) {
            case -1:
            ...
            case 15:
                if (d.b()) {
                    return new DynamicTimeOuterRewardFullSkip(context, dynamicRootView, hVar);
                }
            ...
            case 25:
                return new DynamicLeisureWidget(context, dynamicRootView, hVar);
            case 26:
                if ("vertical".equals(hVar.j().e().al())) {
                    return new DynamicVerticalScrollWidgetImp(context, dynamicRootView, hVar);
                }
                return new DynamicBaseInternalScrollWidgetImp(context, dynamicRootView, hVar);
            case 27:
                return new DynamicTimeOuterSkip(context, dynamicRootView, hVar);
            default:
                return null;
