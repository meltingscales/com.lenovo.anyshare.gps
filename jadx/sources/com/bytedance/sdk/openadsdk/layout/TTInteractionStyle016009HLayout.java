...
public class TTInteractionStyle016009HLayout extends TTInteractionStyleBaseFrameLayout {
    ...
    public void a(Context context) {
        ...
        this.f = d(context);
        this.f.setId(i.at);
        RelativeLayout.LayoutParams layoutParams5 = new RelativeLayout.LayoutParams(ac.b(context, 100.0f), ac.b(context, 30.0f));
        if (Build.VERSION.SDK_INT >= 17) {
    ...
    public PAGTextView b(Context context) {
        ...
        b.setGravity(16);
        b.setMaxWidth(ac.b(context, 250.0f));
        b.setTextColor(-1);
