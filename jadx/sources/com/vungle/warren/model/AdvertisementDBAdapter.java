...
public class AdvertisementDBAdapter implements DBAdapter<Advertisement> {
    ...
    public Type stringArrayType = new TypeToken<String[]>() { // from class: com.vungle.warren.model.AdvertisementDBAdapter.1
    }.getType();
    public Type stringMapType = new TypeToken<Map<String, String>>() { // from class: com.vungle.warren.model.AdvertisementDBAdapter.2
    }.getType();
    public Type cacheableMapType = new TypeToken<Map<String, Pair<String, String>>>() { // from class: com.vungle.warren.model.AdvertisementDBAdapter.5
    }.getType();
    public final Type STRING_LIST_TYPE = new TypeToken<List<String>>() { // from class: com.vungle.warren.model.AdvertisementDBAdapter.6
    }.getType();
    ...
    public ContentValues toContentValues(Advertisement advertisement) {
        ...
        contentValues.put(AdvertisementColumns.COLUMN_NOTIFICATIONS, this.gson.toJson(advertisement.getWinNotifications(), this.STRING_LIST_TYPE));
