...
public class DOMCDATA extends DefaultCDATA implements CDATASection {
    ...
    public Text splitText(int i) throws DOMException {
        if (!isReadOnly()) {
            ...
            if (i >= 0 && i < length) {
                ...
                InterfaceC2616Gic createCDATA = createCDATA(substring2);
                if (parent != null) {
                    parent.add(createCDATA);
                }
                return C8354_ic.a((InterfaceC2904Hic) createCDATA);
            }
    ...
    public DOMCDATA(InterfaceC4340Mic interfaceC4340Mic, String str) {
