...
import com.lenovo.anyshare.C5995Scd;
...
public class AdsHNativeAdapter extends CustomNativeAdapter {
    ...
    public static final String f30680a = "AdsHNativeAdapter";
    public String b;
    public String c;
    public C7142Wcd d;
    public boolean e;
    ...
    private void a(Context context, ATBiddingListener aTBiddingListener) {
        ...
        this.d = new C7142Wcd(context, a2);
        this.d.d = new C5995Scd(this, aTBiddingListener, a2);
        this.d.n();
    }
