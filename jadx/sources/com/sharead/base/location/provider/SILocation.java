...
public class SILocation {
    ...
    public String toString() {
        return "[ source = " + this.f + ", type = " + this.e + ", lat = " + this.f30648a + ", lon = " + this.b + ", time = " + this.d + "]";
    }

    public String a() {
        return this.f30648a + "," + this.b + "," + this.c + "," + this.d + "," + this.e.name() + "," + this.f.name();
    }
