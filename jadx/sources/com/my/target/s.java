...
public final class s {
    ...
    public ArrayList<v9> a(String str) {
    ...
    public void a(ArrayList<v9> arrayList) {
        ArrayList<v9> arrayList2 = this.f;
        if (arrayList2 == null) {
            this.f = arrayList;
