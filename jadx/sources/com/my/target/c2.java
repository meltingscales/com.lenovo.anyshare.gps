...
public class c2 extends a2<String> {
    ...
    public final b2<String> f30118a = new b2<>();
    public int b;
    ...
    public final String a(HttpURLConnection httpURLConnection) {
        if (this.b <= 10) {
            try {
                ?? uri = httpURLConnection.getURL().toURI().resolve(new URI(httpURLConnection.getHeaderField(HttpHeaders.HEAD_KEY_LOCATION))).toString();
                boolean z = true;
                if (Build.VERSION.SDK_INT >= 28 && !ea.c(uri)) {
                    z = false;
                }
                if (!ea.d(uri) && z) {
                    return uri;
    ...
    */
    public final void a(java.lang.String r6, android.content.Context r7) {
        /*
            r5 = this;
            com.my.target.b2<java.lang.String> r0 = r5.f30118a
            r0.d = r6
            ...
            com.my.target.y5 r0 = com.my.target.y5.a(r7)
            r1 = 0
            r2 = 0
            ...
            com.my.target.b2<java.lang.String> r4 = r5.f30118a     // Catch: java.lang.Throwable -> L8b
        ...
        L8d:
            ...
            r6 = r2
        L8f:
            com.my.target.b2<java.lang.String> r3 = r5.f30118a
            r3.f30110a = r1
            ...
            r0.append(r1)
            com.my.target.b2<java.lang.String> r1 = r5.f30118a
