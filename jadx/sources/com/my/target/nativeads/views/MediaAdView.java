...
public class MediaAdView extends FrameLayout {
    ...
    private void initViews(Context context) {
        da.b(this.imageView, "media_image");
        da.b(this.progressBar, "progress_bar");
        da.b(this.playButton, "play_button");
        ...
        this.playButton.a(o6.a(da.e(context).b(80)), false);
