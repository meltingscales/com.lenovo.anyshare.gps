...
public class l0 extends TextView {
    ...
    public final GradientDrawable f30212a;
    public int b;
    ...
    public void a(int i, int i2, int i3) {
        this.f30212a.setStroke(i, i2);
        this.f30212a.setCornerRadius(i3);
        invalidate();
    }

    @Override // android.widget.TextView, android.view.View
    public void onDraw(Canvas canvas) {
        this.f30212a.setBounds(getPaddingLeft() - this.b, getPaddingTop(), getWidth(), getHeight());
        this.f30212a.draw(canvas);
        super.onDraw(canvas);
    }
