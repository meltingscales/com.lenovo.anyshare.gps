...
public final class l7 {
    ...
    public final CreativeType f30221a;
    public final j7 b;
    ...
    public static class b implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final AdSession f30222a;

        public b(AdSession adSession) {
            this.f30222a = adSession;
        }

        @Override // java.lang.Runnable
        public void run() {
            ca.a("OmTracker: keep adSession " + this.f30222a);
        }
    }
    ...
    public interface d {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final Partner f30224a = Partner.createPartner("Corpmailru", MyTargetVersion.VERSION);
    }
    ...
    public static class e implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final WeakReference<l7> f30225a;
        public final AdSession b;

        public e(l7 l7Var, AdSession adSession) {
            this.f30225a = new WeakReference<>(l7Var);
            this.b = adSession;
        }

        @Override // java.lang.Runnable
        public void run() {
            if (this.f30225a.get() != null) {
                l7.l.postDelayed(this, 7000L);
                return;
            }
            ca.a("OmTracker: AdSession finished by cleaning references");
            this.b.finish();
        }
    }

    public l7(CreativeType creativeType, j7 j7Var, b5<VideoData> b5Var) {
        this.f30221a = creativeType;
        this.b = j7Var;
        this.c = b5Var;
    }
    ...
    public static AdSession a(AdSessionContext adSessionContext, CreativeType creativeType, boolean z) {
        try {
            ...
            ca.a("OmTracker: Unable to create AdSession: " + th.getMessage());
            return null;
        }
    }

    public static AdSessionContext a(View view, CreativeType creativeType, j7 j7Var) {
        return (creativeType == CreativeType.HTML_DISPLAY && (view instanceof WebView)) ? a((WebView) view, j7Var) : a(j7Var);
    }

    public static AdSessionContext a(WebView webView, j7 j7Var) {
        String str;
        if (webView == null) {
            str = "OmTracker: HTML could not be tracked without WebView";
        } else {
            try {
                return AdSessionContext.createHtmlAdSessionContext(d.f30224a, webView, j7Var.b, j7Var.f30191a);
            } catch (Throwable th) {
    ...
    public static l7 a(com.my.target.b bVar, int i, b5<VideoData> b5Var, Context context) {
        String str;
        j7 omData = bVar.getOmData();
        if (omData == null) {
            return null;
        }
        if (m.compareAndSet(false, true)) {
            try {
                ca.a("OmTracker: activating OmSDK");
        ...
        if (Omid.isActive()) {
            return new l7(i != 1 ? i != 2 ? i != 3 ? i != 4 ? CreativeType.DEFINED_BY_JAVASCRIPT : CreativeType.AUDIO : CreativeType.VIDEO : CreativeType.NATIVE_DISPLAY : CreativeType.HTML_DISPLAY, omData, b5Var);
        }
    ...
    public static String a(String str) {
        ...
        try {
            ...
            ca.a("OmTracker: Unable to inject script: " + th.getMessage());
            return null;
        }
    }
    ...
    */
    public static java.util.List<com.iab.omid.library.corpmailru.adsession.VerificationScriptResource> a(java.util.List<com.my.target.ha> r6) {
        /*
            r0 = 0
            if (r6 != 0) goto L4
            return r0
        ...
        Ld:
            ...
            com.my.target.ha r2 = (com.my.target.ha) r2
            java.net.URL r3 = new java.net.URL     // Catch: java.lang.Throwable -> L3b
            java.lang.String r4 = r2.f30176a     // Catch: java.lang.Throwable -> L3b
            r3.<init>(r4)     // Catch: java.lang.Throwable -> L3b
            java.lang.String r4 = r2.b     // Catch: java.lang.Throwable -> L3b
            ...
            goto L36
        L31:
            com.iab.omid.library.corpmailru.adsession.VerificationScriptResource r2 = com.iab.omid.library.corpmailru.adsession.VerificationScriptResource.createVerificationScriptResourceWithParameters(r4, r3, r2)     // Catch: java.lang.Throwable -> L3b
            goto L55
        L36:
            com.iab.omid.library.corpmailru.adsession.VerificationScriptResource r2 = com.iab.omid.library.corpmailru.adsession.VerificationScriptResource.createVerificationScriptResourceWithoutParameters(r3)     // Catch: java.lang.Throwable -> L3b
            goto L55
        L3b:
            r2 = move-exception
        ...
        L5b:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.my.target.l7.a(java.util.List):java.util.List");
    }

    public static void a(c cVar, AdSession adSession) {
        try {
            int i = cVar.b;
            adSession.addFriendlyObstruction(cVar.f30223a, i != 0 ? i != 1 ? i != 2 ? FriendlyObstructionPurpose.OTHER : FriendlyObstructionPurpose.NOT_VISIBLE : FriendlyObstructionPurpose.VIDEO_CONTROLS : FriendlyObstructionPurpose.CLOSE_AD, C2051Ejc.f8464a);
        } catch (Throwable th) {
            ca.a("OmTracker: Unable to addObstruction: " + th.getMessage());
        }
    }

    public void a() {
        ca.a("OmTracker: finishing session");
        this.f = null;
        if (this.g == null) {
            ca.a("OmTracker: Unable to finish adSession: adSession is not initialized");
            return;
        }
        e eVar = this.k;
        if (eVar != null) {
        ...
        try {
            this.g.finish();
            l.postDelayed(new b(this.g), 7000L);
        } catch (Throwable th) {
            ca.a("OmTracker: Unable to finish adSession: " + th.getMessage());
        }
    }
    ...
    public void a(float f) {
        ...
        try {
            ...
            ca.a("OmTracker: Unable to track media volume: " + th.getMessage());
        }
    }
    ...
    public void a(int i) {
        ...
        try {
            ...
            ca.a("OmTracker: Unable to track mediaEvent " + i + ": " + th.getMessage());
        }
    }
    ...
    public final void a(int i, float f) {
        ...
        ca.a("OmTracker: sendQuartile() called with: quartile = [" + i + "]");
        try {
            if (i == 0) {
            ...
            ca.a("OmTracker: Unable to track quartiles: " + th.getMessage());
        }
    }
    ...
    public void a(View view) {
        ...
        try {
            ...
            ca.a("OmTracker: Unable to register view: " + th.getMessage());
        }
    }

    public void a(View view, c... cVarArr) {
        StringBuilder sb;
        String str;
        String sb2;
        AdSessionContext a2 = a(view, this.f30221a, this.b);
        if (a2 == null) {
            sb2 = "OmTracker: OmSDK start failed, AdSessionContext is not created";
        } else {
            AdSession a3 = a(a2, this.f30221a, this.c != null);
            this.g = a3;
            if (a3 == null) {
                ...
                this.k = eVar;
                l.postDelayed(eVar, 7000L);
                for (c cVar : cVarArr) {
                    a(cVar, this.g);
                }
                try {
                    ca.a("OmTracker: registering view");
                    this.g.registerAdView(view);
                    try {
                        ca.a("OmTracker: creating AdEvents");
                        this.f = AdEvents.createAdEvents(this.g);
                        VastProperties vastProperties = null;
                        if (this.c != null) {
                            ca.a("OmTracker: Creating MediaEvents");
                            try {
                                ...
                                vastProperties = this.c.isAllowClose() ? VastProperties.createVastPropertiesForSkippableMedia(this.c.getAllowCloseDelay(), this.c.isAutoPlay(), position) : VastProperties.createVastPropertiesForNonSkippableMedia(this.c.isAutoPlay(), position);
                            } catch (Throwable th) {
                                ca.a("OmTracker: Unable to create MediaEvents: " + th.getMessage());
                            }
                        }
                        try {
                            this.g.start();
                            try {
                                ...
                                ca.a("OmTracker: Unable to call loaded: " + th2.getMessage());
                                return;
                            }
                        } catch (Throwable th3) {
                            th = th3;
    ...
    public void a(boolean z) {
        ...
        try {
            ...
            ca.a("OmTracker: Unable to track media fullscreen: " + th.getMessage());
        }
    }
    ...
    public boolean b() {
        return this.f30221a == CreativeType.HTML_DISPLAY;
    }
    ...
    public void c() {
        ...
        try {
            ...
            ca.a("OmTracker: Unable to call impression: " + th.getMessage());
        }
    }
}
