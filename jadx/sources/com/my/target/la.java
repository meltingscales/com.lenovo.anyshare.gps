...
public class la extends View {
    ...
    public final void a() {
        this.f30227a.setColor(-1);
        this.f30227a.setAntiAlias(true);
        this.f30227a.setStyle(Paint.Style.STROKE);
        this.f30227a.setStrokeWidth(this.d.b(1));
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(this.e, -90.0f, isInEditMode() ? 360.0f : this.g, false, this.f30227a);
        this.c.setColor(-1);
