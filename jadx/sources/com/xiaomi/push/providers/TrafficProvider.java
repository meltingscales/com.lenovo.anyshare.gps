...
public class TrafficProvider extends ContentProvider {
    ...
    public static final Uri f32572a = Uri.parse("content://com.xiaomi.push.providers.TrafficProvider/traffic");
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        GEj.a(this, context, providerInfo);
    }
    ...
    public int update(Uri uri, ContentValues contentValues, String str, String[] strArr) {
        if (b.match(uri) == 2 && contentValues != null && contentValues.containsKey("imsi")) {
            WDj.m996a(contentValues.getAsString("imsi"));
            return 0;
        }
        return 0;
    }
