...
public class ConfigManager {
    ...
    public com.apm.insight.e mEncryptImpl = new com.apm.insight.e() { // from class: com.apm.insight.runtime.ConfigManager.1
    ...
    public boolean mNativeCrashMiniDump = true;
    public boolean mEnsureEnable = true;
    public boolean mEnsureWithLogcat = false;
    public long mBlockMonitorInterval = 1000;
    public boolean mBlockMonitorEnable = false;
        ...
        try {
            f fVar = new f() { // from class: com.apm.insight.runtime.ConfigManager.3
                ...
                public Object a(String str2) {
                    return str2.equals(AdvertisementDBAdapter.AdvertisementColumns.COLUMN_MD5) ? str : super.a(str2);
                }
            };
