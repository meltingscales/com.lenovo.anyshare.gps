...
public class Reflection {
    ...
    public static ReferrerDetails getSamsungReferrer(Context context, ILogger iLogger) {
        try {
            ...
            iLogger.info("invoke getSamsungInstallReferrerDetails : " + e.getMessage(), new Object[0]);
            return null;
        }
    }
    ...
    public static ReferrerDetails getVivoReferrer(Context context, ILogger iLogger) {
        try {
            ...
            iLogger.info("invoke getVivoInstallReferrerDetails : " + e.getMessage(), new Object[0]);
            return null;
        }
    }
    ...
    public static ReferrerDetails getXiaomiReferrer(Context context, ILogger iLogger) {
        try {
            ...
            iLogger.info("invoke getXiaomiInstallReferrerDetails : " + e.getMessage(), new Object[0]);
            return null;
        }
    }
