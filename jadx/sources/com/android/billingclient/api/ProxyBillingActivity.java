...
public class ProxyBillingActivity extends Activity {
    ...
    public class _lancet {
        ...
        public static ComponentName com_lenovo_anyshare_hyperboost_scene_HyperBoostSceneAop_actStartForegroundService(ProxyBillingActivity proxyBillingActivity, Intent intent) {
            DEa.b();
            return proxyBillingActivity.startForegroundService$___twin___(intent);
        }

        @Hrk(mayCreateSuper = true, value = "onCreate")
        @Krk(scope = Scope.LEAF, value = "android.app.Activity")
        public static void com_lenovo_anyshare_hyperboost_scene_HyperBoostSceneAop_onCreatePage(ProxyBillingActivity proxyBillingActivity, Bundle bundle) {
            proxyBillingActivity.onCreate$___twin___(bundle);
            DEa.d();
        }
    }
    ...
    public void onCreate$___twin___(Bundle bundle) {
        ...
        if (bundle == null) {
            com.google.android.gms.internal.play_billing.zzb.zzn("ProxyBillingActivity", "Launching Play Store billing flow");
            ...
            try {
                ...
                com.google.android.gms.internal.play_billing.zzb.zzp("ProxyBillingActivity", "Got exception while trying to start a purchase flow.", e);
        ...
        com.google.android.gms.internal.play_billing.zzb.zzn("ProxyBillingActivity", "Launching Play Store billing flow from savedInstanceState");
