...
public class BundleUtils {
    ...
    public static void put(String str, Object obj, Bundle bundle) {
        if (obj != null) {
            if (obj instanceof String) {
                ...
                com.applovin.impl.sdk.x.H(AppLovinSdk.TAG, "Skipped insertion of " + obj + " into Bundle");
                return;
            }
        }
        com.applovin.impl.sdk.x.H(AppLovinSdk.TAG, "Skipped insertion into Bundle because value is null.");
    }
    ...
    public static JSONObject toJSONObject(Bundle bundle) {
        ...
        try {
            ...
            com.applovin.impl.sdk.x.e(AppLovinSdk.TAG, "Failed to convert Bundle to JSONObject", e);
        }
        return jSONObject;
    }
