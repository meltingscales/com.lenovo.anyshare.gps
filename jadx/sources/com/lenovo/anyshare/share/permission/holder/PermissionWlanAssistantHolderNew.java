...
import com.lenovo.anyshare.C19453rsb;
import com.lenovo.anyshare.C20064ssb;
import com.lenovo.anyshare.View$OnClickListenerC18235psb;
import com.lenovo.anyshare.View$OnClickListenerC18845qsb;
...
public class PermissionWlanAssistantHolderNew extends BaseRecyclerViewHolder<PermissionItem> {
    ...
    public PermissionWlanAssistantHolderNew(ViewGroup viewGroup, boolean z) {
        super(viewGroup, R.layout.bd1);
        this.j = false;
        this.k = false;
        this.k = z;
        this.f26724a = (ImageView) getView(R.id.c1p);
        ...
        this.i = getView(R.id.dpk);
        C20064ssb.a(this.itemView, new View$OnClickListenerC18235psb(this));
        if (this.k) {
            this.d.setVisibility(8);
        } else {
            C20064ssb.a(this.d, (View.OnClickListener) new View$OnClickListenerC18845qsb(this));
        }
    }
    ...
    private void b(PermissionItem permissionItem) {
        int i = C19453rsb.f26321a[permissionItem.d.ordinal()];
        if (i == 1) {
            if (!this.k) {
                this.d.setVisibility(8);
            }
        ...
        this.f26724a.setBackgroundResource(permissionItem.c());
