...
public final class C24157zck<T> implements InterfaceC14272jSj<List<T>, List<T>, List<T>> {

    /* renamed from: a  reason: collision with root package name */
    public final Comparator<? super T> f29895a;

    public C24157zck(Comparator<? super T> comparator) {
        this.f29895a = comparator;
    }
    ...
    */
    public java.util.List<T> apply(java.util.List<T> r6, java.util.List<T> r7) throws java.lang.Exception {
        ...
        L37:
            if (r0 == 0) goto L61
            if (r3 == 0) goto L61
            java.util.Comparator<? super T> r4 = r5.f29895a
        ...
        L85:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lenovo.anyshare.C24157zck.apply(java.util.List, java.util.List):java.util.List");
    }
}
