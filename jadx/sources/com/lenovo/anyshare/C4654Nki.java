...
public final class C4654Nki implements Checksum {
    ...
    private long a(byte b, long j) {
        return ((j >> 8) ^ f12456a[(int) ((((byte) (b & 255)) ^ j) & 255)]) & DNi.c;
    }
    ...
    public static String a(SFile sFile) {
        try {
            try {
                try {
                    C4654Nki c4654Nki = new C4654Nki();
                    sFile.a(SFile.OpenMode.Read);
                    byte[] bArr = new byte[8192];
                    while (true) {
                        int a2 = sFile.a(bArr);
                        if (a2 != -1) {
                            c4654Nki.update(bArr, 0, a2);
                        } else {
                            return C18740qje.a(c4654Nki.a());
                        }
                    }
                } catch (IOException e) {
