...
import com.lenovo.anyshare.C7217Wjb;
import com.lenovo.anyshare.gps.R;
import com.lenovo.anyshare.setting.toolbar.BaseToolbarView;
import java.util.List;

/* loaded from: classes5.dex */
public class ToolbarGView extends BaseToolbarView {
    ...
    public void a(int i, List<Integer> list, List<Integer> list2, int[] iArr, int[] iArr2, int[] iArr3, List<Integer> list3) {
        ...
        while (true) {
            if (i4 >= list3.size()) {
                ...
                if (i4 == 0 && C6643Ujb.a().e().size() > 0) {
                    findViewById(R.id.cj_).setVisibility(0);
                }
        ...
        int dimensionPixelSize = viewGroup.getResources().getDimensionPixelSize(R.dimen.bqf);
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        C7217Wjb.a(this, onClickListener);
    }
