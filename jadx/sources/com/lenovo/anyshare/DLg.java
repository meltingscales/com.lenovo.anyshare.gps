...
public class DLg implements C3596Jsj.g<AbstractC20707tuj> {
    ...
    public final /* synthetic */ GLg k;

    public DLg(GLg gLg, String str, C18504qPg c18504qPg, String str2, int i, CNg cNg, InterfaceC23366yNg interfaceC23366yNg, String str3, String str4, String str5, String str6) {
        this.k = gLg;
        this.f7777a = str;
        this.b = c18504qPg;
        this.c = str2;
    ...
    public void onOk(AbstractC20707tuj abstractC20707tuj) {
        ...
        linkedHashMap.put("portal", this.f7777a);
        ...
        try {
            this.f.a(this.f7777a, this.g, this.h, this.i, this.j, abstractC20707tuj.d());
