...
public class LNe extends C8356_ie.b {

    /* renamed from: a  reason: collision with root package name */
    public int f11360a = -1;
    public final /* synthetic */ HomeBatterySaverHolder b;

    public LNe(HomeBatterySaverHolder homeBatterySaverHolder) {
        this.b = homeBatterySaverHolder;
    }
    ...
    public void callback(Exception exc) {
        ...
        Context context2;
        TextView textView;
        String valueOf = String.valueOf(this.f11360a);
        context = this.b.getContext();
        String string = context.getString(R.string.bi9, valueOf + C17016nsc.k);
    ...
    public void execute() throws Exception {
        Context context;
        context = this.b.getContext();
        this.f11360a = C21194ukf.c(context);
    }
}
