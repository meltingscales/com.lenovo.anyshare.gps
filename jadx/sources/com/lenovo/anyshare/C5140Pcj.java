...
public class C5140Pcj {
    ...
    public static class a {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: com.lenovo.anyshare.Pcj$a$a  reason: collision with other inner class name */
        /* loaded from: classes8.dex */
        public static class CallableC0597a implements Callable<Void> {
            ...
            public CallableC0597a(int[] iArr, int i, int i2, int i3, int i4, int i5, int i6) {
                this.f13279a = iArr;
                this.b = i;
                this.c = i2;
                this.d = i3;
            ...
            public Void call() throws Exception {
                a.b(this.f13279a, this.b, this.c, this.d, this.e, this.f, this.g);
                return null;
            }
        }
        ...
        public /* synthetic */ a(C4854Ocj c4854Ocj) {
            this();
        }
        ...
        public Bitmap a(Bitmap bitmap, int i) {
            ...
            int i2 = C5140Pcj.f13277a;
            ArrayList arrayList = new ArrayList(i2);
            ArrayList arrayList2 = new ArrayList(i2);
            for (int i3 = 0; i3 < i2; i3++) {
                int i4 = i3;
                arrayList.add(new CallableC0597a(iArr, width, height, i, i2, i4, 1));
                arrayList2.add(new CallableC0597a(iArr, width, height, i, i2, i4, 2));
            }
            try {
                C5140Pcj.b.invokeAll(arrayList);
                try {
                    C5140Pcj.b.invokeAll(arrayList2);
    ...
    /* renamed from: com.lenovo.anyshare.Pcj$b */
    /* loaded from: classes8.dex */
    public interface b {
    ...
    public static void a(Bitmap bitmap, int i, int i2, int i3, b bVar) {
        C8356_ie.c(new C4854Ocj(bitmap, i, i2, bVar), i3);
    }
    ...
    public static Bitmap a(Bitmap bitmap, int i, int i2) {
        ...
        C6040Sge.e("BlurUtils", "blurImage: usedTime = " + (System.currentTimeMillis() - currentTimeMillis));
        return bitmap3;
    }
