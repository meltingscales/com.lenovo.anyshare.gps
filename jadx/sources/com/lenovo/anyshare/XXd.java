...
public class XXd implements InterfaceC20794uC<Drawable> {
    ...
    public final /* synthetic */ ZXd f;

    public XXd(ZXd zXd, String str, ImageView imageView, int i, long j, C15539lXc c15539lXc) {
        this.f = zXd;
        this.f16715a = str;
        this.b = imageView;
        this.c = i;
    ...
    public boolean a(GlideException glideException, Object obj, RC<Drawable> rc, boolean z) {
        ...
        JJd jJd6;
        JJd jJd7;
        if (FYd.a(this.f16715a)) {
            C8356_ie.a(new WXd(this), 0L, 200L);
            return false;
        }
