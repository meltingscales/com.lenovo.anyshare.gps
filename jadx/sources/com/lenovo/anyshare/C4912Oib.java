...
public class C4912Oib {
    public static void a(FragmentActivity fragmentActivity) {
        ...
        C24348zsj.m().d("APP语言").c(fragmentActivity.getString(R.string.asb)).b(strArr).b(indexOf).a(new C4625Nib(arrayList, fragmentActivity)).a(fragmentActivity);
    }
}
