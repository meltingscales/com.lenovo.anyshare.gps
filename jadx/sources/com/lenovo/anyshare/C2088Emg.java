...
public class C2088Emg {

    /* renamed from: a  reason: collision with root package name */
    public static final String f8490a = "Emg";

    /* renamed from: com.lenovo.anyshare.Emg$a */
    /* loaded from: classes7.dex */
    public interface a {
    ...
    public static List<ActionMenuItemBean> a(AbstractC23099xqf abstractC23099xqf) {
        ...
        arrayList.add(new ActionMenuItemBean((int) C11119eLh.f, (int) R.drawable.bky, (int) R.string.ast));
        arrayList.add(new ActionMenuItemBean(4099, (int) R.drawable.bh8, (int) R.string.asx));
        return arrayList;
    }

    public static List<ActionMenuItemBean> b(AbstractC23099xqf abstractC23099xqf) {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new ActionMenuItemBean(4099, (int) R.drawable.bh9, (int) R.string.asx));
        arrayList.add(new ActionMenuItemBean(4100, (int) R.drawable.bg5, (int) R.string.b9c));
        return arrayList;
    }

    public static void a(FragmentActivity fragmentActivity, ActionMenuItemBean actionMenuItemBean, AbstractC23099xqf abstractC23099xqf, a aVar, String str) {
        ...
        switch (actionMenuItemBean.getId()) {
            ...
            case C11119eLh.f /* 4098 */:
                ...
                if (interfaceC4706Npf == null) {
                    C6040Sge.f(f8490a, "sendSelectedContent no share activity start service");
                    return;
                } else {
            ...
            case 4099:
                C22610xAg.a((Context) fragmentActivity, abstractC23099xqf, str);
                return;
            case 4100:
                C22610xAg.d(fragmentActivity, abstractC23099xqf, "photo_view");
                return;
            default:
                return;
        }
