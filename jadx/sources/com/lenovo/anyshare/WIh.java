...
public class WIh implements Callable<List<SGh>> {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ RoomSQLiteQuery f16180a;
    public final /* synthetic */ C11097eJh b;

    public WIh(C11097eJh c11097eJh, RoomSQLiteQuery roomSQLiteQuery) {
        this.b = c11097eJh;
        this.f16180a = roomSQLiteQuery;
    }

    public void finalize() {
        this.f16180a.release();
    }
    ...
    public List<SGh> call() throws Exception {
        ...
        Cursor query = DBUtil.query(roomDatabase, this.f16180a, false, null);
        try {
