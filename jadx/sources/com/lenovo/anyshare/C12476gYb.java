...
public class C12476gYb extends C13719iYb {
    ...
    public void d(float f) {
        ...
        this.Ha = 0.5f;
        this.Ja = 0.5f;
        float[] fArr = {0.0f, 0.52380955f, 1.0f};
        if (f <= fArr[1]) {
            this.Ba = 0.0f;
            this.xa = 0.0f;
            this.za = 0.0f;
            this.Ha = 0.5f;
            this.Ja = 0.5f;
            this.Da = c(0.8f, 0.7f, 0.7f, (f - fArr[0]) / (fArr[1] - fArr[0]));
            this.Fa = this.Da;
        } else {
            this.Ba = 0.0f;
            this.xa = 0.0f;
            ...
            this.Ha = 0.5f;
            this.Ja = 0.5f;
            this.Da = a(0.7f, 0.5f, 0.7f, 0.6f, 0.7f, (f - fArr[1]) / (fArr[2] - fArr[1]));
            this.Fa = this.Da;
        }
        if (1 == this.La) {
            this.Ba = -this.Ba;
