...
public class C24047zU {

    /* renamed from: a  reason: collision with root package name */
    public static final Pattern f29812a = Pattern.compile("<(head)( [^>]*)?>", 2);
    ...
    public static String a(String str, String str2) {
        C10612dV.a(str, "HTML is null or empty");
        int[][] a2 = a(str);
        StringBuilder sb = new StringBuilder(str.length() + str2.length() + 16);
        if (!b(str, sb, b, str2, a2) && !a(str, sb, f29812a, str2, a2) && !b(str, sb, d, str2, a2) && !a(str, sb, c, str2, a2) && !b(str, sb, f, str2, a2) && !a(str, sb, e, str2, a2) && !a(str, sb, g, str2, a2)) {
            return str2 + str;
        }
        return sb.toString();
    }
