...
public class SNe extends C8356_ie.b {

    /* renamed from: a  reason: collision with root package name */
    public int f14437a = -1;
    public final /* synthetic */ HomeSmallBatterySaverHolder b;

    public SNe(HomeSmallBatterySaverHolder homeSmallBatterySaverHolder) {
        this.b = homeSmallBatterySaverHolder;
    }
    ...
    public void execute() throws Exception {
        Context context;
        context = this.b.getContext();
        this.f14437a = C21194ukf.c(context);
    }
}
