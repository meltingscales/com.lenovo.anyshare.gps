...
public final class C13777icd implements Checksum {
    ...
    private long a(byte b, long j) {
        return ((j >> 8) ^ f22153a[(int) ((((byte) (b & 255)) ^ j) & 255)]) & DNi.c;
    }
    ...
    public static String a(SFile sFile) {
        try {
            try {
                try {
                    C13777icd c13777icd = new C13777icd();
                    sFile.a(SFile.OpenMode.Read);
                    byte[] bArr = new byte[8192];
                    while (true) {
                        int a2 = sFile.a(bArr);
                        if (a2 != -1) {
                            c13777icd.update(bArr, 0, a2);
                        } else {
                            return C13166hcd.a(c13777icd.a());
                        }
                    }
                } catch (IOException e) {
                    C1395Ccd.b(DNi.f7797a, e.getMessage(), e);
                    sFile.c();
                    return null;
                } catch (Exception e2) {
                    C1395Ccd.b(DNi.f7797a, e2.getMessage(), e2);
                    sFile.c();
                    return null;
                }
            } catch (FileNotFoundException e3) {
                C1395Ccd.b(DNi.f7797a, e3.getMessage(), e3);
                sFile.c();
                return null;
            }
        } finally {
