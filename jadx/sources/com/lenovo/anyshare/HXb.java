...
public class HXb extends C14308jWb {
    ...
    public static final String U = "uSwapTopBottom";
    public float V;
    public int W;
    public int X;
    public int Y;
    ...
    public void a(int i, RWb rWb, boolean z, long j) {
        ...
        this.u = i;
        this.G = j;
        android.util.Log.e("shiyang", "shiyang filter ci=" + this.ga + ",gi=" + rWb.N + ", time = " + this.G + ". class =" + getClass().getSimpleName());
        long j2 = this.ea;
        long j3 = this.G;
