...
public class _Hd {
    ...
    public static void a(ReserveCommonDialog reserveCommonDialog, View view, Bundle bundle) {
        reserveCommonDialog.onViewCreated$___twin___(view, bundle);
        String name = reserveCommonDialog.getClass().getName();
