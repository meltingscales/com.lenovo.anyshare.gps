...
public class C18273pvd implements InterfaceC3387Ja {

    /* renamed from: a  reason: collision with root package name */
    public static AbstractC8190Ztd f25460a;
    ...
    public boolean a(Context context, String str, String str2, String str3, long j, boolean z, InterfaceC3099Ia interfaceC3099Ia) {
        return AdXzManagerEx.a(context, str, str2, str3, j, z, new C15834lvd(this, interfaceC3099Ia));
    }
    ...
    */
    public void a(android.content.Context r32, java.util.Map r33, com.lenovo.anyshare.InterfaceC3099Ia r34, java.lang.String r35) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lenovo.anyshare.C18273pvd.a(android.content.Context, java.util.Map, com.lenovo.anyshare.Ia, java.lang.String):void");
    }
    ...
    public void a(Context context, Map map, InterfaceC3099Ia interfaceC3099Ia) {
        ...
        InterfaceC14604juf q = AdXzManagerEx.q();
        ...
        if (intValue2 == 1 && f25460a == null) {
            f25460a = new C17664ovd(this, c9486bcd, str2, context);
            C17546olf.a(f25460a);
        }
        if (intValue2 == 1 && intValue == 1) {
            ...
            if (q != null) {
                ...
                InterfaceC1293Buf b2 = C19481ruf.b();
                arrayList.add(b2.b("apk_" + str5.hashCode()));
                q.b(arrayList);
            }
        } else if (interfaceC3099Ia != null) {
            if (intValue2 == 1) {
                try {
                    InterfaceC1293Buf b3 = C19481ruf.b();
                    if (b3.e("apk_" + str5.hashCode()) != null) {
                        interfaceC3099Ia.a("complete", a(str4, str5, d));
                        new C9486bcd(context).f(str2);
                    } else {
                        InterfaceC1293Buf b4 = C19481ruf.b();
                        XzRecord b5 = b4.b("apk_" + str5.hashCode());
                        if (b5 != null) {
                            XzRecord.Status status = b5.h;
                            ...
                            new C9486bcd(context).f(str2);
                            if (!com.anythink.expressad.e.a.b.az.equals(new OYc(context, "minisite").a(str5)) && AdXzManagerEx.r() < 3) {
                ...
                try {
                    ...
                    String b6 = new C9486bcd(context).b(str2);
                    JSONObject jSONObject3 = !TextUtils.isEmpty(b6) ? new JSONObject(b6) : null;
                    ...
                    if (a4 == -1) {
                        ...
                        if (c9486bcd.e(str5) > 0) {
                            ...
                            AdXzManagerEx.a(str5, 2);
                        } else {
                            str = com.anythink.expressad.e.a.b.az;
                        }
                        try {
                            if (!str.equals(oYc.a(str5)) && AdXzManagerEx.r() < 3) {
                                interfaceC3099Ia.a("download", a(str4, str5, d));
                                return;
                            }
