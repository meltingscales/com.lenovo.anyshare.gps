...
public class RunnableC10591dTa implements Runnable {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ Context f19810a;
    public final /* synthetic */ NotificationCompat.Builder b;

    public RunnableC10591dTa(Context context, NotificationCompat.Builder builder) {
    ...
    public void run() {
        NotificationManager notificationManager = (NotificationManager) this.f19810a.getSystemService("notification");
