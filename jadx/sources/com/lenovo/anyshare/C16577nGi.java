...
public class C16577nGi {
    ...
    public static void a(WaveformFragment waveformFragment, View view, Bundle bundle) {
        waveformFragment.onViewCreated$___twin___(view, bundle);
        String name = waveformFragment.getClass().getName();
