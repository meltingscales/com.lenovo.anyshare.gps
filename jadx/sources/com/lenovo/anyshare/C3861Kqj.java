...
public class C3861Kqj {

    /* renamed from: a  reason: collision with root package name */
    public static final AbstractC10963dy f11197a = AbstractC10963dy.e;
    public static final C10391dB b = new C10391dB().a(new XC.a().a(true));

    /* renamed from: com.lenovo.anyshare.Kqj$a */
    /* loaded from: classes8.dex */
    public interface a {
        void a(boolean z);
    }
    ...
    public static void c(ComponentCallbacks2C14013iw componentCallbacks2C14013iw, String str, ImageView imageView, int i) {
        a(componentCallbacks2C14013iw, str, imageView, i, ObjectStore.getContext().getResources().getDimensionPixelSize(R.dimen.dw1));
    }
    ...
    public static void a(ComponentCallbacks2C14013iw componentCallbacks2C14013iw, String str, ImageView imageView, int i, int i2, String str2, InterfaceC20794uC interfaceC20794uC) {
        try {
            componentCallbacks2C14013iw.load(str).a((AbstractC17134oC<?>) new C21405vC().e(i).b((InterfaceC19511rx<Bitmap>) new OA(i2)).a(f11197a)).a((AbstractC14622jw<?, ? super Drawable>) b).b((InterfaceC20794uC<Drawable>) new C12266gFa(imageView, str, str2, interfaceC20794uC)).a(imageView);
        } catch (Exception e) {
            C6040Sge.b(C18079pfa.f25322a, "load url failed: ", e);
        }
    }
    ...
    public static void a(ComponentCallbacks2C14013iw componentCallbacks2C14013iw, String str, String str2, int i, int i2, a aVar) {
        try {
            ...
            componentCallbacks2C14013iw.a((Object) HEa.a(str, str2)).a((AbstractC17134oC<?>) new C21405vC().a(f11197a).b((InterfaceC19511rx<Bitmap>) new C19606sFa(null, 25, 4)).e(R.color.biu)).b((InterfaceC20794uC<Drawable>) new C3574Jqj(aVar)).e(i, i2);
        } catch (Exception e) {
