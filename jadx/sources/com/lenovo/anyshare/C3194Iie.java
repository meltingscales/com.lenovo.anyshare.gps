...
public class C3194Iie extends C8356_ie.a {
    public final /* synthetic */ String b;
    public final /* synthetic */ InterfaceC23002xie c;
    public final /* synthetic */ String d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C3194Iie(String str, String str2, InterfaceC23002xie interfaceC23002xie, String str3) {
        super(str);
        this.b = str2;
    ...
    public void execute() {
        ...
        for (AbstractC21780vie abstractC21780vie : list) {
            if (abstractC21780vie.f28097a) {
                abstractC21780vie.b(this.b, this.c, this.d);
            }
        }
    }
}
