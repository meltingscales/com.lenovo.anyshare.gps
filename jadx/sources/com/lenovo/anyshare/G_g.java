...
public final class G_g extends Lambda implements InterfaceC16940nlk<String, Kfk> {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ CommonLoginFragment f9246a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public G_g(CommonLoginFragment commonLoginFragment) {
        super(1);
        this.f9246a = commonLoginFragment;
    }
    ...
    public final void a(String str) {
        ...
        loginCommonVerticalPanel = this.f9246a.y;
