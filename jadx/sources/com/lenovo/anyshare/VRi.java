...
public class VRi<R> extends GC implements InterfaceC20794uC<R> {

    /* renamed from: a  reason: collision with root package name */
    public final InterfaceC20794uC<R> f15809a;
    public long b;
    ...
    public VRi(ImageView imageView, String str, String str2, InterfaceC20794uC<R> interfaceC20794uC) {
        super(imageView);
        this.e = ImageLoadStats.Status.INIT;
        this.c = str;
        this.d = str2;
        this.b = System.currentTimeMillis();
        this.f15809a = interfaceC20794uC;
    }
    ...
    public boolean a(GlideException glideException, Object obj, RC<R> rc, boolean z) {
        ...
        InterfaceC20794uC<R> interfaceC20794uC = this.f15809a;
