...
public class IIh implements Callable<List<JuzsData>> {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ RoomSQLiteQuery f9986a;
    public final /* synthetic */ C11097eJh b;

    public IIh(C11097eJh c11097eJh, RoomSQLiteQuery roomSQLiteQuery) {
        this.b = c11097eJh;
        this.f9986a = roomSQLiteQuery;
    }
    ...
    public List<JuzsData> call() throws Exception {
        ...
        Cursor query = DBUtil.query(roomDatabase, this.f9986a, false, null);
        try {
