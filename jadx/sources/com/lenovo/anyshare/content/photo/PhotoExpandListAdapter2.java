...
public class PhotoExpandListAdapter2 extends AdExpandListAdapter<C6631Uia, PhotoChildHolder> {
    public int r;
    public int s;

    public PhotoExpandListAdapter2(List<C6631Uia> list, int i, ContentType contentType) {
        super(list, i);
        this.s = i;
        this.m = contentType;
    }
    ...
    public void a(PhotoChildHolder photoChildHolder, int i, C6631Uia c6631Uia, int i2, List<Object> list) {
        photoChildHolder.a((PhotoChildHolder) ((AbstractC23099xqf) c6631Uia.f15325a.get(i2)), i, (UNb) c6631Uia, i2, list);
    }
    ...
    public PhotoChildHolder c(ViewGroup viewGroup, int i) {
        return new PhotoChildHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.a1t, viewGroup, false), this.s);
    }
}
