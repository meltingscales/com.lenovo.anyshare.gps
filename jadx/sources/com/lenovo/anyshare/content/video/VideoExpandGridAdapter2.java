...
public class VideoExpandGridAdapter2 extends AdExpandListAdapter<C6631Uia, VideoGridChildHolder> {
    public int r;
    public int s;

    public VideoExpandGridAdapter2(List<C6631Uia> list, int i, ContentType contentType) {
        super(list, i);
        this.s = i;
        this.m = contentType;
    }
    ...
    public void a(VideoGridChildHolder videoGridChildHolder, int i, C6631Uia c6631Uia, int i2, List<Object> list) {
        videoGridChildHolder.a((VideoGridChildHolder) ((AbstractC23099xqf) c6631Uia.f15325a.get(i2)), i, (UNb) c6631Uia, i2, list);
    }
    ...
    public VideoGridChildHolder c(ViewGroup viewGroup, int i) {
        return new VideoGridChildHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.a26, viewGroup, false), this.s);
    }
}
