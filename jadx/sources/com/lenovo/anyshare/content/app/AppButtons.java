...
import com.lenovo.anyshare.C10175cja;
...
public class AppButtons extends BaseSwitchView implements View.OnClickListener {
    public TextView b;
    public TextView c;
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.dlw) {
            ...
            C6040Sge.b("AppButtons", "Click the button does not exist!");
        }
    }
    ...
    public void onFinishInflate() {
        ...
        this.b = (TextView) findViewById(R.id.dlw);
        this.c = (TextView) findViewById(R.id.d9k);
        C10175cja.a(this.b, this);
        C10175cja.a(this.c, this);
    }

    @Override // android.view.View
    public void setOnClickListener(View.OnClickListener onClickListener) {
        C10175cja.a(this, onClickListener);
    }
