...
public class C16682nQd {
    ...
    public static void a(OfflineNetGuideDialog offlineNetGuideDialog, View view, Bundle bundle) {
        offlineNetGuideDialog.onViewCreated$___twin___(view, bundle);
        String name = offlineNetGuideDialog.getClass().getName();
