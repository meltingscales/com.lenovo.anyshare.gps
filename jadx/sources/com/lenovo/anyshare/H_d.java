...
public class H_d extends FVc.b {
    ...
    public H_d(Context context, C21719vdd c21719vdd) {
        this.d = context;
        this.e = c21719vdd;
    }
    ...
    public void callback(Exception exc) {
        if (this.b && !this.f9677a) {
            ...
            P_d.b(c21719vdd.f28053a, "cached_url", a2, c21719vdd.e, c21719vdd.k);
            String str = this.c.k;
            if (str != null && str.length() > 0) {
                ...
                if (i == 0 || (i == -1 && !z)) {
                    ...
                    AdXzManager.a(context, c21719vdd2.e, a2, c21719vdd2.d, 0, TextUtils.isEmpty(c21719vdd2.r) ? this.e.e : this.e.r);
                }
            }
            C21719vdd c21719vdd3 = this.e;
            if (c21719vdd3.p) {
                AdXzManager.a(this.d, c21719vdd3.f28053a, a2, c21719vdd3.e, c21719vdd3.f, c21719vdd3.g, c21719vdd3.k, c21719vdd3.l);
            } else {
                ...
                P_d.d(c21719vdd5.f28053a, "inner_xz", a2, c21719vdd5.e);
            }
            AdXzManager.b(this.d, this.c, this.e, 1, a2);
        }
    }
    ...
    public void execute() throws Exception {
        ...
        if (C18644qbd.a(context, c21719vdd.e, c21719vdd.j) == 1) {
            ...
            if (!AdXzManager.f(str, c21719vdd3.b)) {
                str = this.e.b;
            }
            C21719vdd c21719vdd4 = this.e;
            P_d.b(c21719vdd4.f28053a, "insalled", str, c21719vdd4.e, c21719vdd4.k);
            this.b = false;
            return;
        }
        C21719vdd c21719vdd5 = this.e;
        ...
        if (i > 0 && C18644qbd.a(this.d, c21719vdd5.e, i) == 2) {
            ...
            P_d.b(c21719vdd7.f28053a, "insalled_low_version", c21719vdd7.c, c21719vdd7.e, c21719vdd7.k);
            this.b = false;
            return;
        }
        ...
        if (cPIReportInfo == null) {
            b = AdXzManager.b(this.e);
            this.c = b;
            if (l != null) {
                l.b(this.c);
            }
        } else {
            AdXzManager.b(cPIReportInfo, CPIReportInfo.CpiStatus.IMPRESSION, CPIReportInfo.CpiStatus.CLICK, this.e);
            if (l != null) {
                l.a(this.c);
            }
        }
