...
/* renamed from: com.lenovo.anyshare.glj  reason: case insensitive filesystem */
/* loaded from: classes8.dex */
public class C12647glj implements InterfaceC19511rx<Bitmap> {

    /* renamed from: a  reason: collision with root package name */
    public static int f21353a = 25;
    public static int b = 2;
    public int c;
    public int d;
    public float e;

    public C12647glj(Context context) {
        this(context, f21353a, b);
    }
    ...
    public boolean equals(Object obj) {
        return obj instanceof C12647glj;
    }
    ...
    public C12647glj(Context context, int i) {
        this(context, i, b);
    }
    ...
    public C12647glj(Context context, int i, int i2) {
        this.e = 0.2f;
        this.c = i;
        this.d = i2;
    }
