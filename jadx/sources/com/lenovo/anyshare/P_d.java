...
public class P_d {
    ...
    static {
        f13246a = C10693dbd.e() ? "Mads_AddDownloadlist" : "Adshonor_AddDownloadlist";
    ...
    public static void c(AppItem appItem, String str) {
        try {
            ...
            linkedHashMap.put("adId", appItem.c("adId"));
            linkedHashMap.put("isSapk", appItem.i() + "");
            linkedHashMap.put("silence_result", appItem.a("silence_result", -1) + "");
    ...
    public static void d(AppItem appItem, String str) {
        ...
        try {
            Context a2 = C0791Abd.a();
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            linkedHashMap.put("portal", appItem.c("portal"));
            linkedHashMap.put("url", appItem.c("url"));
            linkedHashMap.put(a.C0239a.A, appItem.r);
            linkedHashMap.put("ver", String.valueOf(appItem.s));
            linkedHashMap.put("status", str);
            linkedHashMap.put("lock_screen", appItem.a("lock_screen", false) ? "true" : "false");
            linkedHashMap.put("need_permission", appItem.a("need_permission", false) ? "true" : "false");
            linkedHashMap.put("is_background", appItem.a("is_background", false) ? "true" : "false");
            linkedHashMap.put("silence_result", appItem.a("silence_result", -1) + "");
            InterfaceC2894Hhd l = C14399jdd.l();
            CPIReportInfo l2 = l != null ? l.l(appItem.r, appItem.c("url")) : null;
            ...
            if (C16252mfd.e.contains(appItem.c("portal"))) {
                if (c21108udd != null) {
            ...
            String c2 = appItem.c("error");
            if (!TextUtils.isEmpty(c2)) {
                linkedHashMap.put("error", c2);
            }
            linkedHashMap.put(C19299rfd.u, appItem.i() ? "true" : "false");
    ...
    public static void b(String str, String str2, String str3, String str4, boolean z) {
        if (Looper.getMainLooper() == Looper.myLooper()) {
            FVc.c(new O_d(str, str2, str3, str4, z));
        } else {
    ...
    public static void c(String str, String str2, String str3, String str4) {
        if (Looper.getMainLooper() == Looper.myLooper()) {
            FVc.c(new N_d(str, str2, str3, str4));
        } else {
    ...
    public static void d(String str, String str2, String str3, String str4) {
        if (Looper.getMainLooper() == Looper.myLooper()) {
            FVc.c(new M_d(str, str2, str3, str4));
        } else {
    ...
    /* JADX WARN: Removed duplicated region for block: B:24:0x0087 A[Catch: Exception -> 0x0183, TryCatch #0 {Exception -> 0x0183, blocks: (B:3:0x0012, B:7:0x002e, B:9:0x0044, B:14:0x0050, B:16:0x0058, B:18:0x0063, B:20:0x006d, B:22:0x007f, B:24:0x0087, B:25:0x008e, B:27:0x0096, B:28:0x009d, B:30:0x00a5, B:31:0x00ac, B:35:0x00ca, B:37:0x00e3, B:40:0x00ed, B:42:0x00fc, B:44:0x0104, B:46:0x0115, B:41:0x00f3, B:47:0x0122, B:49:0x012c, B:50:0x0135, B:52:0x0141, B:53:0x0148, B:55:0x0152, B:57:0x015f, B:17:0x005f), top: B:60:0x0012 }] */
    /* JADX WARN: Removed duplicated region for block: B:27:0x0096 A[Catch: Exception -> 0x0183, TryCatch #0 {Exception -> 0x0183, blocks: (B:3:0x0012, B:7:0x002e, B:9:0x0044, B:14:0x0050, B:16:0x0058, B:18:0x0063, B:20:0x006d, B:22:0x007f, B:24:0x0087, B:25:0x008e, B:27:0x0096, B:28:0x009d, B:30:0x00a5, B:31:0x00ac, B:35:0x00ca, B:37:0x00e3, B:40:0x00ed, B:42:0x00fc, B:44:0x0104, B:46:0x0115, B:41:0x00f3, B:47:0x0122, B:49:0x012c, B:50:0x0135, B:52:0x0141, B:53:0x0148, B:55:0x0152, B:57:0x015f, B:17:0x005f), top: B:60:0x0012 }] */
    /* JADX WARN: Removed duplicated region for block: B:30:0x00a5 A[Catch: Exception -> 0x0183, TryCatch #0 {Exception -> 0x0183, blocks: (B