...
public class VNe extends C8356_ie.b {

    /* renamed from: a  reason: collision with root package name */
    public int f15773a = -1;
    public final /* synthetic */ HomeSmallPhoneBoosterHolder b;

    public VNe(HomeSmallPhoneBoosterHolder homeSmallPhoneBoosterHolder) {
        this.b = homeSmallPhoneBoosterHolder;
    }
    ...
    public void execute() throws Exception {
        Context context;
        context = this.b.getContext();
        this.f15773a = C21194ukf.i(context);
    }
}
