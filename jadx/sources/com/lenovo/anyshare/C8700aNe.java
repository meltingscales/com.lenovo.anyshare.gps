...
public class C8700aNe {

    /* renamed from: a  reason: collision with root package name */
    public static volatile C21405vC f18407a;
    ...
    public static void d(Context context, AbstractC23099xqf abstractC23099xqf, ImageView imageView, int i, int i2) {
        try {
            ...
            C8356_ie.c(new _Me(abstractC23099xqf, context, imageView, i, i2));
        } catch (Exception e) {
    ...
    public static void e(Context context, AbstractC23099xqf abstractC23099xqf, ImageView imageView, int i, int i2) {
        if (f18407a == null) {
            f18407a = new C21405vC().d(context.getResources().getDrawable(i)).b((InterfaceC19511rx<Bitmap>) new OA((int) ObjectStore.getContext().getResources().getDimension(R.dimen.cya)));
        }
        if (i2 != 0) {
            PEa.a(context, abstractC23099xqf, imageView, HEa.b, f18407a.b((InterfaceC19511rx<Bitmap>) new OA(i2)));
            return;
        }
        PEa.a(context, abstractC23099xqf, imageView, HEa.b, f18407a);
    }
    ...
    public static void f(Context context, AbstractC23099xqf abstractC23099xqf, ImageView imageView, int i, int i2) {
        ...
        if (b == null) {
            b = new C21405vC().d(context.getResources().getDrawable(i)).a(new C21381vA(), new OA((int) ObjectStore.getContext().getResources().getDimension(R.dimen.cxs)));
        }
        if (i2 != 0) {
    ...
    public static void g(Context context, AbstractC23099xqf abstractC23099xqf, ImageView imageView, int i, int i2) {
        ...
        if (c == null) {
            c = new C21405vC().d(context.getResources().getDrawable(i)).a(new C21381vA(), new OA((int) ObjectStore.getContext().getResources().getDimension(R.dimen.cx6)));
        }
        if (i2 != 0) {
