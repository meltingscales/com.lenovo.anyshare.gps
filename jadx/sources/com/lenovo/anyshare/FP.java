...
public class FP extends AP implements InterfaceC16057mP {
    public String g;
    public Boolean h;
    public GradientDrawable i;
    public GradientDrawable j;

    public FP(TxtReaderView txtReaderView, SP sp, Scroller scroller) {
    ...
    public void e(Canvas canvas) {
        ...
        this.e.lineTo(0.0f, 0.0f);
        canvas.clipPath(this.e, Region.Op.INTERSECT);
        canvas.drawBitmap(e(), j, j, (Paint) null);
    }
