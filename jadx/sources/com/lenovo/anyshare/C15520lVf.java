...
public class C15520lVf extends C8356_ie.b {

    /* renamed from: a  reason: collision with root package name */
    public List<AbstractC0959Aqf> f23412a;
    ...
    public C15520lVf(FilesView filesView, C22488wqf c22488wqf, boolean z, Runnable runnable, int i) {
        this.i = filesView;
        this.e = c22488wqf;
        this.f = z;
        this.g = runnable;
    ...
    */
    public void callback(java.lang.Exception r5) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lenovo.anyshare.C15520lVf.callback(java.lang.Exception):void");
    }
    ...
    public void execute() {
        ...
        contentType = this.i.E;
        str = this.i.D;
        try {
            if (this.e == null) {
                if (this.f) {
                    C1260Brf.a(this.i.getContext());
                    abstractC2131Eqf3 = this.i.F;
                    ...
                    map3 = this.i.J;
                    filesView.G = (C22488wqf) map3.get(Pair.create(contentType, str));
                }
            } else {
                this.i.G = this.e;
            }
