...
public class C24175zee extends C8356_ie.b {

    /* renamed from: a  reason: collision with root package name */
    public PackageInstaller.Session f29917a = null;
    public int b;
    ...
    public C24175zee(String str, Context context, String str2, String str3, String str4) {
        this.c = str;
        this.d = context;
        this.e = str2;
        this.f = str3;
    ...
    public void execute() throws Exception {
        ...
        this.f29917a = packageInstaller.openSession(this.b);
        File[] listFiles = SFile.a(this.e).u().listFiles(new FileFilter() { // from class: com.lenovo.anyshare.see
            @Override // java.io.FileFilter
            public final boolean accept(File file) {
                return C24175zee.a(file);
            }
        });
        List<File> arrayList = listFiles == null ? new ArrayList() : Arrays.asList(listFiles);
        Collections.sort(arrayList, new Comparator() { // from class: com.lenovo.anyshare.tee
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return C24175zee.a((File) obj, (File) obj2);
            }
        });
        for (File file : arrayList) {
            OutputStream openWrite = this.f29917a.openWrite(C5786Rje.b(file.getName()), 0L, file.length());
            C7794Yje.a(SFile.a(file), openWrite);
            this.f29917a.fsync(openWrite);
            C7794Yje.a(openWrite);
        }
        C16863nfe.b(this.c, this.e);
        PackageInstaller.Session session = this.f29917a;
