...
import com.lenovo.anyshare.C15939mEb;
import com.lenovo.anyshare.C2557Gcj;
import com.lenovo.anyshare.C7073Vwb;
import com.lenovo.anyshare.PIb;
import com.lenovo.anyshare.Rek;
import com.lenovo.anyshare.VEa;
import com.lenovo.anyshare.View$OnClickListenerC15329lEb;
...
public final class RemoteShareZoneSubIMSingleHolder extends BaseRecyclerViewHolder<AbstractC23099xqf> {

    /* renamed from: a  reason: collision with root package name */
    public final ImageView f26764a;
    public final View b;
    ...
    public RemoteShareZoneSubIMSingleHolder(ViewGroup viewGroup) {
        super(viewGroup, R.layout.az9);
        View view = getView(R.id.bsa);
        this.f26764a = (ImageView) (view instanceof ImageView ? view : null);
        ...
        if (textView != null) {
            C15939mEb.a(textView, new View$OnClickListenerC15329lEb(this));
        }
    }
    ...
    public void onBindViewHolder(AbstractC23099xqf abstractC23099xqf) {
        ...
        if (abstractC23099xqf != null) {
            ImageView imageView = this.f26764a;
            if (imageView != null) {
