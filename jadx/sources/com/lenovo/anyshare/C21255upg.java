...
public class C21255upg {
    ...
    public static void a(PlaylistEditFragment playlistEditFragment, View view, Bundle bundle) {
        playlistEditFragment.onViewCreated$___twin___(view, bundle);
        String name = playlistEditFragment.getClass().getName();
