...
public class C20499tdf implements InterfaceC5404Qaj {

    /* renamed from: a  reason: collision with root package name */
    public final FragmentActivity f27170a;
    public final View b;
    public final Handler d;
    public final String f;
    public final Runnable e = new RunnableC18060pdf(this);
    public final C7699Yaj c = new C7699Yaj(-1, -2);

    public C20499tdf(FragmentActivity fragmentActivity, View view, String str) {
        this.f27170a = fragmentActivity;
        this.b = view;
        this.f = str;
    ...
    @Override // com.lenovo.anyshare.InterfaceC5691Raj
    public void show() {
        int g = Utils.g(this.f27170a);
        View inflate = View.inflate(this.f27170a, R.layout.ak6, null);
        ...
        if (iArr[0] == 0) {
            ...
            iArr[1] = C3784Kjj.a((Activity) this.f27170a) + C5714Rcj.a(16.0f);
            height = width;
        }
        ...
        C19888sdf.a(inflate, new View$OnClickListenerC18670qdf(this));
        this.c.setContentView(inflate);
        this.c.showAtLocation(this.b, 8388659, 0, iArr[1] + height);
        this.c.setOnDismissListener(new C19277rdf(this));
        this.d.removeCallbacks(this.e);
        this.d.postDelayed(this.e, 5000L);
        C20316tOa c20316tOa = new C20316tOa(this.f27170a);
        c20316tOa.f27031a = "/MainActivity/top/coins_daily";
