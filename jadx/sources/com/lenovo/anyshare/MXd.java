...
public class MXd extends AWd {
    ...
    public InterfaceC1087Bbj w = new BXd(this);
    ...
    public void a(Context context, View view) {
        this.r = context;
        this.q = view;
        this.f11896a = view.findViewById(R.id.d6v);
    ...
    public void a(C1313Bwd c1313Bwd, int i, String str) {
        ...
        if (TextUtils.isEmpty(this.s.i())) {
            ...
            if (this.g instanceof CircleImageView) {
                ...
                C19196rXc.a(this.r, (ComponentCallbacks2C14013iw) null, this.s.i(), this.g, (int) R.color.sl, 0, new CXd(this));
            }
        }
        i();
    ...
    private void a(JJd jJd, int i) {
        ...
        if (jJd.ea()) {
            ...
            if (c(jJd.u())) {
                ...
                a2 = new TemplateCoverView(this.r).d().a(false);
            }
            ...
            this.c.setMediaStatusCallback(new DXd(this));
            this.c.setCoverViewClick(new EXd(this, jJd));
        ...
        if (C12324gKd.a(jJd) && this.h != null && C1894Dvd.h().a(jJd.A()) == 1) {
            this.h.setImageResource(R.drawable.agg);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void a(Bitmap bitmap, ImageView imageView) {
        C22262wYd.a(bitmap, new GXd(this, imageView));
    }
    ...
    public void a(ViewGroup viewGroup, RelativeLayout relativeLayout, JJd jJd, ViewGroup viewGroup2) {
        ...
        C19196rXc.a(this.r, jJd.k(), imageView, new JXd(this, imageView));
    ...
    public void a(ImageView imageView, String str, int i, boolean z) {
        ...
        ComponentCallbacks2C14013iw e = ComponentCallbacks2C7634Xv.e(C13268hkj.a(this.r) ? ObjectStore.getContext() : this.r);
        if (FYd.a(str) && z) {
            b = e.d();
        } else {
            b = e.b();
        ...
        b.a((Object) c15539lXc).b((InterfaceC20794uC<Drawable>) new LXd(this, str, imageView, i, currentTimeMillis, c15539lXc)).a(imageView);
    }
}
