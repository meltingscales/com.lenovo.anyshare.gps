...
public class C8965ajj {

    /* renamed from: a  reason: collision with root package name */
    public static volatile MessageDigest f18612a;
        ...
        synchronized (C8965ajj.class) {
            if (f18612a == null) {
                synchronized (C8965ajj.class) {
                    if (f18612a == null) {
                        try {
                            f18612a = MessageDigest.getInstance("MD5");
    ...
    public static String a(String str) {
        if (str != null) {
            try {
                ...
                e.printStackTrace();
                C12001fij.b(FNi.f8699a, e.getMessage());
                return null;
            }
        }
        return null;
    ...
    */
    public static java.lang.String a(byte r2) {
        ...
        L4:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lenovo.anyshare.C8965ajj.a(byte):java.lang.String");
    }
