...
public class C17415oag implements InterfaceC7719Ycg {

    /* renamed from: a  reason: collision with root package name */
    public Map<String, C22488wqf> f24843a = new HashMap();
    public final /* synthetic */ ContentType b;
    public final /* synthetic */ LocalPDFToolsPage c;

    public C17415oag(LocalPDFToolsPage localPDFToolsPage, ContentType contentType) {
        this.c = localPDFToolsPage;
        this.b = contentType;
    }
    ...
    public C22488wqf a(AbstractC2131Eqf abstractC2131Eqf, C22488wqf c22488wqf, String str, boolean z) throws LoadContentException {
        try {
            C22488wqf c22488wqf2 = this.f24843a.get(str);
            if (c22488wqf2 == null) {
                c22488wqf2 = abstractC2131Eqf.b(this.b, str);
                this.f24843a.put(str, c22488wqf2);
