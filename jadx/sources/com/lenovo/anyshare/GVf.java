...
public class GVf {
    ...
    public static final String[] f9204a = {VisionController.FILTER_ID, "_data", "date_modified", "_display_name", "title", "_size", "datetaken", "duration", "width", "height", PM.H, "mime_type", "bucket_id", "orientation", "parent", "bucket_display_name"};
    public static String b = String.format(Locale.US, "(%s = %d OR %s = %d OR %s = %d OR (%s LIKE %s) OR ((%s = %s OR %s LIKE %s) AND (%s IS NULL OR %s NOT LIKE %s)) )", PM.H, 1, PM.H, 2, PM.H, 3, "_data", "'%.dsv'", "mime_type", "'application/vnd.android.package-archive'", "_data", "'%.apk'", "title", "title", "'split_%'");
    public static String c = String.format(Locale.US, "((%s = %d AND %s > %d) OR (%s = %d AND %s > %d) OR (%s = %d AND %s > %d) OR (%s LIKE %s) OR (%s = %s OR %s LIKE %s))", PM.H, 1, "_size", 1024L, PM.H, 2, "_size", 512000L, PM.H, 3, "_size", 512000L, "_data", "'%.dsv'", "mime_type", "'application/vnd.android.package-archive'", "_data", "'%.apk'");
    ...
    public static int a(ContentType contentType) {
        int i = FVf.f8757a[contentType.ordinal()];
        if (i != 1) {
            if (i != 2) {
                return i != 3 ? 0 : 3;
            }
