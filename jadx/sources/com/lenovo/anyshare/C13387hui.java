...
public class C13387hui {
    ...
    public static C18106phe a(String str, String str2, JSONObject jSONObject) throws IOException {
        ...
        while (i < 3) {
            try {
                ...
                e = e2;
                i++;
                C6040Sge.b(C24033zSh.f29803a, "doRetryPost(): URL: " + str2 + ", Retry count:" + i + " and exception:" + e.toString());
            }
        }
        throw e;
    }
    ...
    public static void a(Context context, String str, String str2, String str3, String str4) {
        try {
            ...
            C6062Sie.a(context, C24033zSh.d, linkedHashMap);
        } catch (Exception unused) {
        }
    }
}
