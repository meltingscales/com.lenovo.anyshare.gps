...
public class DTa {
    ...
    public static void a(MediaUnreadDialog mediaUnreadDialog, View view, Bundle bundle) {
        mediaUnreadDialog.onViewCreated$___twin___(view, bundle);
        String name = mediaUnreadDialog.getClass().getName();
