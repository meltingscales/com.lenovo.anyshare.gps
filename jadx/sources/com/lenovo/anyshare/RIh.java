...
public class RIh implements Callable<List<YGh>> {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ RoomSQLiteQuery f13962a;
    public final /* synthetic */ C11097eJh b;

    public RIh(C11097eJh c11097eJh, RoomSQLiteQuery roomSQLiteQuery) {
        this.b = c11097eJh;
        this.f13962a = roomSQLiteQuery;
    }
    ...
    public List<YGh> call() throws Exception {
        ...
        Cursor query = DBUtil.query(roomDatabase, this.f13962a, false, null);
        try {
