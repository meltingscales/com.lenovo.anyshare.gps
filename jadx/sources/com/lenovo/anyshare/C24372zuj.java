...
public class C24372zuj extends C1297Buj {
    public String f;

    public C24372zuj(Context context, String str, C1599Cuj c1599Cuj) {
        super(context, c1599Cuj);
        this.f = str;
    }

    @Override // com.lenovo.anyshare.C1297Buj, com.lenovo.anyshare.AbstractC20707tuj
    public int a() {
    ...
    @Override // com.lenovo.anyshare.C1297Buj
    public void b(Context context, android.net.Uri uri, String str) {
        C8356_ie.c(new C23762yuj(this, context, CommonProgressCustomDialogFragment.a((FragmentActivity) context, "get_shareit_apk"), uri, str));
    }
    ...
    public void b(Context context, String str, ArrayList<android.net.Uri> arrayList) {
