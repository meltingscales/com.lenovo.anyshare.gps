...
public class QGg {
    ...
    public static void a(GuideAZDialog guideAZDialog, View view, Bundle bundle) {
        guideAZDialog.onViewCreated$___twin___(view, bundle);
        String name = guideAZDialog.getClass().getName();
