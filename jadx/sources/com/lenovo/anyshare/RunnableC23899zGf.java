...
public class RunnableC23899zGf implements Runnable {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ View f29708a;
    public final /* synthetic */ VideoDownloadDialog b;

    public RunnableC23899zGf(VideoDownloadDialog videoDownloadDialog, View view) {
        this.b = videoDownloadDialog;
        this.f29708a = view;
    }
    ...
    public void run() {
        ...
        int height = this.f29708a.getHeight();
        ...
        this.f29708a.setPadding(0, 0, 0, i4);
    }
}
