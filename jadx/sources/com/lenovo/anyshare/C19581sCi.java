...
public class C19581sCi {
    ...
    public static void a(ProductRadioDialog productRadioDialog, View view, Bundle bundle) {
        productRadioDialog.onViewCreated$___twin___(view, bundle);
        String name = productRadioDialog.getClass().getName();
