...
public class C7871Yqe {

    /* renamed from: a  reason: collision with root package name */
    public static final String f17336a = Build.MANUFACTURER.toLowerCase();
    ...
    public static void b(Context context) {
        Intent a2;
        if (f17336a.contains("huawei")) {
            a2 = a();
        } else if (f17336a.contains("xiaomi")) {
            a2 = f(context);
        } else if (f17336a.contains("oppo")) {
            a2 = d(context);
        } else if (f17336a.contains("vivo")) {
            a2 = e(context);
        } else if (f17336a.contains("meizu")) {
            a2 = c(context);
        } else {
            a2 = a(context);
        }
