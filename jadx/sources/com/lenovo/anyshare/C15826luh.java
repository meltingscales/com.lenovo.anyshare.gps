...
public class C15826luh implements GBh {
    public int g;
    public a i;

    /* renamed from: a  reason: collision with root package name */
    public List<NBh> f23635a = new CopyOnWriteArrayList();
    ...
    /* renamed from: com.lenovo.anyshare.luh$a */
    /* loaded from: classes8.dex */
    public interface a {
        void a();
    ...
    public void b(NBh nBh) {
        if (nBh == null || !this.f23635a.contains(nBh)) {
            return;
        }
        this.f23635a.remove(nBh);
    }
    ...
    */
    public synchronized boolean t() {
        ...
        L19:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lenovo.anyshare.C15826luh.t():boolean");
    }
    ...
    */
    public synchronized boolean u() {
        /*
            r3 = this;
            monitor-enter(r3)
            com.ushareit.musicplayerapi.inf.PlayMode r0 = r3.b     // Catch: java.lang.Throwable -> L17
            com.ushareit.musicplayerapi.inf.PlayMode r1 = com.ushareit.musicplayerapi.inf.PlayMode.LIST     // Catch: java.lang.Throwable -> L17
            r2 = 1
            if (r0 != r1) goto L14
        ...
        L17:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lenovo.anyshare.C15826luh.u():boolean");
    }
    ...
    public synchronized PlayMode w() {
        PlayMode playMode;
        int i = C15216kuh.f23186a[this.b.ordinal()];
        if (i == 1) {
    ...
    private synchronized int d(boolean z) {
        ...
        int i2 = C15216kuh.f23186a[this.b.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
    ...
    public synchronized void a(JBh jBh) {
        if (jBh.a()) {
            this.h = false;
            b(jBh.d, jBh.c);
        }
    ...
    @Override // com.lenovo.anyshare.GBh
    ...
    public synchronized void a(AbstractC23099xqf abstractC23099xqf, AbstractC23099xqf abstractC23099xqf2) {
        ...
        if (indexOf != -1 && indexOf2 != -1) {
            AbstractC23099xqf b = b();
            this.d.remove(abstractC23099xqf);
            this.d.add(indexOf2, abstractC23099xqf);
            if (!this.c) {
                this.g = this.d.indexOf(b);
            }
        }
    }

    public synchronized void a(AbstractC23099xqf abstractC23099xqf, int i) {
        if (!this.d.isEmpty() && i <= this.d.size()) {
            this.d.add(i, abstractC23099xqf);
            if (i <= this.g) {
                this.g++;
            }
            this.e.add(abstractC23099xqf);
