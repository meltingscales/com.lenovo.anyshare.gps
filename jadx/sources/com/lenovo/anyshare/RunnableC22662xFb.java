...
public final class RunnableC22662xFb implements Runnable {
    ...
    public RunnableC22662xFb(List list, String str, Context context) {
        this.f28802a = list;
        this.b = str;
        this.c = context;
    }
    ...
    public final void run() {
        try {
            ...
            for (AbstractC23099xqf abstractC23099xqf : this.f28802a) {
