...
public class C16158mYb extends C15549lYb {
    public static final String Tb = "uFade0";
    public float Ub;
    public int Vb;
    ...
    @Override // com.lenovo.anyshare.C15549lYb
    public void D() {
        super.D();
        this.Ub = 0.0f;
    }

    @Override // com.lenovo.anyshare.C15549lYb, com.lenovo.anyshare.C13719iYb
    public void d(float f) {
        G();
        this.Ub = f;
    }

    @Override // com.lenovo.anyshare.C15549lYb, com.lenovo.anyshare.PYb, com.lenovo.anyshare.RYb, com.lenovo.anyshare.C13719iYb, com.lenovo.anyshare.PWb
    public String n() {
    ...
    public void q() {
        super.q();
        this.Vb = GLES20.glGetUniformLocation(this.m, Tb);
    }

    @Override // com.lenovo.anyshare.C15549lYb, com.lenovo.anyshare.PYb, com.lenovo.anyshare.RYb, com.lenovo.anyshare.C13719iYb, com.lenovo.anyshare.PWb
    public void s() {
        super.s();
        GLES20.glUniform1f(this.Vb, this.Ub);
    }

    public C16158mYb(int i) {
        super(i);
        this.Ub = 0.0f;
        this.Vb = -1;
    }
