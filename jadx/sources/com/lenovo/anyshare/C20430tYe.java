...
public final class C20430tYe {
    public static void a(String str, SFile sFile) throws ThumbnailException {
        a(str, sFile, 3, null);
    }

    public static void a(String str, SFile sFile, int i, C8085Zji.c cVar) throws ThumbnailException {
        if (sFile.f()) {
            return;
        }
        boolean n = sFile.n();
    ...
    public static SFile a(SFile sFile, boolean z) {
        if (z) {
            SFile b = C9714bve.c().b();
            if (!b.f()) {
                b.t();
            }
            if (b.f() && b.a() && b.b()) {
                return SFile.a(b, sFile.i() + ".tmp");
            }
            return null;
        }
        SFile k = sFile.k();
