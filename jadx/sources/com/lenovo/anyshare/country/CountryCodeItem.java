...
public class CountryCodeItem implements Serializable {
    ...
    public String toString() {
        return "CountryCodeItem{ mCountry:" + this.mCountry + ",mDisplayCountry:" + this.mDisplayCountry + ",mCode:" + this.mCode + ", source = " + this.mSource + " }";
    }

    /* renamed from: clone */
    public CountryCodeItem m1097clone() {
        CountryCodeItem countryCodeItem = new CountryCodeItem();
