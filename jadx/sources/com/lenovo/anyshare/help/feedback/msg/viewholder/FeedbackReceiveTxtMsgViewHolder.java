...
public class FeedbackReceiveTxtMsgViewHolder extends FeedbackBaseMsgViewHolder {
    ...
    public FeedbackReceiveTxtMsgViewHolder(BaseRecyclerViewAdapter baseRecyclerViewAdapter, ComponentCallbacks2C14013iw componentCallbacks2C14013iw, ViewGroup viewGroup, String str) {
        super(baseRecyclerViewAdapter, viewGroup, R.layout.ahq, componentCallbacks2C14013iw, str);
