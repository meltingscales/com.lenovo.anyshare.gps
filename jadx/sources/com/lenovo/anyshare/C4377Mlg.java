...
public class C4377Mlg extends AbstractC1329Bxi<AbstractC23099xqf> {
    public AbstractC2131Eqf d;
    public List<AbstractC23099xqf> e;

    public C4377Mlg(AbstractC2131Eqf abstractC2131Eqf, List<AbstractC23099xqf> list, ComponentCallbacks2C14013iw componentCallbacks2C14013iw) {
    ...
    public Pair<View, PlayerPageAdView> a(ViewGroup viewGroup, int i) {
        if (f(i)) {
            View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.aew, (ViewGroup) null);
            ...
            int dimensionPixelSize = viewGroup.getResources().getDisplayMetrics().widthPixels - (viewGroup.getResources().getDimensionPixelSize(R.dimen.blv) * 2);
    ...
    public void a(XEa xEa, C21353uxi c21353uxi) {
        if (this.e.get(xEa.b) instanceof C3075Hxi.a) {
            this.f10772a.a().a(Integer.valueOf((int) R.drawable.bp7)).a((AbstractC17134oC<?>) new C21405vC().e(C15948mFa.a(ContentType.PHOTO)).c().a(Priority.HIGH)).a((AbstractC14622jw<?, ? super Bitmap>) C19548sA.d()).a((ImageView) xEa.c);
            return;
        }
