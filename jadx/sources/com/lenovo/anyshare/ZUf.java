...
public class ZUf extends AbstractC4349Mja {
    public Drawable z;

    public ZUf(Context context, PinnedExpandableListView pinnedExpandableListView, List<C22488wqf> list) {
    ...
    public View getChildView(int i, int i2, boolean z, View view, ViewGroup viewGroup) {
        C5495Qja c5495Qja;
        if (view == null) {
            view = View.inflate(this.e, R.layout.a9y, null);
