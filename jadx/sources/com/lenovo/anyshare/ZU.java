...
public class ZU {
    ...
    public static WindowManager f17580a;
    ...
    public static a a(JSONObject jSONObject) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            if (f17580a != null) {
                ...
                f17580a.getDefaultDisplay().getRealSize(point);
                f2 = a(point.x);
                f = a(point.y);
            }
            f = 0.0f;
    ...
    public static JSONObject a(int i, int i2, int i3, int i4) {
        ...
        try {
            ...
            _U.a("Error with creating viewStateObject", e);
        }
        return jSONObject;
    }
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f17580a = (WindowManager) context.getSystemService(VisionController.WINDOW);
        }
    }
    ...
    public static void a(JSONObject jSONObject, OutputDeviceStatus outputDeviceStatus) {
        try {
            ...
            _U.a("Error with setting output device status", e);
        }
    }

    public static void a(JSONObject jSONObject, C14295jV.a aVar) {
        JU ju = aVar.f22525a;
        ...
        try {
            ...
            jSONObject.put("friendlyObstructionClass", ju.b);
            jSONObject.put("friendlyObstructionPurpose", ju.c);
            jSONObject.put("friendlyObstructionReason", ju.d);
        } catch (JSONException e) {
            _U.a("Error with setting friendly obstruction", e);
        }
    }
    ...
    public static void a(JSONObject jSONObject, Boolean bool) {
        try {
            ...
            _U.a("Error with setting has window focus", e);
        }
    }
    ...
    public static void a(JSONObject jSONObject, String str) {
        try {
            ...
            _U.a("Error with setting ad session id", e);
        }
    }
    ...
    public static void a(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            _U.a("JSONException during JSONObject.put for name [" + str + "]", e);
        }
    }
    ...
    public static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return YU.f17141a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        a a2 = a(jSONObject);
        try {
            jSONObject.put("width", a2.f17581a);
    ...
    public static void b(JSONObject jSONObject, String str) {
        try {
            ...
            _U.a("Error with setting not visible reason", e);
        }
    }
