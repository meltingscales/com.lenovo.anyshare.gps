...
public class NVd implements FYd.b {
    ...
    public NVd(TextView textView, int i, JJd jJd, Drawable drawable, String str, long j, String str2) {
    ...
    public void a(String str, String str2, Bitmap bitmap, long j) {
        QVd.b(this.f12313a, bitmap, this.b, this.c, this.d);
        String str3 = this.e;
        long j2 = this.f;
        JJd jJd = this.c;
