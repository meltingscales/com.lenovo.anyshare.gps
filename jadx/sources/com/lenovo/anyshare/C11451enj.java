...
public class C11451enj extends C8356_ie.a {
    ...
    public C11451enj(String str, int i, SZItem sZItem, long j, int i2, String str2) {
        super(str);
        this.b = i;
        this.c = sZItem;
        this.d = j;
    ...
    public void execute() {
        ...
        try {
            ...
            C6040Sge.a("RecommendStats", "statsCancelDownloadEvent: " + hashMap);
            DGi.a("cancel_download", "item", arrayList);
