...
public class C7551Xne {
    ...
    public static void d(SQLiteDatabase sQLiteDatabase) {
        for (int i = 0; i < 16; i++) {
            int i2 = i + 17;
            sQLiteDatabase.execSQL(C12630gke.a("alter table events add name%d TEXT", Integer.valueOf(i2)));
            sQLiteDatabase.execSQL(C12630gke.a("alter table events add value%d TEXT", Integer.valueOf(i2)));
        }
    }
