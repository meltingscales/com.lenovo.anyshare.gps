...
public final class RT {
    ...
    public static WindowManager f14039a;
    ...
    public static JSONObject a(int i, int i2, int i3, int i4) {
        ...
        try {
            jSONObject.put(com.anythink.core.common.x.c, i / c);
            jSONObject.put("y", i2 / c);
            jSONObject.put("width", i3 / c);
            jSONObject.put("height", i4 / c);
        } catch (JSONException e) {
            ST.a("Error with creating viewStateObject", e);
        }
        return jSONObject;
    }
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f14039a = (WindowManager) context.getSystemService(VisionController.WINDOW);
        }
    }
    ...
    public static void a(JSONObject jSONObject) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            if (f14039a != null) {
                ...
                f14039a.getDefaultDisplay().getRealSize(point);
                float f3 = c;
                f2 = point.x / f3;
                f = point.y / f3;
            }
        ...
        a aVar = new a(f2, f);
        try {
            jSONObject.put("width", aVar.f14040a);
            jSONObject.put("height", aVar.b);
        } catch (JSONException unused) {
        }
    }

    public static void a(JSONObject jSONObject, C14284jU.a aVar) {
        GT gt = aVar.f22515a;
        ...
        try {
            ...
            jSONObject.put("friendlyObstructionClass", gt.b);
            jSONObject.put("friendlyObstructionPurpose", gt.c);
            jSONObject.put("friendlyObstructionReason", gt.d);
        } catch (JSONException e) {
            ST.a("Error with setting friendly obstruction", e);
        }
    }
    ...
    public static void a(JSONObject jSONObject, String str) {
        try {
            ...
            ST.a("Error with setting ad session id", e);
        }
    }
    ...
    public static void a(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            ST.a("JSONException during JSONObject.put for name [" + str + "]", e);
        }
    }
    ...
    public static void b(JSONObject jSONObject, String str) {
        try {
            ...
            ST.a("Error with setting not visible reason", e);
        }
    }
    ...
    */
    public static boolean b(org.json.JSONObject r10, org.json.JSONObject r11) {
        ...
        L6:
            ...
            goto La0
        Ld:
            java.lang.String[] r2 = com.lenovo.anyshare.RT.b
            int r3 = r2.length
            r4 = 0
        L11:
            if (r4 >= r3) goto L26
        ...
        La0:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lenovo.anyshare.RT.b(org.json.JSONObject, org.json.JSONObject):boolean");
    }
}
