...
public class C11360egc {

    /* renamed from: a  reason: collision with root package name */
    public static final int f20419a = 5;
    ...
    public static C10751dgc a(float f, float f2, float f3, float f4, C9544bhc c9544bhc, int i) {
    ...
    public static C10751dgc a(float f, float f2, float f3, float f4, C9544bhc c9544bhc, int i, float f5) {
        C10751dgc c10751dgc = new C10751dgc();
        int b2 = b(c9544bhc, i);
        ...
        float f9 = f4 - (f7 * f8);
        float f10 = f3 - (f6 * f8);
        c10751dgc.f19963a = a(f10, f9, f3, f4, b2 * f5, a2, c9544bhc.i);
        c10751dgc.a(f10, f9);
        return c10751dgc;
    }

    public static C10751dgc a(float f, float f2, float f3, float f4, float f5, float f6, C9544bhc c9544bhc, int i) {
    ...
    public static C10751dgc a(float f, float f2, float f3, float f4, float f5, float f6, C9544bhc c9544bhc, int i, float f7) {
        PointF pointF;
        boolean z;
        C10751dgc c10751dgc = new C10751dgc();
        ...
        c10751dgc.f19963a = a(pointF.x, pointF.y, f5, f6, b2, a2, c9544bhc.i);
        c10751dgc.a(pointF.x, pointF.y);
        return c10751dgc;
    }

    public static C10751dgc a(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, C9544bhc c9544bhc, int i) {
        return a(f, f2, f3, f4, f5, f6, f7, f8, c9544bhc, i, 1.0f);
    }

    public static C10751dgc a(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, C9544bhc c9544bhc, int i, float f9) {
        boolean z;
        C10751dgc c10751dgc = new C10751dgc();
        int b2 = b(c9544bhc, i);
        int a2 = a(c9544bhc, i);
        ...
        while (true) {
            ...
            Boolean bool2 = z;
            float f12 = f11;
            pointF = a(f, f2, f3, f4, f5, f6, f7, f8, f10);
            float f13 = pointF.x;
        ...
        c10751dgc.f19963a = a(pointF.x, pointF.y, f7, f8, b2, a2, c9544bhc.i);
        c10751dgc.a(pointF.x, pointF.y);
        return c10751dgc;
    }
    ...
    public static PointF a(InterfaceC4340Mic interfaceC4340Mic, PointF pointF, byte b2) {
        float f;
        float f2;
        float f3;
        float parseInt = (Integer.parseInt(interfaceC4340Mic.attributeValue(com.anythink.core.common.x.c)) * 96.0f) / 914400.0f;
        float parseInt2 = (Integer.parseInt(interfaceC4340Mic.attributeValue("y")) * 96.0f) / 914400.0f;
        if (b2 == 1) {
            f = 0.8f;
    ...
    public static PointF a(float f, float f2, float f3, float f4, byte b2) {
        float f5;
        float f6;
        float f7;
        if (b2 == 1) {
