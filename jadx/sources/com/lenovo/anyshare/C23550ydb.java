...
public class C23550ydb {
    ...
    public static void a(VerifyPasswordFragment verifyPasswordFragment, View view, Bundle bundle) {
        verifyPasswordFragment.onViewCreated$___twin___(view, bundle);
        String name = verifyPasswordFragment.getClass().getName();
