...
public class C24280znb {
    ...
    public static void a(AcceptUserCustomDialog acceptUserCustomDialog, View view, Bundle bundle) {
        acceptUserCustomDialog.onViewCreated$___twin___(view, bundle);
        String name = acceptUserCustomDialog.getClass().getName();
