...
public class RectFrameLayout extends FrameLayout {
    ...
    private void a(AttributeSet attributeSet) {
        ...
        if (obtainStyledAttributes != null) {
            this.f28566a = obtainStyledAttributes.getFloat(0, 0.4f);
    ...
    public void onMeasure(int i, int i2) {
        if (this.f28566a <= 0.0f) {
            super.onMeasure(i, i2);
            return;
        }
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824);
        int makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec((int) (View.MeasureSpec.getSize(i) * this.f28566a), 1073741824);
        ...
        setMeasuredDimension(resolveSize, (int) (resolveSize * this.f28566a));
    }
