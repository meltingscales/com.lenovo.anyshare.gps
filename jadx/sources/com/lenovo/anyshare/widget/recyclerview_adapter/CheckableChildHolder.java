...
public abstract class CheckableChildHolder<V, T> extends ChildViewHolder<V, T> {
    ...
    public abstract void b(T t, int i, UNb uNb, int i2, List<Object> list);

    public void b(boolean z) {
        a(z, true, 1);
    }

    public abstract void c(T t, int i, UNb uNb, int i2, List<Object> list);

    public int u() {
        return R.drawable.as1;
    }

    @Override // com.lenovo.anyshare.widget.recyclerview_adapter.expandable_adapter.ChildViewHolder
    public void a(T t, int i, UNb uNb, int i2, List<Object> list) {
