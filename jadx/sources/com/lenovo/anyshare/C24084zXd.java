...
public class C24084zXd extends WVd {
    ...
    public C24084zXd(ViewGroup viewGroup, String str) {
        super(viewGroup, str);
    ...
    private void a(Exception exc, C1313Bwd c1313Bwd) {
        ...
        if (c1313Bwd != null) {
            C23478yXi.a(this.f16276a.getContext(), c1313Bwd, C24084zXd.class.getSimpleName(), exc);
        }
