...
public class C11450eni extends AbstractC18756qki {
    public static boolean c = false;
    public final List<C6110Smi.a> d;

    public C11450eni(Context context) {
        super(context, "packdownloadcontainer");
    ...
    public void c(String str, String str2, long j, long j2) {
        for (C6110Smi.a aVar : this.d) {
            try {
                ...
                C6040Sge.f("PackDownloadContainer", e.toString());
            }
        }
    }
    ...
    public void b(C13878iki c13878iki, C14487jki c14487jki) throws IOException {
        ...
        if (f != null && f.size() != 0) {
            ...
            if (fromString != FileType.RAW) {
                C6040Sge.f("PackDownloadContainer", "bad request: " + c13878iki.g());
                ...
                C6040Sge.a("PackDownloadContainer", "childId : " + str3 + " child position : " + parseLong);
                ...
                if (c22488wqf == null) {
                    C6040Sge.f("PackDownloadContainer", "folder is not exist: " + c13878iki.g());
    ...
    private void a(C22488wqf c22488wqf, C13878iki c13878iki, C14487jki c14487jki, String str, String str2, long j, long j2) throws IOException {
        ...
        c14487jki.a("Content-Disposition", "attachment;filename=" + c22488wqf.e + ".pack");
        C10841dni c10841dni = new C10841dni(this, str, c13878iki);
        try {
            ...
            if (contentType != ContentType.VIDEO && contentType != ContentType.PHOTO && contentType != ContentType.MUSIC) {
                if (contentType == ContentType.FILE) {
                    ...
                    if (b.f() && b.l()) {
                        try {
                            c6981Vni = new C6981Vni(c14487jki.b());
                        } catch (Throwable th) {
                            th = th;
                            c6981Vni = null;
                        }
                        try {
                            ...
                            StringBuilder sb = new StringBuilder();
                            sb.append(str2);
                            C7842Yni.a(a(c13878iki.i, str), "", c6981Vni, c10841dni, sb, j, true);
                            C7794Yje.a(c6981Vni);
                            return;
                        } catch (Throwable th2) {
                            th = th2;
                    ...
                    C6040Sge.f("PackDownloadContainer", "folder is not exist or it is not folder: " + c22488wqf.c);
                    c14487jki.a(400, "folder is not exist or it is not folder: " + c22488wqf.c);
                    return;
                }
                C6040Sge.f("PackDownloadContainer", "can not support current folder type: " + c22488wqf.getContentType());
            ...
            a(c13878iki.i, str, -1L);
            C7842Yni.a(a(c13878iki.i, str), arrayList, c14487jki.b(), c10841dni);
        } catch (Exception e) {
            C6040Sge.e("PackDownloadContainer", "failed: url = " + str, e);
    ...
    private AbstractC16328mli.b a(String str, String str2) {
        ...
        C6040Sge.a("PackDownloadContainer", "collection obj : " + bVar);
        return bVar;
    }
    ...
    public boolean a(C13878iki c13878iki, boolean z) {
        ...
        C6040Sge.f("PackDownloadContainer", "Can not permit access download, path:" + c13878iki.g());
        return false;
    }
    ...
    private boolean a(String str, Map<String, String> map) {
        try {
            ...
            C6040Sge.e("PackDownloadContainer", "verify exception!", e);
            return false;
        }
    }
    ...
    public void b(String str, String str2, long j, long j2) {
        for (C6110Smi.a aVar : this.d) {
            try {
                ...
                C6040Sge.e("PackDownloadContainer", e.toString(), e);
            }
        }
    }
}
