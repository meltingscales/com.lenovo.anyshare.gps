...
/* renamed from: com.lenovo.anyshare.Vki  reason: case insensitive filesystem */
/* loaded from: classes8.dex */
public final class C6948Vki {
    public static boolean a(Context context) {
        if (b(context)) {
            ConnectivityManager connectivityManager = (ConnectivityManager) context.getApplicationContext().getSystemService("connectivity");
            try {
                Object a2 = a(connectivityManager, "mService");
                C6040Sge.a("Switch3G", "getMobileDataEnabled() return=?");
                return ((Boolean) a(a2, "getMobileDataEnabled", null, null)).booleanValue();
            } catch (Exception unused) {
                C6040Sge.a("Switch3G", "getMobileDataEnabled method failed from service!");
                try {
                    return ((Boolean) a(connectivityManager, "getMobileDataEnabled", null, null)).booleanValue();
                } catch (Exception e) {
    ...
    */
    public static boolean a(android.content.Context r12, boolean r13) {
        /*
            ...
            java.lang.Object r8 = a(r12, r8)     // Catch: java.lang.Exception -> L4a
            if (r8 == 0) goto L5f
            ...
            a(r8, r2, r9, r10)     // Catch: java.lang.Exception -> L4a
        ...
        L60:
            ...
            a(r12, r2, r8, r9)     // Catch: java.lang.Exception -> L8a
        ...
        L9f:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lenovo.anyshare.C6948Vki.a(android.content.Context, boolean):boolean");
    }
