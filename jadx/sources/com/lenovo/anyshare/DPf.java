...
public class DPf {
    ...
    public static List<C20943uPf> f7810a = new ArrayList();

    public static void a(JJd jJd, AdsFeedbackRecylerAdapter.c cVar) {
        try {
            Map<String, String> a2 = a(ObjectStore.getContext(), jJd, cVar);
    ...
    public static Map<String, String> a(Context context, JJd jJd, AdsFeedbackRecylerAdapter.c cVar) throws Exception {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("time", System.currentTimeMillis());
            jSONObject.put("adid", jJd.j());
            if (!TextUtils.isEmpty(jJd.t())) {
                jSONObject.put("cid", jJd.t());
            }
            jSONObject.put("app_id", C15595lbd.a(context));
            jSONObject.put("pid", jJd.h);
