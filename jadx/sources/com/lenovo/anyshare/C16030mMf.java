...
public class C16030mMf {
    ...
    public static void a(GlobalSearchFragment globalSearchFragment, View view, Bundle bundle) {
        globalSearchFragment.onViewCreated$___twin___(view, bundle);
        String name = globalSearchFragment.getClass().getName();
