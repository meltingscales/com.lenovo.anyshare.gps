...
public class TZe {
    ...
    public static final String f14973a = Build.MANUFACTURER.toLowerCase();

    public static int a(Context context) {
        C6040Sge.a("ShortcutPermissionCheck", "manufacturer = " + f14973a + ", api level= " + Build.VERSION.SDK_INT);
        if (f14973a.contains("huawei")) {
            return b(context);
        }
        if (f14973a.contains("xiaomi")) {
            return c(context);
        }
        if (f14973a.contains("oppo")) {
            return d(context);
        }
        if (f14973a.contains("vivo")) {
            return e(context);
        }
        if (f14973a.contains("samsung")) {
            return 0;
        }
        f14973a.contains("meizu");
        return 0;
    }
    ...
    */
    public static int c(android.content.Context r11) {
        ...
        Lb7:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lenovo.anyshare.TZe.c(android.content.Context):int");
    }
    ...
    */
    public static int e(android.content.Context r9) {
        ...
        Lc0:
            goto Lbf
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lenovo.anyshare.TZe.e(android.content.Context):int");
    }
