...
public class C24264zlj implements InterfaceC21206ulf.a {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ SVideoPosterContentViewHolder f29974a;

    public C24264zlj(SVideoPosterContentViewHolder sVideoPosterContentViewHolder) {
        this.f29974a = sVideoPosterContentViewHolder;
    }
    ...
    public void a(SZItem.DownloadState downloadState, String str) {
        ...
        if (i == 1) {
            SVideoPosterContentViewHolder sVideoPosterContentViewHolder = this.f29974a;
            InterfaceC11422ele<T> interfaceC11422ele = sVideoPosterContentViewHolder.mItemClickListener;
            if (interfaceC11422ele != 0) {
                interfaceC11422ele.a(sVideoPosterContentViewHolder, 36);
            }
        } else if (i == 2) {
