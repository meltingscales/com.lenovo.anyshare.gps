...
public abstract class PTd {
    ...
    public abstract void a(BSc bSc);

    public abstract String b(BSc bSc);

    public abstract boolean c(BSc bSc);
    ...
    public void a(Context context, String str, ImageView imageView, boolean z, ViewGroup viewGroup, a aVar, int i, boolean z2) {
        ...
        if (FYd.a(str) && z2) {
            b = ComponentCallbacks2C7634Xv.e(applicationContext).d();
        } else {
            b = ComponentCallbacks2C7634Xv.e(applicationContext).b();
        }
        ...
        b.a((Object) c15539lXc).a((AbstractC17134oC<?>) c21405vC).b((InterfaceC20794uC<Drawable>) new MTd(this, str, z2, applicationContext, imageView, z, viewGroup, aVar, i, c15539lXc)).a(imageView);
    }
    ...
    public void a(ImageView imageView, String str, int i, JJd jJd) {
        ...
        C19196rXc.a(ObjectStore.getContext(), str, imageView, (int) R.color.sh, i, new NTd(this, jJd, str, currentTimeMillis));
    }
    ...
    public void a(ImageView imageView, ViewGroup viewGroup, Bitmap bitmap) {
        ...
        try {
            ...
            C5140Pcj.a(bitmap, new OTd(this, imageView2));
        } catch (Exception unused) {
        }
    }
}
