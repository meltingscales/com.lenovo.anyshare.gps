...
public class C9632bog extends C8356_ie.b {

    /* renamed from: a  reason: collision with root package name */
    public List<AbstractC11150eOf> f19109a;
    public final /* synthetic */ boolean b;
    public final /* synthetic */ MusicBrowserActivity c;

    public C9632bog(MusicBrowserActivity musicBrowserActivity, boolean z) {
    ...
    public void callback(Exception exc) {
        ...
        if (this.b) {
            ...
            browserView2.c(this.f19109a, true);
            return;
        }
        ...
        browserView.a(baseMusicContentAdapter2, this.f19109a);
    }

    @Override // com.lenovo.anyshare.C8356_ie.b
    public void execute() throws LoadContentException {
        List<AbstractC11150eOf> h;
        h = this.c.h(C17606oqf.c().d().b(ContentType.MUSIC, "artists").j);
        this.f19109a = h;
    }
}
