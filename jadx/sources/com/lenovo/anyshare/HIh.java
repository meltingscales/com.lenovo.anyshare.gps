...
public class HIh implements Callable<List<ChapterData>> {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ RoomSQLiteQuery f9544a;
    public final /* synthetic */ C11097eJh b;

    public HIh(C11097eJh c11097eJh, RoomSQLiteQuery roomSQLiteQuery) {
        this.b = c11097eJh;
        this.f9544a = roomSQLiteQuery;
    }
    ...
    public List<ChapterData> call() throws Exception {
        ...
        Cursor query = DBUtil.query(roomDatabase, this.f9544a, false, null);
        try {
