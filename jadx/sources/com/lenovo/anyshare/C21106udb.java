...
public class C21106udb {
    ...
    public static void a(ResetPasswordFragment resetPasswordFragment, View view, Bundle bundle) {
        resetPasswordFragment.onViewCreated$___twin___(view, bundle);
        String name = resetPasswordFragment.getClass().getName();
