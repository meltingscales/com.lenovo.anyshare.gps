...
public class C8974akg implements InterfaceC7936Ywd {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ AdGroupHolder f18617a;

    public C8974akg(AdGroupHolder adGroupHolder) {
        this.f18617a = adGroupHolder;
    }
    ...
    public void a(String str, C1313Bwd c1313Bwd) {
        C6040Sge.a("AdGroupHolder", "onAdClicked() adGroupId: " + str + "; getAdapterPosition = " + this.f18617a.getAdapterPosition());
        a(c1313Bwd);
    }
    ...
    private void a(C1313Bwd c1313Bwd) {
        ...
        linkedHashMap.put(C12546gdd.f, String.valueOf(this.f18617a.getAdapterPosition()));
        linkedHashMap.put("iscache", c1313Bwd.mUpdated + "");
        C23478yXi.b(this.f18617a.getContext(), c1313Bwd, JTd.a(c1313Bwd), linkedHashMap);
    }
}
