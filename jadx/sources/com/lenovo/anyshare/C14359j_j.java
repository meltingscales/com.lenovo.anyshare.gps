...
/* renamed from: com.lenovo.anyshare.j_j  reason: case insensitive filesystem */
/* loaded from: classes9.dex */
public final class C14359j_j<T> extends LYj<T, T> {
    public final HRj<? extends T> b;

    public C14359j_j(AbstractC19747sRj<T> abstractC19747sRj, HRj<? extends T> hRj) {
    ...
    static final class a<T> extends AtomicInteger implements InterfaceC24024zRj<T>, YRj {
        ...
        /* renamed from: com.lenovo.anyshare.j_j$a$a  reason: collision with other inner class name */
        /* loaded from: classes9.dex */
        static final class C0639a<T> extends AtomicReference<YRj> implements ERj<T> {
