...
public final class KZg extends Lambda implements InterfaceC10209clk<Kfk> {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ LoginConfig f11033a;
    ...
    public KZg(LoginConfig loginConfig, ELoginType eLoginType, EApiResultType eApiResultType, MobileClientException mobileClientException, long j) {
        super(0);
        this.f11033a = loginConfig;
        this.b = eLoginType;
    ...
    public final void invoke2() {
        ...
        String a2 = this.f11033a.a();
        C11440emk.d(a2, "loginConfig.bizId");
        String str = this.f11033a.b;
        C11440emk.d(str, "loginConfig.loginPortal");
        EModeType eModeType = this.f11033a.f ? EModeType.LinkOp : EModeType.LoginOp;
        ELoginType eLoginType = this.b;
        EApiResultType eApiResultType = this.c;
        MobileClientException mobileClientException = this.d;
        oZg.a(context, new LoginQueryCodeBean(a2, str, eModeType, eLoginType, b, eApiResultType, mobileClientException == null ? "" : WZg.a(mobileClientException), (this.e / 1000) / 1000));
    }
}
