...
public class C7722Ycj {

    /* renamed from: a  reason: collision with root package name */
    public static Toast f17223a;
    public static Toast b;
    public static Toast c;

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: com.lenovo.anyshare.Ycj$a */
    /* loaded from: classes8.dex */
    public static class a extends Handler {

        /* renamed from: a  reason: collision with root package name */
        public Handler f17224a;
        ...
        public void dispatchMessage(Message message) {
            C7435Xcj.a(this, message);
        }

        @Override // android.os.Handler
        public void handleMessage(Message message) {
            this.f17224a.handleMessage(message);
        }
    }
    ...
    public static void a(String str, int i) {
        try {
            ...
            f17223a = Toast.makeText(ObjectStore.getContext(), str, i);
            a(f17223a);
            f17223a.show();
        } catch (Exception e) {
