...
public class C6508Twj {
    ...
    public static void a(GameSuccDialog gameSuccDialog, View view, Bundle bundle) {
        gameSuccDialog.onViewCreated$___twin___(view, bundle);
        String name = gameSuccDialog.getClass().getName();
