    ...
    public static class a {
        ...
        private boolean d(Context context) {
            ...
            if (identifier != 0) {
                ...
                if ("1".equals(SId.f14398a)) {
                    return false;
                }
                if ("0".equals(SId.f14398a)) {
                    return true;
                }
                return z;
            }
        ...
        public int a(boolean z) {
            return (this.f14399a ? this.c : 0) + (z ? this.d : 0);
        }
    ...
    static {
        if (Build.VERSION.SDK_INT >= 19) {
            try {
                ...
                f14398a = (String) declaredMethod.invoke(null, "qemu.hw.mainkeys");
