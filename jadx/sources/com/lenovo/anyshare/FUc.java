...
public class FUc extends SSLSocketFactory {

    /* renamed from: a  reason: collision with root package name */
    public static final String[] f8744a = {"TLSv1.1", "TLSv1.2"};
    public final SSLSocketFactory b;

    public FUc(SSLSocketFactory sSLSocketFactory) {
        this.b = sSLSocketFactory;
    }

    private Socket a(Socket socket) {
        if (socket instanceof SSLSocket) {
            ((SSLSocket) socket).setEnabledProtocols(f8744a);
        }
        return socket;
    }
