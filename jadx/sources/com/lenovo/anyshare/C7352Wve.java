...
public final class C7352Wve {

    /* renamed from: a  reason: collision with root package name */
    public static List<String> f16498a = new ArrayList();

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: com.lenovo.anyshare.Wve$a */
    /* loaded from: classes6.dex */
    public static class a implements Comparator<ResolveInfo> {
        ...
        public int compare(ResolveInfo resolveInfo, ResolveInfo resolveInfo2) {
            int size;
            int size2;
            if (this.f16499a.contains(resolveInfo.activityInfo.packageName)) {
                size = this.f16499a.indexOf(resolveInfo.activityInfo.packageName);
            } else {
                size = this.f16499a.size();
            }
            if (this.f16499a.contains(resolveInfo2.activityInfo.packageName)) {
                size2 = this.f16499a.indexOf(resolveInfo2.activityInfo.packageName);
            } else {
                size2 = this.f16499a.size();
            }
            return size - size2;
        }
    }
    ...
    static {
        f16498a.add("com.android.chrome");
        f16498a.add("com.android.browser");
        f16498a.add("com.sec.android.app.sbrowser");
        f16498a.add("com.opera.browser");
        f16498a.add("com.opera.mini.android");
        f16498a.add("com.opera.mini.native");
        f16498a.add("com.UCMobile");
        f16498a.add("com.UCMobile.intl");
        f16498a.add("com.uc.browser.en");
        f16498a.add("com.UCMobile.internet.org");
        f16498a.add("com.uc.browser.hd");
        f16498a.add("org.mozilla.firefox");
        f16498a.add("com.tencent.mtt");
        f16498a.add("com.qihoo.browser");
        f16498a.add("com.baidu.browser.apps");
        f16498a.add("sogou.mobile.explorer");
        f16498a.add("com.zui.browser");
        f16498a.add("com.oupeng.browser");
        f16498a.add("com.oupeng.mini.android");
    }
    ...
    public static void a(Context context, String str, String str2, String str3, boolean z) {
        ...
        try {
            try {
                ...
                if (z || a(context, intent, "com.android.vending")) {
                    intent.setPackage("com.android.vending");
                    if (C9116awe.c.e() && a(context, a3, "com.android.vending")) {
    ...
    public static boolean b(Context context, Intent intent, int i) {
        return a(context, intent, i, f16498a);
    }
