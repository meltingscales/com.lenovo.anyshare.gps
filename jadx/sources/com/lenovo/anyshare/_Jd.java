...
public class _Jd implements C16006mKd.a {

    /* renamed from: a  reason: collision with root package name */
    public long f17919a = -1;
    public final /* synthetic */ int b;
    public final /* synthetic */ String c;
    public final /* synthetic */ C9886cKd d;

    public _Jd(C9886cKd c9886cKd, int i, String str) {
        this.d = c9886cKd;
        this.b = i;
        this.c = str;
    }
    ...
    public void a(boolean z, String str, int i) {
        ...
        String d = this.d.d();
        i2 = this.d.i();
        TQd.a(z ? 1 : 0, e, h, d, i2, C12324gKd.a(i, this.d.a(), str, this.b), Math.abs(System.currentTimeMillis() - this.f17919a), this.c);
        i3 = this.d.i();
        C23193xyd.b(i3, str);
    }
    ...
    public void onStart() {
        Handler handler;
        Handler handler2;
        this.f17919a = System.currentTimeMillis();
        handler = this.d.c;
        handler2 = this.d.c;
