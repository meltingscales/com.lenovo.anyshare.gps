...
public class TIh implements Callable<List<YGh>> {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ RoomSQLiteQuery f14842a;
    public final /* synthetic */ C11097eJh b;

    public TIh(C11097eJh c11097eJh, RoomSQLiteQuery roomSQLiteQuery) {
        this.b = c11097eJh;
    ...
    public List<YGh> call() throws Exception {
        ...
        Cursor query = DBUtil.query(roomDatabase, this.f14842a, false, null);
        try {
