...
public final class C7299Wqg extends C8356_ie.b {

    /* renamed from: a  reason: collision with root package name */
    public List<Integer> f16464a;
    public final /* synthetic */ MainHomeMusicTabFragmentNew b;

    public C7299Wqg(MainHomeMusicTabFragmentNew mainHomeMusicTabFragmentNew) {
    ...
    public void callback(Exception exc) {
        ...
        Integer num2;
        int i = 0;
        for (Object obj : MainHomeMusicTabFragmentNew.a(this.b)) {
            int i2 = i + 1;
            String str = null;
            if (i >= 0) {
                ...
                if (i == 0) {
                    ...
                    if (context != null && (resources2 = context.getResources()) != null) {
                        ...
                        List<Integer> list = this.f16464a;
                    ...
                    if (context2 != null && (resources = context2.getResources()) != null) {
                        ...
                        List<Integer> list2 = this.f16464a;
    ...
    @Override // com.lenovo.anyshare.C8356_ie.b
    public void execute() {
        this.f16464a = C11990fhk.c(Integer.valueOf(C17631osg.f24991a.b()), Integer.valueOf(C17631osg.f24991a.a()), Integer.valueOf(C17631osg.f24991a.c()), Integer.valueOf(C17631osg.f24991a.d()));
    }
}
