...
public class C5837Roa extends C8356_ie.b {

    /* renamed from: a  reason: collision with root package name */
    public AbstractC23099xqf f14227a;
    public C22488wqf b;
    ...
    public C5837Roa(AbstractC23099xqf abstractC23099xqf, C22488wqf c22488wqf, Context context, String str) {
    ...
    public void callback(Exception exc) {
        ...
        if (c22488wqf != null && c22488wqf.getContentType() == ContentType.MUSIC) {
            C7845Yoa.a(this.f, this.b, this.f14227a, this.g);
            return;
        }
        List<AbstractC23099xqf> list = this.c;
        if (list != null) {
            if (list.isEmpty()) {
                this.c.add(this.f14227a);
            }
            C7845Yoa.a(this.f, this.c, this.f14227a, this.g);
        }
    }
    ...
    */
    public void execute() throws java.lang.Exception {
        ...
        L7a:
            r4.f14227a = r1
        L7c:
            com.lenovo.anyshare.xqf r0 = r4.f14227a
            if (r0 != 0) goto L8a
        ...
        L8a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lenovo.anyshare.C5837Roa.execute():void");
    }
}
