...
public class C6362Tjg {
    ...
    public static void a(MediaAppFragment mediaAppFragment, View view, Bundle bundle) {
        mediaAppFragment.onViewCreated$___twin___(view, bundle);
        String name = mediaAppFragment.getClass().getName();
