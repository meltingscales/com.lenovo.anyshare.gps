...
public final class C10089cbj implements Checksum {
    ...
    public void update(int i) {
        this.b = a((byte) i, this.b ^ DNi.c) ^ DNi.c;
    }

    private long a(byte b, long j) {
        return ((j >> 8) ^ f19439a[(int) ((((byte) (b & 255)) ^ j) & 255)]) & DNi.c;
    }
    ...
    public static String a(SFile sFile) {
        try {
            try {
                try {
                    C10089cbj c10089cbj = new C10089cbj();
                    sFile.a(SFile.OpenMode.Read);
                    byte[] bArr = new byte[8192];
                    while (true) {
                        int a2 = sFile.a(bArr);
                        if (a2 != -1) {
                            c10089cbj.update(bArr, 0, a2);
                        } else {
                            return C18740qje.a(c10089cbj.a());
                        }
                    }
                } catch (IOException e) {
                    C6040Sge.b(DNi.f7797a, e.getMessage(), e);
                    sFile.c();
                    return null;
                } catch (Exception e2) {
                    C6040Sge.b(DNi.f7797a, e2.getMessage(), e2);
                    sFile.c();
                    return null;
                }
            } catch (FileNotFoundException e3) {
                C6040Sge.b(DNi.f7797a, e3.getMessage(), e3);
                sFile.c();
                return null;
            }
        } finally {
