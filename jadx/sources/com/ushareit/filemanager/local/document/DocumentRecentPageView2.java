...
public class DocumentRecentPageView2 extends BaseFilesLocalView2 {
    public String A;

    public DocumentRecentPageView2(Context context, String str) {
        super(context);
        this.A = str;
    }
    ...
    @Override // com.ushareit.filemanager.local.BaseFilesLocalView2, com.ushareit.filemanager.main.local.base.BaseStatusLocalView, com.lenovo.anyshare.InterfaceC8006Zcg
    public void h() {
        super.h();
        if (C20883uKa.a().f27438a) {
            g();
        }
    }
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        A_f.a(this, onClickListener);
    }

    @Override // com.ushareit.filemanager.main.local.base.BaseStatusLocalView
    public void a(boolean z) throws LoadContentException {
        this.v = C20883uKa.a().b();
