...
import com.lenovo.anyshare.C0872Aig;
import com.lenovo.anyshare.C1162Big;
import com.lenovo.anyshare.C24225zig;
import com.lenovo.anyshare.C4339Mib;
import com.lenovo.anyshare.C8356_ie;
import com.lenovo.anyshare.View$OnClickListenerC23004xig;
import com.lenovo.anyshare.View$OnClickListenerC23615yig;
...
public class AccessibilityGuideActivity extends BFileUATActivity {
    ...
    private void Kb() {
        C1162Big.a(findViewById(R.id.d6v), new View$OnClickListenerC23004xig(this));
        ...
        C1162Big.a(this.C, (View.OnClickListener) new View$OnClickListenerC23615yig(this));
        Lb();
    }
    ...
    private void Lb() {
        ...
        if (!TextUtils.isEmpty(a2.d) && !TextUtils.isEmpty(a2.e)) {
            ...
            this.B.addAnimatorListener(new C24225zig(this));
        } else {
            this.B = null;
        }
        Mb();
    ...
    public static void i(Context context) {
        C8356_ie.a(new C0872Aig(context), 0L, 300L);
    }
