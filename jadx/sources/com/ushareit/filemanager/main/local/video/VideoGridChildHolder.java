...
import com.lenovo.anyshare.C5468Qgg;
import com.lenovo.anyshare.C5755Rgg;
...
public class VideoGridChildHolder extends BaseLocalGridChildHolder<View, AbstractC23099xqf> {
    ...
    public static class a {
        ...
        public /* synthetic */ a(C5468Qgg c5468Qgg) {
            this();
        }
    }
    ...
    public VideoGridChildHolder(View view, int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            a aVar = new a(null);
            View inflate = View.inflate(this.n, R.layout.a_e, null);
            this.m.addView(inflate, layoutParams);
            aVar.f31558a = (ImageView) inflate.findViewById(R.id.c1u);
    ...
    public void a(AbstractC23099xqf abstractC23099xqf, int i, UNb uNb, int i2, List<Object> list) {
        ...
        while (true) {
            ...
            if (i6 >= a2) {
                ...
                a(this.o[i4].b, C6681Umg.b(abstractC23099xqf2));
                ...
                VEa.a(this.o[i4].f31558a.getContext(), abstractC23099xqf2, this.o[i4].f31558a, (int) R.color.ae7);
                ...
                C23475yXf.b.a().c(abstractC23099xqf2, new C5468Qgg(this, this.o[i4].c));
            }
            i4++;
        }
    }
    ...
    public void b(AbstractC23099xqf abstractC23099xqf, int i, UNb uNb, int i2, List<Object> list) {
        ...
        while (true) {
            ...
            int i5 = (i4 * i2) + i3;
            if (i5 < a2) {
                a(this.o[i3].b, C6681Umg.b((AbstractC23099xqf) uNb.f15325a.get(i5)));
            }
            i3++;
        }
    }
