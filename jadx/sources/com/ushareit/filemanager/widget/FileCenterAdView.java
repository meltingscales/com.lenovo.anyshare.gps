...
public class FileCenterAdView extends RelativeLayout {
    ...
    public static HashMap<String, String> f31661a = new HashMap<>();
    public C1313Bwd b;
    public ViewGroup c;
    public ImageView d;
    public boolean e;
    ...
    public class a {
        ...
        public a(boolean z, int i, int i2, int i3, int i4) {
            ...
            this.d = 0;
            if (z) {
                this.f31662a = i2 != 0 ? (int) FileCenterAdView.this.getContext().getResources().getDimension(i2) : 0;
    ...
    public class b {
        ...
        public b(boolean z, int i, int i2, int i3, int i4) {
            ...
            this.d = 0;
            if (z) {
                this.f31663a = i2 != 0 ? (int) FileCenterAdView.this.getContext().getResources().getDimension(i2) : 0;
                this.b = i != 0 ? (int) FileCenterAdView.this.getContext().getResources().getDimension(i) : 0;
    ...
    private void d() {
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (getChildCount() > 0) {
                ...
                relativeLayout.setOutlineProvider(new BBg(this));
    ...
    private void e() {
        ...
        C6138Spd.a(getContext(), C7318Wsd.h(this.b), this.f, new ABg(this));
    }
    ...
    public void c() {
        ...
        if (c1313Bwd != null && c1313Bwd.getAd() != null) {
            ...
            if (adType == 1) {
                if (this.g) {
                    if (DUf.a(C19289ref.U) == 2 || DUf.a(AdFileHolder.j) == 2) {
                        i = R.layout.aek;
                    }
                    if (DUf.a(C19289ref.U) == 3 || DUf.a(AdFileHolder.j) == 3) {
                        i = R.layout.aej;
                    }
                }
                ...
                viewGroup.setBackgroundResource(R.color.bi0);
                if (!this.g) {
    ...
    private RelativeLayout.LayoutParams a(int i) {
        ...
        if (i == 1) {
            ...
            layoutParams = new RelativeLayout.LayoutParams(-1, C5714Rcj.a(58.0f));
        } else if (i != 4) {
    ...
    private void a(int i, a aVar, b bVar) {
        ...
        if (bVar != null) {
            setPadding(bVar.b, bVar.f31663a, bVar.d, bVar.c);
        }
    }
}
