...
public class RecentDocumentView extends RecentBaseView {
    public TextView h;
    public TextView i;
    ...
    public RecentDocumentView(Context context, int i) {
        super(context);
        this.e = i;
    }
    ...
    public void setValue(C22488wqf c22488wqf) {
        ...
        a(this.d);
        this.i.setText(this.f31669a.getResources().getString(R.string.ap7));
    }
