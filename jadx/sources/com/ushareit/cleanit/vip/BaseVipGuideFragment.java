...
public abstract class BaseVipGuideFragment extends BCleanUATFragment {
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.f31290a = (ImageView) view.findViewById(R.id.return_view_res_0x7f090b96);
        ImageView imageView = this.f31290a;
        if (imageView != null) {
            YSe.a(imageView, new ZSe(this));
        }
        ...
        nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() { // from class: com.ushareit.cleanit.vip.BaseVipGuideFragment$onViewCreated$3
            ...
            private final float a(int i) {
                C6040Sge.a("wwwwww", "calculateScrollScale  " + this.b + "     " + this.f31291a + "     " + i);
                int i2 = this.b;
                if (i > i2) {
                    return 1.0f;
                }
            ...
            private final void a(Context context) {
                if (context == null || this.f31291a != -1) {
                    return;
                }
                ...
                Double.isNaN(d);
                this.f31291a = (int) (d - (dimensionPixelSize2 * 0.46d));
    ...
    public final void a(float f) {
        ...
        ImageView imageView2 = this.f31290a;
        if (imageView2 != null) {
