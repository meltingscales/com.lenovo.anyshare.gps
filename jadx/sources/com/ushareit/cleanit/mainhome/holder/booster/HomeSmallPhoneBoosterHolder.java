...
public class HomeSmallPhoneBoosterHolder extends BaseHomeHolder implements InterfaceC1087Bbj {
    public static LinearLayout b;
    public TextView c;
    public TextView d;

    public HomeSmallPhoneBoosterHolder(ViewGroup viewGroup, ComponentCallbacks2C14013iw componentCallbacks2C14013iw) {
        super(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.zg, c(viewGroup.getContext()), false), IJa.b);
    }
    ...
    public void x() {
        ...
        this.d = (TextView) this.itemView.findViewById(R.id.ctx);
        WNe.a(this.itemView.findViewById(R.id.e77), new UNe(this));
        y();
    }
