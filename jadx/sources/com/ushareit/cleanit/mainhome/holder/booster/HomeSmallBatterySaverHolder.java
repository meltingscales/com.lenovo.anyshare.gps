...
public class HomeSmallBatterySaverHolder extends BaseHomeHolder implements InterfaceC1087Bbj {
    public static LinearLayout b;
    public TextView c;
    public TextView d;

    public HomeSmallBatterySaverHolder(ViewGroup viewGroup, ComponentCallbacks2C14013iw componentCallbacks2C14013iw) {
        super(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.zd, c(viewGroup.getContext()), false), IJa.f9989a);
    }
    ...
    public void x() {
        ...
        this.d = (TextView) this.itemView.findViewById(R.id.av6);
        TNe.a(this.itemView.findViewById(R.id.e77), new RNe(this));
        y();
    }
