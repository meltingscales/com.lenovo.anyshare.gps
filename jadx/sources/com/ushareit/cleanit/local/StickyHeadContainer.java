...
import com.lenovo.anyshare.C11138eNe;
import com.lenovo.anyshare.View$OnClickListenerC10529dNe;
...
public class StickyHeadContainer<VH extends c> extends ViewGroup {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.f = paddingTop + marginLayoutParams.topMargin + this.f31265a;
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        C11138eNe.a(this, onClickListener);
    }
    ...
    public void b(int i) {
        if (this.b != i) {
            this.f31265a = i;
            ViewCompat.offsetTopAndBottom(getChildAt(0), this.f31265a - this.b);
        }
        this.b = this.f31265a;
    }
    ...
    public StickyHeadContainer(Context context, AttributeSet attributeSet, int i) {
        ...
        setOnClickListener(new View$OnClickListenerC10529dNe(this));
    }
