...
import com.lenovo.anyshare.C9920cNe;
import com.lenovo.anyshare.View$OnClickListenerC9310bNe;
...
public class ShuffleViewHolder extends BaseLocalRVHolder<AbstractC0959Aqf> {
    ...
    public ShuffleViewHolder(ViewGroup viewGroup) {
        super(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.au6, viewGroup, false));
        this.j = new View$OnClickListenerC9310bNe(this);
    ...
    private void y() {
        C9920cNe.a(this.d, this.j);
        C9920cNe.a(this.f, this.j);
        C9920cNe.a(this.g, this.j);
        C9920cNe.a(this.h, this.j);
    }
    ...
    public void onBindViewHolder(AbstractC0959Aqf abstractC0959Aqf, int i) {
        ...
        if (aVar != null) {
            if (aVar.c()) {
                this.f.setImageResource(C8364_jb.c(ObjectStore.getContext()) ^ true ? R.drawable.cd3 : R.drawable.cd6);
            } else {
