...
import com.lenovo.anyshare.C20799uCe;
...
public class DuplicatePhotoView extends BaseDuplicateView {
    public DuplicatePhotoView(Context context, AttributeSet attributeSet, int i) {
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        C20799uCe.a(this, onClickListener);
    }

    public DuplicatePhotoView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public DuplicatePhotoView(Context context) {
        super(context);
    }
}
