...
public class DuplicateMusicAdapter extends BaseLocalAdapter<C11693fIe, MusicChildHolder> {
    public int t;

    public DuplicateMusicAdapter(List<C11693fIe> list, int i, ContentType contentType) {
        super(list, i);
        this.t = i;
        this.p = contentType;
    }
    ...
    public /* bridge */ /* synthetic */ void a(ChildViewHolder childViewHolder, int i, TKe tKe, int i2, List list) {
        a((MusicChildHolder) childViewHolder, i, (C11693fIe) tKe, i2, (List<Object>) list);
    }

    public void a(MusicChildHolder musicChildHolder, int i, C11693fIe c11693fIe, int i2, List<Object> list) {
        AbstractC23099xqf abstractC23099xqf = (AbstractC23099xqf) c11693fIe.f14856a.get(i2);
        musicChildHolder.g = this.o;
        if (abstractC23099xqf instanceof C7298Wqf) {
            musicChildHolder.a((MusicChildHolder) ((C7298Wqf) abstractC23099xqf), i(i), (TKe) c11693fIe, i2, list);
        }
    }
    ...
    public MusicChildHolder c(ViewGroup viewGroup, int i) {
        return new MusicChildHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.atn, viewGroup, false));
    }
}
