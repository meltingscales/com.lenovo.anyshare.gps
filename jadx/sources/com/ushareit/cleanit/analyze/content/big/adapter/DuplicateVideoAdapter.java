...
public class DuplicateVideoAdapter extends BaseLocalAdapter<C11693fIe, VideoGridChildHolder> {
    public int t;

    public DuplicateVideoAdapter(List<C11693fIe> list, int i, ContentType contentType) {
        super(list, i);
        this.t = i;
        this.p = contentType;
    }
    ...
    public /* bridge */ /* synthetic */ void a(ChildViewHolder childViewHolder, int i, TKe tKe, int i2, List list) {
        a((VideoGridChildHolder) childViewHolder, i, (C11693fIe) tKe, i2, (List<Object>) list);
    }

    public void a(VideoGridChildHolder videoGridChildHolder, int i, C11693fIe c11693fIe, int i2, List<Object> list) {
        AbstractC23099xqf abstractC23099xqf = (AbstractC23099xqf) c11693fIe.f14856a.get(i2);
        videoGridChildHolder.h = this.o;
        videoGridChildHolder.a((VideoGridChildHolder) abstractC23099xqf, i(i), (TKe) c11693fIe, i2, list);
    }
    ...
    public VideoGridChildHolder c(ViewGroup viewGroup, int i) {
        return new VideoGridChildHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.arw, viewGroup, false), this.t);
    }
}
