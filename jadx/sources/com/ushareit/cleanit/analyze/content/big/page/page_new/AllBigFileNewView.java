...
import com.lenovo.anyshare.C12869hCe;
import com.lenovo.anyshare.C16047mOa;
import com.lenovo.anyshare.C17139oCe;
...
public class AllBigFileNewView extends BaseAnalyzeNewView {
    public AllBigFileNewView(Context context, AttributeSet attributeSet, int i) {
    ...
    public void a(boolean z) throws LoadContentException {
        ...
        this.k = this.B.a(AnalyzeType.BIGFILE_MUSIC);
        ...
        this.k = this.B.a(AnalyzeType.BIGFILE_VIDEO);
        C22488wqf c22488wqf3 = this.k;
        if (c22488wqf3 != null) {
            for (C22488wqf c22488wqf4 : c22488wqf3.j) {
                this.x.addAll(c22488wqf4.i);
            }
        }
        this.k = this.B.a(AnalyzeType.BIGFILE_PHOTO);
        C22488wqf c22488wqf5 = this.k;
        if (c22488wqf5 != null) {
            for (C22488wqf c22488wqf6 : c22488wqf5.j) {
                this.x.addAll(c22488wqf6.i);
            }
        }
        this.k = this.B.a(AnalyzeType.BIGFILE_OTHER);
        C22488wqf c22488wqf7 = this.k;
        if (c22488wqf7 != null) {
            this.x.addAll(c22488wqf7.j.get(0).i);
        }
        m();
    }
    ...
    public String getPveCur() {
        return C16047mOa.b("/Files").a("/Files").a("/All").a();
    }
    ...
    @Override // com.ushareit.cleanit.analyze.content.big.page.page_new.BaseAnalyzeNewView, com.ushareit.cleanit.analyze.content.big.page.BaseAnalyzeView, com.ushareit.cleanit.local.BaseStatusLocalView, com.lenovo.anyshare.CLe
    public void h() {
        super.h();
    }
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        C12869hCe.a(this, onClickListener);
    }

    public AllBigFileNewView(Context context, AttributeSet attributeSet) {
    ...
    public AllBigFileNewView(Context context) {
        super(context);
    }
