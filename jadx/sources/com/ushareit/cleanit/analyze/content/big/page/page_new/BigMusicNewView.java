...
import com.lenovo.anyshare.C14091jCe;
...
public class BigMusicNewView extends BaseAnalyzeNewView {
    public BigMusicNewView(Context context, AttributeSet attributeSet, int i) {
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        C14091jCe.a(this, onClickListener);
    }

    public BigMusicNewView(Context context, AttributeSet attributeSet) {
    ...
    public BigMusicNewView(Context context) {
        super(context);
    }
