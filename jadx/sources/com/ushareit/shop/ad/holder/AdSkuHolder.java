...
public class AdSkuHolder extends BaseRecyclerViewHolder<AdSkuCard> {
    ...
    public AdSkuHolder(ViewGroup viewGroup) {
        ...
        this.f32229a = ObjectStore.getContext();
        ...
        this.l = (LinearLayout) getView(R.id.e9m);
        this.m = (CountdownView) getView(R.id.e7z);
    }
    ...
    public void onBindViewHolder(final AdSkuCard adSkuCard) {
        ...
        if (discount != -1.0d && !adSkuItem.isEqualsPrice() && discount >= C15435lNi.g()) {
            this.g.setVisibility(0);
            TextView textView = this.h;
            Resources resources = this.f32229a.getResources();
        ...
        if (C16022mLi.f()) {
            ...
            if (adSkuItem.getSubscribedPrice() == -1) {
                ...
                this.k.setOnClickListener(new View.OnClickListener() { // from class: com.lenovo.anyshare.GKi
        ...
        if (!TextUtils.isEmpty(coverImage) && coverImage.startsWith("data:image/")) {
            ...
            ComponentCallbacks2C14013iw d = TEa.d(this.f32229a);
            if (coverImage == null) {
                coverImage = "";
            }
        ...
        if (adSkuItem.getTags() != null && adSkuItem.getTags().size() > 0) {
            ...
            this.d.setAdapter(new C13572iKi(adSkuItem.getTags()));
        } else {
    ...
    public void onViewAttachedToWindow() {
        ...
        if (!adSkuItem.getCornerTags().isEmpty() && adSkuItem.getCornerTags().contains("flash_sale")) {
            ...
            if (flashSaleEndTime > 0) {
                ...
                this.m.setOnCountdownEndListener(new CountdownView.a() { // from class: com.lenovo.anyshare.FKi
    ...
    public /* synthetic */ void a(AdSkuCard adSkuCard, View view) {
        ...
        if (interfaceC11422ele != 0) {
            interfaceC11422ele.a(this, getAdapterPosition(), adSkuCard, InterfaceC22757xNi.t);
        }
    }
