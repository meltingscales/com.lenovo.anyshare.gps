...
public class OkEventListenerStats extends EventListener {
    ...
    public static final String f32235a = "OkEventListenerStats";
    ...
    private static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final Map<String, JKi> f32236a = new ConcurrentHashMap();
        public static final JKi b = new JKi("null", "null", "null", "null", "null");

        public static JKi a(Call call) {
            return a(call, false);
        }

        public static JKi a(Call call, boolean z) {
            try {
                String header = call.request().header("trace_id");
                if (f32236a.containsKey(header)) {
                    return f32236a.get(header);
                }
                if (!z) {
                    return b;
                }
                JKi jKi = new JKi(header, call.request().url().toString(), call.request().header("portal"), call.request().header(LLi.d), call.request().method());
                f32236a.put(header, jKi);
                return jKi;
        ...
        public static void a(JKi jKi) {
            try {
                if (f32236a.containsValue(jKi)) {
                    f32236a.remove(jKi.f);
                }
            } catch (Exception unused) {
            }
        }
    ...
    */
    public void responseHeadersEnd(okhttp3.Call r10, okhttp3.Response r11) {
        ...
        L91:
            ...
            goto Lc9
        La2:
            com.lenovo.anyshare.JKi r0 = com.ushareit.shop.ad.http.OkEventListenerStats.a.a(r10)
            int r1 = r11.code()
            if (r7 != 0) goto Lae
            r2 = r4
            goto Lb2
        ...
        Lb2:
            ...
            if (r11 < r0) goto Lc8
        Lc5:
            com.ushareit.shop.ad.http.OkEventListenerStats.a.a(r10, r4)
        Lc8:
            return
        Lc9:
            com.lenovo.anyshare.JKi r10 = com.ushareit.shop.ad.http.OkEventListenerStats.a.a(r10)
            int r0 = r11.code()
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ushareit.shop.ad.http.OkEventListenerStats.responseHeadersEnd(okhttp3.Call, okhttp3.Response):void");
    }
