...
public final class VerseAdapter extends CommonPageAdapter<VerseData> {
    ...
    public BaseRecyclerViewHolder<VerseData> c(ViewGroup viewGroup, int i) {
        return new VerseHolder(viewGroup);
    }
