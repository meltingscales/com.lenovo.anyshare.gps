...
public class CalendarView extends ViewPager {
    ...
    public void a() {
        ...
        this.m = new CalendarPagerAdapter(this.i, this.n, this, this.e);
        setAdapter(this.m);
        int[] iArr4 = this.f;
        int i2 = iArr4[0];
        int i3 = iArr4[1];
        int[] iArr5 = this.g;
        this.f31944a = NLh.a(i2, i3, iArr5[0], iArr5[1]);
        HLh hLh = this.n;
        ...
        setCurrentItem(this.f31944a, false);
        addOnPageChangeListener(new QLh(this));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void a(int i) {
        MonthView monthView = this.m.f31943a.get(i);
        if (monthView == null) {
            return;
        }
        HLh hLh = this.n;
        if (hLh.t == 1) {
            if (this.k.get(i) != null) {
                monthView.a(this.k.get(i));
                return;
            }
            return;
        }
        monthView.a(this.j[1], (!hLh.k && this.j[0] == i) || this.n.k);
    }
