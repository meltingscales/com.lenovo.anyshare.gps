...
@Rek(bv = {1, 0, 3}, d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\t\u001a\u00020\nH\u0003J\u0018\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\bH\u0016J \u0010\u000f\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u0010\u001a\u00020\b2\u0006\u0010\u0011\u001a\u00020\bH\u0016J\u0010\u0010\u0012\u001a\u00020\n2\u0006\u0010\u0011\u001a\u00020\bH\u0002R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0013"}, d2 = {"Lcom/ushareit/muslim/base/PlayerViewScrollHelper;", "Landroidx/recyclerview/widget/RecyclerView$OnScrollListener;", "playerView", "Lcom/ushareit/muslim/base/BasePlayerView;", "(Lcom/ushareit/muslim/base/BasePlayerView;)V", "isDragging", "", "playerHeight", "", "animPlayerToFinal", "", "onScrollStateChanged", "recyclerView", "Landroidx/recyclerview/widget/RecyclerView;", "newState", "onScrolled", "dx", "dy", "updatePlayerAsScroll", "ModuleMuslim_release"}, k = 1, mv = {1, 4, 0})
...
public final class PlayerViewScrollHelper extends RecyclerView.OnScrollListener {
    ...
    public boolean b;
    public final BasePlayerView c;

    public PlayerViewScrollHelper(BasePlayerView basePlayerView) {
        C11440emk.e(basePlayerView, "playerView");
        this.c = basePlayerView;
        this.f31904a = C5714Rcj.a(HEh.b());
        this.b = true;
    }
    ...
    private final void a() {
        if (this.c.getVisibility() == 0 && this.c.a()) {
            ...
            if (translationY > 0) {
                ...
                ofFloat.setDuration(Math.abs(((int) (f - translationY)) / this.f31904a) * 2000);
                ofFloat.start();
            }
        }
    }
