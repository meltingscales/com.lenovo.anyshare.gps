...
import com.lenovo.anyshare.C4610Ngi;
import com.lenovo.anyshare.Mek;
import com.lenovo.anyshare.Pek;
import com.lenovo.anyshare.Rek;
import com.lenovo.anyshare.Tkk;
import com.lenovo.anyshare.Ulk;
import com.lenovo.anyshare.View$OnClickListenerC4324Mgi;
...
public final class ShareSetTextActivity extends BaseTitleActivity {
    ...
    public static final class a {
        ...
        private final Intent b(Context context, ShareContent shareContent, String str) {
            Intent intent = new Intent(context, ShareSetTextActivity.class);
    ...
    public final ShareSetTextFragment Vb() {
        return (ShareSetTextFragment) this.P.getValue();
    }
    ...
    private final void Xb() {
        ...
        if (Kb != null) {
            ...
            if (inflate != null) {
                ...
                ((TextView) frameLayout.findViewById(R.id.aa2)).setOnClickListener(new View$OnClickListenerC4324Mgi(this));
                Kb.removeAllViews();
    ...
    private final void Yb() {
        ...
        try {
            C19705sOa.f(C16047mOa.b("/Share/Edit").a("/X").a(), null, linkedHashMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
