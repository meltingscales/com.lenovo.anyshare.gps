...
import com.lenovo.anyshare.RunnableC2899Hhi;
import com.lenovo.anyshare.gps.R;
import com.ushareit.muslim.share.widget.ShareTextLanguageTabView;

/* loaded from: classes8.dex */
public class ShareTextLanguageTabView extends FrameLayout {

    /* renamed from: a  reason: collision with root package name */
    public static final String f32123a = "UI.TitleBar";
    ...
    public ShareTextLanguageTabView(Context context) {
        super(context);
        this.h = -1;
        this.i = -1;
        this.j = 0;
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        b();
        c();
        this.c.postDelayed(new RunnableC2899Hhi(this), 300L);
    }
    ...
    public void setCurrentItem(int i) {
        ...
        post(new Runnable() { // from class: com.lenovo.anyshare.Bhi
            @Override // java.lang.Runnable
            public final void run() {
                ShareTextLanguageTabView.this.a();
            }
        });
    }
    ...
    public void b(int i, int i2) {
        ...
        int childCount = this.f / this.c.getChildCount();
        int i3 = this.h;
        if (i3 <= 0) {
            i3 = childCount;
        }
    ...
    public ShareTextLanguageTabView(Context context, AttributeSet attributeSet) {
    ...
    public void a(String str) {
        ...
        a2.setOnClickListener(new View.OnClickListener() { // from class: com.lenovo.anyshare.Chi
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ShareTextLanguageTabView.this.a(childCount, view);
            }
        });
    }
    ...
    public ShareTextLanguageTabView(Context context, AttributeSet attributeSet, int i) {
