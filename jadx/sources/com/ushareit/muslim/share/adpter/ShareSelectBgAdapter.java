...
import com.lenovo.anyshare.C13842ihi;
import com.lenovo.anyshare.C14451jhi;
...
import com.ushareit.muslim.share.holder.ShareBgGroupHolder;
...
public final class ShareSelectBgAdapter extends CommonPageAdapter<String> {
    ...
    public ShareSelectBgAdapter(Context context, String str) {
        C11440emk.e(context, LogEntry.LOG_ITEM_CONTEXT);
        C11440emk.e(str, "portal");
        this.s = context;
        this.t = str;
        this.p = new ArrayList();
        this.q = Pek.a(C13842ihi.f22198a);
        this.r = Pek.a(C14451jhi.f22646a);
    }
    ...
    public void a(BaseRecyclerViewHolder<String> baseRecyclerViewHolder, int i) {
        ...
        if (baseRecyclerViewHolder instanceof ShareBgGroupHolder) {
            if (i == 0) {
                string = this.s.getString(R.string.a2g, Integer.valueOf(O().size()));
            } else {
                string = this.s.getString(R.string.a2h, Integer.valueOf(P().size()));
            }
            C11440emk.d(string, "if (position == 0) conte…st.size\n                )");
            baseRecyclerViewHolder.onBindViewHolder(string, i);
        } else if (baseRecyclerViewHolder instanceof ShareBgHolder) {
            if (i <= O().size()) {
                int i2 = i - 1;
                a2 = C18699qfk.a(1, Integer.valueOf(i2));
                num = (Integer) C20552thk.i(O(), i2);
            } else {
                int size = (i - O().size()) - 2;
    ...
    public BaseRecyclerViewHolder<String> c(ViewGroup viewGroup, int i) {
        ...
        if (i == 2) {
            return new ShareBgGroupHolder(viewGroup);
        }
