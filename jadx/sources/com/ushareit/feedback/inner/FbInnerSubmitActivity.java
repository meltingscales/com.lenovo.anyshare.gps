...
public class FbInnerSubmitActivity extends BaseTitleActivity {
    ...
    public void onCreate$___twin___(Bundle bundle) {
        ...
        h(R.string.bfe);
        this.E.setBackgroundResource(R.drawable.b9a);
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.bqa, fbInnerSubmitFragment).commitAllowingStateLoss();
    }
    ...
    @Override // com.ushareit.base.activity.BaseTitleActivity
    public void Sb() {
        C6040Sge.a("feedback.inner.submit", "start feedback inner history page.");
    }
    ...
    public static void a(Context context, String str, String str2, String str3, List<C15728lmf> list, String str4, String str5) {
        Intent intent = new Intent(context, FbInnerSubmitActivity.class);
