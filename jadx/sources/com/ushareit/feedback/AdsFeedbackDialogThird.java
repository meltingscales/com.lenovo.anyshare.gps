...
import com.lenovo.anyshare.C18503qPf;
import com.lenovo.anyshare.C19154rTd;
import com.lenovo.anyshare.C19763sTd;
import com.lenovo.anyshare.C20332tPf;
import com.lenovo.anyshare.C20943uPf;
import com.lenovo.anyshare.C23387yPf;
import com.lenovo.anyshare.JJd;
import com.lenovo.anyshare.View$OnClickListenerC17283oPf;
import com.lenovo.anyshare.View$OnClickListenerC17893pPf;
import com.lenovo.anyshare.View$OnClickListenerC19112rPf;
import com.lenovo.anyshare.View$OnClickListenerC19721sPf;
...
public class AdsFeedbackDialogThird extends BaseActionDialogFragment {
    ...
    public AdsFeedbackDialogThird(JJd jJd) {
    ...
    public void onViewCreated$___twin___(View view, Bundle bundle) {
        ...
        if (C19763sTd.a() && C19154rTd.a("feed") && C19154rTd.b("ad_feedback")) {
            ...
            C20332tPf.a(relativeLayout, new View$OnClickListenerC17283oPf(this));
        }
        this.u = (RelativeLayout) view.findViewById(R.id.ao_);
        C20332tPf.a(this.u, new View$OnClickListenerC17893pPf(this));
        this.v = Ib();
        ...
        this.r.d = new C18503qPf(this);
        C20332tPf.a(this.s, new View$OnClickListenerC19112rPf(this));
        C20332tPf.a(this.t, new View$OnClickListenerC19721sPf(this));
    }
    ...
    public static void a(JJd jJd) {
        if (jJd != null && (C10083cbd.d instanceof FragmentActivity)) {
            p = new AdsFeedbackDialogThird(jJd);
            p.show(((FragmentActivity) C10083cbd.d).getSupportFragmentManager(), "ads_feedback");
        }
    }

    public AdsFeedbackDialogThird(JJd jJd, int i) {
        this.v = new ArrayList<>();
        this.x = -1;
        this.w = jJd;
        this.x = i;
    ...
    public static void a(JJd jJd, int i) {
        if (jJd != null && (C10083cbd.d instanceof FragmentActivity)) {
            p = new AdsFeedbackDialogThird(jJd, i);
            p.show(((FragmentActivity) C10083cbd.d).getSupportFragmentManager(), "ads_feedback");
        }
    }
}
