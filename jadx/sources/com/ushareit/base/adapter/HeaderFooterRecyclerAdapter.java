...
import com.lenovo.anyshare.C21756vge;
import com.lenovo.anyshare.C22367wge;
...
public abstract class HeaderFooterRecyclerAdapter<T, FD> extends BaseRecyclerViewAdapter<T, BaseRecyclerViewHolder<T>> {
    ...
    public void onAttachedToRecyclerView(RecyclerView recyclerView) {
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            gridLayoutManager.setSpanSizeLookup(new C21756vge(this, gridLayoutManager));
        }
    ...
    public final BaseRecyclerViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (i == 1000) {
            if (this.n == null) {
                ...
                BaseRecyclerViewHolder<Object> baseRecyclerViewHolder = this.n;
                if (baseRecyclerViewHolder != null) {
                    baseRecyclerViewHolder.mItemClickListener = (InterfaceC11422ele<T>) this.l;
                }
            }
            return this.n;
        } else if (i == 1001) {
    ...
    public void onViewAttachedToWindow(BaseRecyclerViewHolder<T> baseRecyclerViewHolder) {
        ...
        C7816Yle c7816Yle = this.b;
        if (c7816Yle != null) {
            C6040Sge.a(ImpressionTracker.TAG, "track view holder = " + baseRecyclerViewHolder.getClass().getSimpleName());
            c7816Yle.a(baseRecyclerViewHolder.itemView, baseRecyclerViewHolder);
        }
    }
