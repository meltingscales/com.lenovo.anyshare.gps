...
import com.lenovo.anyshare.C21145uge;
import com.lenovo.anyshare.View$OnClickListenerC20534tge;
...
public abstract class BaseViewPagerAdapter<T> extends PagerAdapter {
    ...
    public List<T> f31096a = new ArrayList();
    ...
    public T getItem(int i) {
        if (i < 0 || i >= this.f31096a.size()) {
            return null;
        }
        return this.f31096a.get(i);
    }
    ...
    public Object instantiateItem(ViewGroup viewGroup, int i) {
        ...
        if (a2 != null) {
            ...
            if (this.c != null) {
                C21145uge.a(a2, new View$OnClickListenerC20534tge(this, i));
            }
        }
        return a2;
    }
    ...
    public void a(List<T> list, a aVar) {
        if (aVar != null && aVar.a(list, this.f31096a)) {
            this.b.clear();
        }
        a(list);
    }
