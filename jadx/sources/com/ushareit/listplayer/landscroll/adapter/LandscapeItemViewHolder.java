...
import com.lenovo.anyshare.C12459gWg;
import com.lenovo.anyshare.C13091hWg;
import com.lenovo.anyshare.ComponentCallbacks2C14013iw;
import com.lenovo.anyshare.View$OnClickListenerC11849fWg;
...
public class LandscapeItemViewHolder extends BaseRecyclerViewHolder<SZItem> {
    ...
    public ImageView f31741a;
    public TextView b;
    public LinearLayout c;
    public boolean d;

    public LandscapeItemViewHolder(ViewGroup viewGroup, ComponentCallbacks2C14013iw componentCallbacks2C14013iw) {
        super(viewGroup, (int) R.layout.axc, componentCallbacks2C14013iw);
        this.itemView.setTag(0);
        this.f31741a = (ImageView) this.itemView.findViewById(R.id.bc8);
        ...
        C13091hWg.a((ImageView) this.itemView.findViewById(R.id.anf), new View$OnClickListenerC11849fWg(this));
    }
    ...
    private void b(boolean z) {
        ...
        if (!z) {
            ...
            ofFloat.addListener(new C12459gWg(this));
    ...
    public void onBindViewHolder(SZItem sZItem) {
        ...
        this.mRequestManager.load(((C11495erf) sZItem.getContentItem()).m).e(R.color.v9).a(this.f31741a);
