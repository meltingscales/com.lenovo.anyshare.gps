...
import com.lenovo.anyshare.PTi;
...
public class SwitchButton extends CompoundButton {
    ...
    private void a(AttributeSet attributeSet) {
        ...
        if (this.l) {
            this.f = ObjectAnimator.ofFloat(this, "process", 1.0f, 1.0f).setDuration(250L);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r10) {
        ...
        L9a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ushareit.siplayer.local.popmenu.view.SwitchButton.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void a(boolean z) {
        ...
        if (this.l) {
            if (z) {
                this.f.setFloatValues(this.i, 0.0f);
            } else {
                this.f.setFloatValues(this.i, 1.0f);
            }
        } else if (z) {
            this.f.setFloatValues(this.i, 1.0f);
        } else {
