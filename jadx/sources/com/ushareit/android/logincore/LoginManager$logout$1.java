...
@Jjk(c = "com.ushareit.android.logincore.LoginManager$logout$1", f = "LoginManager.kt", i = {0, 1, 1}, l = {95, 97}, m = "invokeSuspend", n = {"$this$launch", "$this$launch", "result"}, s = {"L$0", "L$0", "L$1"})
@Rek(bv = {1, 0, 3}, d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, k = 3, mv = {1, 4, 0})
/* loaded from: classes6.dex */
public final class LoginManager$logout$1 extends SuspendLambda implements InterfaceC19378rlk<CoroutineScope, InterfaceC20576tjk<? super Kfk>, Object> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Jjk(c = "com.ushareit.android.logincore.LoginManager$logout$1$1", f = "LoginManager.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    @Rek(bv = {1, 0, 3}, d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, k = 3, mv = {1, 4, 0})
    /* renamed from: com.ushareit.android.logincore.LoginManager$logout$1$1  reason: invalid class name */
    /* loaded from: classes6.dex */
    public static final class AnonymousClass1 extends SuspendLambda implements InterfaceC19378rlk<CoroutineScope, InterfaceC20576tjk<? super Kfk>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                ICallBack iCallBack = LoginManager$logout$1.this.$callBack;
                if (iCallBack != null) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LoginManager$logout$1(LoginManager loginManager, FragmentActivity fragmentActivity, ConcurrentHashMap concurrentHashMap, IStatsTracker iStatsTracker, ICallBack iCallBack, InterfaceC20576tjk interfaceC20576tjk) {
        super(2, interfaceC20576tjk);
    ...
    public final InterfaceC20576tjk<Kfk> create(Object obj, InterfaceC20576tjk<?> interfaceC20576tjk) {
        C11440emk.e(interfaceC20576tjk, "completion");
        LoginManager$logout$1 loginManager$logout$1 = new LoginManager$logout$1(this.this$0, this.$activity, this.$params, this.$stats, this.$callBack, interfaceC20576tjk);
        loginManager$logout$1.p$ = (CoroutineScope) obj;
        return loginManager$logout$1;
    }

    @Override // com.lenovo.anyshare.InterfaceC19378rlk
    public final Object invoke(CoroutineScope coroutineScope, InterfaceC20576tjk<? super Kfk> interfaceC20576tjk) {
        return ((LoginManager$logout$1) create(coroutineScope, interfaceC20576tjk)).invokeSuspend(Kfk.f11108a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.L$2 = objectRef;
            this.label = 1;
            obj = enginesProxy.logout(fragmentActivity, concurrentHashMap, iStatsTracker, this);
            if (obj == a2) {
                return a2;
            }
        ...
        if (iCallBack != null) {
            iCallBack.onResultInIO((LoginResult) objectRef2.element);
        }
