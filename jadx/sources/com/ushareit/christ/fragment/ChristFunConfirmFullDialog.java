...
import com.lenovo.anyshare.C17090nye;
import com.lenovo.anyshare.C17701oye;
...
public class ChristFunConfirmFullDialog extends BaseStatusBarDialogFragment implements View.OnClickListener {
    ...
    private void Jb() {
        ...
        christFuncTwiceConfirmDialog.n = new C17090nye(this);
        ((BaseActionDialogFragment) christFuncTwiceConfirmDialog).mOnCancelListener = new C17701oye(this);
