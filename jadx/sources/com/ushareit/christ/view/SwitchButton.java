...
import com.lenovo.anyshare.C12213gAe;
import com.lenovo.anyshare.C12845hAe;
import com.lenovo.anyshare.C8555aAe;
...
public class SwitchButton extends CompoundButton {
    ...
    public static final float f31224a = 1.8f;
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new C12845hAe();

        /* renamed from: a  reason: collision with root package name */
        public CharSequence f31225a;
        public CharSequence b;

        public /* synthetic */ SavedState(Parcel parcel, C12213gAe c12213gAe) {
            this(parcel);
        }
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            TextUtils.writeToParcel(this.f31225a, parcel, i);
        ...
        public SavedState(Parcel parcel) {
            super(parcel);
            this.f31225a = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(parcel);
    ...
    private final class a implements Runnable {
        ...
        public /* synthetic */ a(SwitchButton switchButton, C12213gAe c12213gAe) {
            this();
        }
    }
    ...
    */
    public void onDraw(android.graphics.Canvas r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ushareit.christ.view.SwitchButton.onDraw(android.graphics.Canvas):void");
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        a(savedState.f31225a, savedState.b);
        this.ia = true;
    ...
    */
    ...
    public void setTintColor(int i) {
        this.r = i;
        this.k = C8555aAe.b(this.r);
        this.j = C8555aAe.a(this.r);
        this.K = false;
        this.J = false;
        refreshDrawableState();
        invalidate();
    ...
    private void a(AttributeSet attributeSet) {
        ...
        this.M.addUpdateListener(new C12213gAe(this));
        this.O = new RectF();
        float f13 = getResources().getDisplayMetrics().density * 2.0f;
        TypedArray obtainStyledAttributes2 = attributeSet == null ? null : getContext().obtainStyledAttributes(attributeSet, new int[]{R.attr.am, R.attr.an, R.attr.ao, R.attr.ap, R.attr.aq, R.attr.ar, R.attr.as, R.attr.at, R.attr.au, R.attr.av, R.attr.aw, R.attr.ax, R.attr.ay, R.attr.az, R.attr.b0, R.attr.b1, R.attr.b2, R.attr.b3, R.attr.b4, R.attr.b5, R.attr.b6, R.attr.b7});
