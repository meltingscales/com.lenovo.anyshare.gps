...
import com.lenovo.anyshare.C15670lhh;
import com.lenovo.anyshare.C16279mhh;
...
public class GalleryRoundFrameLayout extends FrameLayout {
    ...
    public GalleryRoundFrameLayout(Context context) {
        this(context, null);
    }
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        C16279mhh.a(this, onClickListener);
    }
    ...
    private void a(AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, new int[]{R.attr.a_v, R.attr.a_w, R.attr.a_x, R.attr.a_y, R.attr.a_z});
        this.f31811a = obtainStyledAttributes.getDimension(2, 0.0f);
    ...
    private void a() {
        ...
        if (this.i && Build.VERSION.SDK_INT >= 21) {
            if (this.f31811a != 0.0f) {
                setOutlineProvider(new C15670lhh(this));
