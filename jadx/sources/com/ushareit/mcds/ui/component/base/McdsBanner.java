...
public abstract class McdsBanner extends RelativeLayout implements InterfaceC8326_fh<McdsBanner, C19926sgh> {
    ...
    public McdsBanner(Context context) {
        super(context);
    ...
    @Override // com.lenovo.anyshare.InterfaceC8326_fh
    public InterfaceC10146cgh.d<McdsBanner> getComponentController() {
        return this.b;
    }
    ...
    @Override // com.lenovo.anyshare.InterfaceC10146cgh
    public void s() {
        InterfaceC10146cgh.d<McdsBanner> componentController;
    ...
    @Override // com.lenovo.anyshare.InterfaceC8326_fh
    public void setComponentController(InterfaceC10146cgh.d<McdsBanner> dVar) {
        this.b = dVar;
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public McdsBanner(Context context, AttributeSet attributeSet) {
    ...
    public McdsBanner a(int i) {
        ...
        d(inflate);
        a();
        setOnClickListener(new View$OnClickListenerC8927agh(this));
        return this;
    }

    @Override // com.lenovo.anyshare.InterfaceC10146cgh
    public McdsBanner b(View view) {
        if (view != null) {
            addView(view);
        }
        return this;
    ...
    @Override // com.lenovo.anyshare.InterfaceC8326_fh
    public C19926sgh getMData() {
        C19926sgh c19926sgh = this.c;
        if (c19926sgh != null) {
            return c19926sgh;
        }
        C11440emk.m("mData");
    ...
    public void setData(C19926sgh c19926sgh) {
        ...
        if (c19926sgh.f27645a.b() && TextUtils.isEmpty(c19926sgh.img)) {
    ...
    @Override // com.lenovo.anyshare.InterfaceC8326_fh
    public void setMData(C19926sgh c19926sgh) {
        C11440emk.f(c19926sgh, "<set-?>");
        this.c = c19926sgh;
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public McdsBanner(Context context, AttributeSet attributeSet, int i) {
    ...
    public void a(boolean z, String str) {
        ...
        c.b(mPageId, getMData().f27645a, str);
    }
}
