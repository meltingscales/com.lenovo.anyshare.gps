...
public abstract class McdsGallery extends RelativeLayout implements InterfaceC8326_fh<McdsGallery, C24202zgh> {
    ...
    public McdsGallery(Context context) {
        super(context);
    ...
    @Override // com.lenovo.anyshare.InterfaceC8326_fh
    public InterfaceC10146cgh.d<McdsGallery> getComponentController() {
        return this.b;
    }
    ...
    @Override // com.lenovo.anyshare.InterfaceC10146cgh
    public void s() {
        InterfaceC10146cgh.d<McdsGallery> componentController;
    ...
    @Override // com.lenovo.anyshare.InterfaceC8326_fh
    public void setComponentController(InterfaceC10146cgh.d<McdsGallery> dVar) {
        this.b = dVar;
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public McdsGallery(Context context, AttributeSet attributeSet) {
    ...
    public McdsGallery a(int i) {
        ...
        d(inflate);
        a();
        setOnClickListener(new View$OnClickListenerC11975fgh(this));
        return this;
    }

    @Override // com.lenovo.anyshare.InterfaceC10146cgh
    public McdsGallery b(View view) {
        if (view != null) {
            addView(view);
        }
        return this;
    ...
    @Override // com.lenovo.anyshare.InterfaceC8326_fh
    public C24202zgh getMData() {
        C24202zgh c24202zgh = this.c;
        if (c24202zgh != null) {
            return c24202zgh;
        }
        C11440emk.m("mData");
    ...
    @Override // com.lenovo.anyshare.InterfaceC8326_fh
    public void setData(C24202zgh c24202zgh) {
        C11440emk.f(c24202zgh, "data");
        setMData(c24202zgh);
    }

    @Override // com.lenovo.anyshare.InterfaceC8326_fh
    public void setMData(C24202zgh c24202zgh) {
        C11440emk.f(c24202zgh, "<set-?>");
        this.c = c24202zgh;
    }

    @Override // com.lenovo.anyshare.InterfaceC10146cgh
    public McdsGallery u() {
        return a(-1);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public McdsGallery(Context context, AttributeSet attributeSet, int i) {
    ...
    public void a(boolean z, String str) {
        if (z) {
            InterfaceC10709dch c = C11928fch.d.c();
            String mPageId = getMPageId();
            c.c(mPageId != null ? mPageId : "", getMData().f27645a, str);
            return;
        }
        InterfaceC10709dch c2 = C11928fch.d.c();
        String mPageId2 = getMPageId();
        c2.b(mPageId2 != null ? mPageId2 : "", getMData().f27645a, str);
    }
}
