...
import com.lenovo.anyshare.C4312Mfh;
import com.lenovo.anyshare.C4598Nfh;
import com.lenovo.anyshare.C4885Ofh;
import com.lenovo.anyshare.C5171Pfh;
...
public final class McdsIconNormal extends McdsIcon {
    ...
    private final void b() {
        ...
        if (inflate != null) {
            ...
            ((RatioByWidthLottieAnimationView) objectRef.element).setFailureListener(new C4885Ofh(this, objectRef));
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        C4312Mfh.a(this, onClickListener);
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public McdsIconNormal(Context context, AttributeSet attributeSet) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public McdsIconNormal(Context context, AttributeSet attributeSet, int i) {
