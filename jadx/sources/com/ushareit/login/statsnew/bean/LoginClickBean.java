...
public final class LoginClickBean extends LoginBaseBean implements Parcelable {
    ...
    public static class a implements Parcelable.Creator {
        ...
        public final Object createFromParcel(Parcel parcel) {
            ...
            return new LoginClickBean(parcel.readString(), parcel.readString(), (ELoginType) Enum.valueOf(ELoginType.class, parcel.readString()), (EModeType) Enum.valueOf(EModeType.class, parcel.readString()), parcel.readString(), parcel.readString());
        }
    ...
    public static /* synthetic */ LoginClickBean a(LoginClickBean loginClickBean, String str, String str2, ELoginType eLoginType, EModeType eModeType, String str3, String str4, int i, Object obj) {
        if ((i & 1) != 0) {
            str = loginClickBean.a();
        }
        if ((i & 2) != 0) {
            str2 = loginClickBean.c();
        }
        String str5 = str2;
        if ((i & 4) != 0) {
            eLoginType = loginClickBean.e();
        }
        ...
        if ((i & 16) != 0) {
            str3 = loginClickBean.d();
        }
        String str6 = str3;
        if ((i & 32) != 0) {
            str4 = loginClickBean.k;
        }
        return loginClickBean.a(str, str5, eLoginType2, eModeType2, str6, str4);
    }

    public final LoginClickBean a(String str, String str2, ELoginType eLoginType, EModeType eModeType, String str3, String str4) {
        C11440emk.e(str, ZZg.f17627a);
        C11440emk.e(str2, "portal");
        C11440emk.e(eLoginType, "type");
        C11440emk.e(eModeType, DBi.l);
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof LoginClickBean) {
                ...
                return C11440emk.a((Object) a(), (Object) loginClickBean.a()) && C11440emk.a((Object) c(), (Object) loginClickBean.c()) && C11440emk.a(e(), loginClickBean.e()) && C11440emk.a(b(), loginClickBean.b()) && C11440emk.a((Object) d(), (Object) loginClickBean.d()) && C11440emk.a((Object) this.k, (Object) loginClickBean.k);
            }
            return false;
        }
        return true;
    ...
    public final StatsParam k() {
        StatsParam.a b = new StatsParam.a().a(true).b("Login_Click");
    ...
    public String toString() {
        return "LoginClickBean(biz_id=" + a() + ", portal=" + c() + ", type=" + e() + ", mode=" + b() + ", session_id=" + d() + ", data=" + this.k + ")";
    }
