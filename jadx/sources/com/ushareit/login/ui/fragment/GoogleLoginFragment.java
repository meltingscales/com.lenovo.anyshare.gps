...
public class GoogleLoginFragment extends BaseFragment implements IXg.k {
    ...
    public void initView(View view) {
        if (view != null) {
            this.f31763a = view.findViewById(R.id.sf);
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        ((IXg.l) getPresenter()).onActivityResult(i, i2, intent);
    }
    ...
    public IXg.l onPresenterCreate() {
        return new FYg(this, null, new C11882fZg(getActivity()));
    }
}
