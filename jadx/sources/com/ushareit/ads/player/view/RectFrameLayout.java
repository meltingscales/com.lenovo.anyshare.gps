...
import com.lenovo.anyshare.C14743kGd;
...
public class RectFrameLayout extends FrameLayout {
    ...
    private void a(AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, new int[]{R.attr.a_u});
        if (obtainStyledAttributes != null) {
            this.f30974a = obtainStyledAttributes.getFloat(0, 0.5235602f);
    ...
    public void onMeasure(int i, int i2) {
        if (this.f30974a <= 0.0f) {
            super.onMeasure(i, i2);
            return;
        }
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824);
        int makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec((int) (View.MeasureSpec.getSize(i) * this.f30974a), 1073741824);
        ...
        setMeasuredDimension(resolveSize, (int) (resolveSize * this.f30974a));
    }

    @Override // android.view.View
    public void setOnClickListener(View.OnClickListener onClickListener) {
        C14743kGd.a(this, onClickListener);
    }
