...
import com.lenovo.anyshare.C20429tYd;
import com.ushareit.muslim.location.SearchActivity;

/* loaded from: classes6.dex */
public class AdsHException extends Exception {
    public int code;
    public int detailCode;

    public AdsHException(int i) {
        this(i, toMessage(i));
    }
                                                                    ...
                                                                    default:
                                                                        switch (i) {
                                                                            ...
                                                                            case 9008:
                                                                                return "timeout";
                                                                            case 9019:
                                                                                return "Need " + C20429tYd.f27116a + " by GooglePlay, it's invalid now";
                                                                            case 9300:
    ...
    public String toString() {
        return "AdsHException[" + this.code + ": " + getMessage() + ']';
    }
    ...
    */
    public AdsHException(int r4, int r5) {
        /*
            r3 = this;
        ...
        L22:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ushareit.ads.base.AdsHException.<init>(int, int):void");
    }

    public AdsHException(int i, String str) {
        super(str);
        this.code = i;
        this.detailCode = -1;
    }

    public AdsHException(int i, String str, int i2) {
        super(str);
        this.code = i;
        this.detailCode = i2;
    }

    public AdsHException(int i, String str, Throwable th) {
        super(str, th);
        this.code = i;
        this.detailCode = -1;
    }

    public AdsHException(int i, Throwable th) {
        super(th);
        this.code = i;
        this.detailCode = -1;
    }
