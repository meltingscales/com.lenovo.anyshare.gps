...
import com.lenovo.anyshare.C14191jLf;
...
import com.lenovo.anyshare.View$OnClickListenerC13580iLf;
...
public class StatusItemHolder extends BaseRecyclerViewHolder<AbstractC23099xqf> implements InterfaceC5032Ota {

    /* renamed from: a  reason: collision with root package name */
    public ImageView f31475a;
    public ImageView b;
    public TextView c;
    public ImageView d;
    ...
    private void b(View view) {
        this.f31475a = (ImageView) view.findViewById(R.id.doh);
    ...
    public void onBindViewHolder(AbstractC23099xqf abstractC23099xqf) {
        ...
        this.mRequestManager.load(abstractC23099xqf.j).d(getContext().getResources().getDrawable(R.color.a1f)).a(this.f31475a);
        ...
        if (abstractC23099xqf.getBooleanExtra(C19984slf.f, false)) {
            ...
            C14191jLf.a(this.b, new View$OnClickListenerC13580iLf(this));
        }
        C17546olf.a(this);
    }
}
