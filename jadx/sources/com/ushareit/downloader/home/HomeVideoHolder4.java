...
public final class HomeVideoHolder4 extends BaseHomeVideoDownloaderHolder {
    ...
    public HomeVideoHolder4(View view, List<? extends SZCard> list) {
        super(view, BaseHomeVideoDownloaderHolder.a(view, (int) R.layout.a71), "homedownloader_videoguide_4", list);
    ...
    public int[] A() {
        return new int[]{R.id.e3b, R.id.e3c, R.id.e3d, R.id.e3e};
    }
