...
@Rek(bv = {1, 0, 3}, d1 = {"\u0000Z\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010%\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\t\u0018\u0000 *2\u00020\u0001:\u0001*B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0015\u001a\u00020\u0016H\u0002J\b\u0010\u0017\u001a\u00020\u0004H\u0014J\b\u0010\u0018\u001a\u00020\u0016H\u0002J\b\u0010\u0019\u001a\u00020\u0016H\u0016J\u001a\u0010\u001a\u001a\u00020\u00162\u0006\u0010\u001b\u001a\u00020\u000e2\b\u0010\u001c\u001a\u0004\u0018\u00010\u001dH\u0016J\u0010\u0010\u001e\u001a\u00020\u00162\u0006\u0010\u001f\u001a\u00020\u0014H\u0002J\u000e\u0010 \u001a\u00020\u00162\u0006\u0010!\u001a\u00020\"J\"\u0010#\u001a\u00020\u00162\u0006\u0010\u001f\u001a\u00020\u00142\u0006\u0010$\u001a\u00020\u00142\b\b\u0001\u0010%\u001a\u00020\u0004H\u0002J \u0010#\u001a\u00020\u00162\u0006\u0010&\u001a\u00020\u00142\u0006\u0010'\u001a\u00020\u00142\u0006\u0010(\u001a\u00020\u0014H\u0002J\b\u0010)\u001a\u00020\u0016H\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0006X\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0007\u001a\u0004\u0018\u00010\bX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\t\u001a\u0004\u0018\u00010\nX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u000b\u001a\u0004\u0018\u00010\fX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\r\u001a\u0004\u0018\u00010\u000eX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u000f\u001a\u0004\u0018\u00010\nX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0010\u001a\u0004\u0018\u00010\u0011X\u0082\u000e¢\u0006\u0002\n\u0000R\u001a\u0010\u0012\u001a\u000e\u0012\u0004\u0012\u00020\u0014\u0012\u0004\u0012\u00020\u00140\u0013X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006+"}, d2 = {"Lcom/ushareit/downloader/videobrowser/WebSplashToponAdFragment;", "Lcom/ushareit/base/fragment/BaseFragment;", "()V", "mCountDownTime", "", "mCountDownTimer", "Landroid/os/CountDownTimer;", "mLoadingIv", "Landroid/widget/ImageView;", "mLoadingTv", "Landroid/widget/TextView;", "mProgressBar", "Landroid/widget/ProgressBar;", "mSkipTimeWholeView", "Landroid/view/View;", "mTimecountTv", "mWebSplashAdView", "Lcom/ushareit/downloader/videobrowser/utils/WebSplashToponAdView;", "webSiteMap", "", "", "cancelTimer", "", "getContentViewLayout", "initLoading", "onDestroyView", "onViewCreated", com.anythink.expressad.a.C, "savedInstanceState", "Landroid/os/Bundle;", "parseArguments", "template", "renderAd", "adWrapper", "Lcom/ushareit/ads/base/AdWrapper;", "setLoadingTv", "name", "resId", "portal", "url", "strPrefix", "startTimer", "Companion", "ModuleResDownloader_release"}, k = 1, mv = {1, 4, 0})
/* loaded from: classes7.dex */
public final class WebSplashToponAdFragment extends BaseFragment {
    ...
    public WebSplashToponAdFragment() {
    ...
    private final void Eb() {
        ...
        this.i = new CCf(this, this.h, 50L);
        CountDownTimer countDownTimer = this.i;
        if (countDownTimer != null) {
            ((CCf) countDownTimer).start();
        }
    }
    ...
    public void onViewCreated$___twin___(View view, Bundle bundle) {
        ...
        this.g = (WebSplashToponAdView) view.findViewById(R.id.e6_);
        ...
        if (findViewById != null) {
            ACf.a(findViewById, new BCf(this));
            Kfk kfk = Kfk.f11108a;
        } else {
            findViewById = null;
        }
    ...
    private final void x(String str) {
        ...
        if (arguments != null) {
            try {
                ...
                C11440emk.d(string, "getString(WebSplashAdFragment.K_PORTAL) ?: \"\"");
                String string2 = arguments.getString("url");
                String str2 = string2 != null ? string2 : "";
                C11440emk.d(str2, "getString(WebSplashAdFragment.K_URL) ?: \"\"");
                c(string, str2, str);
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public final void a(C1313Bwd c1313Bwd) {
        ...
        Boolean valueOf = webSplashToponAdView2 != null ? Boolean.valueOf(webSplashToponAdView2.a(c1313Bwd, C8613aFf.b.c())) : null;
