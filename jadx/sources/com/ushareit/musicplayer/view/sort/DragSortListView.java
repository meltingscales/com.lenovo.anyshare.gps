...
import com.lenovo.anyshare.C10399dBh;
import com.lenovo.anyshare.C6040Sge;
import com.lenovo.anyshare.C8570aBh;
import com.lenovo.anyshare.C9180bBh;
import com.lenovo.anyshare.C9790cBh;
...
public class DragSortListView extends ListView {
    ...
    public class a extends BaseAdapter {
        ...
        /* renamed from: a  reason: collision with root package name */
        public ListAdapter f31885a;

        public a(ListAdapter listAdapter) {
            this.f31885a = listAdapter;
            this.f31885a.registerDataSetObserver(new C9790cBh(this, DragSortListView.this));
        }

        @Override // android.widget.BaseAdapter, android.widget.ListAdapter
        public boolean areAllItemsEnabled() {
            return this.f31885a.areAllItemsEnabled();
        }

        @Override // android.widget.Adapter
        public int getCount() {
            return this.f31885a.getCount();
        }

        @Override // android.widget.Adapter
        public Object getItem(int i) {
            return this.f31885a.getItem(i);
        }

        @Override // android.widget.Adapter
        public long getItemId(int i) {
            return this.f31885a.getItemId(i);
        }

        @Override // android.widget.BaseAdapter, android.widget.Adapter
        public int getItemViewType(int i) {
            return this.f31885a.getItemViewType(i);
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view != null) {
                ...
                view2 = this.f31885a.getView(i, childAt, DragSortListView.this);
                if (view2 != childAt) {
                    if (childAt != null) {
                ...
                view2 = this.f31885a.getView(i, null, DragSortListView.this);
        ...
        public int getViewTypeCount() {
            return this.f31885a.getViewTypeCount();
        }

        @Override // android.widget.BaseAdapter, android.widget.Adapter
        public boolean hasStableIds() {
            return this.f31885a.hasStableIds();
        }

        @Override // android.widget.BaseAdapter, android.widget.Adapter
        public boolean isEmpty() {
            return this.f31885a.isEmpty();
        }

        @Override // android.widget.BaseAdapter, android.widget.ListAdapter
        public boolean isEnabled(int i) {
            return this.f31885a.isEnabled(i);
        }
    }
    ...
    public class f {
        ...
        /* renamed from: a  reason: collision with root package name */
        public StringBuilder f31887a = new StringBuilder();
        public int c = 0;
        public int d = 0;
        ...
        public void a() {
            if (this.e) {
                this.f31887a.append("<DSLVState>\n");
                int childCount = DragSortListView.this.getChildCount();
                int firstVisiblePosition = DragSortListView.this.getFirstVisiblePosition();
                this.f31887a.append("    <Positions>");
                for (int i = 0; i < childCount; i++) {
                    StringBuilder sb = this.f31887a;
                    sb.append(firstVisiblePosition + i);
                    sb.append(",");
                }
                this.f31887a.append("</Positions>\n");
                this.f31887a.append("    <Tops>");
                for (int i2 = 0; i2 < childCount; i2++) {
                    StringBuilder sb2 = this.f31887a;
                    sb2.append(DragSortListView.this.getChildAt(i2).getTop());
                    sb2.append(",");
                }
                this.f31887a.append("</Tops>\n");
                this.f31887a.append("    <Bottoms>");
                for (int i3 = 0; i3 < childCount; i3++) {
                    StringBuilder sb3 = this.f31887a;
                    sb3.append(DragSortListView.this.getChildAt(i3).getBottom());
                    sb3.append(",");
                }
                this.f31887a.append("</Bottoms>\n");
                StringBuilder sb4 = this.f31887a;
                sb4.append("    <FirstExpPos>");
                sb4.append(DragSortListView.this.j);
                sb4.append("</FirstExpPos>\n");
                StringBuilder sb5 = this.f31887a;
                ...
                sb5.append("</FirstExpBlankHeight>\n");
                StringBuilder sb6 = this.f31887a;
                sb6.append("    <SecondExpPos>");
                sb6.append(DragSortListView.this.k);
                sb6.append("</SecondExpPos>\n");
                StringBuilder sb7 = this.f31887a;
                ...
                sb7.append("</SecondExpBlankHeight>\n");
                StringBuilder sb8 = this.f31887a;
                sb8.append("    <SrcPos>");
                sb8.append(DragSortListView.this.m);
                sb8.append("</SrcPos>\n");
                StringBuilder sb9 = this.f31887a;
                sb9.append("    <SrcHeight>");
                sb9.append(DragSortListView.this.x + DragSortListView.this.getDividerHeight());
                sb9.append("</SrcHeight>\n");
                StringBuilder sb10 = this.f31887a;
                sb10.append("    <ViewHeight>");
                sb10.append(DragSortListView.this.getHeight());
                sb10.append("</ViewHeight>\n");
                StringBuilder sb11 = this.f31887a;
                sb11.append("    <LastY>");
                sb11.append(DragSortListView.this.P);
                sb11.append("</LastY>\n");
                StringBuilder sb12 = this.f31887a;
                sb12.append("    <FloatY>");
                sb12.append(DragSortListView.this.d);
                sb12.append("</FloatY>\n");
                this.f31887a.append("    <ShuffleEdges>");
                for (int i4 = 0; i4 < childCount; i4++) {
                    StringBuilder sb13 = this.f31887a;
        ...
        public void b() {
            ...
            if (this.e) {
                ...
                try {
                    fileWriter.write(this.f31887a.toString());
                    this.f31887a.delete(0, this.f31887a.length());
                    fileWriter.flush();
                    this.d++;
        ...
        public void c() {
            this.f31887a.append("<DSLVStates>\n");
            this.d = 0;
            this.e = true;
        }
    ...
    public class n implements Runnable {
        ...
        public void c() {
            this.f31889a = SystemClock.uptimeMillis();
            this.h = false;
            a();
            DragSortListView.this.post(this);
        }
        ...
        public void run() {
            ...
            float uptimeMillis = ((float) (SystemClock.uptimeMillis() - this.f31889a)) / this.b;
    ...
    public DragSortListView(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            if (obtainStyledAttributes.getBoolean(18, true)) {
                ...
                ZAh zAh = new ZAh(this, resourceId, i6, i5, resourceId3, resourceId2);
                zAh.h = z;
                zAh.f = z2;
                zAh.c = color;
                this.U = zAh;
                setOnTouchListener(zAh);
            }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        View view = this.f31884a;
        if (view != null) {
            int width = view.getWidth();
            int height = this.f31884a.getHeight();
            int i4 = this.b.x;
            int width2 = getWidth();
            if (i4 < 0) {
                i4 = -i4;
    ...
    public void layoutChildren() {
        ...
        if (view != null) {
            ...
            View view2 = this.f31884a;
            view2.layout(0, 0, view2.getMeasuredWidth(), this.f31884a.getMeasuredHeight());
            this.e = false;
        }
    }
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        C10399dBh.a(this, onClickListener);
    }
    ...
    public class k extends n {
        ...
        @Override // com.ushareit.musicplayer.view.sort.DragSortListView.n
        public void a() {
    ...
    */
    public int e(int r8, int r9) {
        ...
        L6d:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ushareit.musicplayer.view.sort.DragSortListView.e(int, int):int");
    }
    ...
    private void j() {
        ...
        if (view != null) {
            a(view);
            this.x = this.f31884a.getMeasuredHeight();
            this.y = this.x / 2;
        }
    }
    ...
    private void l() {
        ...
        if (this.U != null) {
            ...
            this.U.a(this.f31884a, this.b, this.c);
        }
        Point point = this.b;
        int i4 = point.x;
        int i5 = point.y;
    ...
    public class j {
        ...
        /* renamed from: a  reason: collision with root package name */
        public SparseIntArray f31888a;
        public ArrayList<Integer> b;
        public int c;

        public j(int i) {
            this.f31888a = new SparseIntArray(i);
            this.b = new ArrayList<>(i);
            this.c = i;
        }

        public void a(int i, int i2) {
            int i3 = this.f31888a.get(i, -1);
            if (i3 != i2) {
                if (i3 == -1) {
                    if (this.f31888a.size() == this.c) {
                        this.f31888a.delete(this.b.remove(0).intValue());
                    }
                } else {
                    this.b.remove(Integer.valueOf(i));
                }
                this.f31888a.put(i, i2);
                this.b.add(Integer.valueOf(i));
            }
        }

        public int a(int i) {
            return this.f31888a.get(i, -1);
        }
    ...
    public class l extends n {
        ...
        public void a(float f, float f2) {
            ...
            if (DragSortListView.this.la) {
                float uptimeMillis = ((float) (SystemClock.uptimeMillis() - this.f31889a)) / 1000.0f;
    ...
    public void a(int i2, View view, boolean z) {
        ...
        int i4 = 0;
        if (i2 == this.m && this.f31884a != null) {
            i4 = 4;
        }
        if (i4 != visibility) {
    ...
    public boolean a(int i2, View view, int i3, int i4, int i5) {
        if (this.v == 0 && this.T && this.f31884a == null && view != null && this.u) {
            if (getParent() != null) {
    ...
    */
    public static int a(android.util.SparseBooleanArray r2, int r3, int r4) {
        ...
        L23:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ushareit.musicplayer.view.sort.DragSortListView.a(android.util.SparseBooleanArray, int, int):int");
    }
