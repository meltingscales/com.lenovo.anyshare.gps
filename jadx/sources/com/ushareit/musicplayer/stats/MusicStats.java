...
public class MusicStats {
    ...
    public static String f31876a = "no policy";
    ...
    public static void b(a aVar) {
        ...
        try {
            if (aVar.b == MusicType.ONLINE) {
                ...
                linkedHashMap.put("portal", a(aVar.f31877a));
                ...
                linkedHashMap.put("app_policy", f31876a);
                ...
                if (aVar.r != null && (videoService = OnlineServiceManager.getVideoService()) != null) {
                    videoService.statsPlayEvent(new C21538vOa(aVar.q, aVar.c(), aVar.b(), null, aVar.r.p, aVar.r.q, aVar.r.z, System.currentTimeMillis(), 0L, null, aVar.f31877a, null, null, 0L, aVar.o, -1, null));
                }
            } else if (aVar.b == MusicType.SHARE_ZONE) {
                LinkedHashMap linkedHashMap2 = new LinkedHashMap();
                linkedHashMap2.put("portal", a(aVar.f31877a));
                ...
                linkedHashMap3.put("portal", a(aVar.f31877a));
                ...
                linkedHashMap3.put("app_policy", f31876a);
                String c = C5786Rje.c(C5786Rje.d(aVar.o));
                linkedHashMap3.put("file_ext", !C13263hke.c(c) ? c.toLowerCase(Locale.US) : null);
                linkedHashMap3.put("path", ZMa.a(aVar.o));
