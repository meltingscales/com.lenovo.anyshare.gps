...
public class BannerWebPlayerContainer extends RelativeLayout {
    ...
    public int _lastVisibility;
    public UnityBannerSize _size;
    public Runnable _unsubscribeLayoutChange;
    public JSONObject _webPlayerEventSettings;
    public JSONObject _webPlayerSettings;
    public WebPlayerView _webPlayerView;
    public JSONObject _webSettings;
