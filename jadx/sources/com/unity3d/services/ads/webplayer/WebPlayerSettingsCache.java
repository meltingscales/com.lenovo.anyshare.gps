...
public class WebPlayerSettingsCache {
    ...
    public HashMap<String, JSONObject> _webSettings = new HashMap<>();
    public HashMap<String, JSONObject> _webPlayerSettings = new HashMap<>();
    public HashMap<String, JSONObject> _webPlayerEventSettings = new HashMap<>();
