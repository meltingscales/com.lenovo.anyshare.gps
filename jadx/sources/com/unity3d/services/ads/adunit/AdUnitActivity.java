...
public class AdUnitActivity extends Activity {
    ...
    public int _displayCutoutMode;
    public boolean _keepScreenOn;
    public ArrayList<Integer> _keyEventList;
    public AdUnitRelativeLayout _layout;
    public int _systemUiVisibility;
    public Map<String, IAdUnitViewHandler> _viewHandlers;
    public String[] _views;
    public int _orientation = -1;
    public final IAdUnitViewHandlerFactory _adUnitViewHandlerFactory = new AdUnitViewHandlerFactory();
    ...
    public Map<String, Integer> getViewFrame(String str) {
        ...
        if (str.equals("adunit")) {
            ...
            hashMap.put(x.c, Integer.valueOf(layoutParams.leftMargin));
        ...
        if (view != null) {
            ...
            hashMap2.put(x.c, Integer.valueOf(layoutParams2.leftMargin));
