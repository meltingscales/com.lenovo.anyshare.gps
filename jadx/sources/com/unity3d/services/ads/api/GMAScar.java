...
public class GMAScar {
    public static final GMAScarAdapterBridge gmaScarAdapterBridge = GMA.getInstance().getBridge();

    public static String[] getPlacementList(JSONArray jSONArray) throws JSONException {
