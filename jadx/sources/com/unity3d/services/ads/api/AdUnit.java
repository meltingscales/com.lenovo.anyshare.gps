...
public class AdUnit {
    public static AdUnitActivity _adUnitActivity = null;
    public static int _currentActivityId = -1;
    ...
    public static ArrayList<Integer> getKeyEventList(JSONArray jSONArray) throws JSONException {
                ...
                for (int i2 = 0; i2 < events.size(); i2++) {
                    ...
                    for (int i3 = 0; i3 < sparseArray2.size(); i3++) {
                        ...
                        try {
                            ...
                            jSONObject4.put(x.c, adUnitMotionEvent.getX());
                            ...
                            jSONObject4.put(ATAdConst.NETWORK_REQUEST_PARAMS_KEY.BANNER_SIZE, adUnitMotionEvent.getSize());
    ...
    public static void getViewFrame(String str, WebViewCallback webViewCallback) {
        if (getAdUnitActivity() != null) {
            if (getAdUnitActivity().getViewFrame(str) != null) {
                ...
                webViewCallback.invoke(viewFrame.get(x.c), viewFrame.get("y"), viewFrame.get("width"), viewFrame.get("height"));
                return;
            }
