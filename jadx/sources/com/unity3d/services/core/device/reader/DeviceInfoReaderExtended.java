...
public class DeviceInfoReaderExtended implements IDeviceInfoReader {
    ...
    public Map<String, Object> getDeviceInfoData() {
        ...
        deviceInfoData.put(MetricsContainer.METRIC_CONTAINER_DEVICE_MODEL, Device.getModel());
        ...
        deviceInfoData.put(MetricsContainer.METRIC_CONTAINER_DEVICE_MAKE, Device.getManufacturer());
