...
public abstract class GenericBridge {
    public final Map<String, Class<?>[]> _functionAndParameters;
    public boolean _methodMapBuilt = false;
    public final String _className = getClassName();
    public final Map<String, Method> _methodMap = new HashMap();
    ...
    private Method getReflectiveMethod(Class<?> cls, String str, Class<?>... clsArr) {
        try {
            ...
            DeviceLog.debug("ERROR: Could not find method %s in %s", str, cls.getName() + C2051Ejc.f8464a + e.getLocalizedMessage());
