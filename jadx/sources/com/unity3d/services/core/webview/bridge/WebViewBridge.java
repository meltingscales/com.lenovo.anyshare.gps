...
public class WebViewBridge {
    public static HashMap<String, HashMap<String, HashMap<Integer, Method>>> _classTable;

    public static Method findMethod(String str, String str2, Object[] objArr) throws JSONException, NoSuchMethodException {
    ...
    public static Class<?>[] getTypes(Object[] objArr) throws JSONException {
        Class<?>[] clsArr;
        if (objArr == null) {
            clsArr = new Class[1];
        } else {
    ...
    public static Object[] getValues(Object[] objArr, WebViewCallback webViewCallback) throws JSONException {
        Object[] objArr2;
        if (objArr != null) {
