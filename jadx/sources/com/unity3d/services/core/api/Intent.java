...
public class Intent {
    public static WeakReference<Activity> _activeActivity;
    ...
    public static boolean checkIntentResolvable(android.content.Intent intent) {
        return ClientProperties.getApplicationContext().getPackageManager().resolveActivity(intent, 0) != null;
    }

    public static Activity getStartingActivity() {
    ...
    public static android.content.Intent intentFromMetadata(JSONObject jSONObject) throws IntentException {
        String str = (String) jSONObject.opt("className");
        String str2 = (String) jSONObject.opt(o.g);
        String str3 = (String) jSONObject.opt("action");
        String str4 = (String) jSONObject.opt(TM.ea);
        ...
        JSONArray jSONArray2 = (JSONArray) jSONObject.opt(YLi.d);
    ...
    public static boolean setCategories(android.content.Intent intent, JSONArray jSONArray) {
    ...
    public static boolean setExtra(android.content.Intent intent, String str, Object obj) {
    ...
    public static boolean setExtras(android.content.Intent intent, JSONArray jSONArray) {
        if (jSONArray != null) {
            for (int i = 0; i < jSONArray.length(); i++) {
                try {
