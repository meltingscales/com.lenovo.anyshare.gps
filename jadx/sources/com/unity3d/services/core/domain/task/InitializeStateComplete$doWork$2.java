...
@Jjk(c = "com.unity3d.services.core.domain.task.InitializeStateComplete$doWork$2", f = "InitializeStateComplete.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
...
public final class InitializeStateComplete$doWork$2 extends SuspendLambda implements InterfaceC19378rlk<CoroutineScope, InterfaceC20576tjk<? super Result<? extends Kfk>>, Object> {
    public final /* synthetic */ InitializeStateComplete.Params $params;
    public int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InitializeStateComplete$doWork$2(InitializeStateComplete.Params params, InterfaceC20576tjk interfaceC20576tjk) {
    ...
    public final InterfaceC20576tjk<Kfk> create(Object obj, InterfaceC20576tjk<?> interfaceC20576tjk) {
        ...
        return new InitializeStateComplete$doWork$2(this.$params, interfaceC20576tjk);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, InterfaceC20576tjk<? super Result<? extends Kfk>> interfaceC20576tjk) {
        return ((InitializeStateComplete$doWork$2) create(coroutineScope, interfaceC20576tjk)).invokeSuspend(Kfk.f11108a);
    }
            ...
            try {
                ...
                for (String str : this.$params.getConfig().getModuleConfigurationList()) {
                    ...
                    if (moduleConfiguration != null) {
                        Gjk.a(moduleConfiguration.initCompleteState(this.$params.getConfig()));
                    }
                }
                a2 = Kfk.f11108a;
