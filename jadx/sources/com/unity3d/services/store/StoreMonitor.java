...
public class StoreMonitor {
    ...
    public static StoreLifecycleListener _lifecycleListener;
    public static StoreBilling _storeBilling;
    public static StoreExceptionHandler _storeExceptionHandler;
    ...
    public static void initialize(StoreExceptionHandler storeExceptionHandler) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        ...
        _storeBilling = new StoreBilling(ClientProperties.getApplicationContext(), new IPurchaseUpdatedResponseListener() { // from class: com.unity3d.services.store.StoreMonitor.1
        ...
        _storeBilling.initialize(new IBillingClientStateListener() { // from class: com.unity3d.services.store.StoreMonitor.2
