...
public class UnityAnalytics {
    ...
    public static JSONObject createAdComplete(String str, String str2, Boolean bool) {
        HashMap hashMap = new HashMap();
        hashMap.put(AdFormat.REWARDED, bool);
    ...
    public static JSONObject createIapTransaction(String str, Float f, String str2, Boolean bool, String str3) {
        HashMap hashMap = new HashMap();
    ...
    public static JSONObject createItemAcquired(String str, Float f, String str2, Float f2, String str3, String str4, String str5, AcquisitionType acquisitionType) {
        HashMap hashMap = new HashMap();
    ...
    public static JSONObject createItemSpent(String str, Float f, String str2, Float f2, String str3, String str4, String str5, AcquisitionType acquisitionType) {
        HashMap hashMap = new HashMap();
        hashMap.put("currency_type", acquisitionType.toString());
        hashMap.put("transaction_context", str);
        hashMap.put("amount", f);
    ...
    public static JSONObject createLevelFail(String str) {
        HashMap hashMap = new HashMap();
    ...
    public static JSONObject createLevelUp(String str) {
        HashMap hashMap = new HashMap();
    ...
    public static synchronized void postEvent(JSONObject jSONObject) {
