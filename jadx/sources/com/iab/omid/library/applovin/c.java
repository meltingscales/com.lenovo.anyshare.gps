...
public class c {
    ...
    public static final Pattern f6244a = Pattern.compile("<(head)( [^>]*)?>", 2);
    ...
    public static String a(String str, String str2) {
        ...
        if (!b(str, sb, b, str2, a2) && !a(str, sb, f6244a, str2, a2) && !b(str, sb, d, str2, a2) && !a(str, sb, c, str2, a2) && !b(str, sb, f, str2, a2) && !a(str, sb, e, str2, a2) && !a(str, sb, g, str2, a2)) {
            return str2 + str;
        }
        return sb.toString();
    }
