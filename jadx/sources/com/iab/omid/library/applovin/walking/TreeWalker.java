...
public class TreeWalker implements a.InterfaceC0547a {
    ...
    public List<TreeWalkerTimeLogger> f6265a = new ArrayList();
    public boolean c = false;
    public final List<com.iab.omid.library.applovin.weakreference.a> d = new ArrayList();
    public com.iab.omid.library.applovin.walking.a f = new com.iab.omid.library.applovin.walking.a();
    public com.iab.omid.library.applovin.processor.b e = new com.iab.omid.library.applovin.processor.b();
    public com.iab.omid.library.applovin.walking.b g = new com.iab.omid.library.applovin.walking.b(new com.iab.omid.library.applovin.walking.async.c());
    ...
    private void a(long j2) {
        if (this.f6265a.size() > 0) {
            for (TreeWalkerTimeLogger treeWalkerTimeLogger : this.f6265a) {
    ...
    @Override // com.iab.omid.library.applovin.processor.a.InterfaceC0547a
    ...
    public void addTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f6265a.contains(treeWalkerTimeLogger)) {
            return;
        }
        this.f6265a.add(treeWalkerTimeLogger);
    }
    ...
    public void removeTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f6265a.contains(treeWalkerTimeLogger)) {
            this.f6265a.remove(treeWalkerTimeLogger);
        }
    }
}
