...
public class c {
    ...
    public static WindowManager f6304a;
    ...
    public static b a(JSONObject jSONObject) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            if (f6304a != null) {
                ...
                f6304a.getDefaultDisplay().getRealSize(point);
                f2 = a(point.x);
                f = a(point.y);
            }
            f = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f6304a = (WindowManager) context.getSystemService(VisionController.WINDOW);
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0552a c0552a) {
        com.iab.omid.library.bytedance2.internal.e a2 = c0552a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0552a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    public static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f6305a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        b a2 = a(jSONObject);
        try {
            jSONObject.put("width", a2.f6306a);
