...
public class b {
    ...
    public static String[] c = {x.c, "y", "width", "height"};

    /* renamed from: a  reason: collision with root package name */
    public static float f6332a = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void a(Context context) {
        if (context != null) {
            f6332a = context.getResources().getDisplayMetrics().density;
    ...
    public static void a(JSONObject jSONObject) {
        a b2 = b(jSONObject);
        try {
            jSONObject.put("width", b2.f6333a);
    ...
    public static void a(JSONObject jSONObject, a.C0555a c0555a) {
        com.iab.omid.library.corpmailru.b.c a2 = c0555a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0555a.b()) {
            jSONArray.put(str);
        }
        try {
