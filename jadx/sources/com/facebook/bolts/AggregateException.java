...
public final class AggregateException extends Exception {
    ...
    public AggregateException(String str, List<? extends Throwable> list) {
        ...
        List<Throwable> unmodifiableList = Collections.unmodifiableList(list == null ? C11990fhk.c() : list);
        C11440emk.d(unmodifiableList, "Collections.unmodifiable…hrowables ?: emptyList())");
        this.innerThrowables = unmodifiableList;
    }

    @Override // java.lang.Throwable
    public void printStackTrace(PrintStream printStream) {
        C11440emk.e(printStream, "err");
