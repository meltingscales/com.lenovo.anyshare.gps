    ...
    */
    public static com.google.api.client.auth.oauth2.TokenResponseException from(com.google.api.client.json.JsonFactory r6, com.google.api.client.http.HttpResponse r7) {
        /*
            ...
            r2 = 0
            boolean r3 = r7.isSuccessStatusCode()     // Catch: java.io.IOException -> L54
            if (r3 != 0) goto L4c
            if (r1 == 0) goto L4c
            java.io.InputStream r3 = r7.getContent()     // Catch: java.io.IOException -> L54
            if (r3 == 0) goto L4c
            java.lang.String r3 = "application/json; charset=UTF-8"
            boolean r1 = com.google.api.client.http.HttpMediaType.equalsIgnoreParameters(r3, r1)     // Catch: java.io.IOException -> L54
            if (r1 == 0) goto L4c
            com.google.api.client.json.JsonObjectParser r1 = new com.google.api.client.json.JsonObjectParser     // Catch: java.io.IOException -> L54
            r1.<init>(r6)     // Catch: java.io.IOException -> L54
            java.io.InputStream r6 = r7.getContent()     // Catch: java.io.IOException -> L54
            java.nio.charset.Charset r3 = r7.getContentCharset()     // Catch: java.io.IOException -> L54
            ...
            java.lang.Object r6 = r1.parseAndClose(r6, r3, r4)     // Catch: java.io.IOException -> L54
            com.google.api.client.auth.oauth2.TokenErrorResponse r6 = (com.google.api.client.auth.oauth2.TokenErrorResponse) r6     // Catch: java.io.IOException -> L54
            java.lang.String r1 = r6.toPrettyString()     // Catch: java.io.IOException -> L4a
            r2 = r1
            goto L59
        L4a:
            r1 = move-exception
            goto L56
        L4c:
            java.lang.String r6 = r7.parseAsString()     // Catch: java.io.IOException -> L54
            r5 = r2
            r2 = r6
            r6 = r5
            goto L59
