...
public final class DateTime implements Serializable {
    ...
    public static final Pattern RFC3339_PATTERN = Pattern.compile("(\\d{4})-(\\d{2})-(\\d{2})([Tt](\\d{2}):(\\d{2}):(\\d{2})(\\.\\d{1,9})?)?([Zz]|([+-])(\\d{2}):(\\d{2}))?");
    ...
    public static class Rfc3339ParseResult implements Serializable {
        ...
        public final boolean timeGiven;
        ...
        public Rfc3339ParseResult(long j, int i, boolean z, Integer num) {
            this.seconds = j;
            this.nanos = i;
            this.timeGiven = z;
            this.tzShift = num;
    ...
    public static final class SecondsAndNanos implements Serializable {
        ...
        public SecondsAndNanos(long j, int i) {
            this.seconds = j;
            this.nanos = i;
        }
    }
    ...
    public DateTime(Date date, TimeZone timeZone) {
        this(false, date.getTime(), timeZone == null ? null : Integer.valueOf(timeZone.getOffset(date.getTime()) / f.b));
    }

    public static void appendInt(StringBuilder sb, int i, int i2) {
        if (i < 0) {
            sb.append('-');
            i = -i;
        }
    ...
    public static Rfc3339ParseResult parseRfc3339WithNanoSeconds(String str) throws NumberFormatException {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        if (matcher.matches()) {
            ...
            if (z) {
                ...
                if (matcher.group(8) != null) {
                    i4 = Integer.parseInt(com.google.common.base.Strings.padEnd(matcher.group(8).substring(1), 9, BCc.f6785a));
                    i2 = parseInt5;
                    i3 = parseInt6;
                } else {
                    i2 = parseInt5;
    ...
    public DateTime(boolean z, long j, Integer num) {
        ...
        if (z) {
            ...
            offset = num == null ? TimeZone.getDefault().getOffset(j) / f.b : num.intValue();
        }
        this.tzShift = offset;
    }
