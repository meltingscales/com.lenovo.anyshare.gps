...
public abstract class zzak<T extends zzam> {
    public static Logger zza = new Logger("BiChannelGoogleApi", "FirebaseAuth: ");
    public zzan<T> zzb;
    ...
    public final <ResultT, A extends Api.AnyClient> Task<ResultT> zza(zzar<A, ResultT> zzarVar) {
        GoogleApi<T> zza2 = zza(zzarVar.zza());
        if (zza2 == null) {
            return zzb();
        }
        ...
        return (Task<ResultT>) zza2.doRead((TaskApiCall<A, ResultT>) zzarVar.zzb());
    }
    ...
    public final <ResultT, A extends Api.AnyClient> Task<ResultT> zzb(zzar<A, ResultT> zzarVar) {
        ...
        return (Task<ResultT>) zza2.doWrite((TaskApiCall<A, ResultT>) zzarVar.zzb());
    }
    ...
    public static <ResultT> Task<ResultT> zzb() {
        return Tasks.forException(zzdx.zza(new Status(17499, "Unable to connect to GoogleApi instance - Google Play Services may be unavailable")));
    }
}
