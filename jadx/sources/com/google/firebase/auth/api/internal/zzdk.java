...
public final class zzdk extends zzet<Void, com.google.firebase.auth.internal.zzb> {
    public final UserProfileChangeRequest zza;

    public zzdk(UserProfileChangeRequest userProfileChangeRequest) {
        super(2);
    ...
    public final /* synthetic */ void zza(zzdv zzdvVar, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ...
        if (this.zzu) {
            ...
            zzdvVar.zza().zza(new com.google.android.gms.internal.firebase_auth.zzdy(this.zza, this.zze.zzf()), this.zzc);
        }
    }
