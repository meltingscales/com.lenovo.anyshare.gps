...
public final class zzdx {
    public static final SparseArray<Pair<String, String>> zza;
    ...
    static {
        ...
        zza.put(17093, new Pair<>("MISSING_CLIENT_IDENTIFIER", "This request is missing a reCAPTCHA token."));
    }
    ...
    */
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.auth.api.internal.zzdx.zza(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }
    ...
    public static com.google.firebase.auth.zzs zza(FirebaseAuth firebaseAuth, com.google.android.gms.internal.firebase_auth.zzee zzeeVar, FirebaseUser firebaseUser) {
        com.google.android.gms.internal.firebase_auth.zzao.zza(firebaseAuth);
        com.google.android.gms.internal.firebase_auth.zzao.zza(zzeeVar);
        Pair<String, String> pair = zza.get(17078);
        return new com.google.firebase.auth.zzs((String) pair.first, (String) pair.second, com.google.firebase.auth.internal.zzs.zza(zzeeVar, firebaseAuth, firebaseUser));
    }

    public static String zza(String str, Status status) {
