...
public class ComponentDiscoveryService extends Service {
    ...
    public class _lancet {
        ...
        public static ComponentName com_lenovo_anyshare_hyperboost_scene_HyperBoostSceneAop_actStartForegroundService(ComponentDiscoveryService componentDiscoveryService, Intent intent) {
            DEa.b();
            return componentDiscoveryService.startForegroundService$___twin___(intent);
        }
        ...
        public static SharedPreferences com_lotus_hook_SpLancet_getServiceSp(ComponentDiscoveryService componentDiscoveryService, String str, int i) {
            ...
            return (MSb.d(str) || (a2 = C10581dSb.d().a(componentDiscoveryService, str, i)) == null) ? componentDiscoveryService.getSharedPreferences$___twin___(str, i) : a2;
        }
    }
