...
public final class zzc {
    public static final Set zza = new HashSet(Arrays.asList("_in", "_xa", "_xu", "_aq", "_aa", "_ai", "_ac", VisionController.CAMPAIGN_DETAILS, "_ug", "_iapx", "_exp_set", "_exp_clear", "_exp_activate", "_exp_timeout", "_exp_expire"));
    public static final List zzb = Arrays.asList("_e", "_f", "_iap", "_s", "_au", "_ui", "_cd");
    public static final List zzc = Arrays.asList("auto", a.J, "am");
    public static final List zzd = Arrays.asList("_r", "_dbg");
    public static final List zze = Arrays.asList((String[]) ArrayUtils.concat(zzhh.zza, zzhh.zzb));
    public static final List zzf = Arrays.asList("^_ltv_[A-Z]{3}$", "^_cc[1-5]{1}$");
    ...
    public static AnalyticsConnector.ConditionalUserProperty zzb(Bundle bundle) {
        ...
        String str = (String) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.ORIGIN, String.class, null);
        Preconditions.checkNotNull(str);
        conditionalUserProperty.origin = str;
        String str2 = (String) zzhe.zza(bundle, "name", String.class, null);
        Preconditions.checkNotNull(str2);
        conditionalUserProperty.name = str2;
        conditionalUserProperty.value = zzhe.zza(bundle, "value", Object.class, null);
        conditionalUserProperty.triggerEventName = (String) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGER_EVENT_NAME, String.class, null);
        ...
        conditionalUserProperty.timedOutEventName = (String) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_NAME, String.class, null);
        conditionalUserProperty.timedOutEventParams = (Bundle) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_PARAMS, Bundle.class, null);
        conditionalUserProperty.triggeredEventName = (String) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_NAME, String.class, null);
        conditionalUserProperty.triggeredEventParams = (Bundle) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_PARAMS, Bundle.class, null);
        ...
        conditionalUserProperty.expiredEventName = (String) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_NAME, String.class, null);
        conditionalUserProperty.expiredEventParams = (Bundle) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_PARAMS, Bundle.class, null);
        conditionalUserProperty.active = ((Boolean) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.ACTIVE, Boolean.class, false)).booleanValue();
    ...
    public static boolean zzi(AnalyticsConnector.ConditionalUserProperty conditionalUserProperty) {
        ...
        Object obj = conditionalUserProperty.value;
        if ((obj == null || zzit.zza(obj) != null) && zzl(str) && zzm(str, conditionalUserProperty.name)) {
