...
public final class IntMath {
    ...
    public static final int[] powersOf10 = {1, 10, 100, 1000, 10000, h.o.u, 1000000, 10000000, 100000000, 1000000000};
    ...
    public static int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, 477, InterfaceC13225hhc.Jc, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    ...
    public static int ceilingPowerOfTwo(int i) {
        MathPreconditions.checkPositive(x.c, i);
        if (i <= 1073741824) {
    ...
    */
    ...
    public static int sqrt(int i, RoundingMode roundingMode) {
        int lessThanBranchFree;
        MathPreconditions.checkNonNegative(x.c, i);
    ...
    public static int sqrtFloor(int i) {
