...
public final class LongMath {
    ...
    public static final long[] powersOf10 = {1, 10, 100, 1000, n.f2525a, 100000, 1000000, 10000000, 100000000, 1000000000, 10000000000L, 100000000000L, 1000000000000L, 10000000000000L, 100000000000000L, C19575sCc.f, 10000000000000000L, 100000000000000000L, 1000000000000000000L};
    ...
    public static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, InterfaceC13225hhc.Wc, 169, 143, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    public static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, 419, a.aY, InterfaceC13225hhc.dd, 169, 139, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    public static long ceilingPowerOfTwo(long j) {
        MathPreconditions.checkPositive(x.c, j);
        if (j <= C1739Dhc.e) {
    ...
    public static long checkedPow(long j, int i) {
        ...
        if (!(j2 >= -2) || !(j2 <= 2)) {
            while (i2 != 0) {
                ...
                i2 >>= 1;
                if (i2 > 0) {
                    MathPreconditions.checkNoOverflow(-3037000499L <= j2 && j2 <= 3037000499L, "checkedPow", j2, i2);
                    j2 *= j2;
                }
            }
            return j3;
    ...
    */
    ...
    public static long sqrt(long j, RoundingMode roundingMode) {
        MathPreconditions.checkNonNegative(x.c, j);
        if (fitsInInt(j)) {
