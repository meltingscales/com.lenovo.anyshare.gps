...
public final class ClassPath {
    ...
    public static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.on(C2051Ejc.f8464a).omitEmptyStrings();
    ...
    public static final class ClassInfo extends ResourceInfo {
        ...
        public String getSimpleName() {
            ...
            if (lastIndexOf != -1) {
                return CharMatcher.inRange(BCc.f6785a, '9').trimLeadingFrom(this.className.substring(lastIndexOf + 1));
            }
    ...
    public static String getClassName(String str) {
        return str.substring(0, str.length() - 6).replace(C15259kyc.f, '.');
    }
    ...
    public static ImmutableSet<File> getClassPathFromManifest(File file, @InterfaceC18890qvk Manifest manifest) {
        if (manifest == null) {
