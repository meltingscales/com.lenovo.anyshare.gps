...
public final class Strings {
    ...
    public static boolean isNullOrEmpty(@InterfaceC18890qvk String str) {
        return Platform.stringIsNullOrEmpty(str);
    }

    public static String lenientFormat(@InterfaceC18890qvk String str, @InterfaceC18890qvk Object... objArr) {
        int indexOf;
    ...
    public static String lenientToString(@InterfaceC18890qvk Object obj) {
        if (obj == null) {
            return "null";
        }
        try {
            ...
            sb3.append(C9066asc.j);
            sb3.append(sb2);
            sb3.append(" threw ");
            sb3.append(name2);
            sb3.append(C7593Xrc.j);
            return sb3.toString();
        }
    }
