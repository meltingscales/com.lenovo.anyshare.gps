...
public final class ClosingFuture<V> {
    ...
    public static /* synthetic */ class AnonymousClass12 {
        public static final /* synthetic */ int[] $SwitchMap$com$google$common$util$concurrent$ClosingFuture$State = new int[State.values().length];
    ...
    public interface AsyncClosingFunction<T, U> {
        ClosingFuture<U> apply(DeferredCloser deferredCloser, @InterfaceC18890qvk T t) throws Exception;
    }
    ...
    public static final class CloseableList extends IdentityHashMap<Closeable, Executor> implements Closeable {
        ...
        public void add(@InterfaceC18890qvk Closeable closeable, Executor executor) {
    ...
    public interface ClosingFunction<T, U> {
        @InterfaceC18890qvk
        U apply(DeferredCloser deferredCloser, @InterfaceC18890qvk T t) throws Exception;
    }

    @DoNotMock("Use ClosingFuture.whenAllSucceed() or .whenAllComplete() instead.")
    /* loaded from: classes3.dex */
    public static class Combiner {
        public static final Function<ClosingFuture<?>, FluentFuture<?>> INNER_FUTURE = new Function<ClosingFuture<?>, FluentFuture<?>>() { // from class: com.google.common.util.concurrent.ClosingFuture.Combiner.3
    ...
    public static final class Combiner2<V1, V2> extends Combiner {
        ...
        public interface AsyncClosingFunction2<V1, V2, U> {
            ClosingFuture<U> apply(DeferredCloser deferredCloser, @InterfaceC18890qvk V1 v1, @InterfaceC18890qvk V2 v2) throws Exception;
        }

        /* loaded from: classes3.dex */
        public interface ClosingFunction2<V1, V2, U> {
            @InterfaceC18890qvk
            U apply(DeferredCloser deferredCloser, @InterfaceC18890qvk V1 v1, @InterfaceC18890qvk V2 v2) throws Exception;
        }
    ...
    public static final class Combiner3<V1, V2, V3> extends Combiner {
        ...
        public interface AsyncClosingFunction3<V1, V2, V3, U> {
            ClosingFuture<U> apply(DeferredCloser deferredCloser, @InterfaceC18890qvk V1 v1, @InterfaceC18890qvk V2 v2, @InterfaceC18890qvk V3 v3) throws Exception;
        }

        /* loaded from: classes3.dex */
        public interface ClosingFunction3<V1, V2, V3, U> {
            @InterfaceC18890qvk
            U apply(DeferredCloser deferredCloser, @InterfaceC18890qvk V1 v1, @InterfaceC18890qvk V2 v2, @InterfaceC18890qvk V3 v3) throws Exception;
        }
    ...
    public static final class Combiner4<V1, V2, V3, V4> extends Combiner {
        ...
        public interface AsyncClosingFunction4<V1, V2, V3, V4, U> {
            ClosingFuture<U> apply(DeferredCloser deferredCloser, @InterfaceC18890qvk V1 v1, @InterfaceC18890qvk V2 v2, @InterfaceC18890qvk V3 v3, @InterfaceC18890qvk V4 v4) throws Exception;
        }

        /* loaded from: classes3.dex */
        public interface ClosingFunction4<V1, V2, V3, V4, U> {
            @InterfaceC18890qvk
            U apply(DeferredCloser deferredCloser, @InterfaceC18890qvk V1 v1, @InterfaceC18890qvk V2 v2, @InterfaceC18890qvk V3 v3, @InterfaceC18890qvk V4 v4) throws Exception;
        }
    ...
    public static final class Combiner5<V1, V2, V3, V4, V5> extends Combiner {
        ...
        public interface AsyncClosingFunction5<V1, V2, V3, V4, V5, U> {
            ClosingFuture<U> apply(DeferredCloser deferredCloser, @InterfaceC18890qvk V1 v1, @InterfaceC18890qvk V2 v2, @InterfaceC18890qvk V3 v3, @InterfaceC18890qvk V4 v4, @InterfaceC18890qvk V5 v5) throws Exception;
        }

        /* loaded from: classes3.dex */
        public interface ClosingFunction5<V1, V2, V3, V4, V5, U> {
            @InterfaceC18890qvk
            U apply(DeferredCloser deferredCloser, @InterfaceC18890qvk V1 v1, @InterfaceC18890qvk V2 v2, @InterfaceC18890qvk V3 v3, @InterfaceC18890qvk V4 v4, @InterfaceC18890qvk V5 v5) throws Exception;
        }
    ...
    public static final class DeferredCloser {
        ...
        @InterfaceC18890qvk
        public <C extends Closeable> C eventuallyClose(@InterfaceC18890qvk C c, Executor executor) {
            Preconditions.checkNotNull(executor);
            if (c != null) {
    ...
    public static <C extends Closeable> ClosingFuture<C> eventuallyClosing(ListenableFuture<C> listenableFuture, final Executor executor) {
        ...
        Futures.addCallback(listenableFuture, new FutureCallback<Closeable>() { // from class: com.google.common.util.concurrent.ClosingFuture.1
            ...
            @Override // com.google.common.util.concurrent.FutureCallback
            public void onSuccess(@InterfaceC18890qvk Closeable closeable) {
