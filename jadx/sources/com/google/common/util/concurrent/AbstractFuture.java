...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    public static final class Cancellation {
        ...
        public Cancellation(boolean z, @InterfaceC18890qvk Throwable th) {
    ...
    public static CancellationException cancellationExceptionWithCause(@InterfaceC18890qvk String str, @InterfaceC18890qvk Throwable th) {
        ...
        if (!Thread.interrupted()) {
            ...
            if (nanos + 1000 < 0) {
                ...
                if (convert > 0) {
                    ...
                    concat = String.valueOf(sb4).concat(C2051Ejc.f8464a);
                }
                if (z) {
    ...
    public final void maybePropagateCancellationTo(@InterfaceC18890qvk Future<?> future) {
