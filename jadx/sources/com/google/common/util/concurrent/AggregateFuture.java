...
public abstract class AggregateFuture<InputT, OutputT> extends AggregateFutureState<OutputT> {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void decrementCountAndMaybeComplete(@InterfaceC18890qvk ImmutableCollection<? extends Future<? extends InputT>> immutableCollection) {
    ...
    private void processCompleted(@InterfaceC18890qvk ImmutableCollection<? extends Future<? extends InputT>> immutableCollection) {
    ...
    public abstract void collectOneValue(int i, @InterfaceC18890qvk InputT inputt);
