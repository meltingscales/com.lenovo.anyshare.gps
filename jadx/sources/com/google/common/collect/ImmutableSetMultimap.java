...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    public ImmutableSetMultimap(ImmutableMap<K, ImmutableSet<V>> immutableMap, int i, @InterfaceC18890qvk Comparator<? super V> comparator) {
    ...
    public static <V> ImmutableSet<V> emptySet(@InterfaceC18890qvk Comparator<? super V> comparator) {
        if (comparator == null) {
    ...
    public static <K, V> ImmutableSetMultimap<K, V> fromMapEntries(Collection<? extends Map.Entry<? extends K, ? extends Collection<? extends V>>> collection, @InterfaceC18890qvk Comparator<? super V> comparator) {
    ...
    public static <V> ImmutableSet<V> valueSet(@InterfaceC18890qvk Comparator<? super V> comparator, Collection<? extends V> collection) {
        if (comparator == null) {
    ...
    public static <V> ImmutableSet.Builder<V> valuesBuilder(@InterfaceC18890qvk Comparator<? super V> comparator) {
        if (comparator == null) {
    ...
    public /* bridge */ /* synthetic */ ImmutableCollection get(@InterfaceC18890qvk Object obj) {
    ...
    @Override // com.google.common.collect.ImmutableMultimap, com.google.common.collect.Multimap
    public ImmutableSet<V> get(@InterfaceC18890qvk K k) {
