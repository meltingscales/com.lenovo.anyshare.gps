...
public final class Synchronized {
    ...
    private static class SynchronizedAsMap<K, V> extends SynchronizedMap<K, Collection<V>> {
        ...
        public SynchronizedAsMap(Map<K, Collection<V>> map, @InterfaceC18890qvk Object obj) {
            super(map, obj);
        }
    ...
    public static class SynchronizedAsMapValues<V> extends SynchronizedCollection<Collection<V>> {
        public SynchronizedAsMapValues(Collection<Collection<V>> collection, @InterfaceC18890qvk Object obj) {
    ...
    public static class SynchronizedBiMap<K, V> extends SynchronizedMap<K, V> implements BiMap<K, V>, Serializable {
        ...
        public SynchronizedBiMap(BiMap<K, V> biMap, @InterfaceC18890qvk Object obj, @InterfaceC18890qvk BiMap<V, K> biMap2) {
            super(biMap, obj);
            this.inverse = biMap2;
        }
    ...
    public static class SynchronizedCollection<E> extends SynchronizedObject implements Collection<E> {
        ...
        public SynchronizedCollection(Collection<E> collection, @InterfaceC18890qvk Object obj) {
            super(collection, obj);
        }
    ...
    public static class SynchronizedEntry<K, V> extends SynchronizedObject implements Map.Entry<K, V> {
        public SynchronizedEntry(Map.Entry<K, V> entry, @InterfaceC18890qvk Object obj) {
            super(entry, obj);
        }
    ...
    public static class SynchronizedList<E> extends SynchronizedCollection<E> implements List<E> {
        public SynchronizedList(List<E> list, @InterfaceC18890qvk Object obj) {
            super(list, obj);
        }
    ...
    private static class SynchronizedListMultimap<K, V> extends SynchronizedMultimap<K, V> implements ListMultimap<K, V> {
        public SynchronizedListMultimap(ListMultimap<K, V> listMultimap, @InterfaceC18890qvk Object obj) {
    ...
    public static class SynchronizedMap<K, V> extends SynchronizedObject implements Map<K, V> {
        ...
        public SynchronizedMap(Map<K, V> map, @InterfaceC18890qvk Object obj) {
            super(map, obj);
        }
    ...
    public static class SynchronizedMultimap<K, V> extends SynchronizedObject implements Multimap<K, V> {
        ...
        public SynchronizedMultimap(Multimap<K, V> multimap, @InterfaceC18890qvk Object obj) {
            super(multimap, obj);
        }
    ...
    public static class SynchronizedObject implements Serializable {
        ...
        public SynchronizedObject(Object obj, @InterfaceC18890qvk Object obj2) {
    ...
    public static class SynchronizedRandomAccessList<E> extends SynchronizedList<E> implements RandomAccess {
        public SynchronizedRandomAccessList(List<E> list, @InterfaceC18890qvk Object obj) {
            super(list, obj);
        }
    }
    ...
    public static class SynchronizedSetMultimap<K, V> extends SynchronizedMultimap<K, V> implements SetMultimap<K, V> {
        ...
        public SynchronizedSetMultimap(SetMultimap<K, V> setMultimap, @InterfaceC18890qvk Object obj) {
    ...
    private static class SynchronizedSortedSetMultimap<K, V> extends SynchronizedSetMultimap<K, V> implements SortedSetMultimap<K, V> {
        public SynchronizedSortedSetMultimap(SortedSetMultimap<K, V> sortedSetMultimap, @InterfaceC18890qvk Object obj) {
    ...
    public static <K, V> BiMap<K, V> biMap(BiMap<K, V> biMap, @InterfaceC18890qvk Object obj) {
        return ((biMap instanceof SynchronizedBiMap) || (biMap instanceof ImmutableBiMap)) ? biMap : new SynchronizedBiMap(biMap, obj, null);
    }

    public static <E> Collection<E> collection(Collection<E> collection, @InterfaceC18890qvk Object obj) {
        return new SynchronizedCollection(collection, obj);
    }

    public static <E> Deque<E> deque(Deque<E> deque, @InterfaceC18890qvk Object obj) {
        return new SynchronizedDeque(deque, obj);
    }

    public static <E> List<E> list(List<E> list, @InterfaceC18890qvk Object obj) {
    ...
    public static <K, V> ListMultimap<K, V> listMultimap(ListMultimap<K, V> listMultimap, @InterfaceC18890qvk Object obj) {
    ...
    public static <K, V> Map<K, V> map(Map<K, V> map, @InterfaceC18890qvk Object obj) {
        return new SynchronizedMap(map, obj);
    }

    public static <K, V> Multimap<K, V> multimap(Multimap<K, V> multimap, @InterfaceC18890qvk Object obj) {
    ...
    public static <E> Multiset<E> multiset(Multiset<E> multiset, @InterfaceC18890qvk Object obj) {
    ...
    public static <E> NavigableSet<E> navigableSet(NavigableSet<E> navigableSet, @InterfaceC18890qvk Object obj) {
        return new SynchronizedNavigableSet(navigableSet, obj);
    }

    public static <K, V> Map.Entry<K, V> nullableSynchronizedEntry(@InterfaceC18890qvk Map.Entry<K, V> entry, @InterfaceC18890qvk Object obj) {
        if (entry == null) {
            return null;
        }
    ...
    public static <E> Queue<E> queue(Queue<E> queue, @InterfaceC18890qvk Object obj) {
        return queue instanceof SynchronizedQueue ? queue : new SynchronizedQueue(queue, obj);
    }

    public static <E> Set<E> set(Set<E> set, @InterfaceC18890qvk Object obj) {
        return new SynchronizedSet(set, obj);
    }

    public static <K, V> SetMultimap<K, V> setMultimap(SetMultimap<K, V> setMultimap, @InterfaceC18890qvk Object obj) {
    ...
    public static <K, V> SortedMap<K, V> sortedMap(SortedMap<K, V> sortedMap, @InterfaceC18890qvk Object obj) {
        return new SynchronizedSortedMap(sortedMap, obj);
    }

    public static <E> SortedSet<E> sortedSet(SortedSet<E> sortedSet, @InterfaceC18890qvk Object obj) {
        return new SynchronizedSortedSet(sortedSet, obj);
    }

    public static <K, V> SortedSetMultimap<K, V> sortedSetMultimap(SortedSetMultimap<K, V> sortedSetMultimap, @InterfaceC18890qvk Object obj) {
    ...
    public static <E> Collection<E> typePreservingCollection(Collection<E> collection, @InterfaceC18890qvk Object obj) {
    ...
    public static <E> Set<E> typePreservingSet(Set<E> set, @InterfaceC18890qvk Object obj) {
    ...
    public static class SynchronizedMultiset<E> extends SynchronizedCollection<E> implements Multiset<E> {
        ...
        public SynchronizedMultiset(Multiset<E> multiset, @InterfaceC18890qvk Object obj) {
            super(multiset, obj);
        }
    ...
    public static class SynchronizedQueue<E> extends SynchronizedCollection<E> implements Queue<E> {
        public SynchronizedQueue(Queue<E> queue, @InterfaceC18890qvk Object obj) {
            super(queue, obj);
        }
    ...
    public static class SynchronizedSet<E> extends SynchronizedCollection<E> implements Set<E> {
        public SynchronizedSet(Set<E> set, @InterfaceC18890qvk Object obj) {
            super(set, obj);
        }
    ...
    public static class SynchronizedSortedMap<K, V> extends SynchronizedMap<K, V> implements SortedMap<K, V> {
        public SynchronizedSortedMap(SortedMap<K, V> sortedMap, @InterfaceC18890qvk Object obj) {
            super(sortedMap, obj);
        }
    ...
    public static <K, V> NavigableMap<K, V> navigableMap(NavigableMap<K, V> navigableMap, @InterfaceC18890qvk Object obj) {
    ...
    public static class SynchronizedAsMapEntries<K, V> extends SynchronizedSet<Map.Entry<K, Collection<V>>> {
        public SynchronizedAsMapEntries(Set<Map.Entry<K, Collection<V>>> set, @InterfaceC18890qvk Object obj) {
            super(set, obj);
        }
    ...
    private static final class SynchronizedDeque<E> extends SynchronizedQueue<E> implements Deque<E> {
        public SynchronizedDeque(Deque<E> deque, @InterfaceC18890qvk Object obj) {
            super(deque, obj);
        }
    ...
    public static class SynchronizedNavigableMap<K, V> extends SynchronizedSortedMap<K, V> implements NavigableMap<K, V> {
        ...
        public SynchronizedNavigableMap(NavigableMap<K, V> navigableMap, @InterfaceC18890qvk Object obj) {
    ...
    public static class SynchronizedNavigableSet<E> extends SynchronizedSortedSet<E> implements NavigableSet<E> {
        ...
        public SynchronizedNavigableSet(NavigableSet<E> navigableSet, @InterfaceC18890qvk Object obj) {
    ...
    public static class SynchronizedSortedSet<E> extends SynchronizedSet<E> implements SortedSet<E> {
        public SynchronizedSortedSet(SortedSet<E> sortedSet, @InterfaceC18890qvk Object obj) {
            super(sortedSet, obj);
        }
