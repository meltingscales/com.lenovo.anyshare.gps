...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    public static SpliceInsertCommand parseFromSection(ParsableByteArray parsableByteArray, long j, TimestampAdjuster timestampAdjuster) {
        ...
        if (z6) {
            ...
            long parseSpliceTime = (!z8 || z10) ? b.b : TimeSignalCommand.parseSpliceTime(parsableByteArray, j);
            if (z8) {
                list2 = emptyList;
            } else {
                ...
                for (int i4 = 0; i4 < readUnsignedByte2; i4++) {
                    ...
                    long parseSpliceTime2 = !z10 ? TimeSignalCommand.parseSpliceTime(parsableByteArray, j) : b.b;
