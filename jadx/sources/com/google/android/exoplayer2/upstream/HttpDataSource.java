...
public interface HttpDataSource extends DataSource {
    public static final Predicate<String> REJECT_PAYWALL_TYPES = new Predicate<String>() { // from class: com.google.android.exoplayer2.upstream.HttpDataSource.1
        ...
        public boolean evaluate(String str) {
            ...
            return (TextUtils.isEmpty(lowerInvariant) || (lowerInvariant.contains("text") && !lowerInvariant.contains(o.O)) || lowerInvariant.contains(a.b) || lowerInvariant.contains("xml")) ? false : true;
        }
    };
