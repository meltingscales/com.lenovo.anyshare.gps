...
public final class DtsUtil {
    ...
    public static final int[] TWICE_BITRATE_KBPS_BY_RATE = {64, 112, 128, InterfaceC13225hhc.Ic, InterfaceC13225hhc.nd, 256, 384, p.a.f2823a, 512, 640, 768, 896, 1024, 1152, 1280, 1536, 1920, 2048, 2304, 2560, 2688, 2816, 2823, 2944, DeviceLog.MAX_DEBUG_MSG_LENGTH, 3840, 4096, 6144, 7680};
    ...
    */
    ...
    public static Format parseDtsFormat(byte[] bArr, String str, String str2, DrmInitData drmInitData) {
        ...
        return Format.createAudioSampleFormat(str, o.D, null, i3, -1, i + (normalizedFrameHeader.readBits(2) > 0 ? 1 : 0), i2, null, drmInitData, 0, str2);
    }
