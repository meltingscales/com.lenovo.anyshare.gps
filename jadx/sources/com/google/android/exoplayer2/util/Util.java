...
public final class Util {
    ...
    public static Point getPhysicalDisplaySize(Context context) {
        return getPhysicalDisplaySize(context, ((WindowManager) context.getSystemService(VisionController.WINDOW)).getDefaultDisplay());
    }
    ...
    public static String getUserAgent(Context context, String str) {
        ...
        return str + "/" + str2 + " (Linux;Android " + Build.VERSION.RELEASE + ") " + l.c;
    }
    ...
    public static long parseXsDateTime(String str) throws ParserException {
        ...
        if (matcher.matches()) {
            ...
            return i != 0 ? timeInMillis - (i * f.b) : timeInMillis;
        }
        ...
        if (SDK_INT < 25 && display.getDisplayId() == 0) {
            ...
            if (("NVIDIA".equals(MANUFACTURER) && MODEL.contains("SHIELD")) || ("philips".equals(toLowerInvariant(MANUFACTURER)) && (MODEL.startsWith("QM1") || MODEL.equals("QV151E") || MODEL.equals("TPM171E")))) {
                ...
                try {
                    ...
                    Log.e(af.f, "Failed to read sys.display-size", e);
                }
                if (!TextUtils.isEmpty(str)) {
                    try {
                        String[] split = split(str.trim(), x.c);
                        if (split.length == 2) {
                    ...
                    Log.e(af.f, "Invalid sys.display-size: " + str);
                }
            }
        }
