...
public abstract class Atom {
    ...
    public static final int TYPE_avc1 = Util.getIntegerCodeForString(d.i);
    public static final int TYPE_avc3 = Util.getIntegerCodeForString("avc3");
    public static final int TYPE_hvc1 = Util.getIntegerCodeForString(d.m);
    public static final int TYPE_hev1 = Util.getIntegerCodeForString(d.l);
    ...
    public static final int TYPE_av1 = Util.getIntegerCodeForString("av01");
