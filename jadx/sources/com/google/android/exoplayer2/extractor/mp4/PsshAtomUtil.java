...
import com.anythink.expressad.exoplayer.e.a.h;
...
public final class PsshAtomUtil {
    ...
    public static PsshAtom parsePsshAtom(byte[] bArr) {
        ...
        if (parsableByteArray.readInt() == parsableByteArray.bytesLeft() + 4 && parsableByteArray.readInt() == Atom.TYPE_pssh) {
            ...
            if (parseFullAtomVersion > 1) {
                Log.w(h.f2430a, "Unsupported pssh version: " + parseFullAtomVersion);
                return null;
            }
    ...
    public static byte[] parseSchemeSpecificData(byte[] bArr, UUID uuid) {
        ...
        Log.w(h.f2430a, "UUID mismatch. Expected: " + uuid + ", got: " + parsePsshAtom.uuid + ".");
        return null;
    }
