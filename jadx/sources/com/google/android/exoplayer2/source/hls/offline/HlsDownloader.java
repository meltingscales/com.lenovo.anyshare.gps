...
public final class HlsDownloader extends SegmentDownloader<HlsPlaylist, RenditionKey> {
    ...
    public static void addResolvedUris(String str, List<HlsMasterPlaylist.HlsUrl> list, List<Uri> list2) {
        for (int i = 0; i < list.size(); i++) {
            list2.add(UriUtil.resolveToUri(str, list.get(i).url));
        }
    }

    public static void addSegment(ArrayList<SegmentDownloader.Segment> arrayList, HlsMediaPlaylist hlsMediaPlaylist, HlsMediaPlaylist.Segment segment, HashSet<Uri> hashSet) {
    ...
    public static HlsPlaylist loadManifest(DataSource dataSource, Uri uri) throws IOException {
