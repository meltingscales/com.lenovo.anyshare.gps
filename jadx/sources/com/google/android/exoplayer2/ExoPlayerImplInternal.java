...
public final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSource.SourceInfoRefreshListener, DefaultMediaClock.PlaybackParameterListener, PlayerMessage.Sender {
    ...
    public class _lancet {
        ...
        @Hrk("handleMessage")
        public static boolean com_ushareit_medusa_crash_anr_msg_MessageLancet_handleOsMessageByMedusa(ExoPlayerImplInternal exoPlayerImplInternal, Message message) {
            C6098Slh c6098Slh;
            if (C7532Xlh.a().b() && (c6098Slh = C7532Xlh.a().b) != null && C1799Dmh.a(message) && C16949nmh.a(C1799Dmh.b(message))) {
                c6098Slh.d = C1799Dmh.b(message);
            }
            return exoPlayerImplInternal.handleMessage$___twin___(message);
        }
    }
    ...
    public ExoPlayerImplInternal(Renderer[] rendererArr, TrackSelector trackSelector, TrackSelectorResult trackSelectorResult, LoadControl loadControl, boolean z, int i, boolean z2, Handler handler, ExoPlayer exoPlayer, Clock clock) {
        ...
        this.playbackInfo = new PlaybackInfo(Timeline.EMPTY, b.b, TrackGroupArray.EMPTY, trackSelectorResult);
    ...
    private void doSomeWork() throws ExoPlaybackException, IOException {
        ...
        if (z2 && ((j == b.b || j <= this.playbackInfo.positionUs) && playingPeriod.info.isFinal)) {
            setState(4);
            stopRenderers();
    ...
    private void handleSourceInfoRefreshed(MediaSourceRefreshInfo mediaSourceRefreshInfo) throws ExoPlaybackException {
        ...
        if (i > 0) {
            ...
            if (seekPosition != null) {
                ...
                return;
            } else if (this.playbackInfo.startPositionUs == b.b) {
                if (timeline2.isEmpty()) {
                    handleSourceInfoRefreshEndedPlayback();
                    return;
                }
                Pair<Integer, Long> periodPosition = getPeriodPosition(timeline2, timeline2.getFirstWindowIndex(this.shuffleModeEnabled), b.b);
        ...
        if (indexOfPeriod == -1) {
            ...
            Pair<Integer, Long> periodPosition2 = getPeriodPosition(timeline2, timeline2.getPeriod(resolveSubsequentPeriod, this.period).windowIndex, b.b);
    ...
    private boolean isTimelineReady() {
        ...
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        long j = playingPeriod.info.durationUs;
        return j == b.b || this.playbackInfo.positionUs < j || ((mediaPeriodHolder = playingPeriod.next) != null && (mediaPeriodHolder.prepared || mediaPeriodHolder.info.id.isAd()));
    }
    ...
    */
    ...
    private Pair<Integer, Long> resolveSeekPosition(SeekPosition seekPosition, boolean z) {
        ...
        try {
            ...
            return getPeriodPosition(timeline, timeline.getPeriod(resolveSubsequentPeriod, this.period).windowIndex, b.b);
    ...
    */
    ...
    private void sendMessageInternal(PlayerMessage playerMessage) throws ExoPlaybackException {
        if (playerMessage.getPositionMs() == b.b) {
        ...
        if (readingPeriod.info.isFinal) {
            ...
            while (true) {
                ...
                if (i3 < rendererArr2.length) {
                    ...
                    boolean z2 = advanceReadingPeriod.mediaPeriod.readDiscontinuity() != b.b;
                    int i4 = 0;
                    while (true) {
    ...
    public synchronized void sendMessage(PlayerMessage playerMessage) {
        if (this.released) {
            Log.w(k.d, "Ignoring messages sent after release.");
            playerMessage.markAsProcessed(false);
            return;
        }
