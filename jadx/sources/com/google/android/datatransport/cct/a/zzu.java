...
public final class zzu {
    public static final zzu zza = new zzu(PM.r, 0, 0);
    ...
    public static final SparseArray<zzu> zzg;

    static {
        zzu[] zzuVarArr = {zza, zzb, zzc, zzd, zze, zzf};
        zzg = new SparseArray<>();
        zzg.put(0, zza);
        zzg.put(1, zzb);
        zzg.put(2, zzc);
    ...
    public zzu(String str, int i, int i2) {
    }
}
