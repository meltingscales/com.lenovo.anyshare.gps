...
public final class zzc implements TransportBackend {
    ...
    public final DataEncoder zza = new JsonDataEncoderBuilder().configureWith(com.google.android.datatransport.cct.a.zzb.zza).ignoreNullValues(true).build();
    ...
    public EventInternal decorate(EventInternal eventInternal) {
        ...
        EventInternal.Builder addMetadata = eventInternal.toBuilder().addMetadata("sdk-version", Build.VERSION.SDK_INT).addMetadata("model", Build.MODEL).addMetadata("hardware", Build.HARDWARE).addMetadata(GI.d, Build.DEVICE).addMetadata(AppLovinEventTypes.USER_VIEWED_PRODUCT, Build.PRODUCT).addMetadata("os-uild", Build.ID).addMetadata(LLi.N, Build.MANUFACTURER).addMetadata("fingerprint", Build.FINGERPRINT);
        ...
        try {
            ...
            try {
                ...
                if (responseCode == 302 || responseCode == 301 || responseCode == 307) {
                    return new zzb(responseCode, new URL(httpURLConnection.getHeaderField(HttpHeaders.HEAD_KEY_LOCATION)), 0L);
                }
                if (responseCode != 200) {
