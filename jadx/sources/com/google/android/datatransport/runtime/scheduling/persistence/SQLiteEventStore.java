...
public class SQLiteEventStore implements EventStore, SynchronizationGuard {
    ...
    private long ensureTransportContext(SQLiteDatabase sQLiteDatabase, TransportContext transportContext) {
        ...
        contentValues.put(Progress.PRIORITY, Integer.valueOf(PriorityMapping.toInt(transportContext.getPriority())));
        contentValues.put("next_request_ms", (Integer) 0);
        if (transportContext.getExtras() != null) {
            contentValues.put(YLi.d, Base64.encodeToString(transportContext.getExtras(), 0));
        }
    ...
    public static /* synthetic */ Object lambda$clearDb$11(SQLiteDatabase sQLiteDatabase) {
        sQLiteDatabase.delete(C6381Tld.d.b, null, new String[0]);
    ...
    public static /* synthetic */ Long lambda$persist$1(SQLiteEventStore sQLiteEventStore, TransportContext transportContext, EventInternal eventInternal, SQLiteDatabase sQLiteDatabase) {
        ...
        long insert = sQLiteDatabase.insert(C6381Tld.d.b, null, contentValues);
        if (!z) {
    ...
    private List<PersistedEvent> loadEvents(SQLiteDatabase sQLiteDatabase, TransportContext transportContext) {
        ...
        tryWithCursor(sQLiteDatabase.query(C6381Tld.d.b, new String[]{VisionController.FILTER_ID, "transport_name", "timestamp_ms", "uptime_ms", "payload_encoding", "payload", "code", CallMraidJS.k}, "context_id = ?", new String[]{transportContextId.toString()}, null, null, null, String.valueOf(this.config.getLoadBatchSize())), SQLiteEventStore$$Lambda$15.lambdaFactory$(this, arrayList, transportContext));
        return arrayList;
    }
    ...
    private Map<Long, Set<Metadata>> loadMetadata(SQLiteDatabase sQLiteDatabase, List<PersistedEvent> list) {
        ...
        sb.append(')');
        tryWithCursor(sQLiteDatabase.query("event_metadata", new String[]{LogEntry.LOG_ITEM_EVENT_ID, "name", "value"}, sb.toString(), null, null, null, null), SQLiteEventStore$$Lambda$17.lambdaFactory$(hashMap));
        return hashMap;
    }
    ...
    private byte[] readPayload(long j) {
        Function function;
        Cursor query = getDb().query("event_payloads", new String[]{AssetDownloader.BYTES}, "event_id = ?", new String[]{String.valueOf(j)}, null, null, "sequence_num");
