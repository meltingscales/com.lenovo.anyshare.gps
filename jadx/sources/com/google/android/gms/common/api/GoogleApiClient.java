...
public abstract class GoogleApiClient {
    ...
    public static void dumpAll(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        synchronized (zaa) {
            String concat = String.valueOf(str).concat(C18128pjc.f25363a);
            int i = 0;
    ...
    public static final class Builder {
        ...
        public String zaf;
        public String zag;
        public final Map<Api<?>, com.google.android.gms.common.internal.zab> zah;
        public final Context zai;
        public final Map<Api<?>, Api.ApiOptions> zaj;
        public LifecycleActivity zak;
        public int zal;
        public OnConnectionFailedListener zam;
        public Looper zan;
        public GoogleApiAvailability zao;
        public Api.AbstractClientBuilder<? extends com.google.android.gms.signin.zae, SignInOptions> zap;
        ...
        private final <O extends Api.ApiOptions> void zab(Api<O> api, O o, Scope... scopeArr) {
            ...
            HashSet hashSet = new HashSet(zac.getImpliedScopes(o));
        ...
        public GoogleApiClient build() {
            ...
            for (Api<?> api2 : this.zaj.keySet()) {
                ...
                Api.AbstractClientBuilder<?, ?> zaa2 = api2.zaa();
                Preconditions.checkNotNull(zaa2);
                Api.AbstractClientBuilder<?, ?> abstractClientBuilder = zaa2;
                ?? buildClient = abstractClientBuilder.buildClient(this.zai, this.zan, zaa, (ClientSettings) apiOptions, (ConnectionCallbacks) zatVar, (OnConnectionFailedListener) zatVar);
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApi(Api<O> api, O o) {
            ...
            Api.BaseClientBuilder<?, O> zac = api.zac();
            Preconditions.checkNotNull(zac, "Base client builder must not be null");
            List<Scope> impliedScopes = zac.getImpliedScopes(o);
            this.zac.addAll(impliedScopes);
            this.zab.addAll(impliedScopes);
            return this;
        }
