...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    public final Api.Client zab(Looper looper, zabq<O> zabqVar) {
        ...
        Api.AbstractClientBuilder<?, O> zaa = this.zad.zaa();
        Preconditions.checkNotNull(zaa);
        ?? buildClient = zaa.buildClient(this.zab, looper, build, (ClientSettings) this.zae, (GoogleApiClient.ConnectionCallbacks) zabqVar, (GoogleApiClient.OnConnectionFailedListener) zabqVar);
