...
public class GoogleApiManager implements Handler.Callback {
    ...
    public class _lancet {
        ...
        public static boolean com_ushareit_lancet_GoogleAdMobCrashFixLancet_handleMessage(GoogleApiManager googleApiManager, Message message) {
            try {
                Log.e("CrashFixLancet", "com.google.android.gms.common.api.internal.GoogleApiManager  handleMessage");
                return com_ushareit_medusa_crash_anr_msg_MessageLancet_handleOsMessageByMedusa(googleApiManager, message);
            } catch (Throwable th) {
                th.printStackTrace();
                return false;
            }
        ...
        @Hrk("handleMessage")
        public static boolean com_ushareit_medusa_crash_anr_msg_MessageLancet_handleOsMessageByMedusa(GoogleApiManager googleApiManager, Message message) {
            C6098Slh c6098Slh;
            if (C7532Xlh.a().b() && (c6098Slh = C7532Xlh.a().b) != null && C1799Dmh.a(message) && C16949nmh.a(C1799Dmh.b(message))) {
                c6098Slh.d = C1799Dmh.b(message);
            }
            return googleApiManager.handleMessage$___twin___(message);
        }
    }
    ...
    public final boolean handleMessage$___twin___(Message message) {
        ...
        switch (i) {
            case 1:
                this.zag = true == ((Boolean) message.obj).booleanValue() ? n.f2525a : 300000L;
    ...
    public final boolean handleMessage(Message message) {
        return _lancet.com_ushareit_lancet_GoogleAdMobCrashFixLancet_handleMessage(this, message);
    }
