...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    public class _lancet {
        ...
        public static void com_lenovo_anyshare_hyperboost_scene_HyperBoostSceneAop_androidxFragmentOnViewCreated(zzd zzdVar, View view, Bundle bundle) {
            zzdVar.onViewCreated$___twin___(view, bundle);
            String name = zzdVar.getClass().getName();
