...
public final class WakeLockEvent extends StatsEvent {
    ...
    public WakeLockEvent(int i, long j, int i2, String str, int i3, @Qdk List<String> list, String str2, long j2, int i4, String str3, String str4, float f, long j3, String str5, boolean z) {
        this.zza = i;
        this.zzb = j;
        this.zzc = i2;
        this.zzd = str;
