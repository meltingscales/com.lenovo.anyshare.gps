...
public abstract class zag implements DialogInterface.OnClickListener {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        try {
            ...
            Log.e("DialogRedirect", true == Build.FINGERPRINT.contains(PM.u) ? "Failed to start resolution intent. This may occur when resolving Google Play services connection issues on emulators with Google APIs but not Google Play Store." : "Failed to start resolution intent.", e);
        } finally {
