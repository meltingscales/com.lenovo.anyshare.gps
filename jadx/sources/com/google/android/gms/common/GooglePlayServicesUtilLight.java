...
public class GooglePlayServicesUtilLight {
    ...
    public class _lancet {
        ...
        public static int com_ushareit_lancet_AdMobAnrLancet_isGooglePlayServicesAvailable(Context context) {
            if (ASg.f6490a == -111) {
                ...
                ASg.f6490a = GooglePlayServicesUtilLight.isGooglePlayServicesAvailable$___twin___(context);
            } else {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        return _lancet.com_ushareit_lancet_AdMobAnrLancet_isGooglePlayServicesAvailable(context);
    }
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        ...
        try {
            context.getResources().getString(R.string.aqk);
    ...
    public static boolean isRestrictedUserProfile(Context context) {
        if (PlatformVersion.isAtLeastJellyBeanMR2()) {
            Object systemService = context.getSystemService(LLi.B);
