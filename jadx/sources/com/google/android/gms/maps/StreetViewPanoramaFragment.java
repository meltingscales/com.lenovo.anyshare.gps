...
public class StreetViewPanoramaFragment extends Fragment {
    public final zzb zzbt = new zzb(this);

    /* loaded from: classes.dex */
    public class _lancet {
        @Hrk(mayCreateSuper = true, value = "onViewCreated")
        @Krk(scope = Scope.LEAF, value = "android.app.Fragment")
        public static void com_lenovo_anyshare_hyperboost_scene_HyperBoostSceneAop_onFragmentViewCreated(StreetViewPanoramaFragment streetViewPanoramaFragment, View view, Bundle bundle) {
            streetViewPanoramaFragment.onViewCreated$___twin___(view, bundle);
            String name = streetViewPanoramaFragment.getClass().getName();
