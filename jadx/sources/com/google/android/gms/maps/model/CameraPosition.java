...
public final class CameraPosition extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public CameraPosition(LatLng latLng, float f, float f2, float f3) {
        ...
        this.zoom = f;
        this.tilt = f2 + 0.0f;
        this.bearing = (((double) f3) <= AbstractC4714Nqc.f12500a ? (f3 % 360.0f) + 360.0f : f3) % 360.0f;
    }
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add(LLi.ua, this.target).add("zoom", Float.valueOf(this.zoom)).add("tilt", Float.valueOf(this.tilt)).add("bearing", Float.valueOf(this.bearing)).toString();
    }
