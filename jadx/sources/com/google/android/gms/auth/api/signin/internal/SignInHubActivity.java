...
public class SignInHubActivity extends FragmentActivity {
    ...
    private final void zbe(String str) {
        ...
        intent.putExtra(VungleApiImpl.CONFIG, this.zbc);
        try {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (action != null) {
            if ("com.google.android.gms.auth.NO_IMPL".equals(action)) {
                ...
                Bundle bundleExtra = intent.getBundleExtra(VungleApiImpl.CONFIG);
                if (bundleExtra != null) {
                    SignInConfiguration signInConfiguration = (SignInConfiguration) bundleExtra.getParcelable(VungleApiImpl.CONFIG);
