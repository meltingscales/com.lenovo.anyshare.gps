...
public final class zzay extends zzaw {
    ...
    public static boolean zzd(zzap zzapVar, zzap zzapVar2) {
        ...
        return (Double.isNaN(doubleValue) || Double.isNaN(doubleValue2) || (doubleValue == AbstractC4714Nqc.f12500a && doubleValue2 == AbstractC4714Nqc.f12500a) || ((doubleValue == AbstractC4714Nqc.f12500a && doubleValue2 == AbstractC4714Nqc.f12500a) || Double.compare(doubleValue, doubleValue2) >= 0)) ? false : true;
    }
