...
public final class zzcx extends zzdt {
    ...
    public final void zza() {
        ...
        try {
            ...
            zzcl zzclVar = new zzcl(61000L, Math.max(localVersion, remoteVersion), DynamiteModule.getRemoteVersion(this.zzc, ModuleDescriptor.MODULE_ID) < localVersion, str, str2, str3, this.zzd, com.google.android.gms.measurement.internal.zzga.zza(this.zzc));
            zzccVar2 = this.zze.zzj;
            Preconditions.checkNotNull(zzccVar2);
            zzccVar2.initialize(ObjectWrapper.wrap(this.zzc), zzclVar, this.zzh);
        } catch (Exception e) {
