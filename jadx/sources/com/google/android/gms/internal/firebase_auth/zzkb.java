...
public class zzkb<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public boolean containsKey(Object obj) {
        ...
        return zza((zzkb<K, V>) comparable) >= 0 || this.zzc.containsKey(comparable);
    }
    ...
    public boolean equals(Object obj) {
        ...
        int zzc = zzc();
        if (zzc != zzkbVar.zzc()) {
            return entrySet().equals(zzkbVar.entrySet());
        }
        for (int i = 0; i < zzc; i++) {
        ...
        if (zzc != size) {
            return this.zzc.equals(zzkbVar.zzc);
        }
        return true;
    }
    ...
    public /* synthetic */ Object put(Object obj, Object obj2) {
        return zza((zzkb<K, V>) ((Comparable) obj), (Comparable) obj2);
    }
