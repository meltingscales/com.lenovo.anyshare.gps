...
public interface zzjx {
    ...
    <T> T zza(zzjw<T> zzjwVar, zzhl zzhlVar) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzjw<T> zzjwVar, zzhl zzhlVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzjb<K, V> zzjbVar, zzhl zzhlVar) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzjw<T> zzjwVar, zzhl zzhlVar) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzjw<T> zzjwVar, zzhl zzhlVar) throws IOException;
    ...
    void zzk(List<zzgo> list) throws IOException;
