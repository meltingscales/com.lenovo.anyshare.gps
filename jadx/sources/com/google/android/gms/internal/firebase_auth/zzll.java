...
public interface zzll {
    ...
    void zza(int i, zzgo zzgoVar) throws IOException;

    <K, V> void zza(int i, zzjb<K, V> zzjbVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzjw zzjwVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzjw zzjwVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzjw zzjwVar) throws IOException;

    void zzb(int i, List<zzgo> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzjw zzjwVar) throws IOException;
