...
public final class zzfib {
    ...
    public static final String[] zzc = {x.c, "y", "width", "height"};
    ...
    public static void zzb(JSONObject jSONObject, String str) {
        try {
            ...
            zzfic.zza("Error with setting ad session id", e);
        }
    }
    ...
    public static void zze(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            zzfic.zza("JSONException during JSONObject.put for name [" + str + "]", e);
        }
    }
    ...
    public static boolean zzh(JSONArray jSONArray, JSONArray jSONArray2) {
