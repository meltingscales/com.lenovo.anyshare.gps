...
public final class zzgrk {
    ...
    private final void zzb(zzgoe zzgoeVar) {
        ...
        if (zzgoeVar.zzh()) {
            ...
            throw new IllegalArgumentException("Has a new type of ByteString been created? Found ".concat(String.valueOf(String.valueOf(zzgoeVar.getClass()))));
        }
    }

    public static final int zzc(int i) {
        int binarySearch = Arrays.binarySearch(zzgro.zza, i);
