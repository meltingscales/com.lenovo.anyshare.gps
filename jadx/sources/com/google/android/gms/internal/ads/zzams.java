...
public abstract class zzams implements zzamt {
    public static final Logger zzb = Logger.getLogger(zzams.class.getName());
    public final ThreadLocal zza = new zzamr(this);
            ...
            if (zza == 8) {
                ...
                try {
                    ...
                    if (zze == 1) {
                        ...
                        zzc = zzamv.zzf((ByteBuffer) this.zza.get()) - 16;
                    } else {
                        zzc = zze == 0 ? zzgvqVar.zzc() - zzgvqVar.zzb() : zze - 8;
                    }
                    if ("uuid".equals(str)) {
                    ...
                    long j = zzc;
                    zzamw zza2 = zza(str, bArr, zzamxVar instanceof zzamw ? ((zzamw) zzamxVar).zza() : "");
                    zza2.zzc(zzamxVar);
                    ((ByteBuffer) this.zza.get()).rewind();
                    zza2.zzb(zzgvqVar, (ByteBuffer) this.zza.get(), j, this);
                    return zza2;
