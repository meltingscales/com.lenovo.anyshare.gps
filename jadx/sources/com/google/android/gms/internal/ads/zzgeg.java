...
public final class zzgeg {
    public static final zzgeg zza;
    public final AtomicReference zzb = new AtomicReference(new zzgfk(new zzgfe(), null));
    ...
    public final zzfxn zza(zzgfa zzgfaVar, @Qdk zzfyq zzfyqVar) throws GeneralSecurityException {
