...
public final class zzug extends zzsx {
    ...
    public final zzfsy zzf;
    public int zzg;
    public long[][] zzh;
    public zzuf zzi;
    public final zzsz zzj;
    ...
    public final void zzF(zztm zztmVar) {
        ...
        while (true) {
            ...
            zztqVarArr[i].zzF(zzueVar.zzn(i));
            i++;
        }
    }
    ...
    public final zztm zzH(zzto zztoVar, zzxp zzxpVar, long j) {
        zztm[] zztmVarArr = new zztm[this.zzb.length];
        int zza2 = this.zzc[0].zza(zztoVar.zza);
        for (int i = 0; i < zztmVarArr.length; i++) {
            zztmVarArr[i] = this.zzb[i].zzH(zztoVar.zzc(this.zzc[i].zzf(zza2)), zzxpVar, j - this.zzh[zza2][i]);
        }
