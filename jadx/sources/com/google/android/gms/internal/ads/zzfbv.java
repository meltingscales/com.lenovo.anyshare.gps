...
public final class zzfbv implements zzfbu {
    public final ConcurrentHashMap zza;
    public final zzfcb zzb;
    public final zzfbx zzc = new zzfbx();
    ...
    private final void zzf() {
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbbm.zzgf)).booleanValue()) {
            ...
            for (Map.Entry entry : this.zza.entrySet()) {
                ...
                sb.append("    ");
                for (int i2 = 0; i2 < ((zzfbt) entry.getValue()).zzb(); i2++) {
                    sb.append("[O]");
                }
        ...
        if (zzfbtVar == null) {
            ...
            if (size == zzfcbVar2.zzc) {
                ...
                if (i != 0) {
                    ...
                    if (i2 == 0) {
                        for (Map.Entry entry : this.zza.entrySet()) {
                            if (((zzfbt) entry.getValue()).zzc() < j) {
                                j = ((zzfbt) entry.getValue()).zzc();
                        ...
                        for (Map.Entry entry2 : this.zza.entrySet()) {
                            if (((zzfbt) entry2.getValue()).zzd() < j) {
                                j = ((zzfbt) entry2.getValue()).zzd();
                        ...
                        for (Map.Entry entry3 : this.zza.entrySet()) {
                            if (((zzfbt) entry3.getValue()).zza() < i3) {
                                i3 = ((zzfbt) entry3.getValue()).zza();
    ...
    public final synchronized boolean zze(zzfce zzfceVar) {
        zzfbt zzfbtVar = (zzfbt) this.zza.get(zzfceVar);
        if (zzfbtVar != null) {
            return zzfbtVar.zzb() < this.zzb.zzd;
        }
        return true;
    }
}
