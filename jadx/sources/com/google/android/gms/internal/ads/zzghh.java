...
public final class zzghh implements zzfyn {
    ...
    public static final zzghh zzc = new zzghh();
            ...
            for (zzfyi zzfyiVar : list) {
                if (zzfyiVar.zzb() instanceof zzghd) {
                    ...
                    if (!zzb2.equals(zzghdVar.zzb())) {
                        ...
                        String zzgnkVar2 = zzb2.toString();
                        throw new GeneralSecurityException("Mac Key with parameters " + valueOf + " has wrong output prefix (" + zzgnkVar + ") instead of (" + zzgnkVar2 + ")");
                    }
                }
            }
        }
