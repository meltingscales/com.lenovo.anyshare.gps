...
public final class zzcae {
    ...
    static {
        ...
        if (ClientLibraryUtils.isPackageSide()) {
            zzfmc.zza();
            threadPoolExecutor = Executors.unconfigurableExecutorService(Executors.newCachedThreadPool(new zzcaa(ContentTypeManager.DEFAULT_TAG_NAME)));
        } else {
            threadPoolExecutor = new ThreadPoolExecutor(2, Integer.MAX_VALUE, 10L, TimeUnit.SECONDS, new SynchronousQueue(), new zzcaa(ContentTypeManager.DEFAULT_TAG_NAME));
        }
