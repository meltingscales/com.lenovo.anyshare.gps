...
public final class zzeai {
    ...
    public static Cursor zzh(SQLiteDatabase sQLiteDatabase, int i) {
        String[] strArr = {"value"};
    ...
    public static void zzi(SQLiteDatabase sQLiteDatabase, String str, int i) {
        ContentValues contentValues = new ContentValues();
    ...
    public static void zzj(SQLiteDatabase sQLiteDatabase, String str, int i) {
        ContentValues contentValues = new ContentValues();
        contentValues.put("value", (Integer) 0);
