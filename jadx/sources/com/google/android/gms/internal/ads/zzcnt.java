...
public final class zzcnt implements zzbms {
    ...
    public final JSONObject zzb(zzcnw zzcnwVar) throws JSONException {
        ...
        if (zzatzVar == null) {
            ...
            boolean z = zzatzVar.zza;
            JSONObject jSONObject3 = new JSONObject();
            JSONObject put = jSONObject3.put("afmaVersion", this.zzb.zzb()).put("activeViewJSON", this.zzb.zzd()).put("timestamp", zzcnwVar.zzd).put("adFormat", this.zzb.zza()).put("hashCode", this.zzb.zzc()).put("isMraid", false);
            boolean z2 = zzcnwVar.zzc;
            JSONObject put2 = put.put("isStopped", false).put("isPaused", zzcnwVar.zzb).put("isNative", this.zzb.zze());
