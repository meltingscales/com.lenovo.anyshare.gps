    ...
    public final zzfwm zza(final zzezz zzezzVar, final zzezn zzeznVar, final JSONObject jSONObject) {
        ...
        final zzfwm zzb = this.zza.zzb(new Callable() { // from class: com.google.android.gms.internal.ads.zzdjm
            ...
            public final Object call() {
                ...
                zzdhaVar.zzY(jSONObject2.optInt(ReportDBAdapter.ReportColumns.COLUMN_TEMPATE_ID, -1));
                zzdhaVar.zzJ(jSONObject2.optString("custom_template_id"));
                JSONObject optJSONObject = jSONObject2.optJSONObject("omid_settings");
                zzdhaVar.zzU(optJSONObject != null ? optJSONObject.optString("omid_partner_name") : null);
                ...
                if (zzfaiVar.zzg.contains(Integer.toString(zzdhaVar.zzc()))) {
                    ...
                    zzdhaVar.zzW(jSONObject2.optDouble(d.ac, -1.0d));
                    ...
                    zzdhaVar.zzX(MFc.d, jSONObject2.optString(MFc.d, null));
                    zzdhaVar.zzX("call_to_action", jSONObject2.optString("call_to_action", null));
                    zzdhaVar.zzX(NavigationType.STORE, jSONObject2.optString(NavigationType.STORE, null));
                    zzdhaVar.zzX("price", jSONObject2.optString("price", null));
