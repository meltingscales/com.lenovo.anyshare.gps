...
public final class zzgns extends zzgno implements RandomAccess, zzgpv, zzgrd {
    public static final zzgns zza = new zzgns(new boolean[0], 0, false);
    public boolean[] zzb;
    public int zzc;
    ...
    public final /* bridge */ /* synthetic */ zzgpv zzd(int i) {
        if (i >= this.zzc) {
            return new zzgns(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    public zzgns(boolean[] zArr, int i, boolean z) {
        super(z);
        this.zzb = zArr;
        this.zzc = i;
    }
