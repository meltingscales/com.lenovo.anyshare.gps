...
public abstract class zzcgu implements zzcmg {
    @Qdk
    public static zzcgu zza;

    public static synchronized zzcgu zzC(Context context, @Qdk zzbnw zzbnwVar, int i, boolean z, int i2, zzchy zzchyVar) {
        synchronized (zzcgu.class) {
            ...
            zzbzx zzc = zzd.zzc(ModuleDescriptor.MODULE_VERSION, false, i2);
            zzd.zzf(zzbnwVar);
    ...
    public static zzcgu zza(Context context, @Qdk zzbnw zzbnwVar, int i) {
        return zzC(context, zzbnwVar, ModuleDescriptor.MODULE_VERSION, false, i, new zzchy());
    }
    ...
    public final zzerq zzp(zzbue zzbueVar, int i) {
        return zzq(new zzets(zzbueVar, i));
    }

    public abstract zzerq zzq(zzets zzetsVar);
