...
public final class zzgpn extends zzgno implements RandomAccess, zzgpr, zzgrd {
    public static final zzgpn zza = new zzgpn(new int[0], 0, false);
    public int[] zzb;
    public int zzc;
    ...
    /* renamed from: zzg */
    public final zzgpr zzd(int i) {
        if (i >= this.zzc) {
            return new zzgpn(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    public zzgpn(int[] iArr, int i, boolean z) {
        super(z);
        this.zzb = iArr;
        this.zzc = i;
    }
