...
public final class zzgez {
    ...
    public final Class zza(Class cls) throws GeneralSecurityException {
        ...
        throw new GeneralSecurityException("No input primitive class for " + cls2 + " available");
    }
    ...
    public final Object zzb(zzfxn zzfxnVar, Class cls) throws GeneralSecurityException {
        ...
        String zzgexVar2 = zzgexVar.toString();
        throw new GeneralSecurityException("No PrimitiveConstructor for " + zzgexVar2 + " available");
    }
