...
public final class zzfoh {
    ...
    public final zzfne zzo;
    public final List zze = new ArrayList();
    public final Set zzf = new HashSet();
    public final Object zzg = new Object();
    public final IBinder.DeathRecipient zzk = new IBinder.DeathRecipient() { // from class: com.google.android.gms.internal.ads.zzfnz
    ...
    public static /* bridge */ /* synthetic */ void zzp(zzfoh zzfohVar, zzfnx zzfnxVar) {
        ...
        zzfohVar.zze.add(zzfnxVar);
        zzfohVar.zzm = new zzfog(zzfohVar, null);
        zzfohVar.zzh = true;
        if (zzfohVar.zzb.bindService(zzfohVar.zzi, zzfohVar.zzm, 1)) {
            return;
        }
    ...
    public static /* bridge */ /* synthetic */ void zzq(zzfoh zzfohVar) {
        ...
        try {
            ...
            zzfohVar.zzc.zzb(e, "linkToDeath failed", new Object[0]);
        }
    }
