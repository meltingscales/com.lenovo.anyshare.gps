...
public final class zzddn extends zzcrd {
    ...
    public final zzdcc zze;
    public final zzdew zzf;
    public final zzcrx zzg;
    public final zzfjm zzh;
    public final zzcvt zzi;
    public boolean zzj;

    public zzddn(zzcrc zzcrcVar, Context context, @Qdk zzcez zzcezVar, zzdcc zzdccVar, zzdew zzdewVar, zzcrx zzcrxVar, zzfjm zzfjmVar, zzcvt zzcvtVar) {
        super(zzcrcVar);
        this.zzj = false;
        this.zzc = context;
    ...
    public final boolean zzc(boolean z, @Qdk Activity activity) {
        this.zze.zzb();
