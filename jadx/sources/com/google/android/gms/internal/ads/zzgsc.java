...
public class zzgsc extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = comparable.compareTo(((zzgrw) this.zzb.get(i2)).zza());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public final Object zzl(int i) {
        zzn();
        Object value = ((zzgrw) this.zzb.remove(i)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzgsc) {
            ...
            if (zzb == zzgscVar.zzb()) {
                for (int i = 0; i < zzb; i++) {
                    if (!zzg(i).equals(zzgscVar.zzg(i))) {
                        return false;
                    }
                }
                if (zzb != size) {
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < zzb; i2++) {
            i += ((zzgrw) this.zzb.get(i2)).hashCode();
        }
    ...
    public final Iterable zzc() {
        return this.zzc.isEmpty() ? zzgrv.zza() : this.zzc.entrySet();
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzgrw zzgrwVar = (zzgrw) this.zzb.remove(i2 - 1);
            zzm().put(zzgrwVar.zza(), zzgrwVar.getValue());
        }
        this.zzb.add(i, new zzgrw(this, comparable, obj));
        return null;
    }
