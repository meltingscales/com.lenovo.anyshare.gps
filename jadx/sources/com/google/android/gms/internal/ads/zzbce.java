...
public final class zzbce {
    public final List zza = new LinkedList();
    public final Map zzb = new LinkedHashMap();
    public final Object zzc = new Object();

    public zzbce(boolean z, String str, String str2) {
        this.zzb.put("action", "make_wv");
        this.zzb.put(ATAdConst.NETWORK_REQUEST_PARAMS_KEY.FORMAT, str2);
    }
    ...
    public final boolean zze(zzbcb zzbcbVar, long j, String... strArr) {
        synchronized (this.zzc) {
            for (int i = 0; i <= 0; i++) {
                this.zza.add(new zzbcb(j, strArr[i], zzbcbVar));
            }
        }
        return true;
    }
