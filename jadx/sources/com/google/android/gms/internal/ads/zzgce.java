...
public final class zzgce extends zzgdt {
    public final /* synthetic */ zzgcf zza;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public zzgce(zzgcf zzgcfVar, Class cls) {
        super(cls);
        this.zza = zzgcfVar;
    }
