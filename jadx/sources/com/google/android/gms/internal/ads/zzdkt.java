...
public final class zzdkt {
    ...
    public static final void zzi(zzcez zzcezVar) {
    ...
    public final /* synthetic */ void zzf(zzcez zzcezVar, zzcai zzcaiVar, boolean z) {
    ...
    public final /* synthetic */ void zzg(zzcez zzcezVar, zzcai zzcaiVar, boolean z) {
        if (z) {
            if (this.zza.zza != null && zzcezVar.zzq() != null) {
                zzcezVar.zzq().zzs(this.zza.zza);
            }
