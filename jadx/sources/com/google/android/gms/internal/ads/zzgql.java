...
public final class zzgql extends zzgno implements RandomAccess, zzgpu, zzgrd {
    public static final zzgql zza = new zzgql(new long[0], 0, false);
    public long[] zzb;
    public int zzc;
    ...
    /* renamed from: zza */
    public final zzgpu zzd(int i) {
        if (i >= this.zzc) {
            return new zzgql(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    public zzgql(long[] jArr, int i, boolean z) {
        super(z);
        this.zzb = jArr;
        this.zzc = i;
    }
