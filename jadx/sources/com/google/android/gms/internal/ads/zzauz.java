...
public final class zzauz extends Thread {
    ...
    */
    ...
    public final zzauy zzb(View view, zzaup zzaupVar) {
        if (view == null) {
        ...
        if ((view instanceof TextView) && !(view instanceof EditText)) {
            ...
            for (int i3 = 0; i3 < viewGroup.getChildCount(); i3++) {
                zzauy zzb = zzb(viewGroup.getChildAt(i3), zzaupVar);
                i += zzb.zza;
                i2 += zzb.zzb;
            }
            return new zzauy(this, i, i2);
        } else {
            return new zzauy(this, 0, 0);
        }
    }
    ...
    */
    ...
    public final void zzd(zzaup zzaupVar, WebView webView, String str, boolean z) {
        zzaupVar.zzg();
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                if (!this.zzn && !TextUtils.isEmpty(webView.getTitle())) {
                    ...
                    zzaupVar.zzl(optString, z, webView.getX(), webView.getY(), webView.getWidth(), webView.getHeight());
                }
            }
            if (zzaupVar.zzo()) {
