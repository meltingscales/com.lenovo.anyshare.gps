...
public final class zzgbs extends zzfyt {
    public final zzgbx zza;
    public final zzgnl zzb;
    public final zzgnk zzc;
    @Qdk
    public final Integer zzd;

    public zzgbs(zzgbx zzgbxVar, zzgnl zzgnlVar, zzgnk zzgnkVar, @Qdk Integer num) {
        this.zza = zzgbxVar;
        this.zzb = zzgnlVar;
        this.zzc = zzgnkVar;
        this.zzd = num;
    ...
    public static zzgbs zza(zzgbw zzgbwVar, zzgnl zzgnlVar, @Qdk Integer num) throws GeneralSecurityException {
        zzgnk zzb;
        zzgbw zzgbwVar2 = zzgbw.zzc;
        if (zzgbwVar != zzgbwVar2 && num == null) {
            String zzgbwVar3 = zzgbwVar.toString();
            throw new GeneralSecurityException("For given Variant " + zzgbwVar3 + " the value of idRequirement must be non-null");
