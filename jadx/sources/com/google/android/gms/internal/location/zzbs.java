...
public abstract class zzbs<E> extends zzbp<E> implements List<E>, RandomAccess {
    ...
    */
    public final boolean equals(@com.lenovo.anyshare.InterfaceC18890qvk java.lang.Object r7) {
        /*
            r6 = this;
            r0 = 1
            r1 = 0
    ...
    @Override // java.util.List
    public final int indexOf(@InterfaceC18890qvk Object obj) {
        if (obj == null) {
            return -1;
        }
        int size = size();
    ...
    @Override // java.util.List
    public final int lastIndexOf(@InterfaceC18890qvk Object obj) {
        if (obj == null) {
            return -1;
        }
