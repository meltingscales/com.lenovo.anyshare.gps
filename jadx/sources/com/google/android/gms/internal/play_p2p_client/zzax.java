...
public final class zzax {
    ...
    public zzax(zzaw zzawVar) {
        zzbn.zzb(zzawVar, "output");
        this.zza = zzawVar;
        this.zza.zza = this;
    }

    public static zzax zza(zzaw zzawVar) {
        zzax zzaxVar = zzawVar.zza;
        return zzaxVar != null ? zzaxVar : new zzax(zzawVar);
    }
    ...
    public final void zzA(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzaw.zzv(list.get(i4).intValue());
            }
            this.zza.zzl(i3);
            while (i2 < list.size()) {
    ...
    public final void zzD(int i, List<zzap> list) throws IOException {
    ...
    public final void zzE(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzaw.zzw(list.get(i4).intValue());
            }
            this.zza.zzl(i3);
            while (i2 < list.size()) {
    ...
    public final void zzH(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zzaw.zzw((intValue >> 31) ^ (intValue + intValue));
            }
            this.zza.zzl(i3);
            while (i2 < list.size()) {
                zzaw zzawVar = this.zza;
                int intValue2 = list.get(i2).intValue();
                zzawVar.zzl((intValue2 >> 31) ^ (intValue2 + intValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zzawVar2.zzc(i, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzI(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zzaw.zzx((longValue >> 63) ^ (longValue + longValue));
            }
            this.zza.zzl(i3);
            while (i2 < list.size()) {
                zzaw zzawVar = this.zza;
                long longValue2 = list.get(i2).longValue();
                zzawVar.zzn((longValue2 >> 63) ^ (longValue2 + longValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zzawVar2.zze(i, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
    ...
    public final void zzn(int i, zzap zzapVar) throws IOException {
        this.zza.zzi(i, zzapVar);
    }
    ...
    public final void zzr(int i, Object obj, zzcv zzcvVar) throws IOException {
        ...
        zzauVar.zzl(zzl);
        zzcvVar.zzi(zzckVar, zzauVar.zza);
    }

    public final void zzs(int i, Object obj, zzcv zzcvVar) throws IOException {
        zzaw zzawVar = this.zza;
        zzawVar.zza(i, 3);
        zzcvVar.zzi((zzck) obj, zzawVar.zza);
        zzawVar.zza(i, 4);
    }
    ...
    public final void zzv(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzaw.zzx(list.get(i4).longValue());
            }
            this.zza.zzl(i3);
            while (i2 < list.size()) {
