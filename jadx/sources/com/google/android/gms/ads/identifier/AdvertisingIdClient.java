...
public class AdvertisingIdClient {
        ...
        synchronized (this) {
            ...
            try {
                ...
                if (ConnectionTracker.getInstance().bindService(context, intent, blockingServiceConnection, 1)) {
                    ...
                    try {
                        this.zzb = zze.zza(this.zza.getServiceWithTimeout(n.f2525a, TimeUnit.MILLISECONDS));
                        this.zzc = true;
                        if (z) {
                            zze();
                        }
    ...
    public final boolean zzc(Info info, boolean z, float f, long j, String str, Throwable th) {
        if (Math.random() <= AbstractC4714Nqc.f12500a) {
            HashMap hashMap = new HashMap();
            hashMap.put("app_context", "1");
            if (info != null) {
                hashMap.put(LLi.E, true != info.isLimitAdTrackingEnabled() ? "0" : "1");
