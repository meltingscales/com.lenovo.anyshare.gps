...
public final class zzek extends ContentProvider {
    ...
    public class _lancet {
        ...
        public static void com_ushareit_launch_LaunchAop_attachInfoContentProvider(zzek zzekVar, Context context, ProviderInfo providerInfo) {
            long currentTimeMillis = System.currentTimeMillis();
            zzekVar.attachInfo$___twin___(context, providerInfo);
            C10597dTg.a(zzekVar.getClass().getSimpleName(), System.currentTimeMillis() - currentTimeMillis);
        }
    }
    ...
    public final void attachInfo$___twin___(Context context, ProviderInfo providerInfo) {
        ...
        try {
            ...
            zzbzr.zzh("Failed to load metadata: Package name not found.", e);
