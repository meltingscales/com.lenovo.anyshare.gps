    ...
    public static JSONObject zzc(String str, Context context, Point point, Point point2) {
        ...
        try {
            ...
            try {
                ...
                try {
                    jSONObject3.put(x.c, com.google.android.gms.ads.internal.client.zzay.zzb().zzb(context, point2.x));
                    ...
                    zzbzr.zzh("Error occurred while putting signals into JSON object.", e);
                }
            ...
            if (view2 != null) {
                ...
                try {
                    ...
                    try {
                        ...
                        jSONObject5.put(x.c, com.google.android.gms.ads.internal.client.zzay.zzb().zzb(context, zzj2[0] - zzj[0]));
                        ...
                        if (view2.getLocalVisibleRect(rect)) {
                            ...
                            jSONObject2.put(x.c, com.google.android.gms.ads.internal.client.zzay.zzb().zzb(context, zzj2[0] - zzj[0]));
                        ...
                        if (view2 instanceof TextView) {
                            ...
                            jSONObject4.put(DonutProgress.m, textView.getCurrentTextColor());
                            str = str3;
                            str2 = str4;
                            try {
    ...
    */
    ...
    public static boolean zzi(int i) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbbm.zzde)).booleanValue()) {
            return ((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbbm.zzdf)).booleanValue() || i <= 15299999;
        }
        return true;
    }
    ...
    public static JSONObject zzk(Context context, Rect rect) throws JSONException {
        ...
        jSONObject.put(x.c, com.google.android.gms.ads.internal.client.zzay.zzb().zzb(context, rect.left));
