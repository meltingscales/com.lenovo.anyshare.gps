...
public final class zzbu {
    ...
    public static String zzl(zzezs zzezsVar) {
        ...
        try {
            ...
            zzn(jsonWriter, zzezsVar);
            jsonWriter.close();
            return stringWriter.toString();
        } catch (IOException e) {
            zzbzr.zzh("Error when writing JSON.", e);
            return null;
        }
    }

    public static JSONObject zzm(JSONObject jSONObject, String[] strArr) {
    ...
    public static void zzn(JsonWriter jsonWriter, Object obj) throws IOException {
        if (obj == null) {
