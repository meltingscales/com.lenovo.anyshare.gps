...
public final class c {
    ...
    public c(Context context) throws PackageManager.NameNotFoundException {
        this.b = context;
        this.f6153a = context.getPackageManager().getPackageInfo(context.getPackageName(), 0).versionCode;
    }
    ...
    private final File g() throws IOException {
        File file = new File(h(), Long.toString(this.f6153a));
        d(file);
        return file;
    }
    ...
    public final void a() throws IOException {
        ...
        if (list != null) {
            for (String str : list) {
                if (!str.equals(Long.toString(this.f6153a))) {
