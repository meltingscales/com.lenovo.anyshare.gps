...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    public static final int ad1 = 2131887276;
    public static final int DEFAULT_THEME_ATTR = 2130968671;
    ...
    public BadgeDrawable(Context context, int i, int i2, int i3, BadgeState.State state) {
        ...
        setTextAppearanceResource(R.style.zs);
    ...
    private void calculateCenterAndBounds(Context context, Rect rect, View view) {
        ...
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(hasNumber() ? R.dimen.d64 : R.dimen.d61);
    ...
    public static BadgeDrawable create(Context context) {
        return new BadgeDrawable(context, 0, DEFAULT_THEME_ATTR, ad1, null);
    }

    public static BadgeDrawable createFromResource(Context context, int i) {
        return new BadgeDrawable(context, i, DEFAULT_THEME_ATTR, ad1, null);
    }

    public static BadgeDrawable createFromSavedState(Context context, BadgeState.State state) {
        return new BadgeDrawable(context, 0, DEFAULT_THEME_ATTR, ad1, state);
    }
    ...
    private String getBadgeText() {
        ...
        return context == null ? "" : String.format(this.state.getNumberLocale(), context.getString(R.string.c_p), Integer.valueOf(this.maxBadgeNumber), "+");
    }
    ...
    private void tryWrapAnchorInCompatParent(final View view) {
        ...
        if (viewGroup == null || viewGroup.getId() != R.id.clb) {
            WeakReference<FrameLayout> weakReference = this.customBadgeParentRef;
            if (weakReference == null || weakReference.get() != viewGroup) {
                updateAnchorParentToNotClip(view);
                final FrameLayout frameLayout = new FrameLayout(view.getContext());
                frameLayout.setId(R.id.clb);
