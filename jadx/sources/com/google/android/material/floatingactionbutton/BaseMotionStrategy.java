...
public abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(ZoomRecyclerView.f)) {
            arrayList.add(motionSpec.getAnimator(ZoomRecyclerView.f, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec.getAnimator(ZoomRecyclerView.f, this.fab, View.SCALE_X));
        }
