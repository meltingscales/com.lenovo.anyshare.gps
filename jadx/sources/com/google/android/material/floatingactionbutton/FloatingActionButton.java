...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public static final int a9u = 2131887121;
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public BaseBehavior(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{R.attr.lg});
    ...
    public class _lancet {
        ...
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setImageViewSubOnClickListener(FloatingActionButton floatingActionButton, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(floatingActionButton, onClickListener);
            } else {
                com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(floatingActionButton, new View$OnClickListenerC4863Odh(onClickListener));
            }
        }

        @Hrk(mayCreateSuper = true, value = "setOnClickListener")
        @Krk(scope = Scope.LEAF, value = "android.view.View")
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(FloatingActionButton floatingActionButton, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                floatingActionButton.setOnClickListener$___twin___(onClickListener);
            } else {
                floatingActionButton.setOnClickListener$___twin___(new View$OnClickListenerC4863Odh(onClickListener));
            }
        }
    }
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.vx);
    }
    ...
    private int getSizeDimension(int i) {
        ...
        if (i != -1) {
            if (i != 1) {
                return resources.getDimensionPixelSize(R.dimen.bx5);
            }
            return resources.getDimensionPixelSize(R.dimen.bx4);
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        super(MaterialThemeOverlay.wrap(context, attributeSet, i, a9u), attributeSet, i);
        this.shadowPadding = new Rect();
        this.touchArea = new Rect();
        Context context2 = getContext();
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, new int[]{16842766, R.attr.kx, R.attr.ky, R.attr.ls, R.attr.u0, R.attr.uf, R.attr.ve, R.attr.vf, R.attr.xe, R.attr.xp, R.attr.a56, R.attr.a90, R.attr.aa7, R.attr.aav, R.attr.aay, R.attr.adb, R.attr.amf}, i, a9u, new int[0]);
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(R.dimen.d8z);
        ...
        ShapeAppearanceModel build = ShapeAppearanceModel.builder(context2, attributeSet, i, a9u, ShapeAppearanceModel.PILL).build();
