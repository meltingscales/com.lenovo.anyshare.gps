...
public class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public BorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, R.color.a8u), ContextCompat.getColor(context, R.color.a8t), ContextCompat.getColor(context, R.color.a8r), ContextCompat.getColor(context, R.color.a8s));
