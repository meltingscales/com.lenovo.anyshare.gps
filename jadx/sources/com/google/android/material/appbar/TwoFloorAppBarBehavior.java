...
public class TwoFloorAppBarBehavior<T extends AppBarLayout> extends AppBarLayout.BaseBehavior<T> {
    ...
    private void addAccessibilityScrollActions(final CoordinatorLayout coordinatorLayout, final T t, final View view) {
        ...
        if (getTopBottomOffsetForScrollingSibling() != 0) {
            if (view.canScrollVertically(-1)) {
                ...
                if (i != 0) {
                    ViewCompat.replaceAccessibilityAction(coordinatorLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_SCROLL_BACKWARD, null, new AccessibilityViewCommand() { // from class: com.google.android.material.appbar.TwoFloorAppBarBehavior.2
                        /* JADX WARN: Multi-variable type inference failed */
                        @Override // androidx.core.view.accessibility.AccessibilityViewCommand
                        public boolean perform(View view2, AccessibilityViewCommand.CommandArguments commandArguments) {
                            TwoFloorAppBarBehavior.this.onNestedPreScroll(coordinatorLayout, (CoordinatorLayout) t, view, 0, i, new int[]{0, 0}, 1);
                            return true;
                        }
                    });
                    return;
    ...
    private void addActionToExpand(CoordinatorLayout coordinatorLayout, final T t, AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat, final boolean z) {
        ViewCompat.replaceAccessibilityAction(coordinatorLayout, accessibilityActionCompat, null, new AccessibilityViewCommand() { // from class: com.google.android.material.appbar.TwoFloorAppBarBehavior.3
            @Override // androidx.core.view.accessibility.AccessibilityViewCommand
    ...
    private void animateOffsetWithDuration(final CoordinatorLayout coordinatorLayout, final T t, int i, int i2) {
        ...
        if (valueAnimator2 == null) {
            ...
            this.offsetAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.TwoFloorAppBarBehavior.1
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public void onAnimationUpdate(ValueAnimator valueAnimator3) {
                    TwoFloorAppBarBehavior.this.setHeaderTopBottomOffset(coordinatorLayout, t, ((Integer) valueAnimator3.getAnimatedValue()).intValue());
                }
            });
        } else {
    ...
    public /* bridge */ /* synthetic */ boolean canDragView(View view) {
        return canDragView((TwoFloorAppBarBehavior<T>) ((AppBarLayout) view));
    }
    ...
    public /* bridge */ /* synthetic */ int getMaxDragOffset(View view) {
        return getMaxDragOffset((TwoFloorAppBarBehavior<T>) ((AppBarLayout) view));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // com.google.android.material.appbar.AppBarLayout.BaseBehavior, com.google.android.material.appbar.HeaderBehavior
    public /* bridge */ /* synthetic */ int getScrollRangeForDragFling(View view) {
        return getScrollRangeForDragFling((TwoFloorAppBarBehavior<T>) ((AppBarLayout) view));
    }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: com.google.android.material.appbar.TwoFloorAppBarBehavior.SavedState.1
    ...
    public TwoFloorAppBarBehavior(Context context, AttributeSet attributeSet) {
