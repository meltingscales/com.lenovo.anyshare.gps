...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public class _lancet {
        ...
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewGroupSubOnClickListener(NavigationMenuItemView navigationMenuItemView, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                ...
                com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(navigationMenuItemView, new View$OnClickListenerC4863Odh(onClickListener));
            }
        }
        ...
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(NavigationMenuItemView navigationMenuItemView, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                ...
                navigationMenuItemView.setOnClickListener$___twin___(new View$OnClickListenerC4863Odh(onClickListener));
            }
        }
    }
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (getContext().getTheme().resolveAttribute(R.attr.pg, typedValue, true)) {
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(R.id.bdy)).inflate();
            }
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.emptyDrawable == null) {
                this.emptyDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.d0s, getContext().getTheme());
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        setIconSize(context.getResources().getDimensionPixelSize(R.dimen.bx_));
        this.textView = (CheckedTextView) findViewById(R.id.bdz);
