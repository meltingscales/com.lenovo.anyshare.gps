...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    public static final int DEF_STYLE_RES = R.style.ad_;
    ...
    private void updateIconPosition(int i, int i2) {
        ...
        if (i4 != 1 && i4 != 3 && ((i4 != 2 || actualTextAlignment != Layout.Alignment.ALIGN_NORMAL) && (this.iconGravity != 4 || actualTextAlignment != Layout.Alignment.ALIGN_OPPOSITE))) {
            ...
            int textWidth = ((((i - getTextWidth()) - ViewCompat.getPaddingEnd(this)) - i5) - this.iconPadding) - ViewCompat.getPaddingStart(this);
    ...
    public MaterialButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, new int[]{16842964, 16843191, 16843192, 16843193, 16843194, 16843237, R.attr.kx, R.attr.ky, R.attr.r9, R.attr.u0, R.attr.xq, R.attr.xs, R.attr.xt, R.attr.xu, R.attr.xw, R.attr.xx, R.attr.aa7, R.attr.aav, R.attr.aay, R.attr.ag8, R.attr.ag9}, i, DEF_STYLE_RES, new int[0]);
