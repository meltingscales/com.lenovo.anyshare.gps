...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public BottomSheetDialog(Context context) {
        this(context, 0);
        this.edgeToEdgeEnabled = getContext().getTheme().obtainStyledAttributes(new int[]{R.attr.u5}).getBoolean(0, false);
    }

    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            this.container = (FrameLayout) View.inflate(getContext(), R.layout.a2j, null);
            this.coordinator = (CoordinatorLayout) this.container.findViewById(R.id.bbq);
            this.bottomSheet = (FrameLayout) this.container.findViewById(R.id.bdw);
    ...
    public static int getThemeResId(Context context, int i) {
        if (i == 0) {
            ...
            return context.getTheme().resolveAttribute(R.attr.m2, typedValue, true) ? typedValue.resourceId : R.style.a1g;
        }
        return i;
    }
    ...
    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) this.container.findViewById(R.id.bbq);
        if (i != 0 && view == null) {
        ...
        _lancet.com_ushareit_mcds_uatracker_aop_UATAop_setOnClickListener(coordinatorLayout.findViewById(R.id.drx), new View.OnClickListener() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.2
