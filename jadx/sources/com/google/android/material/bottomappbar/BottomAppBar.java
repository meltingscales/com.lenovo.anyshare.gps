...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public static final int ad2 = 2131887277;
                ...
                public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                    ...
                    if (bottomAppBar != null && (view instanceof FloatingActionButton)) {
                        ...
                        if (Behavior.this.originalBottomMargin == 0) {
                            ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin = bottomAppBar.getBottomInset() + (bottomAppBar.getResources().getDimensionPixelOffset(R.dimen.d6_) - ((floatingActionButton.getMeasuredHeight() - height) / 2));
    ...
    public class _lancet {
        ...
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewGroupSubOnClickListener(BottomAppBar bottomAppBar, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(bottomAppBar, onClickListener);
            } else {
                com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(bottomAppBar, new View$OnClickListenerC4863Odh(onClickListener));
            }
        }

        @Hrk(mayCreateSuper = true, value = "setOnClickListener")
        @Krk(scope = Scope.LEAF, value = "android.view.View")
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(BottomAppBar bottomAppBar, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                bottomAppBar.setOnClickListener$___twin___(onClickListener);
            } else {
                bottomAppBar.setOnClickListener$___twin___(new View$OnClickListenerC4863Odh(onClickListener));
            }
        }
    }
    ...
    */
    ...
    public BottomAppBar(Context context, AttributeSet attributeSet, int i) {
        super(MaterialThemeOverlay.wrap(context, attributeSet, i, ad2), attributeSet, i);
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, new int[]{R.attr.kx, R.attr.u0, R.attr.v_, R.attr.va, R.attr.vb, R.attr.vc, R.attr.vd, R.attr.xg, R.attr.a6y, R.attr.a80, R.attr.a82, R.attr.a83}, i, ad2, new int[0]);
        ...
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(R.dimen.d69);
        ...
        ViewUtils.doOnApplyWindowInsets(this, attributeSet, i, ad2, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.3
