...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    public static final int adn = 2131887299;
        ...
        public void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    objArr[0] = text;
                    accessibilityNodeInfoCompat.setContentDescription(context.getString(R.string.c_n, objArr).trim());
                }
    ...
    public class _lancet {
        ...
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setBtnSubOnClickListener(Chip chip, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                com_ushareit_mcds_uatracker_aop_UATAop_setTextViewSubOnClickListener(chip, onClickListener);
            } else {
                com_ushareit_mcds_uatracker_aop_UATAop_setTextViewSubOnClickListener(chip, new View$OnClickListenerC4863Odh(onClickListener));
            }
        }

        @Hrk(mayCreateSuper = true, value = "setOnClickListener")
        @Krk(scope = Scope.LEAF, value = "android.widget.CheckBox")
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setCheckBoxSubOnClickListener(Chip chip, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                com_ushareit_mcds_uatracker_aop_UATAop_setBtnSubOnClickListener(chip, onClickListener);
            } else {
                com_ushareit_mcds_uatracker_aop_UATAop_setBtnSubOnClickListener(chip, new View$OnClickListenerC4863Odh(onClickListener));
            }
        }

        @Hrk(mayCreateSuper = true, value = "setOnClickListener")
        @Krk(scope = Scope.LEAF, value = "android.widget.TextView")
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setTextViewSubOnClickListener(Chip chip, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(chip, onClickListener);
            } else {
                com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(chip, new View$OnClickListenerC4863Odh(onClickListener));
            }
        }

        @Hrk(mayCreateSuper = true, value = "setOnClickListener")
        @Krk(scope = Scope.LEAF, value = "android.view.View")
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(Chip chip, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                chip.setOnClickListener$___twin___(onClickListener);
            } else {
                chip.setOnClickListener$___twin___(new View$OnClickListenerC4863Odh(onClickListener));
            }
        }
    }
    ...
    private void initMinTouchTarget(Context context, AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, new int[]{16842804, 16842901, 16842904, 16842923, 16843039, 16843087, 16843237, R.attr.nk, R.attr.f33402nl, R.attr.np, R.attr.nq, R.attr.ns, R.attr.nt, R.attr.nu, R.attr.nw, R.attr.nx, R.attr.ny, R.attr.nz, R.attr.o0, R.attr.o1, R.attr.o2, R.attr.o7, R.attr.o8, R.attr.o9, R.attr.oa, R.attr.op, R.attr.oq, R.attr.or, R.attr.os, R.attr.ot, R.attr.ou, R.attr.ov, R.attr.uf, R.attr.xe, R.attr.xr, R.attr.xv, R.attr.aa7, R.attr.aav, R.attr.aay, R.attr.adb, R.attr.aj2, R.attr.ajc}, i, adn, new int[0]);
    ...
    */
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        super(MaterialThemeOverlay.wrap(context, attributeSet, i, adn), attributeSet, i);
        this.rect = new Rect();
        ...
        ChipDrawable createFromAttributes = ChipDrawable.createFromAttributes(context2, attributeSet, i, adn);
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, new int[]{16842804, 16842901, 16842904, 16842923, 16843039, 16843087, 16843237, R.attr.nk, R.attr.f33402nl, R.attr.np, R.attr.nq, R.attr.ns, R.attr.nt, R.attr.nu, R.attr.nw, R.attr.nx, R.attr.ny, R.attr.nz, R.attr.o0, R.attr.o1, R.attr.o2, R.attr.o7, R.attr.o8, R.attr.o9, R.attr.oa, R.attr.op, R.attr.oq, R.attr.or, R.attr.os, R.attr.ot, R.attr.ou, R.attr.ov, R.attr.uf, R.attr.xe, R.attr.xr, R.attr.xv, R.attr.aa7, R.attr.aav, R.attr.aay, R.attr.adb, R.attr.aj2, R.attr.ajc}, i, adn, new int[0]);
        if (Build.VERSION.SDK_INT < 23) {
