...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public class _lancet {
        ...
        public static void com_lenovo_anyshare_hyperboost_scene_HyperBoostSceneAop_androidxFragmentOnViewCreated(MaterialCalendar materialCalendar, View view, Bundle bundle) {
            materialCalendar.onViewCreated$___twin___(view, bundle);
            String name = materialCalendar.getClass().getName();
    ...
    private void addActionsToMonthNavigation(View view, final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton materialButton = (MaterialButton) view.findViewById(R.id.ckn);
        ...
        ViewCompat.setAccessibilityDelegate(materialButton, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.5
            ...
            public void onInitializeAccessibilityNodeInfo(View view2, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    string = MaterialCalendar.this.getString(R.string.caj);
                } else {
                    string = MaterialCalendar.this.getString(R.string.cah);
                }
                accessibilityNodeInfoCompat.setHintText(string);
            }
        });
        MaterialButton materialButton2 = (MaterialButton) view.findViewById(R.id.ckp);
        materialButton2.setTag(NAVIGATION_PREV_TAG);
        MaterialButton materialButton3 = (MaterialButton) view.findViewById(R.id.cko);
        materialButton3.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = view.findViewById(R.id.clj);
        this.dayFrame = view.findViewById(R.id.clc);
    ...
    public static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(R.dimen.d78);
    }

    public static int getDialogPickerHeight(Context context) {
        Resources resources = context.getResources();
        return resources.getDimensionPixelSize(R.dimen.d7s) + resources.getDimensionPixelOffset(R.dimen.d7t) + resources.getDimensionPixelOffset(R.dimen.d7r) + resources.getDimensionPixelSize(R.dimen.d7c) + (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(R.dimen.d78)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(R.dimen.d7q)) + resources.getDimensionPixelOffset(R.dimen.d75);
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        GridView gridView = (GridView) inflate.findViewById(R.id.cld);
        ...
        this.recyclerView = (RecyclerView) inflate.findViewById(R.id.clg);
        ...
        this.yearSelector = (RecyclerView) inflate.findViewById(R.id.clj);
        ...
        if (inflate.findViewById(R.id.ckn) != null) {
