...
public class UtcDates {
    ...
    public static String getTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        String string = resources.getString(R.string.caf);
        String string2 = resources.getString(R.string.cae);
        String string3 = resources.getString(R.string.cad);
    ...
    public static String removeYearFromDateFormatPattern(String str) {
        ...
        return str.replace(str.substring(findCharactersInDateFormatPattern(str, str2, -1, findCharactersInDateFormatPattern) + 1, findCharactersInDateFormatPattern2), C2051Ejc.f8464a).trim();
    }
