...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = ContextCompat.getColor(context, R.color.a8q);
        this.shadowMiddleColor = ContextCompat.getColor(context, R.color.a8p);
        this.shadowEndColor = ContextCompat.getColor(context, R.color.a8o);
