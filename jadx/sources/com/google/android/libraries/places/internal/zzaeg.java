...
public final class zzaeg extends zzacd implements RandomAccess, zzadq, zzaey {
    public static final zzaeg zza = new zzaeg(new long[0], 0);
    public long[] zzb;
    public int zzc;
    ...
    public final /* bridge */ /* synthetic */ zzadr zzf(int i) {
        if (i >= this.zzc) {
            return new zzaeg(Arrays.copyOf(this.zzb, i), this.zzc);
        }
        throw new IllegalArgumentException();
    }

    public zzaeg(long[] jArr, int i) {
        this.zzb = jArr;
        this.zzc = i;
    }
