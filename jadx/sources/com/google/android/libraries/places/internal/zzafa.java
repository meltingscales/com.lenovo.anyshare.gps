...
public final class zzafa extends zzacd implements RandomAccess {
    public static final zzafa zza = new zzafa(new Object[0], 0);
    public Object[] zzb;
    public int zzc;
    ...
    public final /* bridge */ /* synthetic */ zzadr zzf(int i) {
        if (i >= this.zzc) {
            return new zzafa(Arrays.copyOf(this.zzb, i), this.zzc);
        }
        throw new IllegalArgumentException();
    }

    public zzafa(Object[] objArr, int i) {
        this.zzb = objArr;
        this.zzc = i;
    }
