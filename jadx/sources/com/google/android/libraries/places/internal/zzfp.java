...
public final class zzfp {
    ...
    public static boolean zzc(int i, int i2, int i3) {
        ...
        return zze <= 3.0d && zze <= zze(zzf(i3), zzf);
    }

    public static double zzd(double d) {
    ...
    public static double zzf(int i) {
        double red = Color.red(i);
        Double.isNaN(red);
        double green = Color.green(i);
        Double.isNaN(green);
        double zzd = (zzd(red / 255.0d) * 0.2126d) + (zzd(green / 255.0d) * 0.7152d);
        double blue = Color.blue(i);
        Double.isNaN(blue);
        return zzd + (zzd(blue / 255.0d) * 0.0722d);
    }
}
