...
import com.lenovo.anyshare.C20133sxk;
...
public final class HijrahDate extends AbstractC9134axk<HijrahDate> implements Serializable {
    public static final Long[] ADJUSTED_CYCLES;
    public static final Integer[] ADJUSTED_LEAST_MAX_VALUES;
    public static final Integer[] ADJUSTED_MAX_VALUES;
    public static final Integer[] ADJUSTED_MIN_VALUES;
    public static final String DEFAULT_CONFIG_FILENAME = "hijrah_deviation.cfg";
    public static final Integer[] DEFAULT_CYCLE_YEARS;
    public static final Integer[] DEFAULT_LEAP_MONTH_DAYS;
    public static final Integer[] DEFAULT_LEAP_MONTH_LENGTHS;
    public static final Integer[] DEFAULT_MONTH_LENGTHS;
    public static final int HIJRAH_JAN_1_1_GREGORIAN_DAY = -492148;
    public static final int MAX_ADJUSTED_CYCLE = 334;
    public static final int MAX_VALUE_OF_ERA = 9999;
    public static final int MIN_VALUE_OF_ERA = 1;
    public static final int POSITION_DAY_OF_MONTH = 5;
    public static final int POSITION_DAY_OF_YEAR = 6;
    ...
    public static final int[] NUM_DAYS = {0, 30, 59, 89, 118, 148, 177, InterfaceC13225hhc.Xc, InterfaceC13225hhc.zd, 266, 295, 325};
    public static final int[] LEAP_NUM_DAYS = {0, 30, 59, 89, 118, 148, 177, InterfaceC13225hhc.Xc, InterfaceC13225hhc.zd, 266, 295, 325};
    ...
    public static final String DEFAULT_CONFIG_PATH = "org" + FILE_SEP + "threeten" + FILE_SEP + "bp" + FILE_SEP + "chrono";
    ...
    public static void addDeviationAsHijrah(int i, int i2, int i3, int i4, int i5) {
        ...
        int intValue3 = ADJUSTED_MONTH_DAYS.get(Integer.valueOf(i))[11].intValue() + numArr11[11].intValue();
        int intValue4 = ADJUSTED_MONTH_DAYS.get(Integer.valueOf(i3))[11].intValue() + numArr12[11].intValue();
    ...
    public static void checkValidDayOfYear(int i) {
        if (i < 1 || i > getMaximumDayOfYear()) {
            throw new DateTimeException("Invalid day of year of Hijrah date");
        }
    }

    public static void checkValidMonth(int i) {
        if (i < 1 || i > 12) {
            throw new DateTimeException("Invalid month of Hijrah date");
        }
    }

    public static void checkValidYearOfEra(int i) {
        if (i < 1 || i > 9999) {
            throw new DateTimeException("Invalid year of Hijrah Era");
        }
    }

    public static HijrahDate from(InterfaceC12194fyk interfaceC12194fyk) {
        return HijrahChronology.INSTANCE.date(interfaceC12194fyk);
    }
    ...
    public static Integer[] getAdjustedMonthLength(int i) {
        Integer[] numArr;
        try {
    ...
    public static InputStream getConfigFileInputStream() throws IOException {
        ZipFile zipFile;
    ...
    public static int getCycleNumber(long j) {
        Long[] lArr = ADJUSTED_CYCLES;
    ...
    public static int getDayOfCycle(long j, int i) {
        Long l;
        try {
            l = ADJUSTED_CYCLES[i];
        } catch (ArrayIndexOutOfBoundsException unused) {
    ...
    public static int[] getHijrahDateInfo(long j) {
        int monthOfYear;
        int dayOfMonth;
        int value;
        int i;
    ...
    private Object writeReplace() {
        return new C23188xxk((byte) 3, this);
    }

    public static long yearToGregorianEpochDay(int i) {
        Long l;
        int i2 = i - 1;
        int i3 = i2 / 30;
        int i4 = i2 % 30;
    ...
    public final AbstractC11572exk<HijrahDate> atTime(LocalTime localTime) {
    ...
    public long getLong(InterfaceC15267kyk interfaceC15267kyk) {
        ...
        if (interfaceC15267kyk instanceof ChronoField) {
            switch (C20133sxk.f26909a[((ChronoField) interfaceC15267kyk).ordinal()]) {
                case 1:
                    i = this.dayOfMonth;
                    break;
                case 2:
    ...
    public ValueRange range(InterfaceC15267kyk interfaceC15267kyk) {
        if (interfaceC15267kyk instanceof ChronoField) {
            if (isSupported(interfaceC15267kyk)) {
                ...
                int i = C20133sxk.f26909a[chronoField.ordinal()];
                if (i != 1) {
                    if (i != 2) {
                        if (i != 3) {
                            if (i != 4) {
    ...
    public AbstractC9134axk<HijrahDate> plusDays(long j) {
        return new HijrahDate(this.gregorianEpochDay + j);
    }

    @Override // com.lenovo.anyshare.AbstractC9134axk
    public AbstractC9134axk<HijrahDate> plusMonths(long j) {
        if (j == 0) {
            return this;
        }
        ...
        return of(this.era, Xxk.d(this.yearOfEra, i2), i3 + 1, this.dayOfMonth);
    }

    @Override // com.lenovo.anyshare.AbstractC9134axk
    public AbstractC9134axk<HijrahDate> plusYears(long j) {
        if (j == 0) {
            return this;
        }
        return of(this.era, Xxk.d(this.yearOfEra, (int) j), this.monthOfYear, this.dayOfMonth);
    }

    @Override // com.lenovo.anyshare.AbstractC9134axk, com.lenovo.anyshare.AbstractC10353cxk
    public /* bridge */ /* synthetic */ AbstractC13425hxk until(AbstractC10353cxk abstractC10353cxk) {
        super.until(abstractC10353cxk);
        throw null;
    }

    public static HijrahDate now(AbstractC20732twk abstractC20732twk) {
        return HijrahChronology.INSTANCE.dateNow(abstractC20732twk);
    }
    ...
    public HijrahDate minus(InterfaceC14657jyk interfaceC14657jyk) {
        return (HijrahDate) super.minus(interfaceC14657jyk);
    }

    @Override // com.lenovo.anyshare.AbstractC10353cxk, com.lenovo.anyshare.Vxk, com.lenovo.anyshare.InterfaceC11584eyk
    public HijrahDate with(InterfaceC12826gyk interfaceC12826gyk) {
        return (HijrahDate) super.with(interfaceC12826gyk);
    }

    @Override // com.lenovo.anyshare.AbstractC10353cxk, com.lenovo.anyshare.Vxk, com.lenovo.anyshare.InterfaceC11584eyk
    public HijrahDate minus(long j, InterfaceC21367uyk interfaceC21367uyk) {
        return (HijrahDate) super.minus(j, interfaceC21367uyk);
    }

    @Override // com.lenovo.anyshare.AbstractC10353cxk, com.lenovo.anyshare.Vxk, com.lenovo.anyshare.InterfaceC11584eyk
    public HijrahDate plus(InterfaceC14657jyk interfaceC14657jyk) {
        return (HijrahDate) super.plus(interfaceC14657jyk);
    }
    ...
    public HijrahDate with(InterfaceC15267kyk interfaceC15267kyk, long j) {
        if (interfaceC15267kyk instanceof ChronoField) {
            ChronoField chronoField = (ChronoField) interfaceC15267kyk;
            chronoField.checkValidValue(j);
            int i = (int) j;
            switch (C20133sxk.f26909a[chronoField.ordinal()]) {
                case 1:
        ...
        return (HijrahDate) interfaceC15267kyk.adjustInto(this, j);
    }
    ...
    public HijrahDate plus(long j, InterfaceC21367uyk interfaceC21367uyk) {
        return (HijrahDate) super.plus(j, interfaceC21367uyk);
    }
