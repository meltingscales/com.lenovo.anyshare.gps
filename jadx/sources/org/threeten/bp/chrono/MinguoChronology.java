...
import com.lenovo.anyshare.C21966vxk;
...
public final class MinguoChronology extends AbstractC18914qxk implements Serializable {
    ...
    @Override // com.lenovo.anyshare.AbstractC18914qxk
    public AbstractC11572exk<MinguoDate> localDateTime(InterfaceC12194fyk interfaceC12194fyk) {
        return super.localDateTime(interfaceC12194fyk);
    }

    @Override // com.lenovo.anyshare.AbstractC18914qxk
    public int prolepticYear(InterfaceC19522rxk interfaceC19522rxk, int i) {
        if (interfaceC19522rxk instanceof MinguoEra) {
            return interfaceC19522rxk == MinguoEra.ROC ? i : 1 - i;
        }
    ...
    public ValueRange range(ChronoField chronoField) {
        int i = C21966vxk.f28225a[chronoField.ordinal()];
        if (i == 1) {
    ...
    @Override // com.lenovo.anyshare.AbstractC18914qxk
    public AbstractC15865lxk<MinguoDate> zonedDateTime(InterfaceC12194fyk interfaceC12194fyk) {
    ...
    /* JADX WARN: Type inference failed for: r11v20, types: [org.threeten.bp.chrono.MinguoDate, com.lenovo.anyshare.Wxk] */
    ...
    @Override // com.lenovo.anyshare.AbstractC18914qxk
    public MinguoDate resolveDate(Map<InterfaceC15267kyk, Long> map, ResolverStyle resolverStyle) {
        ...
        if (map.containsKey(ChronoField.YEAR)) {
            if (map.containsKey(ChronoField.MONTH_OF_YEAR)) {
                if (map.containsKey(ChronoField.DAY_OF_MONTH)) {
                    ...
                    if (map.containsKey(ChronoField.ALIGNED_DAY_OF_WEEK_IN_MONTH)) {
                        ...
                        MinguoDate plus = date(checkValidIntValue4, checkValidIntValue5, 1).plus(((checkValidIntValue6 - 1) * 7) + (chronoField6.checkValidIntValue(map.remove(chronoField6).longValue()) - 1), (InterfaceC21367uyk) ChronoUnit.DAYS);
                        ...
                        MinguoDate with = date(checkValidIntValue7, checkValidIntValue8, 1).plus(checkValidIntValue9 - 1, (InterfaceC21367uyk) ChronoUnit.WEEKS).with(C14048iyk.d(DayOfWeek.of(chronoField10.checkValidIntValue(map.remove(chronoField10).longValue()))));
            ...
            if (map.containsKey(ChronoField.DAY_OF_YEAR)) {
                ...
                if (map.containsKey(ChronoField.ALIGNED_DAY_OF_WEEK_IN_YEAR)) {
                    ...
                    MinguoDate with2 = date(checkValidIntValue13, 1, 1).plus(checkValidIntValue14 - 1, (InterfaceC21367uyk) ChronoUnit.WEEKS).with(C14048iyk.d(DayOfWeek.of(chronoField18.checkValidIntValue(map.remove(chronoField18).longValue()))));
    ...
    @Override // com.lenovo.anyshare.AbstractC18914qxk
    public AbstractC15865lxk<MinguoDate> zonedDateTime(Instant instant, ZoneId zoneId) {
        return super.zonedDateTime(instant, zoneId);
    }

    @Override // com.lenovo.anyshare.AbstractC18914qxk
    public MinguoDate dateYearDay(InterfaceC19522rxk interfaceC19522rxk, int i, int i2) {
        return (MinguoDate) super.dateYearDay(interfaceC19522rxk, i, i2);
    }

    @Override // com.lenovo.anyshare.AbstractC18914qxk
    public MinguoDate date(InterfaceC19522rxk interfaceC19522rxk, int i, int i2, int i3) {
        return (MinguoDate) super.date(interfaceC19522rxk, i, i2, i3);
    }
    ...
    @Override // com.lenovo.anyshare.AbstractC18914qxk
    public MinguoDate date(InterfaceC12194fyk interfaceC12194fyk) {
        if (interfaceC12194fyk instanceof MinguoDate) {
            return (MinguoDate) interfaceC12194fyk;
        }
        return new MinguoDate(LocalDate.from(interfaceC12194fyk));
    }

    @Override // com.lenovo.anyshare.AbstractC18914qxk
    public MinguoDate dateNow(AbstractC20732twk abstractC20732twk) {
        Xxk.a(abstractC20732twk, "clock");
        return (MinguoDate) super.dateNow(abstractC20732twk);
    }
}
