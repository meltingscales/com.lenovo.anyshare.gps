...
public class URLEncodedUtils {
    ...
    public static final BitSet PATH_SEPARATORS = new BitSet(256);
    ...
    public static boolean isEncoded(HttpEntity httpEntity) {
        ...
        if (contentType != null) {
            ...
            if (elements.length > 0) {
                return elements[0].getName().equalsIgnoreCase(b.e);
            }
        }
        return false;
    }
        ...
        while (wrap.hasRemaining()) {
            ...
            if (c == '%' && wrap.remaining() >= 2) {
                ...
                if (digit != -1 && digit2 != -1) {
                    ...
                    allocate.put(InterfaceC18296pxc.F);
    ...
    public static List<NameValuePair> parse(HttpEntity httpEntity) throws IOException {
        ...
        if (contentType != null && contentType.getMimeType().equalsIgnoreCase(b.e)) {
