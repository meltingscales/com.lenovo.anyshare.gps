...
public class ResponseAuthCache implements HttpResponseInterceptor {
    public final Log log = LogFactory.getLog(ResponseAuthCache.class);

    /* renamed from: org.apache.http.client.protocol.ResponseAuthCache$1  reason: invalid class name */
    /* loaded from: classes9.dex */
    static /* synthetic */ class AnonymousClass1 {
        public static final /* synthetic */ int[] $SwitchMap$org$apache$http$auth$AuthProtocolState = new int[AuthProtocolState.values().length];
