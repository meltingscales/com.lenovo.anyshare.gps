...
public class ResponseProcessCookies implements HttpResponseInterceptor {
    public final Log log = LogFactory.getLog(ResponseProcessCookies.class);
    ...
    public static String formatCooke(Cookie cookie) {
        ...
        if (value != null) {
            if (value.length() > 100) {
                value = value.substring(0, 100) + C0945Apc.b;
            }
            sb.append(value);
        }
        sb.append("\"");
    ...
    public void process(HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        processCookies(httpResponse.headerIterator(HttpHeaders.HEAD_KEY_SET_COOKIE), cookieSpec, cookieOrigin, cookieStore);
        if (cookieSpec.getVersion() > 0) {
            processCookies(httpResponse.headerIterator(HttpHeaders.HEAD_KEY_SET_COOKIE2), cookieSpec, cookieOrigin, cookieStore);
        }
    }
}
