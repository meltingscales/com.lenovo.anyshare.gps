        ...
        for (NameType nameType : NameType.values()) {
            ...
            for (RuleType ruleType : RuleType.values()) {
                ...
                if (!ruleType.equals(RuleType.RULES)) {
                    try {
                        hashMap.put(c.X, parseRules(createScanner(nameType, ruleType, c.X), createResourceName(nameType, ruleType, c.X)));
                    } finally {
                    }
                }
    ...
    public static PhonemeExpr parsePhonemeExpr(String str) {
        if (str.startsWith("(")) {
            if (str.endsWith(")")) {
                ...
                if (substring.startsWith(a.bU) || substring.endsWith(a.bU)) {
            ...
            if (z) {
                ...
                if (nextLine.startsWith("/*")) {
                    ...
                    if (trim.length() == 0) {
                        ...
                        if (!trim2.contains(C2051Ejc.f8464a)) {
