...
public class DoubleMetaphone implements StringEncoder {
    ...
    public static final String[] L_R_N_M_B_H_F_V_W_SPACE = {"L", "R", "N", "M", "B", "H", "F", "V", "W", C2051Ejc.f8464a};
    public static final String[] ES_EP_EB_EL_EY_IB_IL_IN_IE_EI_ER = {"ES", "EP", "EB", "EL", "EY", "IB", "IL", ATCountryCode.INDIA, "IE", "EI", "ER"};
    ...
    private boolean conditionCH1(String str, int i) {
        if (!contains(str, 0, 4, "VAN ", "VON ") && !contains(str, 0, 3, "SCH") && !contains(str, i - 2, 6, "ORCHES", "ARCHIT", "ORCHID")) {
            int i2 = i + 2;
            if (!contains(str, i2, 1, RequestConfiguration.MAX_AD_CONTENT_RATING_T, "S")) {
                if (!contains(str, i - 1, 1, C2727Gsd.f9402a, "O", "U", "E") && i != 0) {
                    return false;
                }
    ...
    private boolean conditionL0(String str, int i) {
        ...
        return (contains(str, str.length() - 2, 2, "AS", "OS") || contains(str, str.length() - 1, 1, C2727Gsd.f9402a, "O")) && contains(str, i - 1, 4, "ALLE");
    }
    ...
    private int handleGH(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        if (i > 0 && !isVowel(charAt(str, i - 1))) {
            ...
            if (i > 2 && charAt(str, i - 1) == 'U' && contains(str, i - 3, 1, "C", RequestConfiguration.MAX_AD_CONTENT_RATING_G, "L", "R", RequestConfiguration.MAX_AD_CONTENT_RATING_T)) {
    ...
    private int handleJ(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if (i == 0 && !contains(str, i, 4, "JOSE")) {
            ...
            if (i == str.length() - 1) {
                doubleMetaphoneResult.append('J', Ascii.CASE_MASK);
    ...
    private int handleR(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        if (i == str.length() - 1 && !z && contains(str, i - 2, 2, "IE") && !contains(str, i - 4, 2, "ME", RequestConfiguration.MAX_AD_CONTENT_RATING_MA)) {
    ...
    private int handleT(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        if (contains(str, i, 4, "TION")) {
            ...
            if (!contains(str, i, 2, "TH") && !contains(str, i, 3, "TTH")) {
                doubleMetaphoneResult.append('T');
                int i2 = i + 1;
                return contains(str, i2, 1, RequestConfiguration.MAX_AD_CONTENT_RATING_T, "D") ? i + 2 : i2;
            }
            int i3 = i + 2;
            if (!contains(str, i3, 2, "OM", "AM") && !contains(str, 0, 4, "VAN ", "VON ") && !contains(str, 0, 3, "SCH")) {
                doubleMetaphoneResult.append(BCc.f6785a, 'T');
                return i3;
            }
            doubleMetaphoneResult.append('T');
            return i3;
