...
public class XXHash32 implements Checksum {
    ...
    public static int getInt(byte[] bArr, int i) {
        return (int) (fromLittleEndian(bArr, i, 4) & DNi.c);
    }
    ...
    private void process(byte[] bArr, int i) {
        ...
        iArr2[0] = Integer.rotateLeft(i2 + (getInt(bArr, i) * (-2048144777)), 13) * (-1640531535);
        iArr2[1] = Integer.rotateLeft(i3 + (getInt(bArr, i + 4) * (-2048144777)), 13) * (-1640531535);
        iArr2[2] = Integer.rotateLeft(i4 + (getInt(bArr, i + 8) * (-2048144777)), 13) * (-1640531535);
        iArr2[3] = Integer.rotateLeft(i5 + (getInt(bArr, i + 12) * (-2048144777)), 13) * (-1640531535);
        this.pos = 0;
    }
    ...
    public long getValue() {
        ...
        if (this.totalLen > 16) {
            ...
            i = this.state[2] + 374761393;
        }
        int i3 = i + this.totalLen;
        int i4 = this.pos - 4;
        while (i2 <= i4) {
            i3 = Integer.rotateLeft(i3 + (getInt(this.buffer, i2) * (-1028477379)), 17) * 668265263;
            i2 += 4;
        }
        while (i2 < this.pos) {
            i3 = Integer.rotateLeft(i3 + ((this.buffer[i2] & 255) * 374761393), 11) * (-1640531535);
            i2++;
        }
        int i5 = (i3 ^ (i3 >>> 15)) * (-2048144777);
        int i6 = (i5 ^ (i5 >>> 13)) * (-1028477379);
        return (i6 ^ (i6 >>> 16)) & DNi.c;
    }
