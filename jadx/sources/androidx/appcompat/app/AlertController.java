...
public class AlertController {
    ...
    public static final class ButtonHandler extends Handler {
        ...
        public class _lancet {
            ...
            public static void com_ushareit_medusa_crash_anr_msg_MessageLancet_dispatchMessageByMedusa(ButtonHandler buttonHandler, Message message) {
                C6098Slh c6098Slh;
                if (C7532Xlh.a().b() && (c6098Slh = C7532Xlh.a().b) != null && Looper.getMainLooper().getThread() == Thread.currentThread()) {
                    c6098Slh.d = C1799Dmh.b(message);
                }
                buttonHandler.dispatchMessage$___twin___(message);
            }
        }
    ...
    public static class RecycleListView extends ListView {
        ...
        public class _lancet {
            ...
            public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewGroupSubOnClickListener(RecycleListView recycleListView, View.OnClickListener onClickListener) {
                if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                    com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(recycleListView, onClickListener);
                } else {
                    com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(recycleListView, new View$OnClickListenerC4863Odh(onClickListener));
                }
            }

            @Hrk(mayCreateSuper = true, value = "setOnClickListener")
            @Krk(scope = Scope.LEAF, value = "android.view.View")
            public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(RecycleListView recycleListView, View.OnClickListener onClickListener) {
                if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                    recycleListView.setOnClickListener$___twin___(onClickListener);
                } else {
                    recycleListView.setOnClickListener$___twin___(new View$OnClickListenerC4863Odh(onClickListener));
                }
            }
        }
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{R.attr.a7z, R.attr.a85});
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, new int[]{16842994, R.attr.mp, R.attr.mq, R.attr.a2v, R.attr.a2w, R.attr.a6v, R.attr.adh, R.attr.adl}, R.attr.DEF_STYLE_ATTR, 0);
    ...
    private void setupButtons(ViewGroup viewGroup) {
        ...
        _lancet.com_ushareit_mcds_uatracker_aop_UATAop_setBtnOnClickListener(this.mButtonPositive, this.mButtonHandler);
        ...
        _lancet.com_ushareit_mcds_uatracker_aop_UATAop_setBtnOnClickListener(this.mButtonNegative, this.mButtonHandler);
        ...
        _lancet.com_ushareit_mcds_uatracker_aop_UATAop_setBtnOnClickListener(this.mButtonNeutral, this.mButtonHandler);
