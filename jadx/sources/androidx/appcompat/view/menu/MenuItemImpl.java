...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            sb.append(resources.getString(R.string.ac8));
        }
        int i = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb, i, 65536, resources.getString(R.string.ac4));
        appendModifier(sb, i, 4096, resources.getString(R.string.ac0));
        appendModifier(sb, i, 2, resources.getString(R.string.abz));
        appendModifier(sb, i, 1, resources.getString(R.string.ac5));
        appendModifier(sb, i, 4, resources.getString(R.string.ac7));
        appendModifier(sb, i, 8, resources.getString(R.string.ac3));
        if (shortcut == '\b') {
            sb.append(resources.getString(R.string.ac1));
        } else if (shortcut == '\n') {
            sb.append(resources.getString(R.string.ac2));
        } else if (shortcut != ' ') {
            sb.append(shortcut);
        } else {
            sb.append(resources.getString(R.string.ac6));
        }
        return sb.toString();
    }
