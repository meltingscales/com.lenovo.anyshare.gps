...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SearchView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mIconifiedByDefaultId = propertyMapper.mapBoolean("iconifiedByDefault", R.attr.xz);
            this.mQueryHintId = propertyMapper.mapObject("queryHint", R.attr.a_4);
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public class _lancet {
            ...
            public static void com_ushareit_mcds_uatracker_aop_UATAop_setEditTextSubOnClickListener(SearchAutoComplete searchAutoComplete, View.OnClickListener onClickListener) {
                if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                    com_ushareit_mcds_uatracker_aop_UATAop_setTextViewSubOnClickListener(searchAutoComplete, onClickListener);
                } else {
                    com_ushareit_mcds_uatracker_aop_UATAop_setTextViewSubOnClickListener(searchAutoComplete, new View$OnClickListenerC4863Odh(onClickListener));
                }
            }

            @Hrk(mayCreateSuper = true, value = "setOnClickListener")
            @Krk(scope = Scope.LEAF, value = "android.widget.TextView")
            public static void com_ushareit_mcds_uatracker_aop_UATAop_setTextViewSubOnClickListener(SearchAutoComplete searchAutoComplete, View.OnClickListener onClickListener) {
                if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                    com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(searchAutoComplete, onClickListener);
                } else {
                    com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(searchAutoComplete, new View$OnClickListenerC4863Odh(onClickListener));
                }
            }

            @Hrk(mayCreateSuper = true, value = "setOnClickListener")
            @Krk(scope = Scope.LEAF, value = "android.view.View")
            public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(SearchAutoComplete searchAutoComplete, View.OnClickListener onClickListener) {
                if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                    searchAutoComplete.setOnClickListener$___twin___(onClickListener);
                } else {
                    searchAutoComplete.setOnClickListener$___twin___(new View$OnClickListenerC4863Odh(onClickListener));
                }
            }
        }
    ...
    public class _lancet {
        ...
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewGroupSubOnClickListener(SearchView searchView, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(searchView, onClickListener);
            } else {
                com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(searchView, new View$OnClickListenerC4863Odh(onClickListener));
            }
        }

        @Hrk(mayCreateSuper = true, value = "setOnClickListener")
        @Krk(scope = Scope.LEAF, value = "android.view.View")
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(SearchView searchView, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(R.dimen.bf5);
    }

    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(R.dimen.bf6);
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(R.dimen.bes) + resources.getDimensionPixelSize(R.dimen.bet) : 0;
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.aak);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, new int[]{16842970, 16843039, 16843296, 16843364, R.attr.op, R.attr.qe, R.attr.sj, R.attr.x1, R.attr.xz, R.attr.a0_, R.attr.a_3, R.attr.a_4, R.attr.aai, R.attr.aaj, R.attr.agf, R.attr.ago, R.attr.ams}, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, new int[]{16842970, 16843039, 16843296, 16843364, R.attr.op, R.attr.qe, R.attr.sj, R.attr.x1, R.attr.xz, R.attr.a0_, R.attr.a_3, R.attr.a_4, R.attr.aai, R.attr.aaj, R.attr.agf, R.attr.ago, R.attr.ams}, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(9, R.layout.sk), (ViewGroup) this, true);
        ...
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(R.string.acb));
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(15, R.layout.sj);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(5, 0);
        _lancet.com_ushareit_mcds_uatracker_aop_UATAop_setImageViewOnClickListener(this.mSearchButton, this.mOnClickListener);
        _lancet.com_ushareit_mcds_uatracker_aop_UATAop_setImageViewOnClickListener(this.mCloseButton, this.mOnClickListener);
        _lancet.com_ushareit_mcds_uatracker_aop_UATAop_setImageViewOnClickListener(this.mGoButton, this.mOnClickListener);
        _lancet.com_ushareit_mcds_uatracker_aop_UATAop_setImageViewOnClickListener(this.mVoiceButton, this.mOnClickListener);
        ...
        this.mVoiceWebSearchIntent.addFlags(C21155uhc.x);
        this.mVoiceWebSearchIntent.putExtra("android.speech.extra.LANGUAGE_MODEL", "web_search");
        this.mVoiceAppSearchIntent = new Intent("android.speech.action.RECOGNIZE_SPEECH");
        this.mVoiceAppSearchIntent.addFlags(C21155uhc.x);
