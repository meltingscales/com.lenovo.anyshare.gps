...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<Toolbar> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mCollapseContentDescriptionId = propertyMapper.mapObject("collapseContentDescription", R.attr.oy);
            this.mCollapseIconId = propertyMapper.mapObject("collapseIcon", R.attr.oz);
            this.mContentInsetEndId = propertyMapper.mapInt("contentInsetEnd", R.attr.qm);
            this.mContentInsetEndWithActionsId = propertyMapper.mapInt("contentInsetEndWithActions", R.attr.qn);
            this.mContentInsetLeftId = propertyMapper.mapInt("contentInsetLeft", R.attr.qo);
            this.mContentInsetRightId = propertyMapper.mapInt("contentInsetRight", R.attr.qp);
            this.mContentInsetStartId = propertyMapper.mapInt("contentInsetStart", R.attr.qq);
            this.mContentInsetStartWithNavigationId = propertyMapper.mapInt("contentInsetStartWithNavigation", R.attr.qr);
            this.mLogoId = propertyMapper.mapObject("logo", R.attr.a38);
            this.mLogoDescriptionId = propertyMapper.mapObject("logoDescription", R.attr.a3_);
            this.mMenuId = propertyMapper.mapObject("menu", R.attr.a5h);
            this.mNavigationContentDescriptionId = propertyMapper.mapObject("navigationContentDescription", R.attr.a6w);
            this.mNavigationIconId = propertyMapper.mapObject("navigationIcon", R.attr.a6x);
            this.mPopupThemeId = propertyMapper.mapResourceId("popupTheme", R.attr.a8u);
            this.mSubtitleId = propertyMapper.mapObject(PM.c, R.attr.agg);
            this.mTitleId = propertyMapper.mapObject("title", R.attr.ak8);
            this.mTitleMarginBottomId = propertyMapper.mapInt("titleMarginBottom", R.attr.akc);
            this.mTitleMarginEndId = propertyMapper.mapInt("titleMarginEnd", R.attr.akd);
            this.mTitleMarginStartId = propertyMapper.mapInt("titleMarginStart", R.attr.ake);
            this.mTitleMarginTopId = propertyMapper.mapInt("titleMarginTop", R.attr.akf);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, R.attr.aky);
            LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, R.attr.aky);
    ...
    */
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new Runnable() { // from class: com.lenovo.anyshare.G
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, new int[]{16842927, 16843072, R.attr.mo, R.attr.oy, R.attr.oz, R.attr.qm, R.attr.qn, R.attr.qo, R.attr.qp, R.attr.qq, R.attr.qr, R.attr.a38, R.attr.a3_, R.attr.a51, R.attr.a5h, R.attr.a6w, R.attr.a6x, R.attr.a8u, R.attr.agg, R.attr.agi, R.attr.agj, R.attr.ak8, R.attr.akb, R.attr.akc, R.attr.akd, R.attr.ake, R.attr.akf, R.attr.akg, R.attr.aki, R.attr.akj}, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, new int[]{16842927, 16843072, R.attr.mo, R.attr.oy, R.attr.oz, R.attr.qm, R.attr.qn, R.attr.qo, R.attr.qp, R.attr.qq, R.attr.qr, R.attr.a38, R.attr.a3_, R.attr.a51, R.attr.a5h, R.attr.a6w, R.attr.a6x, R.attr.a8u, R.attr.agg, R.attr.agi, R.attr.agj, R.attr.ak8, R.attr.akb, R.attr.akc, R.attr.akd, R.attr.ake, R.attr.akf, R.attr.akg, R.attr.aki, R.attr.akj}, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
