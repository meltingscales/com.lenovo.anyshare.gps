...
public class TooltipPopup {
    ...
    public TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(R.layout.sm, (ViewGroup) null);
    ...
    private void computePosition(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams) {
        ...
        int dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(R.dimen.dth);
        if (view.getWidth() < dimensionPixelOffset) {
            i = view.getWidth() / 2;
        }
        if (view.getHeight() >= dimensionPixelOffset) {
            int dimensionPixelOffset2 = this.mContext.getResources().getDimensionPixelOffset(R.dimen.dtg);
        ...
        int dimensionPixelOffset3 = this.mContext.getResources().getDimensionPixelOffset(z ? R.dimen.dtk : R.dimen.dtj);
    ...
    public void hide() {
        if (isShowing()) {
            ((WindowManager) this.mContext.getSystemService(VisionController.WINDOW)).removeView(this.mContentView);
        }
    }
    ...
    public void show(View view, int i, int i2, boolean z, CharSequence charSequence) {
        ...
        ((WindowManager) this.mContext.getSystemService(VisionController.WINDOW)).addView(this.mContentView, this.mLayoutParams);
    }
}
