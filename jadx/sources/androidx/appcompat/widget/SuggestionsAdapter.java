...
public class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(R.attr.aj1, typedValue, true);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        _lancet.com_ushareit_mcds_uatracker_aop_UATAop_setImageViewOnClickListener(childViewCache.mIconRefine, this);
    }
