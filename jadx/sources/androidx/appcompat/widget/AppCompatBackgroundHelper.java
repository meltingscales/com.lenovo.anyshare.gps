...
public class AppCompatBackgroundHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, new int[]{16842964, R.attr.kx, R.attr.ky}, i, 0);
        View view = this.mView;
        ViewCompat.saveAttributeDataForStyleable(view, view.getContext(), new int[]{16842964, R.attr.kx, R.attr.ky}, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
        try {
