...
public class AppCompatSeekBarHelper extends AppCompatProgressBarHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, new int[]{16843074, R.attr.ak2, R.attr.ak3, R.attr.ak4}, i, 0);
        SeekBar seekBar = this.mView;
        ViewCompat.saveAttributeDataForStyleable(seekBar, seekBar.getContext(), new int[]{16843074, R.attr.ak2, R.attr.ak3, R.attr.ak4}, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
