...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, new int[]{R.attr.ko, R.attr.kv, R.attr.kw, R.attr.qm, R.attr.qn, R.attr.qo, R.attr.qp, R.attr.qq, R.attr.qr, R.attr.s_, R.attr.st, R.attr.sw, R.attr.u0, R.attr.x8, R.attr.xf, R.attr.xl, R.attr.xm, R.attr.xq, R.attr.y6, R.attr.z7, R.attr.a38, R.attr.a6z, R.attr.a8u, R.attr.a92, R.attr.a93, R.attr.agg, R.attr.agk, R.attr.ak8, R.attr.akk}, R.attr.ie, 0);
    ...
    public AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (context.getTheme().resolveAttribute(R.attr.ib, typedValue, true) && (i2 = typedValue.resourceId) != 0) {
