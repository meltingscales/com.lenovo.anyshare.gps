        ...
        if (i == -1 && i2 == -1) {
            ...
            if (i3 != -1 || i4 != -1) {
                ...
                if (i3 != -1 && i4 != -1) {
                    ...
                    if (i != -1 || i4 != -1) {
                        ConstraintLayout.LayoutParams layoutParams4 = this.mParams;
                        int i5 = layoutParams4.rightToRight;
                        if (i5 != -1) {
                            constraintProperties.connect(7, i5, 7, 0);
                        } else {
                            int i6 = layoutParams4.leftToLeft;
                            if (i6 != -1) {
            ...
            if (i != -1 && i2 != -1) {
                ...
                if (i != -1 || i2 != -1) {
                    ConstraintLayout.LayoutParams layoutParams7 = this.mParams;
                    int i7 = layoutParams7.rightToRight;
                    if (i7 != -1) {
                        constraintProperties3.connect(2, i7, 2, 0);
                    } else {
                        int i8 = layoutParams7.leftToLeft;
                        if (i8 != -1) {
    ...
    public ConstraintProperties removeFromVerticalChain() {
        ...
        if (i != -1 || i2 != -1) {
            ...
            if (i != -1 && i2 != -1) {
                ...
                if (i != -1 || i2 != -1) {
                    ConstraintLayout.LayoutParams layoutParams4 = this.mParams;
                    int i3 = layoutParams4.bottomToBottom;
                    if (i3 != -1) {
