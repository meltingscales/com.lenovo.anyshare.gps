...
public class Placeholder extends View {
    ...
    public class _lancet {
        ...
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(Placeholder placeholder, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                placeholder.setOnClickListener$___twin___(onClickListener);
            } else {
                placeholder.setOnClickListener$___twin___(new View$OnClickListenerC4863Odh(onClickListener));
            }
        }
    }
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, new int[]{R.attr.qk, R.attr.a8q});
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            canvas.drawRGB(InterfaceC13225hhc.md, InterfaceC13225hhc.md, InterfaceC13225hhc.md);
            Paint paint = new Paint();
            paint.setARGB(255, InterfaceC13225hhc._c, InterfaceC13225hhc._c, InterfaceC13225hhc._c);
