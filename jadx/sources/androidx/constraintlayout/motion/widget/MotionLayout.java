...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        public static final /* synthetic */ int[] $SwitchMap$androidx$constraintlayout$motion$widget$MotionLayout$TransitionState = new int[TransitionState.values().length];
    ...
    public class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            String str2 = str + C2051Ejc.f8464a + Debug.getName((View) constraintWidgetContainer.getCompanionWidget());
            ...
            for (int i = 0; i < size; i++) {
                ...
                Log.v("MotionLayout", str3 + C18128pjc.f25363a + name + C2051Ejc.f8464a + constraintWidget + C2051Ejc.f8464a + sb8);
            }
    ...
    private static class MyTracker implements MotionTracker {
        ...
        public static MyTracker f1069me = new MyTracker();
        public VelocityTracker tracker;

        public static MyTracker obtain() {
            f1069me.tracker = VelocityTracker.obtain();
            return f1069me;
        }
    ...
    public class _lancet {
        ...
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewGroupSubOnClickListener(MotionLayout motionLayout, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(motionLayout, onClickListener);
            } else {
                com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(motionLayout, new View$OnClickListenerC4863Odh(onClickListener));
            }
        }

        @Hrk(mayCreateSuper = true, value = "setOnClickListener")
        @Krk(scope = Scope.LEAF, value = "android.view.View")
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(MotionLayout motionLayout, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                motionLayout.setOnClickListener$___twin___(onClickListener);
            } else {
                motionLayout.setOnClickListener$___twin___(new View$OnClickListenerC4863Odh(onClickListener));
            }
        }
    }
    ...
    private void debugPos() {
        for (int i = 0; i < getChildCount(); i++) {
            View childAt = getChildAt(i);
            Log.v("MotionLayout", C2051Ejc.f8464a + Debug.getLocation() + C2051Ejc.f8464a + Debug.getName(this) + C2051Ejc.f8464a + Debug.getName(getContext(), this.mCurrentState) + C2051Ejc.f8464a + Debug.getName(childAt) + childAt.getLeft() + C2051Ejc.f8464a + childAt.getTop());
        }
    }
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, new int[]{R.attr.k7, R.attr.s2, R.attr.a0a, R.attr.a5x, R.attr.a6b, R.attr.add});
    ...
    public void setupMotionViews() {
        ...
        if (staggered != 0.0f) {
            boolean z2 = ((double) staggered) < AbstractC4714Nqc.f12500a;
