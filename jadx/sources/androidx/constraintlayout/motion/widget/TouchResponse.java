...
public class TouchResponse {
    ...
    private void fillFromAttributeList(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{R.attr.t7, R.attr.t8, R.attr.t9, R.attr.a2l, R.attr.a4z, R.attr.a5_, R.attr.a6g, R.attr.a72, R.attr.a7v, R.attr.al_, R.attr.ala, R.attr.alc});
