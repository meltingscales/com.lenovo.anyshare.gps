...
public abstract class FragmentManager {
    ...
    public static Fragment getViewFragment(View view) {
        Object tag = view.getTag(R.id.bqb);
    ...
    private void setVisibleRemovingFragment(Fragment fragment) {
        ...
        if (fragmentContainer != null) {
            if (fragmentContainer.getTag(R.id.e50) == null) {
                fragmentContainer.setTag(R.id.e50, fragment);
            }
            ((Fragment) fragmentContainer.getTag(R.id.e50)).setNextAnim(fragment.getNextAnim());
        }
    }
    ...
    private void throwException(RuntimeException runtimeException) {
        ...
        if (fragmentHostCallback != null) {
            try {
                fragmentHostCallback.onDump(C18128pjc.f25363a, null, printWriter, new String[0]);
            } catch (Exception e) {
                Log.e("FragmentManager", "Failed dumping state", e);
            }
        } else {
            try {
                dump(C18128pjc.f25363a, null, printWriter, new String[0]);
            } catch (Exception e2) {
    ...
    */
    ...
    public void restoreSaveState(Parcelable parcelable) {
        ...
        if (backStackStateArr != null) {
            ...
            while (true) {
                ...
                if (isLoggingEnabled(2)) {
                    ...
                    PrintWriter printWriter = new PrintWriter(new LogWriter("FragmentManager"));
                    instantiate.dump(C18128pjc.f25363a, printWriter, false);
                    printWriter.close();
                }
        ...
        if (str != null) {
            this.mPrimaryNav = findActiveFragment(str);
            dispatchParentPrimaryNavigationFragmentChanged(this.mPrimaryNav);
        }
    }
