...
public final class SparseArrayKt {
    ...
    public static final <T> T getOrElse(SparseArrayCompat<T> sparseArrayCompat, int i, InterfaceC10209clk<? extends T> interfaceC10209clk) {
        C11440emk.f(sparseArrayCompat, "receiver$0");
        C11440emk.f(interfaceC10209clk, "defaultValue");
        T t = sparseArrayCompat.get(i);
        return t != null ? t : interfaceC10209clk.invoke();
    }
    ...
    public static final <T> Fhk keyIterator(final SparseArrayCompat<T> sparseArrayCompat) {
        C11440emk.f(sparseArrayCompat, "receiver$0");
        return new Fhk() { // from class: androidx.collection.SparseArrayKt$keyIterator$1
            public int index;
    ...
    public static final <T> SparseArrayCompat<T> plus(SparseArrayCompat<T> sparseArrayCompat, SparseArrayCompat<T> sparseArrayCompat2) {
        C11440emk.f(sparseArrayCompat, "receiver$0");
        C11440emk.f(sparseArrayCompat2, "other");
    ...
    @InterfaceC24181zek(message = "Replaced with member function. Remove extension import!")
