...
public final class ActivityResultLauncherKt {
    public static final void launch(ActivityResultLauncher<Void> activityResultLauncher, ActivityOptionsCompat activityOptionsCompat) {
        C11440emk.e(activityResultLauncher, "$this$launch");
    ...
    public static final void launchUnit(ActivityResultLauncher<Kfk> activityResultLauncher, ActivityOptionsCompat activityOptionsCompat) {
        C11440emk.e(activityResultLauncher, "$this$launch");
        activityResultLauncher.launch(Kfk.f11108a, activityOptionsCompat);
    }
