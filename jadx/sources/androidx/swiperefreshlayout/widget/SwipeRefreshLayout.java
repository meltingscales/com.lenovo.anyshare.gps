...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public class _lancet {
        ...
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewGroupSubOnClickListener(SwipeRefreshLayout swipeRefreshLayout, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(swipeRefreshLayout, onClickListener);
            } else {
                com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(swipeRefreshLayout, new View$OnClickListenerC4863Odh(onClickListener));
            }
        }

        @Hrk(mayCreateSuper = true, value = "setOnClickListener")
        @Krk(scope = Scope.LEAF, value = "android.view.View")
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setViewOnClickListener(SwipeRefreshLayout swipeRefreshLayout, View.OnClickListener onClickListener) {
            if ((onClickListener instanceof View$OnClickListenerC4863Odh) || !C1410Cdh.c()) {
                swipeRefreshLayout.setOnClickListener$___twin___(onClickListener);
            } else {
                swipeRefreshLayout.setOnClickListener$___twin___(new View$OnClickListenerC4863Odh(onClickListener));
            }
        }
    }
    ...
    private void createProgressView() {
        this.mCircleView = new CircleImageView(getContext(), SIRefreshHeader.d);
    ...
    private void moveSpinner(float f) {
        ...
        double d = min;
        Double.isNaN(d);
        float max = (((float) Math.max(d - 0.4d, (double) AbstractC4714Nqc.f12500a)) * 5.0f) / 3.0f;
