...
public final class Utf8Safe extends Utf8 {
    ...
    */
    public static int encodeUtf8Array(java.lang.CharSequence r7, byte[] r8, int r9, int r10) {
        /*
    ...
    public static void encodeUtf8Buffer(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i < length) {
            ...
            if (charAt2 < 128) {
                ...
                int i2 = position + 1;
                try {
                    byteBuffer.put(position, (byte) ((charAt2 >>> 6) | InterfaceC13225hhc.Ic));
                ...
                int i7 = position + 1;
                byteBuffer.put(position, (byte) ((charAt2 >>> '\f') | InterfaceC13225hhc.nd));
                position = i7 + 1;
