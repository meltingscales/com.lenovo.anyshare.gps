...
public class Alarms {
    ...
    public static void cancelExactAlarm(Context context, String str, int i) {
        ...
        PendingIntent service = PendingIntent.getService(context, i, CommandHandler.createDelayMetIntent(context, str), Build.VERSION.SDK_INT >= 23 ? 603979776 : C21155uhc.K);
