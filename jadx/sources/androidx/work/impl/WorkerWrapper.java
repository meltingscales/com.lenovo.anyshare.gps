...
public class WorkerWrapper implements Runnable {
    ...
    public class _lancet {
        @Hrk("run")
        @Krk("androidx.work.impl.WorkerWrapper")
        public static void com_ushareit_lancet_WorkerWrapperLancet_run(WorkerWrapper workerWrapper) {
            try {
                workerWrapper.run$___twin___();
            } catch (Throwable th) {
                th.printStackTrace();
            }
        }
    ...
    @Override // java.lang.Runnable
    public void run() {
        _lancet.com_ushareit_lancet_WorkerWrapperLancet_run(this);
    }
