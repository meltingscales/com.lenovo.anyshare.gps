...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    */
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.r2);
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (i == 0) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{R.attr.zy, R.attr.ag5}, 0, R.style.ag3);
        } else {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{R.attr.zy, R.attr.ag5}, i, 0);
        }
        if (Build.VERSION.SDK_INT >= 29) {
            if (i == 0) {
                saveAttributeDataForStyleable(context, new int[]{R.attr.zy, R.attr.ag5}, attributeSet, obtainStyledAttributes, 0, R.style.ag3);
            } else {
                saveAttributeDataForStyleable(context, new int[]{R.attr.zy, R.attr.ag5}, attributeSet, obtainStyledAttributes, i, 0);
            }
        }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.dodgeInsetEdges = 0;
            this.mLastChildRect = new Rect();
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{16842931, R.attr.a0d, R.attr.a0e, R.attr.a0g, R.attr.a1o, R.attr.a1y, R.attr.a1z});
