...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl21 extends Impl {
        ...
        public static View.OnApplyWindowInsetsListener createProxyListener(View view, Callback callback) {
        ...
        public static WindowInsets forwardToViewIfNeeded(View view, WindowInsets windowInsets) {
            return view.getTag(R.id.dmc) != null ? windowInsets : view.onApplyWindowInsets(windowInsets);
        }

        public static Callback getCallback(View view) {
            Object tag = view.getTag(R.id.dmm);
        ...
        public static void setCallback(View view, Callback callback) {
            Object tag = view.getTag(R.id.dmc);
            if (callback == null) {
                view.setTag(R.id.dmm, null);
                if (tag == null) {
            ...
            view.setTag(R.id.dmm, createProxyListener);
            if (tag == null) {
