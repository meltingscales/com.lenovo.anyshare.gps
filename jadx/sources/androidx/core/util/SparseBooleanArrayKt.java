...
import com.lenovo.anyshare.AbstractC8942ahk;
...
public final class SparseBooleanArrayKt {
    public static final boolean contains(SparseBooleanArray sparseBooleanArray, int i) {
        C11440emk.e(sparseBooleanArray, "<this>");
    ...
    public static final void forEach(SparseBooleanArray sparseBooleanArray, InterfaceC19378rlk<? super Integer, ? super Boolean, Kfk> interfaceC19378rlk) {
        C11440emk.e(sparseBooleanArray, "<this>");
        ...
        while (true) {
            int i2 = i + 1;
            interfaceC19378rlk.invoke(Integer.valueOf(sparseBooleanArray.keyAt(i)), Boolean.valueOf(sparseBooleanArray.valueAt(i)));
            if (i2 >= size) {
                return;
            }
            i = i2;
    ...
    public static final boolean getOrElse(SparseBooleanArray sparseBooleanArray, int i, InterfaceC10209clk<Boolean> interfaceC10209clk) {
        C11440emk.e(sparseBooleanArray, "<this>");
        C11440emk.e(interfaceC10209clk, "defaultValue");
        int indexOfKey = sparseBooleanArray.indexOfKey(i);
        return indexOfKey >= 0 ? sparseBooleanArray.valueAt(indexOfKey) : interfaceC10209clk.invoke().booleanValue();
    }
    ...
    public static final Fhk keyIterator(final SparseBooleanArray sparseBooleanArray) {
        C11440emk.e(sparseBooleanArray, "<this>");
        return new Fhk() { // from class: androidx.core.util.SparseBooleanArrayKt$keyIterator$1
            public int index;
    ...
    public static final SparseBooleanArray plus(SparseBooleanArray sparseBooleanArray, SparseBooleanArray sparseBooleanArray2) {
        C11440emk.e(sparseBooleanArray, "<this>");
        C11440emk.e(sparseBooleanArray2, "other");
    ...
    public static final AbstractC8942ahk valueIterator(final SparseBooleanArray sparseBooleanArray) {
        C11440emk.e(sparseBooleanArray, "<this>");
        return new AbstractC8942ahk() { // from class: androidx.core.util.SparseBooleanArrayKt$valueIterator$1
            public int index;
