...
import com.lenovo.anyshare.Ghk;
...
public final class LongSparseArrayKt {
    ...
    public static final <T> void forEach(LongSparseArray<T> longSparseArray, InterfaceC19378rlk<? super Long, ? super T, Kfk> interfaceC19378rlk) {
        C11440emk.e(longSparseArray, "<this>");
        ...
        while (true) {
            int i2 = i + 1;
            interfaceC19378rlk.invoke(Long.valueOf(longSparseArray.keyAt(i)), longSparseArray.valueAt(i));
            if (i2 >= size) {
                return;
            }
            i = i2;
    ...
    public static final <T> T getOrElse(LongSparseArray<T> longSparseArray, long j, InterfaceC10209clk<? extends T> interfaceC10209clk) {
        C11440emk.e(longSparseArray, "<this>");
    ...
    public static final <T> Ghk keyIterator(final LongSparseArray<T> longSparseArray) {
        C11440emk.e(longSparseArray, "<this>");
        return new Ghk() { // from class: androidx.core.util.LongSparseArrayKt$keyIterator$1
            public int index;
    ...
    public static final <T> LongSparseArray<T> plus(LongSparseArray<T> longSparseArray, LongSparseArray<T> longSparseArray2) {
        C11440emk.e(longSparseArray, "<this>");
        C11440emk.e(longSparseArray2, "other");
    ...
    public static final <T> boolean remove(LongSparseArray<T> longSparseArray, long j, T t) {
        ...
        if (indexOfKey < 0 || !C11440emk.a(t, longSparseArray.valueAt(indexOfKey))) {
            return false;
        }
