...
public final class SparseLongArrayKt {
    public static final boolean contains(SparseLongArray sparseLongArray, int i) {
        C11440emk.e(sparseLongArray, "<this>");
    ...
    public static final void forEach(SparseLongArray sparseLongArray, InterfaceC19378rlk<? super Integer, ? super Long, Kfk> interfaceC19378rlk) {
        C11440emk.e(sparseLongArray, "<this>");
        ...
        while (true) {
            int i2 = i + 1;
            interfaceC19378rlk.invoke(Integer.valueOf(sparseLongArray.keyAt(i)), Long.valueOf(sparseLongArray.valueAt(i)));
            if (i2 >= size) {
                return;
            }
            i = i2;
    ...
    public static final long getOrElse(SparseLongArray sparseLongArray, int i, InterfaceC10209clk<Long> interfaceC10209clk) {
        C11440emk.e(sparseLongArray, "<this>");
        C11440emk.e(interfaceC10209clk, "defaultValue");
        int indexOfKey = sparseLongArray.indexOfKey(i);
        return indexOfKey >= 0 ? sparseLongArray.valueAt(indexOfKey) : interfaceC10209clk.invoke().longValue();
    }
    ...
    public static final Fhk keyIterator(final SparseLongArray sparseLongArray) {
        C11440emk.e(sparseLongArray, "<this>");
        return new Fhk() { // from class: androidx.core.util.SparseLongArrayKt$keyIterator$1
            public int index;
    ...
    public static final SparseLongArray plus(SparseLongArray sparseLongArray, SparseLongArray sparseLongArray2) {
        C11440emk.e(sparseLongArray, "<this>");
        C11440emk.e(sparseLongArray2, "other");
    ...
    public static final Ghk valueIterator(final SparseLongArray sparseLongArray) {
        C11440emk.e(sparseLongArray, "<this>");
        return new Ghk() { // from class: androidx.core.util.SparseLongArrayKt$valueIterator$1
            public int index;
