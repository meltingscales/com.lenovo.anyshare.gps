...
public final class SparseIntArrayKt {
    public static final boolean contains(SparseIntArray sparseIntArray, int i) {
        C11440emk.e(sparseIntArray, "<this>");
    ...
    public static final void forEach(SparseIntArray sparseIntArray, InterfaceC19378rlk<? super Integer, ? super Integer, Kfk> interfaceC19378rlk) {
        C11440emk.e(sparseIntArray, "<this>");
        ...
        while (true) {
            int i2 = i + 1;
            interfaceC19378rlk.invoke(Integer.valueOf(sparseIntArray.keyAt(i)), Integer.valueOf(sparseIntArray.valueAt(i)));
            if (i2 >= size) {
                return;
            }
            i = i2;
    ...
    public static final int getOrElse(SparseIntArray sparseIntArray, int i, InterfaceC10209clk<Integer> interfaceC10209clk) {
        C11440emk.e(sparseIntArray, "<this>");
        C11440emk.e(interfaceC10209clk, "defaultValue");
        int indexOfKey = sparseIntArray.indexOfKey(i);
        return indexOfKey >= 0 ? sparseIntArray.valueAt(indexOfKey) : interfaceC10209clk.invoke().intValue();
    }
    ...
    public static final Fhk keyIterator(final SparseIntArray sparseIntArray) {
        C11440emk.e(sparseIntArray, "<this>");
        return new Fhk() { // from class: androidx.core.util.SparseIntArrayKt$keyIterator$1
            public int index;
    ...
    public static final SparseIntArray plus(SparseIntArray sparseIntArray, SparseIntArray sparseIntArray2) {
        C11440emk.e(sparseIntArray, "<this>");
        C11440emk.e(sparseIntArray2, "other");
    ...
    public static final Fhk valueIterator(final SparseIntArray sparseIntArray) {
        C11440emk.e(sparseIntArray, "<this>");
        return new Fhk() { // from class: androidx.core.util.SparseIntArrayKt$valueIterator$1
            public int index;
