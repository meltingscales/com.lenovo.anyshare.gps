    ...
    */
    ...
    public static class PathDataNode {
        ...
        public static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d20 == AbstractC4714Nqc.f12500a) {
                Log.w("PathParser", " Points are coincident");
                return;
            }
            double d21 = (1.0d / d20) - 0.25d;
            if (d21 < AbstractC4714Nqc.f12500a) {
            ...
            if (z2 != (atan22 >= AbstractC4714Nqc.f12500a)) {
                atan22 = atan22 > AbstractC4714Nqc.f12500a ? atan22 - 6.283185307179586d : atan22 + 6.283185307179586d;
            }
            Double.isNaN(d6);
            double d24 = d * d6;
            Double.isNaN(d9);
