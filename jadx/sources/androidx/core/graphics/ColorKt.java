...
public final class ColorKt {
    ...
    public static final ColorSpace getColorSpace(long j) {
        ...
        C11440emk.d(colorSpace, "colorSpace(this)");
        return colorSpace;
    }
    ...
    public static final Color plus(Color color, Color color2) {
        C11440emk.e(color, "<this>");
        C11440emk.e(color2, "c");
        Color compositeColors = ColorUtils.compositeColors(color2, color);
        C11440emk.d(compositeColors, "compositeColors(c, this)");
    ...
    public static final Color convertTo(Color color, ColorSpace.Named named) {
        ...
        C11440emk.d(convert, "convert(ColorSpace.get(colorSpace))");
        return convert;
    }
    ...
    public static final Color convertTo(Color color, ColorSpace colorSpace) {
        ...
        C11440emk.d(convert, "convert(colorSpace)");
        return convert;
    }
}
