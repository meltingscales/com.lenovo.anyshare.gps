        ...
        while (i < length) {
            ...
            if (component2 == null) {
                ...
                if (Build.VERSION.SDK_INT >= 22) {
                    ...
                    throw new IllegalArgumentException("Illegal value type boolean for key \"" + component1 + C23731ysc.g);
                }
                ...
                C11440emk.a(componentType);
                if (!String.class.isAssignableFrom(componentType)) {
                    String canonicalName = componentType.getCanonicalName();
                    throw new IllegalArgumentException("Illegal value array type " + ((Object) canonicalName) + " for key \"" + component1 + C23731ysc.g);
                ...
                throw new IllegalArgumentException("Illegal value type " + ((Object) canonicalName2) + " for key \"" + component1 + C23731ysc.g);
            }
        }
