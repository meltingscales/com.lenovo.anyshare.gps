...
public final class TypedArrayKt {
    ...
    public static final Drawable getDrawableOrThrow(TypedArray typedArray, int i) {
        ...
        C11440emk.a(drawable);
        C11440emk.d(drawable, "getDrawable(index)!!");
        return drawable;
    }
    ...
    public static final Typeface getFontOrThrow(TypedArray typedArray, int i) {
        ...
        C11440emk.a(font);
        C11440emk.d(font, "getFont(index)!!");
        return font;
    }
    ...
    public static final CharSequence[] getTextArrayOrThrow(TypedArray typedArray, int i) {
        ...
        C11440emk.d(textArray, "getTextArray(index)");
        return textArray;
    }
    ...
    public static final <R> R use(TypedArray typedArray, InterfaceC16940nlk<? super TypedArray, ? extends R> interfaceC16940nlk) {
        C11440emk.e(typedArray, "<this>");
        C11440emk.e(interfaceC16940nlk, OQb.e);
        R invoke = interfaceC16940nlk.invoke(typedArray);
        typedArray.recycle();
        return invoke;
    }
}
