...
public final class TextViewOnReceiveContentListener implements OnReceiveContentListener {
    ...
    public static CharSequence coerceToText(Context context, ClipData.Item item, int i) {
    ...
    public static void replaceSelection(Editable editable, CharSequence charSequence) {
