...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    private int releaseVerticalGlow(int i, float f) {
        ...
        if (EdgeEffectCompat.getDistance(this.mEdgeGlowTop) != 0.0f) {
            f2 = -EdgeEffectCompat.onPullDistance(this.mEdgeGlowTop, -height, width);
            if (EdgeEffectCompat.getDistance(this.mEdgeGlowTop) == 0.0f) {
                this.mEdgeGlowTop.onRelease();
            }
        } else if (EdgeEffectCompat.getDistance(this.mEdgeGlowBottom) != 0.0f) {
            f2 = EdgeEffectCompat.onPullDistance(this.mEdgeGlowBottom, height, 1.0f - width);
    ...
    */
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.a73);
    }
