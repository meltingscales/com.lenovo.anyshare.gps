...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class MediaBrowserServiceImplApi26 extends MediaBrowserServiceImplApi23 {
        ...
        public class MediaBrowserServiceApi26 extends MediaBrowserServiceImplApi23.MediaBrowserServiceApi23 {
            ...
            public class _lancet {
                ...
                public static ComponentName com_lenovo_anyshare_hyperboost_scene_HyperBoostSceneAop_actStartForegroundService(MediaBrowserServiceApi26 mediaBrowserServiceApi26, Intent intent) {
                    DEa.b();
                    return mediaBrowserServiceApi26.startForegroundService$___twin___(intent);
                }

                @Hrk(mayCreateSuper = true, value = "getSharedPreferences")
                @Krk(scope = Scope.LEAF, value = "android.app.Service")
                public static SharedPreferences com_lotus_hook_SpLancet_getServiceSp(MediaBrowserServiceApi26 mediaBrowserServiceApi26, String str, int i) {
                    SharedPreferences a2;
                    return (MSb.d(str) || (a2 = C10581dSb.d().a(mediaBrowserServiceApi26, str, i)) == null) ? mediaBrowserServiceApi26.getSharedPreferences$___twin___(str, i) : a2;
                }
            }
    ...
    public final class ServiceHandler extends Handler {
        ...
        public class _lancet {
            ...
            public static void com_ushareit_medusa_crash_anr_msg_MessageLancet_dispatchMessageByMedusa(ServiceHandler serviceHandler, Message message) {
                C6098Slh c6098Slh;
                if (C7532Xlh.a().b() && (c6098Slh = C7532Xlh.a().b) != null && Looper.getMainLooper().getThread() == Thread.currentThread()) {
                    c6098Slh.d = C1799Dmh.b(message);
                }
                serviceHandler.dispatchMessage$___twin___(message);
            }
        }
