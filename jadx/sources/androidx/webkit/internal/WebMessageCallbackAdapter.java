...
public class WebMessageCallbackAdapter implements WebMessageCallbackBoundaryInterface {
    public final WebMessagePortCompat.WebMessageCallbackCompat mImpl;
    ...
    public void onMessage(InvocationHandler invocationHandler, InvocationHandler invocationHandler2) {
        this.mImpl.onMessage(new WebMessagePortImpl(invocationHandler), WebMessageAdapter.webMessageCompatFromBoundaryInterface((WebMessageBoundaryInterface) BoundaryInterfaceReflectionUtil.a(WebMessageBoundaryInterface.class, invocationHandler2)));
    }
}
