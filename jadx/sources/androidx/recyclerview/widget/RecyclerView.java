...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static /* synthetic */ class AnonymousClass7 {
        public static final /* synthetic */ int[] $SwitchMap$androidx$recyclerview$widget$RecyclerView$Adapter$StateRestorationPolicy = new int[Adapter.StateRestorationPolicy.values().length];
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{16842948, 16842987, 16842993, R.attr.vg, R.attr.vh, R.attr.vi, R.attr.vj, R.attr.vk, R.attr.a0c, R.attr.a_t, R.attr.adw, R.attr.afl}, i, i2);
    ...
    public final class Recycler {
        ...
        public class _lancet {
            ...
            public static boolean com_ushareit_medusa_crash_rescuer_fix_lancet_CrashFixLancet_validateViewHolderForOffsetPosition(Recycler recycler, ViewHolder viewHolder) {
                try {
                    return recycler.validateViewHolderForOffsetPosition$___twin___(viewHolder);
        ...
        public boolean validateViewHolderForOffsetPosition$___twin___(ViewHolder viewHolder) {
        ...
        /* JADX WARN: Removed duplicated region for block: B:105:0x0227 A[ADDED_TO_REGION] */
        ...
        */
        ...
        public boolean validateViewHolderForOffsetPosition(ViewHolder viewHolder) {
            return _lancet.com_ushareit_medusa_crash_rescuer_fix_lancet_CrashFixLancet_validateViewHolderForOffsetPosition(this, viewHolder);
        }
    ...
    public static class State {
        ...
        public class _lancet {
            ...
            public static void com_ushareit_lancet_CrashFixLancet_assertLayoutStep(State state, int i) {
                try {
                    state.assertLayoutStep$___twin___(i);
                } catch (Throwable unused) {
                }
            }
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void assertLayoutStep$___twin___(int i) {
        ...
        public void assertLayoutStep(int i) {
            _lancet.com_ushareit_lancet_CrashFixLancet_assertLayoutStep(this, i);
        }
    ...
    public class _lancet {
        ...
        public static void com_ushareit_mcds_uatracker_aop_UATAop_setAdapter(RecyclerView recyclerView, Adapter adapter) {
            if (!C1410Cdh.c()) {
                recyclerView.setAdapter$___twin___(adapter);
                return;
            }
        ...
        @Hrk("scrollStep")
        @Krk("androidx.recyclerview.widget.RecyclerView")
        public static void com_ushareit_medusa_crash_rescuer_fix_lancet_CrashFixLancet_scrollStep(RecyclerView recyclerView, int i, int i2, int[] iArr) {
            try {
                recyclerView.scrollStep$___twin___(i, i2, iArr);
            } catch (Throwable unused) {
            }
        }
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void scrollStep$___twin___(int i, int i2, int[] iArr) {
        startInterceptRequestLayout();
        onEnterLayoutOrScroll();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setAdapter$___twin___(Adapter adapter) {
    ...
    public String exceptionLabel() {
        return C2051Ejc.f8464a + super.toString() + ", adapter:" + this.mAdapter + ", layout:" + this.mLayout + ", context:" + getContext();
    }
    ...
    */
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable != null && drawable != null && stateListDrawable2 != null && drawable2 != null) {
            ...
            new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(R.dimen.c5f), resources.getDimensionPixelSize(R.dimen.c5h), resources.getDimensionPixelOffset(R.dimen.c5g));
            return;
        }
    ...
    */
    ...
    public void scrollStep(int i, int i2, int[] iArr) {
        _lancet.com_ushareit_medusa_crash_rescuer_fix_lancet_CrashFixLancet_scrollStep(this, i, i2, iArr);
    }
    ...
    public void setAdapter(Adapter adapter) {
        _lancet.com_ushareit_mcds_uatracker_aop_UATAop_setAdapter(this, adapter);
    }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.a_k);
    }
    ...
    */
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{16842948, 16842987, 16842993, R.attr.vg, R.attr.vh, R.attr.vi, R.attr.vj, R.attr.vk, R.attr.a0c, R.attr.a_t, R.attr.adw, R.attr.afl}, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, new int[]{16842948, 16842987, 16842993, R.attr.vg, R.attr.vh, R.attr.vi, R.attr.vj, R.attr.vk, R.attr.a0c, R.attr.a_t, R.attr.adw, R.attr.afl}, attributeSet, obtainStyledAttributes, i, 0);
