...
public class ViewPager extends ViewGroup {
        ...
        if (findFocus != this) {
            if (findFocus != null) {
                ...
                if (!z) {
                    ...
                    Log.e(VerticalViewPager.f31350a, "arrowScroll tried to find focus based on non-child current focused view " + sb.toString());
                }
            }
            view = findFocus;
        }
    ...
    */
    ...
    public void setOffscreenPageLimit(int i) {
        if (i < 1) {
            Log.w(VerticalViewPager.f31350a, "Requested offscreen page limit " + i + " too small; defaulting to 1");
            i = 1;
        }
