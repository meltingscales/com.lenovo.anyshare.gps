...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public /* synthetic */ ExperimentalCoroutineDispatcher(int i, int i2, long j, String str, int i3, Ulk ulk) {
    ...
    public void mo1627dispatch(InterfaceC23020xjk interfaceC23020xjk, Runnable runnable) {
        try {
            ...
            DefaultExecutor.INSTANCE.mo1627dispatch(interfaceC23020xjk, runnable);
        }
    }
    ...
    public void dispatchYield(InterfaceC23020xjk interfaceC23020xjk, Runnable runnable) {
        try {
            ...
            DefaultExecutor.INSTANCE.dispatchYield(interfaceC23020xjk, runnable);
        }
    }
    ...
    public /* synthetic */ ExperimentalCoroutineDispatcher(int i, int i2, String str, int i3, Ulk ulk) {
    ...
    public /* synthetic */ ExperimentalCoroutineDispatcher(int i, int i2, int i3, Ulk ulk) {
        this((i3 & 1) != 0 ? TasksKt.CORE_POOL_SIZE : i, (i3 & 2) != 0 ? TasksKt.MAX_POOL_SIZE : i2);
    }

    @InterfaceC24181zek(level = DeprecationLevel.HIDDEN, message = "Binary compatibility for Ktor 1.0-beta")
