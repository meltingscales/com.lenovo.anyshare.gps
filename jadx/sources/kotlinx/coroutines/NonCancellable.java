...
public final class NonCancellable extends AbstractC18136pjk implements Job {
    ...
    @Override // kotlinx.coroutines.Job
    public InterfaceC24301zok<Job> getChildren() {
        return Rok.b();
    }
    ...
    @Override // kotlinx.coroutines.Job
    public DisposableHandle invokeOnCompletion(InterfaceC16940nlk<? super Throwable, Kfk> interfaceC16940nlk) {
        return NonDisposableHandle.INSTANCE;
    }
    ...
    @Override // kotlinx.coroutines.Job
    public Object join(InterfaceC20576tjk<? super Kfk> interfaceC20576tjk) {
        throw new UnsupportedOperationException("This job is always active");
    }
    ...
    public Job plus(Job job) {
        Job.DefaultImpls.plus((Job) this, job);
        return job;
    }
    ...
    @Override // kotlinx.coroutines.Job
    public DisposableHandle invokeOnCompletion(boolean z, boolean z2, InterfaceC16940nlk<? super Throwable, Kfk> interfaceC16940nlk) {
        return NonDisposableHandle.INSTANCE;
    }
}
