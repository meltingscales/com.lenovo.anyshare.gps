...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3<T> implements Flow<T> {
    ...
    @Jjk(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3", f = "Builders.kt", i = {0, 0, 0, 0, 0, 0, 0}, l = {115}, m = BaseDataLoaderFragment.Q, n = {"this", "collector", "continuation", "$receiver", "$this$forEach$iv", "element$iv", "value"}, s = {"L$0", "L$1", "L$2", "L$3", "L$4", "L$6", "L$7"})
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector r9, com.lenovo.anyshare.InterfaceC20576tjk r10) {
        ...
        L53:
            com.lenovo.anyshare.C12577gfk.b(r10)
            java.lang.Iterable r10 = r8.$this_asFlow$inlined
        ...
        L86:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3.collect(kotlinx.coroutines.flow.FlowCollector, com.lenovo.anyshare.tjk):java.lang.Object");
    }
}
