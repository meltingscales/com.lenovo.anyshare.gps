...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$6<R> implements Flow<R> {
    ...
    public FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$6(Flow flow, InterfaceC19989slk interfaceC19989slk) {
    ...
    public Object collect(FlowCollector flowCollector, InterfaceC20576tjk interfaceC20576tjk) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$6$lambda$1(flowCollector, this), interfaceC20576tjk);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, InterfaceC20576tjk interfaceC20576tjk) {
        C9612bmk.c(4);
        new ContinuationImpl(interfaceC20576tjk) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$6.1
            public int label;
        ...
        C9612bmk.c(0);
        flow.collect(flowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$6$lambda$1, interfaceC20576tjk);
        C9612bmk.c(2);
        C9612bmk.c(1);
        return Kfk.f11108a;
    }
