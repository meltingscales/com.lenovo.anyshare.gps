...
public final class SharingStartedKt {
    ...
    public static final SharingStarted m1615WhileSubscribed9tZugJw(SharingStarted.Companion companion, double d, double d2) {
        return new StartedWhileSubscribed(Zqk.v(d), Zqk.v(d2));
    }

    /* renamed from: WhileSubscribed-9tZugJw$default  reason: not valid java name */
    public static /* synthetic */ SharingStarted m1616WhileSubscribed9tZugJw$default(SharingStarted.Companion companion, double d, double d2, int i, Object obj) {
        if ((i & 1) != 0) {
            d = Zqk.c.b();
        }
        if ((i & 2) != 0) {
        ...
        return m1615WhileSubscribed9tZugJw(companion, d, d2);
    }
}
