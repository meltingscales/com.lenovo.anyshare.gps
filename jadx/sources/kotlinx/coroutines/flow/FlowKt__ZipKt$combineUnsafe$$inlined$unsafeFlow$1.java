...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1<R> implements Flow<R> {
    ...
    public FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1(Flow[] flowArr, InterfaceC19378rlk interfaceC19378rlk) {
    ...
    public Object collect(FlowCollector flowCollector, InterfaceC20576tjk interfaceC20576tjk) {
        ...
        Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, interfaceC10209clk, new FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1(null, this), interfaceC20576tjk);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, InterfaceC20576tjk interfaceC20576tjk) {
        InterfaceC10209clk interfaceC10209clk;
        C9612bmk.c(4);
        new ContinuationImpl(interfaceC20576tjk) { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1.1
            public int label;
        ...
        C9612bmk.c(0);
        CombineKt.combineInternal(flowCollector, flowArr, interfaceC10209clk, flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1, interfaceC20576tjk);
        C9612bmk.c(2);
        C9612bmk.c(1);
        return Kfk.f11108a;
    }
