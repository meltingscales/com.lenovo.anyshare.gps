...
public abstract class AbstractSharedFlow<S extends AbstractSharedFlowSlot<?>> {
    ...
    public final void forEachSlotLocked(InterfaceC16940nlk<? super S, Kfk> interfaceC16940nlk) {
        ...
        for (AbstractSharedFlowSlot abstractSharedFlowSlot : abstractSharedFlowSlotArr) {
            if (abstractSharedFlowSlot != null) {
                interfaceC16940nlk.invoke(abstractSharedFlowSlot);
            }
        }
    }
    ...
    public final void freeSlot(S s) {
        MutableStateFlow<Integer> mutableStateFlow;
        int i;
        InterfaceC20576tjk<Kfk>[] freeLocked;
        synchronized (this) {
            this.nCollectors--;
            mutableStateFlow = this._subscriptionCount;
        ...
        for (InterfaceC20576tjk<Kfk> interfaceC20576tjk : freeLocked) {
