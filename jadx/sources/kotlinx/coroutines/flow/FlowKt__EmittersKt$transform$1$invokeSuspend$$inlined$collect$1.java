...
public final class FlowKt__EmittersKt$transform$1$invokeSuspend$$inlined$collect$1<T> implements FlowCollector<T> {
    ...
    public Object emit(Object obj, InterfaceC20576tjk interfaceC20576tjk) {
        return this.this$0.$transform.invoke(this.$this_flow$inlined, obj, interfaceC20576tjk);
    }

    public Object emit$$forInline(Object obj, InterfaceC20576tjk interfaceC20576tjk) {
        C9612bmk.c(4);
        new ContinuationImpl(interfaceC20576tjk) { // from class: kotlinx.coroutines.flow.FlowKt__EmittersKt$transform$1$invokeSuspend$$inlined$collect$1.1
            public int label;
