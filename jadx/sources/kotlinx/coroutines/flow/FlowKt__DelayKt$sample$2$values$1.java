...
@Jjk(c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", f = "Delay.kt", i = {0, 0}, l = {352}, m = "invokeSuspend", n = {"$this$produce", "$this$collect$iv"}, s = {"L$0", "L$1"})
...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements InterfaceC19378rlk<ProducerScope<? super Object>, InterfaceC20576tjk<? super Kfk>, Object> {
    public Object L$0;
    public Object L$1;
    public int label;
    ...
    public FlowKt__DelayKt$sample$2$values$1(FlowKt__DelayKt$sample$2 flowKt__DelayKt$sample$2, InterfaceC20576tjk interfaceC20576tjk) {
    ...
    public final InterfaceC20576tjk<Kfk> create(Object obj, InterfaceC20576tjk<?> interfaceC20576tjk) {
        FlowKt__DelayKt$sample$2$values$1 flowKt__DelayKt$sample$2$values$1 = new FlowKt__DelayKt$sample$2$values$1(this.this$0, interfaceC20576tjk);
    ...
    public final Object invoke(ProducerScope<? super Object> producerScope, InterfaceC20576tjk<? super Kfk> interfaceC20576tjk) {
        return ((FlowKt__DelayKt$sample$2$values$1) create(producerScope, interfaceC20576tjk)).invokeSuspend(Kfk.f11108a);
    }
