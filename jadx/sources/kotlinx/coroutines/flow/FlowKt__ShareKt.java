...
public final /* synthetic */ class FlowKt__ShareKt {
    ...
    public static final <T> SharingConfig<T> configureSharing$FlowKt__ShareKt(Flow<? extends T> flow, int i) {
        ...
        int a2 = C21235unk.a(i, Channel.Factory.getCHANNEL_DEFAULT_CAPACITY$kotlinx_coroutines_core()) - i;
        ...
        return new SharingConfig<>(flow, a2, BufferOverflow.SUSPEND, EmptyCoroutineContext.INSTANCE);
    }

    public static final <T> void launchSharing$FlowKt__ShareKt(CoroutineScope coroutineScope, InterfaceC23020xjk interfaceC23020xjk, Flow<? extends T> flow, MutableSharedFlow<T> mutableSharedFlow, SharingStarted sharingStarted, T t) {
        BuildersKt__Builders_commonKt.launch$default(coroutineScope, interfaceC23020xjk, null, new FlowKt__ShareKt$launchSharing$1(sharingStarted, flow, mutableSharedFlow, t, null), 2, null);
    }

    public static final <T> void launchSharingDeferred$FlowKt__ShareKt(CoroutineScope coroutineScope, InterfaceC23020xjk interfaceC23020xjk, Flow<? extends T> flow, CompletableDeferred<StateFlow<T>> completableDeferred) {
        BuildersKt__Builders_commonKt.launch$default(coroutineScope, interfaceC23020xjk, null, new FlowKt__ShareKt$launchSharingDeferred$1(flow, completableDeferred, null), 2, null);
    }
    ...
    public static final <T> SharedFlow<T> onSubscription(SharedFlow<? extends T> sharedFlow, InterfaceC19378rlk<? super FlowCollector<? super T>, ? super InterfaceC20576tjk<? super Kfk>, ? extends Object> interfaceC19378rlk) {
        return new SubscribedSharedFlow(sharedFlow, interfaceC19378rlk);
    }
    ...
    public static final <T> Object stateIn(Flow<? extends T> flow, CoroutineScope coroutineScope, InterfaceC20576tjk<? super StateFlow<? extends T>> interfaceC20576tjk) {
        ...
        return CompletableDeferred$default.await(interfaceC20576tjk);
    }
}
