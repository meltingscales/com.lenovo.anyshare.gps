...
@Jjk(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4", f = "Zip.kt", i = {0}, l = {273}, m = "invokeSuspend", n = {"$this$flow"}, s = {"L$0"})
...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4<R> extends SuspendLambda implements InterfaceC19378rlk<FlowCollector<? super R>, InterfaceC20576tjk<? super Kfk>, Object> {
    public final /* synthetic */ Flow[] $flows;
    public final /* synthetic */ InterfaceC21822vlk $transform$inlined;
    public Object L$0;
    public int label;
    public FlowCollector p$;

    @Jjk(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4$1", f = "Zip.kt", i = {0, 0, 0, 0, 0}, l = {337}, m = "invokeSuspend", n = {"$this$combineInternal", "it", "continuation", "args", "$receiver"}, s = {"L$0", "L$1", "L$2", "L$3", "L$4"})
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements InterfaceC19989slk<FlowCollector<? super R>, Object[], InterfaceC20576tjk<? super Kfk>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                InterfaceC21822vlk interfaceC21822vlk = FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4.this.$transform$inlined;
                ...
                this.label = 1;
                C9612bmk.c(6);
                Object invoke = interfaceC21822vlk.invoke(flowCollector, obj2, obj3, obj4, obj5, this);
                C9612bmk.c(7);
                if (invoke == a2) {
                    return a2;
                }
    ...
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4(Flow[] flowArr, InterfaceC20576tjk interfaceC20576tjk, InterfaceC21822vlk interfaceC21822vlk) {
        super(2, interfaceC20576tjk);
        this.$flows = flowArr;
        this.$transform$inlined = interfaceC21822vlk;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final InterfaceC20576tjk<Kfk> create(Object obj, InterfaceC20576tjk<?> interfaceC20576tjk) {
        FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4 flowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4 = new FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4(this.$flows, interfaceC20576tjk, this.$transform$inlined);
    ...
    public final Object invoke(Object obj, InterfaceC20576tjk<? super Kfk> interfaceC20576tjk) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4) create(obj, interfaceC20576tjk)).invokeSuspend(Kfk.f11108a);
    }
