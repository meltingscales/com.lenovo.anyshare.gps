...
public class BroadcastCoroutine<E> extends AbstractCoroutine<Kfk> implements ProducerScope<E>, BroadcastChannel<E> {
    public final BroadcastChannel<E> _channel;

    public BroadcastCoroutine(InterfaceC23020xjk interfaceC23020xjk, BroadcastChannel<E> broadcastChannel, boolean z) {
        super(interfaceC23020xjk, z);
        this._channel = broadcastChannel;
    }

    public static /* synthetic */ Object send$suspendImpl(BroadcastCoroutine broadcastCoroutine, Object obj, InterfaceC20576tjk interfaceC20576tjk) {
        return broadcastCoroutine._channel.send(obj, interfaceC20576tjk);
    }
    ...
    @Override // kotlinx.coroutines.AbstractCoroutine
    public void onCompleted(Kfk kfk) {
