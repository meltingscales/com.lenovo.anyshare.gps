...
public class SendElement<E> extends Send {
    ...
    public SendElement(E e, CancellableContinuation<? super Kfk> cancellableContinuation) {
        this.pollResult = e;
    ...
    public void resumeSendClosed(Closed<?> closed) {
        CancellableContinuation<Kfk> cancellableContinuation = this.cont;
        Throwable sendException = closed.getSendException();
        Result.a aVar = Result.Companion;
        Object a2 = C12577gfk.a(sendException);
    ...
    public Symbol tryResumeSend(LockFreeLinkedListNode.PrepareOp prepareOp) {
        Object tryResume = this.cont.tryResume(Kfk.f11108a, prepareOp != null ? prepareOp.desc : null);
        if (tryResume != null) {
