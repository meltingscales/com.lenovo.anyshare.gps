...
public final class ArrayBroadcastChannel<E> extends AbstractSendChannel<E> implements BroadcastChannel<E> {
        ...
        */
        public java.lang.Object pollInternal() {
            /*
                ...
                goto L13
            Lf:
                kotlinx.coroutines.internal.Symbol r2 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch: java.lang.Throwable -> L44
                if (r1 != r2) goto L15
            L13:
                r2 = 0
                goto L20
    ...
    private final long computeMinHead() {
        ...
        for (Subscriber<E> subscriber : this.subscribers) {
            j = C21235unk.b(j, subscriber.getSubHead());
        }
        return j;
    }
    ...
    private final void updateHead(Subscriber<E> subscriber, Subscriber<E> subscriber2) {
        ...
        while (true) {
            ...
            long tail = getTail();
            long head = getHead();
            long b = C21235unk.b(computeMinHead, tail);
            if (b <= head) {
                return;
            }
            int size = getSize();
