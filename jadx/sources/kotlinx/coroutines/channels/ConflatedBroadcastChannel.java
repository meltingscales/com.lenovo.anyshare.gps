...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    private final Subscriber<E>[] addSubscriber(Subscriber<E>[] subscriberArr, Subscriber<E> subscriber) {
        ...
        return (Subscriber[]) C22373wgk.a(subscriberArr, subscriber);
    }
    ...
    private final Subscriber<E>[] removeSubscriber(Subscriber<E>[] subscriberArr, Subscriber<E> subscriber) {
        ...
        int d = Zgk.d(subscriberArr, subscriber);
        ...
        C22373wgk.a(subscriberArr, subscriberArr2, 0, 0, d, 6, (Object) null);
        C22373wgk.a(subscriberArr, subscriberArr2, d, d + 1, 0, 8, (Object) null);
        return subscriberArr2;
    }
    ...
    public SelectClause2<E, SendChannel<E>> getOnSend() {
        return (SelectClause2<E, SendChannel<? super E>>) new SelectClause2<E, SendChannel<? super E>>() { // from class: kotlinx.coroutines.channels.ConflatedBroadcastChannel$onSend$1
            ...
            public <R> void registerSelectClause2(SelectInstance<? super R> selectInstance, E e, InterfaceC19378rlk<? super SendChannel<? super E>, ? super InterfaceC20576tjk<? super R>, ? extends Object> interfaceC19378rlk) {
                ConflatedBroadcastChannel.this.registerSelectSend(selectInstance, e, interfaceC19378rlk);
            }
        };
    }
    ...
    public void invokeOnClose(InterfaceC16940nlk<? super Throwable, Kfk> interfaceC16940nlk) {
        ...
        if ((obj2 instanceof Closed) && onCloseHandler$FU.compareAndSet(this, interfaceC16940nlk, AbstractChannelKt.HANDLER_INVOKED)) {
            interfaceC16940nlk.invoke(((Closed) obj2).closeCause);
        }
    }
    ...
    public Object send(E e, InterfaceC20576tjk<? super Kfk> interfaceC20576tjk) {
        Closed offerInternal = offerInternal(e);
        if (offerInternal == null) {
            return offerInternal == Fjk.a() ? offerInternal : Kfk.f11108a;
        }
        throw offerInternal.getSendException();
    }
