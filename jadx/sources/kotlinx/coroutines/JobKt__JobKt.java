...
public final /* synthetic */ class JobKt__JobKt {
    ...
    public static /* synthetic */ void cancel$default(InterfaceC23020xjk interfaceC23020xjk, CancellationException cancellationException, int i, Object obj) {
        if ((i & 1) != 0) {
            cancellationException = null;
        }
        JobKt.cancel(interfaceC23020xjk, cancellationException);
    }

    public static final Object cancelAndJoin(Job job, InterfaceC20576tjk<? super Kfk> interfaceC20576tjk) {
        Job.DefaultImpls.cancel$default(job, (CancellationException) null, 1, (Object) null);
        Object join = job.join(interfaceC20576tjk);
        return join == Fjk.a() ? join : Kfk.f11108a;
    }
    ...
    public static final Job getJob(InterfaceC23020xjk interfaceC23020xjk) {
        ...
        throw new IllegalStateException(("Current context doesn't contain Job in it: " + interfaceC23020xjk).toString());
    }
    ...
    /* renamed from: Job */
    public static final /* synthetic */ Job m1588Job(Job job) {
        return JobKt.Job(job);
    }

    /* renamed from: Job$default */
    public static /* synthetic */ Job m1589Job$default(Job job, int i, Object obj) {
        Job m1588Job;
        if ((i & 1) != 0) {
            job = null;
        }
        m1588Job = m1588Job(job);
        return m1588Job;
    }
    ...
    public static /* synthetic */ boolean cancel$default(InterfaceC23020xjk interfaceC23020xjk, Throwable th, int i, Object obj) {
        boolean cancel;
        if ((i & 1) != 0) {
            th = null;
        }
        cancel = cancel(interfaceC23020xjk, th);
        return cancel;
    }

    public static /* synthetic */ void cancelChildren$default(InterfaceC23020xjk interfaceC23020xjk, CancellationException cancellationException, int i, Object obj) {
        if ((i & 1) != 0) {
            cancellationException = null;
        }
        JobKt.cancelChildren(interfaceC23020xjk, cancellationException);
    }

    @InterfaceC24181zek(level = DeprecationLevel.HIDDEN, message = "Since 1.2.0, binary compatibility with versions <= 1.1.x")
    public static final /* synthetic */ boolean cancel(InterfaceC23020xjk interfaceC23020xjk, Throwable th) {
        InterfaceC23020xjk.b bVar = interfaceC23020xjk.get(Job.Key);
    ...
    public static /* synthetic */ void cancelChildren$default(InterfaceC23020xjk interfaceC23020xjk, Throwable th, int i, Object obj) {
        if ((i & 1) != 0) {
            th = null;
        }
        cancelChildren(interfaceC23020xjk, th);
    }
    ...
    public static final void cancelChildren(InterfaceC23020xjk interfaceC23020xjk, CancellationException cancellationException) {
        InterfaceC24301zok<Job> children;
        Job job = (Job) interfaceC23020xjk.get(Job.Key);
    ...
    @InterfaceC24181zek(level = DeprecationLevel.HIDDEN, message = "Since 1.2.0, binary compatibility with versions <= 1.1.x")
    public static final /* synthetic */ void cancelChildren(InterfaceC23020xjk interfaceC23020xjk, Throwable th) {
        Job job = (Job) interfaceC23020xjk.get(Job.Key);
        if (job != null) {
            for (Job job2 : job.getChildren()) {
                if (!(job2 instanceof JobSupport)) {
