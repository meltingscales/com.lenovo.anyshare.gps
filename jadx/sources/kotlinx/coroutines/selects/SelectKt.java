...
public final class SelectKt {
    ...
    public static final <R> void m1639onTimeout0lHKgQg(SelectBuilder<? super R> selectBuilder, double d, InterfaceC16940nlk<? super InterfaceC20576tjk<? super R>, ? extends Object> interfaceC16940nlk) {
        selectBuilder.onTimeout(DelayKt.m1585toDelayMillisLRDsOJo(d), interfaceC16940nlk);
    }

    public static final <R> Object select(InterfaceC16940nlk<? super SelectBuilder<? super R>, Kfk> interfaceC16940nlk, InterfaceC20576tjk<? super R> interfaceC20576tjk) {
    ...
    public static final Object select$$forInline(InterfaceC16940nlk interfaceC16940nlk, InterfaceC20576tjk interfaceC20576tjk) {
        C9612bmk.c(0);
        SelectBuilderImpl selectBuilderImpl = new SelectBuilderImpl(interfaceC20576tjk);
        try {
            interfaceC16940nlk.invoke(selectBuilderImpl);
