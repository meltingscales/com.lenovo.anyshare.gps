...
public class DeferredCoroutine<T> extends AbstractCoroutine<T> implements Deferred<T>, SelectClause1<T> {
    public DeferredCoroutine(InterfaceC23020xjk interfaceC23020xjk, boolean z) {
    ...
    */
    public static /* synthetic */ java.lang.Object await$suspendImpl(kotlinx.coroutines.DeferredCoroutine r4, com.lenovo.anyshare.InterfaceC20576tjk r5) {
        /*
        ...
        L43:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.DeferredCoroutine.await$suspendImpl(kotlinx.coroutines.DeferredCoroutine, com.lenovo.anyshare.tjk):java.lang.Object");
    }

    @Override // kotlinx.coroutines.Deferred
    public Object await(InterfaceC20576tjk<? super T> interfaceC20576tjk) {
        return await$suspendImpl(this, interfaceC20576tjk);
    }
    ...
    public <R> void registerSelectClause1(SelectInstance<? super R> selectInstance, InterfaceC19378rlk<? super T, ? super InterfaceC20576tjk<? super R>, ? extends Object> interfaceC19378rlk) {
        registerSelectClause1Internal$kotlinx_coroutines_core(selectInstance, interfaceC19378rlk);
    }
}
