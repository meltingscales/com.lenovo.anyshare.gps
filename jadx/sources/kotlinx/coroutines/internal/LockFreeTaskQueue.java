...
public class LockFreeTaskQueue<E> {
    ...
    public final <R> List<R> map(InterfaceC16940nlk<? super E, ? extends R> interfaceC16940nlk) {
        return ((LockFreeTaskQueueCore) this._cur).map(interfaceC16940nlk);
    }
